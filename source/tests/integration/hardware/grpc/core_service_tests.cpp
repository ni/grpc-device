...
class InProcessServerClientTest : public ::testing::Test {
 public:
  ...
  void SetUp() override
  {
    ...
    device_management_library = std::make_unique<ni::hardware::grpc::internal::SharedLibrary>();
    device_management_ = std::make_unique<ni::hardware::grpc::internal::DeviceManagement>(device_management_library.get());
 ...
 private:
  ...
  std::unique_ptr<ni::hardware::grpc::internal::SharedLibrary> device_management_library;
