...
TEST(ServerConfigurationParserTests, JsonConfigWithInvalidFeatureToggleValue_ParseFeatureToggles_ThrowsException)
{
  nlohmann::json config_json = nlohmann::json::parse(R"(
    {
      "feature_toggles" : { 
...
TEST(ServerConfigurationParserTests, JsonConfigWithFeatureTogglesAsArray_ParseFeatureToggles_ThrowsException)
{
  nlohmann::json config_json = nlohmann::json::parse(R"(
    {
