...
TEST_F(NiRFmxTDSCDMADriverApiTests, AcpFromExample_FetchData_DataLooksReasonable)
{
  ...
  EXPECT_EQ(0.0, acp_fetch_carrier_absolute_power_response.carrier_absolute_power());
...
TEST_F(NiRFmxTDSCDMADriverApiTests, CdaFromExample_FetchData_DataLooksReasonable)
{
  ...
  EXPECT_EQ(0.0, cda_fetch_iq_impairments_response.iq_origin_offset());
  EXPECT_EQ(0.0, cda_fetch_iq_impairments_response.iq_gain_imbalance());
  EXPECT_EQ(0.0, cda_fetch_iq_impairments_response.iq_quadrature_error());
  EXPECT_SUCCESS(session, cda_fetch_code_domain_power_response);
  EXPECT_EQ(0.0, cda_fetch_code_domain_power_response.mean_total_power());
  EXPECT_EQ(0.0, cda_fetch_code_domain_power_response.mean_total_active_power());
  EXPECT_EQ(0.0, cda_fetch_code_domain_power_response.mean_active_power());
  EXPECT_EQ(0.0, cda_fetch_code_domain_power_response.maximum_peak_active_power());
  EXPECT_EQ(0.0, cda_fetch_code_domain_power_response.mean_inactive_power());
  EXPECT_EQ(0.0, cda_fetch_code_domain_power_response.maximum_peak_inactive_power());
  EXPECT_SUCCESS(session, cda_fetch_symbol_evm_response);
  EXPECT_EQ(0.0, cda_fetch_symbol_evm_response.mean_rms_symbol_evm());
  EXPECT_EQ(0.0, cda_fetch_symbol_evm_response.maximum_peak_symbol_evm());
  EXPECT_EQ(0.0, cda_fetch_symbol_evm_response.frequency_error());
  EXPECT_EQ(0.0, cda_fetch_symbol_evm_response.chip_rate_error());
  EXPECT_EQ(0.0, cda_fetch_symbol_evm_response.mean_rms_symbol_magnitude_error());
  EXPECT_EQ(0.0, cda_fetch_symbol_evm_response.mean_rms_symbol_phase_error());
  EXPECT_EQ(0.0, cda_fetch_symbol_evm_response.mean_symbol_power());
  EXPECT_SUCCESS(session, cda_fetch_mean_code_domain_power_trace_response);
  EXPECT_EQ(999, cda_fetch_mean_code_domain_power_trace_response.mean_code_domain_powers_size());
  EXPECT_EQ(999, cda_fetch_mean_code_domain_power_trace_response.mean_code_domain_powers().size());
  EXPECT_EQ(0.0, cda_fetch_mean_code_domain_power_trace_response.mean_code_domain_powers(0));
  EXPECT_SUCCESS(session, cda_fetch_mean_symbol_evm_trace_response);
  EXPECT_EQ(999, cda_fetch_mean_symbol_evm_trace_response.mean_symbol_evm_size());
  EXPECT_EQ(999, cda_fetch_mean_symbol_evm_trace_response.mean_symbol_evm().size());
  EXPECT_EQ(0.0, cda_fetch_mean_symbol_evm_trace_response.mean_symbol_evm(0));
  EXPECT_SUCCESS(session, cda_fetch_symbol_constellation_trace_response);
  EXPECT_EQ(0.0, cda_fetch_symbol_constellation_trace_response.symbol_constellation(0).real());
  EXPECT_EQ(0.0, cda_fetch_symbol_constellation_trace_response.symbol_constellation(0).imaginary());
}
...
TEST_F(NiRFmxTDSCDMADriverApiTests, ChpFromExample_FetchData_DataLooksReasonable)
{
  ...
  EXPECT_EQ(0.0, chp_fetch_carrier_absolute_power_response.carrier_absolute_power());
...
TEST_F(NiRFmxTDSCDMADriverApiTests, ModAccFromExample_FetchData_DataLooksReasonable)
{
  ...
  EXPECT_EQ(0.0, mod_acc_fetch_composite_evm_response.peak_composite_evm());
  EXPECT_EQ(0.0, mod_acc_fetch_composite_evm_response.composite_rho());
  EXPECT_EQ(0.0, mod_acc_fetch_composite_evm_response.frequency_error());
  EXPECT_EQ(0.0, mod_acc_fetch_composite_evm_response.chip_rate_error());
  EXPECT_EQ(0.0, mod_acc_fetch_composite_evm_response.rms_composite_magnitude_error());
  EXPECT_EQ(0.0, mod_acc_fetch_composite_evm_response.rms_composite_phase_error());
  EXPECT_SUCCESS(session, mod_acc_fetch_data_evm_response);
  EXPECT_EQ(0.0, mod_acc_fetch_data_evm_response.rms_data_evm());
  EXPECT_EQ(0.0, mod_acc_fetch_data_evm_response.peak_data_evm());
  EXPECT_EQ(0.0, mod_acc_fetch_data_evm_response.data_rho());
  EXPECT_EQ(0.0, mod_acc_fetch_data_evm_response.rms_data_magnitude_error());
  EXPECT_EQ(0.0, mod_acc_fetch_data_evm_response.rms_data_phase_error());
  EXPECT_SUCCESS(session, mod_acc_fetch_iq_impairments_response);
  EXPECT_EQ(0.0, mod_acc_fetch_iq_impairments_response.iq_origin_offset());
  EXPECT_EQ(0.0, mod_acc_fetch_iq_impairments_response.iq_gain_imbalance());
  EXPECT_EQ(0.0, mod_acc_fetch_iq_impairments_response.iq_quadrature_error());
  EXPECT_SUCCESS(session, mod_acc_fetch_constellation_trace_response);
  EXPECT_EQ(0.0, mod_acc_fetch_constellation_trace_response.constellation(0).real());
  EXPECT_EQ(0.0, mod_acc_fetch_constellation_trace_response.constellation(0).imaginary());
  EXPECT_SUCCESS(session, mod_acc_fetch_midamble_evm_response);
  EXPECT_EQ(0.0, mod_acc_fetch_midamble_evm_response.rms_midamble_evm());
  EXPECT_EQ(0.0, mod_acc_fetch_midamble_evm_response.peak_midamble_evm());
  EXPECT_EQ(0.0, mod_acc_fetch_midamble_evm_response.midamble_rho());
  EXPECT_EQ(0.0, mod_acc_fetch_midamble_evm_response.rms_midamble_magnitude_error());
  EXPECT_EQ(0.0, mod_acc_fetch_midamble_evm_response.rms_midamble_phase_error());
  EXPECT_SUCCESS(session, mod_acc_fetch_midamble_and_data_power_response);
  EXPECT_EQ(0.0, mod_acc_fetch_midamble_and_data_power_response.midamble_power());
  EXPECT_EQ(0.0, mod_acc_fetch_midamble_and_data_power_response.data_field1_power());
  EXPECT_EQ(0.0, mod_acc_fetch_midamble_and_data_power_response.data_field2_power());
...
TEST_F(NiRFmxTDSCDMADriverApiTests, ModAccAcpChpObwSemCompositeFromExample_FetchData_DataLooksReasonable)
{
  ...
  EXPECT_EQ(0.0, sem_fetch_carrier_absolute_integrated_power_response.carrier_absolute_integrated_power());
}
...
TEST_F(NiRFmxTDSCDMADriverApiTests, ModAccPilotFromExample_FetchData_DataLooksReasonable)
{
  ...
  EXPECT_EQ(0.0, mod_acc_fetch_pilot_evm_response.rms_pilot_evm());
  EXPECT_EQ(0.0, mod_acc_fetch_pilot_evm_response.peak_pilot_evm());
  EXPECT_EQ(0.0, mod_acc_fetch_pilot_evm_response.pilot_rho());
  EXPECT_EQ(0.0, mod_acc_fetch_pilot_evm_response.rms_pilot_magnitude_error());
  EXPECT_EQ(0.0, mod_acc_fetch_pilot_evm_response.rms_pilot_phase_error());
  EXPECT_SUCCESS(session, mod_acc_fetch_composite_evm_response);
  EXPECT_EQ(0.0, mod_acc_fetch_composite_evm_response.rms_composite_evm());
  EXPECT_EQ(0.0, mod_acc_fetch_composite_evm_response.peak_composite_evm());
  EXPECT_EQ(0.0, mod_acc_fetch_composite_evm_response.composite_rho());
...
TEST_F(NiRFmxTDSCDMADriverApiTests, PvtFromExample_FetchData_DataLooksReasonable)
{
  auto session = init_session(stub(), PXI_5663E);
  EXPECT_SUCCESS(session, client::cfg_frequency_reference(stub(), session, "", FREQUENCY_REFERENCE_SOURCE_ONBOARD_CLOCK, 10E+6));
  EXPECT_SUCCESS(session, client::cfg_rf(stub(), session, "", 1.91E+9, 0.00, 0.00));
  ...
  EXPECT_EQ(0.0, pvt_fetch_powers_response.mean_absolute_on_power());
  EXPECT_EQ(0.0, pvt_fetch_powers_response.mean_absolute_off_power());
  EXPECT_SUCCESS(session, pvt_fetch_segment_measurement_array_response);
  EXPECT_EQ(999, pvt_fetch_segment_measurement_array_response.segment_status_size());
  EXPECT_EQ(999, pvt_fetch_segment_measurement_array_response.segment_status().size());
  EXPECT_EQ(0, pvt_fetch_segment_measurement_array_response.segment_status(0));
  EXPECT_EQ(999, pvt_fetch_segment_measurement_array_response.segment_margin_size());
  EXPECT_EQ(999, pvt_fetch_segment_measurement_array_response.segment_margin().size());
  EXPECT_EQ(0.0, pvt_fetch_segment_measurement_array_response.segment_margin(0));
  EXPECT_EQ(999, pvt_fetch_segment_measurement_array_response.segment_margin_time_size());
  EXPECT_EQ(999, pvt_fetch_segment_measurement_array_response.segment_margin_time().size());
  EXPECT_EQ(0.0, pvt_fetch_segment_measurement_array_response.segment_margin_time(0));
  EXPECT_EQ(999, pvt_fetch_segment_measurement_array_response.segment_mean_absolute_power_size());
  EXPECT_EQ(999, pvt_fetch_segment_measurement_array_response.segment_mean_absolute_power().size());
  EXPECT_EQ(0.0, pvt_fetch_segment_measurement_array_response.segment_mean_absolute_power(0));
  EXPECT_EQ(999, pvt_fetch_segment_measurement_array_response.segment_maximum_absolute_power_size());
  EXPECT_EQ(999, pvt_fetch_segment_measurement_array_response.segment_maximum_absolute_power().size());
  EXPECT_EQ(0.0, pvt_fetch_segment_measurement_array_response.segment_maximum_absolute_power(0));
  EXPECT_EQ(999, pvt_fetch_segment_measurement_array_response.segment_minimum_absolute_power_size());
  EXPECT_EQ(999, pvt_fetch_segment_measurement_array_response.segment_minimum_absolute_power().size());
  EXPECT_EQ(0.0, pvt_fetch_segment_measurement_array_response.segment_minimum_absolute_power(0));
...
TEST_F(NiRFmxTDSCDMADriverApiTests, SemFromExample_FetchData_DataLooksReasonable)
{
  ...
  EXPECT_EQ(999, sem_fetch_spectrum_response.relative_mask_size());
  EXPECT_EQ(999, sem_fetch_spectrum_response.relative_mask().size());
  EXPECT_EQ(0.0, sem_fetch_spectrum_response.relative_mask(0));
  EXPECT_EQ(999, sem_fetch_spectrum_response.absolute_mask_size());
  EXPECT_EQ(999, sem_fetch_spectrum_response.absolute_mask().size());
  EXPECT_EQ(0.0, sem_fetch_spectrum_response.absolute_mask(0));
}
...
TEST_F(NiRFmxTDSCDMADriverApiTests, SlotPowerFromExample_FetchData_DataLooksReasonable)
{
  ...
  EXPECT_EQ(999, slot_power_fetch_powers_response.slot_power_size());
  EXPECT_EQ(999, slot_power_fetch_powers_response.slot_power().size());
  EXPECT_EQ(0.0, slot_power_fetch_powers_response.slot_power(0));
  EXPECT_EQ(999, slot_power_fetch_powers_response.slot_power_delta_size());
  EXPECT_EQ(999, slot_power_fetch_powers_response.slot_power_delta().size());
  EXPECT_EQ(0.0, slot_power_fetch_powers_response.slot_power_delta(0));
}
