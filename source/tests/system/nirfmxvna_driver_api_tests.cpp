...
TEST_F(NiRFmxVNADriverApiTests, AcpFromExample_FetchData_DataLooksReasonable)
{
...
TEST_F(NiRFmxVNADriverApiTests, CdaFromExample_FetchData_DataLooksReasonable)
{
  auto session = init_session(stub(), PXI_5663E);
  EXPECT_SUCCESS(session, client::cfg_frequency_reference(stub(), session, "", FREQUENCY_REFERENCE_SOURCE_ONBOARD_CLOCK, 10.0e+6));
...
TEST_F(NiRFmxVNADriverApiTests, ChpFromExample_FetchData_DataLooksReasonable)
{
  auto session = init_session(stub(), PXI_5663E);
  EXPECT_SUCCESS(session, client::cfg_frequency_reference(stub(), session, "", FREQUENCY_REFERENCE_SOURCE_ONBOARD_CLOCK, 10.0e+6));
  EXPECT_SUCCESS(session, client::cfg_rf(stub(), session, "", 833.490e+6, 0.00, 0.00 ));
...
TEST_F(NiRFmxVNADriverApiTests, ModAccFromExample_FetchData_DataLooksReasonable)
{
  auto session = init_session(stub(), PXI_5663E);
  EXPECT_SUCCESS(session, client::cfg_frequency_reference(stub(), session, "", FREQUENCY_REFERENCE_SOURCE_ONBOARD_CLOCK, 10.0e+6));
  EXPECT_SUCCESS(session, client::cfg_rf(stub(), session, "", 833.490e+6, 0.00, 0.00));
...
TEST_F(NiRFmxVNADriverApiTests, ObwFromExample_FetchData_DataLooksReasonable)
{
  auto session = init_session(stub(), PXI_5663E);
  EXPECT_SUCCESS(session, client::cfg_frequency_reference(stub(), session, "", FREQUENCY_REFERENCE_SOURCE_ONBOARD_CLOCK, 10.0e+6));
  EXPECT_SUCCESS(session, client::cfg_rf(stub(), session, "", 833.490e+6, 0.00, 0.00 ));
...
TEST_F(NiRFmxVNADriverApiTests, QevmFromExample_FetchData_DataLooksReasonable)
{
  auto session = init_session(stub(), PXI_5663E);
  EXPECT_SUCCESS(session, client::cfg_frequency_reference(stub(), session, "", FREQUENCY_REFERENCE_SOURCE_ONBOARD_CLOCK, 10.0e+6 ));
  EXPECT_SUCCESS(session, client::cfg_rf(stub(), session, "", 833.490e+6, 0.00, 0.00 ));
...
TEST_F(NiRFmxVNADriverApiTests, SlotPhaseFromExample_FetchData_DataLooksReasonable)
{
...
TEST_F(NiRFmxVNADriverApiTests, SlotPowerFromExample_FetchData_DataLooksReasonable)
{
  const auto NUMBER_OF_SLOTS = 16;
  auto session = init_session(stub(), PXI_5663E);
  EXPECT_SUCCESS(session, client::cfg_frequency_reference(stub(), session, "", FREQUENCY_REFERENCE_SOURCE_ONBOARD_CLOCK, 10.0e+6));
