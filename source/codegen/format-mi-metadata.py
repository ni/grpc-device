...
from template_helpers import load_metadata, write_if_changed
...
def _format_mi_metadata(metadata_dir: str):
    ...
    for mi_driver in mi_drivers:
        ...
        for metadata_name in metadata_names:
            ...
            pretty_metadata = pretty(actual_metadata)
            write_if_changed(f"{path}{metadata_name}.py", pretty_metadata)
