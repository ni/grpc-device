enums = {
    ...
    'ScaleType': {
        'values': [
            ...
            {
                'documentation': {
                    'description': ' Map a list of pre-scaled values to a list of corresponding scaled values,  with all other values scaled proportionally.'
                },
                'name': 'TABLE',
                'value': 10450
            }
    ...
    'ScaleType2': {
        ...
        'values': [
            ...
            {
                'documentation': {
                    'description': ' Map a list of prescaled values to a list of corresponding scaled values,  with all other values scaled proportionally.'
                },
                'name': 'TABLE',
                'value': 10450
            }
    ...
    'ScaleType4': {
        ...
        'values': [
            ...
            {
                'documentation': {
                    'description': ' Map a list of electrical values to a list of corresponding physical values,  with all other values scaled proportionally. If you specify this scaling type,  DAQmx_AI_Max and DAQmx_AI_Min must be within the smallest and largest physical  values. For any data outside those endpoints, NI-DAQmx coerces that data to the  endpoints.',
