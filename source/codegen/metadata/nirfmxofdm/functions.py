functions = {
    ...
    'AnalyzeIQ1WaveformInterleavedIQ': {
        'cname': 'RFmxOFDM_AnalyzeIQ1Waveform',
        'parameters': [
            {
                'direction': 'in',
                'grpc_name': 'instrument',
    ...
    'Initialize': {
        'custom_close': 'Close(id, RFMXOFDM_VAL_FALSE)',
        'init_method': True,
        'parameters': [
            {
                'direction': 'in',
    ...
    'LoadResourceAllocationCustomIQValuesFromFile': {
        'parameters': [
            {
                'direction': 'in',
                'grpc_name': 'instrument',
    ...
    'ModAccFetchChannelFrequencyResponseMeanTrace': {
        'parameters': [
            {
                'direction': 'in',
                'grpc_name': 'instrument',
    ...
    'ModAccFetchDataConstellationTrace': {
        'parameters': [
            {
                'direction': 'in',
                'grpc_name': 'instrument',
    ...
    'ModAccFetchDataConstellationTraceInterleavedIQ': {
        'cname': 'RFmxOFDM_ModAccFetchDataConstellationTrace',
        'parameters': [
            {
                'direction': 'in',
                'grpc_name': 'instrument',
    ...
    'ModAccFetchDataConstellationTraceSplit': {
        'parameters': [
            {
                'direction': 'in',
                'grpc_name': 'instrument',
    ...
    'ModAccFetchDataRMSEVMPerSymbolMeanTrace': {
        'parameters': [
            {
                'direction': 'in',
                'grpc_name': 'instrument',
            ...
            {
                'direction': 'out',
                'grpc_name': 'data_rms_evm_per_symbol_mean',
                'name': 'dataRMSEVMPerSymbolMean',
                'size': {
                    'mechanism': 'ivi-dance-with-a-twist',
                    'value': 'arraySize',
                    'value_twist': 'actualArraySize'
    ...
    'ModAccFetchEVMSubcarrierIndices': {
        'parameters': [
            {
                'direction': 'in',
                'grpc_name': 'instrument',
    ...
    'ModAccFetchPilotConstellationTrace': {
        'parameters': [
            {
                'direction': 'in',
                'grpc_name': 'instrument',
    ...
    'ModAccFetchPilotConstellationTraceInterleavedIQ': {
        'cname': 'RFmxOFDM_ModAccFetchPilotConstellationTrace',
        'parameters': [
            {
                'direction': 'in',
                'grpc_name': 'instrument',
    ...
    'ModAccFetchPilotConstellationTraceSplit': {
        'parameters': [
            {
                'direction': 'in',
                'grpc_name': 'instrument',
    ...
    'ModAccFetchPilotRMSEVMPerSymbolMeanTrace': {
        'parameters': [
            {
                'direction': 'in',
                'grpc_name': 'instrument',
            ...
            {
                'direction': 'out',
                'grpc_name': 'pilot_rms_evm_per_symbol_mean',
                'name': 'pilotRMSEVMPerSymbolMean',
                'size': {
                    'mechanism': 'ivi-dance-with-a-twist',
                    'value': 'arraySize',
                    'value_twist': 'actualArraySize'
