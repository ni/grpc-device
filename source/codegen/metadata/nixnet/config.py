...
config = {
    ...
    'driver_name': 'NI-XNET',
    'status_ok': 'status >= 0',
    'additional_headers': {'server/converters.h': ['service_registrar.h', 'library_interface.h'], 'custom/nixnet_converters.h': ['service_registrar.h', 'service.cpp', 'library_interface.h'] }, 
