...
def _validate_examples(
    ...
    with _create_stage_dir(staging_dir):
        ...
        _system(
            rf"poetry run python -m grpc_tools.protoc -I{proto_dir} -I{ni_apis_root}/ni/grpcdevice/v1/ -I{ni_apis_root}/ --python_out=. --grpc_python_out=. --mypy_out=. --mypy_grpc_out=. {proto_files_str}"
        )
