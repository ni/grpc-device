...
::grpc::Status NiRFmxBluetoothService::ConvertApiErrorStatusForNiRFmxInstrHandle(::grpc::ServerContext* context, google::protobuf::int32 status, niRFmxInstrHandle instrumentHandle)
{
  ViStatus error_code{};
