#include <nirfmxofdm/nirfmxofdm_service.h>

namespace nirfmxofdm_grpc {

::grpc::Status NiRFmxOFDMService::ConvertApiErrorStatusForNiRFmxInstrHandle(::grpc::ServerContextBase* context, int32_t status, niRFmxInstrHandle instrumentHandle)
{
  ViStatus error_code{};
