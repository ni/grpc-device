...
::grpc::Status NiRFmxWLANService::ConvertApiErrorStatusForNiRFmxInstrHandle(::grpc::ServerContext* context, google::protobuf::int32 status, niRFmxInstrHandle instrumentHandle)
{
  int32 error_code{};
