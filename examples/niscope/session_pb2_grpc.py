...
class SessionUtilitiesStub(object):
    ...
    def __init__(self, channel):
        ...
        self.EnumerateDevices = channel.unary_unary(
                '/grpc.nidevice.SessionUtilities/EnumerateDevices',
        ...
        self.Reserve = channel.unary_unary(
                '/grpc.nidevice.SessionUtilities/Reserve',
        ...
        self.IsReservedByClient = channel.unary_unary(
                '/grpc.nidevice.SessionUtilities/IsReservedByClient',
        ...
        self.Unreserve = channel.unary_unary(
                '/grpc.nidevice.SessionUtilities/Unreserve',
        ...
        self.ResetServer = channel.unary_unary(
                '/grpc.nidevice.SessionUtilities/ResetServer',
...
def add_SessionUtilitiesServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'grpc.nidevice.SessionUtilities', rpc_method_handlers)
...
class SessionUtilities(object):
    ...
    def EnumerateDevices(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/grpc.nidevice.SessionUtilities/EnumerateDevices',
    ...
    def Reserve(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/grpc.nidevice.SessionUtilities/Reserve',
    ...
    def IsReservedByClient(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/grpc.nidevice.SessionUtilities/IsReservedByClient',
    ...
    def Unreserve(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/grpc.nidevice.SessionUtilities/Unreserve',
    ...
    def ResetServer(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/grpc.nidevice.SessionUtilities/ResetServer',
