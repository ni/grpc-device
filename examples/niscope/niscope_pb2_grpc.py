...
import niscope_pb2 as niscope__pb2
...
class NiScopeStub(object):
    ...
    def __init__(self, channel):
        ...
        self.LockSession = channel.unary_unary(
                '/niscope_grpc.NiScope/LockSession',
                request_serializer=niscope__pb2.LockSessionRequest.SerializeToString,
                response_deserializer=niscope__pb2.LockSessionResponse.FromString,
                )
        ...
        self.UnlockSession = channel.unary_unary(
                '/niscope_grpc.NiScope/UnlockSession',
                request_serializer=niscope__pb2.UnlockSessionRequest.SerializeToString,
                response_deserializer=niscope__pb2.UnlockSessionResponse.FromString,
                )
...
def add_NiScopeServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'LockSession': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=niscope__pb2.LockSessionRequest.FromString,
                    response_serializer=niscope__pb2.LockSessionResponse.SerializeToString,
            ),
            ...
            'UnlockSession': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=niscope__pb2.UnlockSessionRequest.FromString,
                    response_serializer=niscope__pb2.UnlockSessionResponse.SerializeToString,
            ),
    }
...
class NiScope(object):
    ...
    def LockSession(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/niscope_grpc.NiScope/LockSession',
            niscope__pb2.LockSessionRequest.SerializeToString,
            niscope__pb2.LockSessionResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def UnlockSession(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/niscope_grpc.NiScope/UnlockSession',
            niscope__pb2.UnlockSessionRequest.SerializeToString,
            niscope__pb2.UnlockSessionResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
