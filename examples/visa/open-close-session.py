...
try:
    ...
    get_resp = client.GetAttribute(
        visa_types.GetAttributeRequest(
            vi=vi, attribute_name=visa_types.VisaAttribute.VISA_ATTRIBUTE_TCPIP_ADDR
        )
    )
    ...
    get_resp = client.GetAttribute(
        visa_types.GetAttributeRequest(
            vi=vi, attribute_name=visa_types.VisaAttribute.VISA_ATTRIBUTE_TCPIP_HOSTNAME,
        )
    )
    ...
    get_resp = client.GetAttribute(
        visa_types.GetAttributeRequest(
            vi=vi, attribute_name=visa_types.VisaAttribute.VISA_ATTRIBUTE_TMO_VALUE
        )
    )
    ...
    if "vi" in vars():
        # Close VISA session
        client.Close(visa_types.CloseRequest(vi=vi))
