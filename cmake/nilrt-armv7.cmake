...
# Provide the C++17 type-trait variable templates used by newer protobuf headers.
# nlohmann/json uses this value to enable <optional>, which is not available in
# the GCC 6 libstdc++ headers.
...
set(CMAKE_CXX_FLAGS_INIT "-Wall -fmessage-length=0 -march=armv7-a -mfpu=vfpv3 -mfloat-abi=softfp -nostdinc++ -U__cplusplus -D__cplusplus=201500L -DJSON_HAS_CPP_14 -include ${CMAKE_CURRENT_LIST_DIR}/nilrt-cxx17-type-traits.h")
