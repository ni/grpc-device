...
class NiXnetMockLibrary : public nixnet_grpc::NiXnetLibraryInterface {
 public:
  ...
  MOCK_METHOD(nxStatus_t, ConvertFramesToByteArraySinglePoint, (nxSessionRef_t sessionRef, u8* frameBuffer, u32 numberOfBytesForFrames, u8 valueBuffer[], u32 sizeOfValueBuffer), (override));
  MOCK_METHOD(nxStatus_t, ConvertFramesToSignalsSinglePoint, (nxSessionRef_t sessionRef, u8* frameBuffer, u32 numberOfBytesForFrames, f64 valueBuffer[], u32 sizeOfValueBuffer, nxTimestamp100ns_t timestampBuffer[], u32 sizeOfTimestampBuffer), (override));
  ...
  MOCK_METHOD(nxStatus_t, DbGetDBCAttribute, (nxDatabaseRef_t dbObjectRef, u32 mode, const char attributeName[], u32 attributeTextSize, char attributeText[], u32* isDefault), (override));
  MOCK_METHOD(nxStatus_t, DbGetDBCAttributeSize, (nxDatabaseRef_t dbObjectRef, u32 mode, const char attributeName[], u32* attributeTextSize), (override));
  ...
  MOCK_METHOD(nxStatus_t, DbSetProperty, (nxDatabaseRef_t dbObjectRef, u32 propertyID, u32 propertySize, void* propertyValue), (override));
  ...
  MOCK_METHOD(nxStatus_t, GetSubProperty, (nxSessionRef_t sessionRef, u32 activeIndex, u32 propertyID, u32 propertySize, void* propertyValue), (override));
  ...
  MOCK_METHOD(nxStatus_t, ReadFrame, (nxSessionRef_t sessionRef, u8 buffer[], u32 sizeOfBuffer, f64 timeout, u32* numberOfBytesReturned), (override));
  ...
  MOCK_METHOD(nxStatus_t, ReadSignalXY, (nxSessionRef_t sessionRef, nxTimestamp100ns_t* timeLimit, f64 valueBuffer[], u32 sizeOfValueBuffer, nxTimestamp100ns_t timestampBuffer[], u32 sizeOfTimestampBuffer, u32 numPairsBuffer[], u32 sizeOfNumPairsBuffer), (override));
  ...
  MOCK_METHOD(nxStatus_t, WriteFrame, (nxSessionRef_t sessionRef, u8* buffer, u32 numberOfBytesForFrames, f64 timeout), (override));
