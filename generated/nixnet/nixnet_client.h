...
ReadSignalWaveformResponse read_signal_waveform(const StubPtr& stub, const nidevice_grpc::Session& session_ref, const simple_variant<TimeOut, double>& timeout, const pb::uint32& number_of_samples, const pb::uint32& number_of_signals);
ReadSignalXYResponse read_signal_xy(const StubPtr& stub, const nidevice_grpc::Session& session_ref, const pb::uint64& time_limit, const pb::uint32& number_of_samples, const pb::uint32& number_of_signals);
