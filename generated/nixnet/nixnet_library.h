...
class NiXnetLibrary : public nixnet_grpc::NiXnetLibraryInterface {
 public:
  ...
  nxStatus_t CreateSession(const char databaseName[], const char clusterName[], const char list[], const char interface_parameter[], u32 mode, nxSessionRef_t* session);
