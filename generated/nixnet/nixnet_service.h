...
private:
  ...
  ::grpc::Status ConvertApiErrorStatusForNxSessionRef_t(::grpc::ServerContext* context, google::protobuf::int32 status, nxSessionRef_t session);
  ::grpc::Status ConvertApiErrorStatusForNxDatabaseRef_t(::grpc::ServerContext* context, google::protobuf::int32 status, nxDatabaseRef_t session);
