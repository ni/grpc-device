...
private:
  ...
  ::grpc::Status ConvertApiErrorStatusForNxSessionRef_t(google::protobuf::int32 status, nxSessionRef_t session);
  ::grpc::Status ConvertApiErrorStatusForNxDatabaseRef_t(google::protobuf::int32 status, nxDatabaseRef_t session);
