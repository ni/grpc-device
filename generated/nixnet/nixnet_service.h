...
enum TypeIdentifier { db_ref_array_, string_, boolean_, u64_, u32_, db_ref_, f64_, u8_array_, u32_array_, parent_ref_, structure_, i32_, string_array_, dev_ref_array_, intf_ref_array_, dev_ref_,  };
