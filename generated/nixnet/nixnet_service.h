...
enum TypeIdentifier { boolean_, db_ref_, db_ref_array_, dev_ref_, dev_ref_array_, f64_, i32_, intf_ref_array_, nxEptRxFilter_Element_t_array_, parent_ref_, string_, string_array_, u32_, u32_array_, u64_, u8_array_ };
