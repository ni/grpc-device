...
class NiRFmxInstrRestrictedLibrary : public nirfmxinstr_restricted_grpc::NiRFmxInstrRestrictedLibraryInterface {
 public:
  ...
  int32 GetSFPSessionAcccessEnabled(char selectorString[], int32* isSFPSessionAcccessEnabled);
 ...
 private:
  ...
  using GetSFPSessionAcccessEnabledPtr = int32 (*)(char selectorString[], int32* isSFPSessionAcccessEnabled);
  ...
  typedef struct FunctionPointers {
    ...
    GetSFPSessionAcccessEnabledPtr GetSFPSessionAcccessEnabled;
  } FunctionLoadStatus;
