...
NiRFmxTDSCDMALibrary::NiRFmxTDSCDMALibrary(std::shared_ptr<nidevice_grpc::SharedLibraryInterface> pSharedLibrary) : p_shared_library_(pSharedLibrary)
{
  ...
  function_pointers_.ACPCfgAveraging = reinterpret_cast<ACPCfgAveragingPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_ACPCfgAveraging"));
  function_pointers_.ACPCfgMeasurementMethod = reinterpret_cast<ACPCfgMeasurementMethodPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_ACPCfgMeasurementMethod"));
  function_pointers_.ACPCfgNoiseCompensationEnabled = reinterpret_cast<ACPCfgNoiseCompensationEnabledPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_ACPCfgNoiseCompensationEnabled"));
  function_pointers_.ACPCfgNumberOfOffsets = reinterpret_cast<ACPCfgNumberOfOffsetsPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_ACPCfgNumberOfOffsets"));
  function_pointers_.ACPCfgRBWFilter = reinterpret_cast<ACPCfgRBWFilterPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_ACPCfgRBWFilter"));
  function_pointers_.ACPCfgSweepTime = reinterpret_cast<ACPCfgSweepTimePtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_ACPCfgSweepTime"));
  function_pointers_.ACPFetchAbsolutePowersTrace = reinterpret_cast<ACPFetchAbsolutePowersTracePtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_ACPFetchAbsolutePowersTrace"));
  function_pointers_.ACPFetchCarrierAbsolutePower = reinterpret_cast<ACPFetchCarrierAbsolutePowerPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_ACPFetchCarrierAbsolutePower"));
  function_pointers_.ACPFetchOffsetMeasurement = reinterpret_cast<ACPFetchOffsetMeasurementPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_ACPFetchOffsetMeasurement"));
  function_pointers_.ACPFetchOffsetMeasurementArray = reinterpret_cast<ACPFetchOffsetMeasurementArrayPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_ACPFetchOffsetMeasurementArray"));
  function_pointers_.ACPFetchRelativePowersTrace = reinterpret_cast<ACPFetchRelativePowersTracePtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_ACPFetchRelativePowersTrace"));
  function_pointers_.ACPFetchSpectrum = reinterpret_cast<ACPFetchSpectrumPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_ACPFetchSpectrum"));
  function_pointers_.AbortMeasurements = reinterpret_cast<AbortMeasurementsPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_AbortMeasurements"));
  function_pointers_.AnalyzeIQ1Waveform = reinterpret_cast<AnalyzeIQ1WaveformPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_AnalyzeIQ1Waveform"));
  function_pointers_.AnalyzeSpectrum1Waveform = reinterpret_cast<AnalyzeSpectrum1WaveformPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_AnalyzeSpectrum1Waveform"));
  function_pointers_.AutoLevel = reinterpret_cast<AutoLevelPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_AutoLevel"));
  function_pointers_.BuildChannelString = reinterpret_cast<BuildChannelStringPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_BuildChannelString"));
  function_pointers_.BuildOffsetString = reinterpret_cast<BuildOffsetStringPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_BuildOffsetString"));
  function_pointers_.BuildSegmentString = reinterpret_cast<BuildSegmentStringPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_BuildSegmentString"));
  function_pointers_.BuildSignalString = reinterpret_cast<BuildSignalStringPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_BuildSignalString"));
  function_pointers_.CDACfgAveraging = reinterpret_cast<CDACfgAveragingPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_CDACfgAveraging"));
  function_pointers_.CDACfgMeasurementChannel = reinterpret_cast<CDACfgMeasurementChannelPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_CDACfgMeasurementChannel"));
  function_pointers_.CDACfgPowerUnit = reinterpret_cast<CDACfgPowerUnitPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_CDACfgPowerUnit"));
  function_pointers_.CDACfgSynchronizationModeAndOffset = reinterpret_cast<CDACfgSynchronizationModeAndOffsetPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_CDACfgSynchronizationModeAndOffset"));
  function_pointers_.CDAFetchCodeDomainPower = reinterpret_cast<CDAFetchCodeDomainPowerPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_CDAFetchCodeDomainPower"));
  function_pointers_.CDAFetchIQImpairments = reinterpret_cast<CDAFetchIQImpairmentsPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_CDAFetchIQImpairments"));
  function_pointers_.CDAFetchMaximumCodeDomainPowerTrace = reinterpret_cast<CDAFetchMaximumCodeDomainPowerTracePtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_CDAFetchMaximumCodeDomainPowerTrace"));
  function_pointers_.CDAFetchMaximumSymbolEVMTrace = reinterpret_cast<CDAFetchMaximumSymbolEVMTracePtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_CDAFetchMaximumSymbolEVMTrace"));
  function_pointers_.CDAFetchMaximumSymbolMagnitudeErrorTrace = reinterpret_cast<CDAFetchMaximumSymbolMagnitudeErrorTracePtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_CDAFetchMaximumSymbolMagnitudeErrorTrace"));
  function_pointers_.CDAFetchMaximumSymbolPhaseErrorTrace = reinterpret_cast<CDAFetchMaximumSymbolPhaseErrorTracePtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_CDAFetchMaximumSymbolPhaseErrorTrace"));
  function_pointers_.CDAFetchMeanCodeDomainPowerTrace = reinterpret_cast<CDAFetchMeanCodeDomainPowerTracePtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_CDAFetchMeanCodeDomainPowerTrace"));
  function_pointers_.CDAFetchMeanSymbolEVMTrace = reinterpret_cast<CDAFetchMeanSymbolEVMTracePtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_CDAFetchMeanSymbolEVMTrace"));
  function_pointers_.CDAFetchMeanSymbolMagnitudeErrorTrace = reinterpret_cast<CDAFetchMeanSymbolMagnitudeErrorTracePtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_CDAFetchMeanSymbolMagnitudeErrorTrace"));
  function_pointers_.CDAFetchMeanSymbolPhaseErrorTrace = reinterpret_cast<CDAFetchMeanSymbolPhaseErrorTracePtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_CDAFetchMeanSymbolPhaseErrorTrace"));
  function_pointers_.CDAFetchSymbolConstellationTrace = reinterpret_cast<CDAFetchSymbolConstellationTracePtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_CDAFetchSymbolConstellationTrace"));
  function_pointers_.CDAFetchSymbolEVM = reinterpret_cast<CDAFetchSymbolEVMPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_CDAFetchSymbolEVM"));
  function_pointers_.CHPCfgAveraging = reinterpret_cast<CHPCfgAveragingPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_CHPCfgAveraging"));
  function_pointers_.CHPCfgRBWFilter = reinterpret_cast<CHPCfgRBWFilterPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_CHPCfgRBWFilter"));
  function_pointers_.CHPCfgSweepTime = reinterpret_cast<CHPCfgSweepTimePtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_CHPCfgSweepTime"));
  function_pointers_.CHPFetchCarrierAbsolutePower = reinterpret_cast<CHPFetchCarrierAbsolutePowerPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_CHPFetchCarrierAbsolutePower"));
  function_pointers_.CHPFetchSpectrum = reinterpret_cast<CHPFetchSpectrumPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_CHPFetchSpectrum"));
  function_pointers_.CfgChannelConfigurationMode = reinterpret_cast<CfgChannelConfigurationModePtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_CfgChannelConfigurationMode"));
  function_pointers_.CfgDigitalEdgeTrigger = reinterpret_cast<CfgDigitalEdgeTriggerPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_CfgDigitalEdgeTrigger"));
  function_pointers_.CfgExternalAttenuation = reinterpret_cast<CfgExternalAttenuationPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_CfgExternalAttenuation"));
  function_pointers_.CfgFrequency = reinterpret_cast<CfgFrequencyPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_CfgFrequency"));
  function_pointers_.CfgFrequencyChannelNumber = reinterpret_cast<CfgFrequencyChannelNumberPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_CfgFrequencyChannelNumber"));
  function_pointers_.CfgFrequencyReference = reinterpret_cast<CfgFrequencyReferencePtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_CfgFrequencyReference"));
  function_pointers_.CfgIQPowerEdgeTrigger = reinterpret_cast<CfgIQPowerEdgeTriggerPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_CfgIQPowerEdgeTrigger"));
  function_pointers_.CfgMechanicalAttenuation = reinterpret_cast<CfgMechanicalAttenuationPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_CfgMechanicalAttenuation"));
  function_pointers_.CfgMidambleShift = reinterpret_cast<CfgMidambleShiftPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_CfgMidambleShift"));
  function_pointers_.CfgNumberOfChannels = reinterpret_cast<CfgNumberOfChannelsPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_CfgNumberOfChannels"));
  function_pointers_.CfgPilot = reinterpret_cast<CfgPilotPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_CfgPilot"));
  function_pointers_.CfgRF = reinterpret_cast<CfgRFPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_CfgRF"));
  function_pointers_.CfgRFAttenuation = reinterpret_cast<CfgRFAttenuationPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_CfgRFAttenuation"));
  function_pointers_.CfgReferenceLevel = reinterpret_cast<CfgReferenceLevelPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_CfgReferenceLevel"));
  function_pointers_.CfgSoftwareEdgeTrigger = reinterpret_cast<CfgSoftwareEdgeTriggerPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_CfgSoftwareEdgeTrigger"));
  function_pointers_.CfgUplinkScramblingCode = reinterpret_cast<CfgUplinkScramblingCodePtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_CfgUplinkScramblingCode"));
  function_pointers_.CfgUserDefinedChannel = reinterpret_cast<CfgUserDefinedChannelPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_CfgUserDefinedChannel"));
  function_pointers_.CfgUserDefinedChannelArray = reinterpret_cast<CfgUserDefinedChannelArrayPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_CfgUserDefinedChannelArray"));
  function_pointers_.CheckMeasurementStatus = reinterpret_cast<CheckMeasurementStatusPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_CheckMeasurementStatus"));
  function_pointers_.ClearAllNamedResults = reinterpret_cast<ClearAllNamedResultsPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_ClearAllNamedResults"));
  function_pointers_.ClearNamedResult = reinterpret_cast<ClearNamedResultPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_ClearNamedResult"));
  function_pointers_.CloneSignalConfiguration = reinterpret_cast<CloneSignalConfigurationPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_CloneSignalConfiguration"));
  function_pointers_.Close = reinterpret_cast<ClosePtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_Close"));
  function_pointers_.Commit = reinterpret_cast<CommitPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_Commit"));
  function_pointers_.CreateSignalConfiguration = reinterpret_cast<CreateSignalConfigurationPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_CreateSignalConfiguration"));
  function_pointers_.DeleteSignalConfiguration = reinterpret_cast<DeleteSignalConfigurationPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_DeleteSignalConfiguration"));
  function_pointers_.DisableTrigger = reinterpret_cast<DisableTriggerPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_DisableTrigger"));
  function_pointers_.GetAllNamedResultNames = reinterpret_cast<GetAllNamedResultNamesPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_GetAllNamedResultNames"));
  function_pointers_.GetAttributeF32 = reinterpret_cast<GetAttributeF32Ptr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_GetAttributeF32"));
  function_pointers_.GetAttributeF32Array = reinterpret_cast<GetAttributeF32ArrayPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_GetAttributeF32Array"));
  function_pointers_.GetAttributeF64 = reinterpret_cast<GetAttributeF64Ptr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_GetAttributeF64"));
  function_pointers_.GetAttributeF64Array = reinterpret_cast<GetAttributeF64ArrayPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_GetAttributeF64Array"));
  function_pointers_.GetAttributeI16 = reinterpret_cast<GetAttributeI16Ptr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_GetAttributeI16"));
  function_pointers_.GetAttributeI32 = reinterpret_cast<GetAttributeI32Ptr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_GetAttributeI32"));
  function_pointers_.GetAttributeI32Array = reinterpret_cast<GetAttributeI32ArrayPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_GetAttributeI32Array"));
  function_pointers_.GetAttributeI64 = reinterpret_cast<GetAttributeI64Ptr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_GetAttributeI64"));
  function_pointers_.GetAttributeI64Array = reinterpret_cast<GetAttributeI64ArrayPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_GetAttributeI64Array"));
  function_pointers_.GetAttributeI8 = reinterpret_cast<GetAttributeI8Ptr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_GetAttributeI8"));
  function_pointers_.GetAttributeI8Array = reinterpret_cast<GetAttributeI8ArrayPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_GetAttributeI8Array"));
  function_pointers_.GetAttributeNIComplexDoubleArray = reinterpret_cast<GetAttributeNIComplexDoubleArrayPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_GetAttributeNIComplexDoubleArray"));
  function_pointers_.GetAttributeNIComplexSingleArray = reinterpret_cast<GetAttributeNIComplexSingleArrayPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_GetAttributeNIComplexSingleArray"));
  function_pointers_.GetAttributeString = reinterpret_cast<GetAttributeStringPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_GetAttributeString"));
  function_pointers_.GetAttributeU16 = reinterpret_cast<GetAttributeU16Ptr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_GetAttributeU16"));
  function_pointers_.GetAttributeU32 = reinterpret_cast<GetAttributeU32Ptr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_GetAttributeU32"));
  function_pointers_.GetAttributeU32Array = reinterpret_cast<GetAttributeU32ArrayPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_GetAttributeU32Array"));
  function_pointers_.GetAttributeU64Array = reinterpret_cast<GetAttributeU64ArrayPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_GetAttributeU64Array"));
  function_pointers_.GetAttributeU8 = reinterpret_cast<GetAttributeU8Ptr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_GetAttributeU8"));
  function_pointers_.GetAttributeU8Array = reinterpret_cast<GetAttributeU8ArrayPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_GetAttributeU8Array"));
  function_pointers_.GetError = reinterpret_cast<GetErrorPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_GetError"));
  function_pointers_.GetErrorString = reinterpret_cast<GetErrorStringPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_GetErrorString"));
  function_pointers_.Initialize = reinterpret_cast<InitializePtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_Initialize"));
  function_pointers_.InitializeFromNIRFSASession = reinterpret_cast<InitializeFromNIRFSASessionPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_InitializeFromNIRFSASession"));
  function_pointers_.Initiate = reinterpret_cast<InitiatePtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_Initiate"));
  function_pointers_.ModAccCfgAveraging = reinterpret_cast<ModAccCfgAveragingPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_ModAccCfgAveraging"));
  function_pointers_.ModAccCfgSlotType = reinterpret_cast<ModAccCfgSlotTypePtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_ModAccCfgSlotType"));
  function_pointers_.ModAccCfgSynchronizationModeAndInterval = reinterpret_cast<ModAccCfgSynchronizationModeAndIntervalPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_ModAccCfgSynchronizationModeAndInterval"));
  function_pointers_.ModAccFetchCodeDomainErrorTrace = reinterpret_cast<ModAccFetchCodeDomainErrorTracePtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_ModAccFetchCodeDomainErrorTrace"));
  function_pointers_.ModAccFetchCompositeEVM = reinterpret_cast<ModAccFetchCompositeEVMPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_ModAccFetchCompositeEVM"));
  function_pointers_.ModAccFetchConstellationTrace = reinterpret_cast<ModAccFetchConstellationTracePtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_ModAccFetchConstellationTrace"));
  function_pointers_.ModAccFetchDataActiveCDE = reinterpret_cast<ModAccFetchDataActiveCDEPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_ModAccFetchDataActiveCDE"));
  function_pointers_.ModAccFetchDataCDE = reinterpret_cast<ModAccFetchDataCDEPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_ModAccFetchDataCDE"));
  function_pointers_.ModAccFetchDataEVM = reinterpret_cast<ModAccFetchDataEVMPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_ModAccFetchDataEVM"));
  function_pointers_.ModAccFetchDataRCDE = reinterpret_cast<ModAccFetchDataRCDEPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_ModAccFetchDataRCDE"));
  function_pointers_.ModAccFetchDetectedChannel = reinterpret_cast<ModAccFetchDetectedChannelPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_ModAccFetchDetectedChannel"));
  function_pointers_.ModAccFetchDetectedChannelArray = reinterpret_cast<ModAccFetchDetectedChannelArrayPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_ModAccFetchDetectedChannelArray"));
  function_pointers_.ModAccFetchEVMTrace = reinterpret_cast<ModAccFetchEVMTracePtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_ModAccFetchEVMTrace"));
  function_pointers_.ModAccFetchIQImpairments = reinterpret_cast<ModAccFetchIQImpairmentsPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_ModAccFetchIQImpairments"));
  function_pointers_.ModAccFetchMagnitudeErrorTrace = reinterpret_cast<ModAccFetchMagnitudeErrorTracePtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_ModAccFetchMagnitudeErrorTrace"));
  function_pointers_.ModAccFetchMaximumCodeDomainErrorTrace = reinterpret_cast<ModAccFetchMaximumCodeDomainErrorTracePtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_ModAccFetchMaximumCodeDomainErrorTrace"));
  function_pointers_.ModAccFetchMaximumEVMTrace = reinterpret_cast<ModAccFetchMaximumEVMTracePtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_ModAccFetchMaximumEVMTrace"));
  function_pointers_.ModAccFetchMaximumMagnitudeErrorTrace = reinterpret_cast<ModAccFetchMaximumMagnitudeErrorTracePtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_ModAccFetchMaximumMagnitudeErrorTrace"));
  function_pointers_.ModAccFetchMaximumPhaseErrorTrace = reinterpret_cast<ModAccFetchMaximumPhaseErrorTracePtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_ModAccFetchMaximumPhaseErrorTrace"));
  function_pointers_.ModAccFetchMidambleAndDataPower = reinterpret_cast<ModAccFetchMidambleAndDataPowerPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_ModAccFetchMidambleAndDataPower"));
  function_pointers_.ModAccFetchMidambleEVM = reinterpret_cast<ModAccFetchMidambleEVMPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_ModAccFetchMidambleEVM"));
  function_pointers_.ModAccFetchNumberOfDetectedChannels = reinterpret_cast<ModAccFetchNumberOfDetectedChannelsPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_ModAccFetchNumberOfDetectedChannels"));
  function_pointers_.ModAccFetchPhaseErrorTrace = reinterpret_cast<ModAccFetchPhaseErrorTracePtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_ModAccFetchPhaseErrorTrace"));
  function_pointers_.ModAccFetchPilotEVM = reinterpret_cast<ModAccFetchPilotEVMPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_ModAccFetchPilotEVM"));
  function_pointers_.OBWCfgAveraging = reinterpret_cast<OBWCfgAveragingPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_OBWCfgAveraging"));
  function_pointers_.OBWCfgRBWFilter = reinterpret_cast<OBWCfgRBWFilterPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_OBWCfgRBWFilter"));
  function_pointers_.OBWCfgSweepTime = reinterpret_cast<OBWCfgSweepTimePtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_OBWCfgSweepTime"));
  function_pointers_.OBWFetchMeasurement = reinterpret_cast<OBWFetchMeasurementPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_OBWFetchMeasurement"));
  function_pointers_.OBWFetchSpectrum = reinterpret_cast<OBWFetchSpectrumPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_OBWFetchSpectrum"));
  function_pointers_.PVTCfgAveraging = reinterpret_cast<PVTCfgAveragingPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_PVTCfgAveraging"));
  function_pointers_.PVTCfgMeasurementMethod = reinterpret_cast<PVTCfgMeasurementMethodPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_PVTCfgMeasurementMethod"));
  function_pointers_.PVTFetchMeasurementStatus = reinterpret_cast<PVTFetchMeasurementStatusPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_PVTFetchMeasurementStatus"));
  function_pointers_.PVTFetchPowers = reinterpret_cast<PVTFetchPowersPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_PVTFetchPowers"));
  function_pointers_.PVTFetchSegmentMeasurement = reinterpret_cast<PVTFetchSegmentMeasurementPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_PVTFetchSegmentMeasurement"));
  function_pointers_.PVTFetchSegmentMeasurementArray = reinterpret_cast<PVTFetchSegmentMeasurementArrayPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_PVTFetchSegmentMeasurementArray"));
  function_pointers_.PVTFetchSignalPowerTrace = reinterpret_cast<PVTFetchSignalPowerTracePtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_PVTFetchSignalPowerTrace"));
  function_pointers_.ResetAttribute = reinterpret_cast<ResetAttributePtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_ResetAttribute"));
  function_pointers_.ResetToDefault = reinterpret_cast<ResetToDefaultPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_ResetToDefault"));
  function_pointers_.SEMCfgAveraging = reinterpret_cast<SEMCfgAveragingPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_SEMCfgAveraging"));
  function_pointers_.SEMCfgSweepTime = reinterpret_cast<SEMCfgSweepTimePtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_SEMCfgSweepTime"));
  function_pointers_.SEMFetchCarrierAbsoluteIntegratedPower = reinterpret_cast<SEMFetchCarrierAbsoluteIntegratedPowerPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_SEMFetchCarrierAbsoluteIntegratedPower"));
  function_pointers_.SEMFetchLowerOffsetMargin = reinterpret_cast<SEMFetchLowerOffsetMarginPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_SEMFetchLowerOffsetMargin"));
  function_pointers_.SEMFetchLowerOffsetMarginArray = reinterpret_cast<SEMFetchLowerOffsetMarginArrayPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_SEMFetchLowerOffsetMarginArray"));
  function_pointers_.SEMFetchLowerOffsetPower = reinterpret_cast<SEMFetchLowerOffsetPowerPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_SEMFetchLowerOffsetPower"));
  function_pointers_.SEMFetchLowerOffsetPowerArray = reinterpret_cast<SEMFetchLowerOffsetPowerArrayPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_SEMFetchLowerOffsetPowerArray"));
  function_pointers_.SEMFetchMeasurementStatus = reinterpret_cast<SEMFetchMeasurementStatusPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_SEMFetchMeasurementStatus"));
  function_pointers_.SEMFetchSpectrum = reinterpret_cast<SEMFetchSpectrumPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_SEMFetchSpectrum"));
  function_pointers_.SEMFetchUpperOffsetMargin = reinterpret_cast<SEMFetchUpperOffsetMarginPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_SEMFetchUpperOffsetMargin"));
  function_pointers_.SEMFetchUpperOffsetMarginArray = reinterpret_cast<SEMFetchUpperOffsetMarginArrayPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_SEMFetchUpperOffsetMarginArray"));
  function_pointers_.SEMFetchUpperOffsetPower = reinterpret_cast<SEMFetchUpperOffsetPowerPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_SEMFetchUpperOffsetPower"));
  function_pointers_.SEMFetchUpperOffsetPowerArray = reinterpret_cast<SEMFetchUpperOffsetPowerArrayPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_SEMFetchUpperOffsetPowerArray"));
  function_pointers_.SelectMeasurements = reinterpret_cast<SelectMeasurementsPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_SelectMeasurements"));
  function_pointers_.SendSoftwareEdgeTrigger = reinterpret_cast<SendSoftwareEdgeTriggerPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_SendSoftwareEdgeTrigger"));
  function_pointers_.SetAttributeF32 = reinterpret_cast<SetAttributeF32Ptr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_SetAttributeF32"));
  function_pointers_.SetAttributeF32Array = reinterpret_cast<SetAttributeF32ArrayPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_SetAttributeF32Array"));
  function_pointers_.SetAttributeF64 = reinterpret_cast<SetAttributeF64Ptr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_SetAttributeF64"));
  function_pointers_.SetAttributeF64Array = reinterpret_cast<SetAttributeF64ArrayPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_SetAttributeF64Array"));
  function_pointers_.SetAttributeI16 = reinterpret_cast<SetAttributeI16Ptr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_SetAttributeI16"));
  function_pointers_.SetAttributeI32 = reinterpret_cast<SetAttributeI32Ptr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_SetAttributeI32"));
  function_pointers_.SetAttributeI32Array = reinterpret_cast<SetAttributeI32ArrayPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_SetAttributeI32Array"));
  function_pointers_.SetAttributeI64 = reinterpret_cast<SetAttributeI64Ptr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_SetAttributeI64"));
  function_pointers_.SetAttributeI64Array = reinterpret_cast<SetAttributeI64ArrayPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_SetAttributeI64Array"));
  function_pointers_.SetAttributeI8 = reinterpret_cast<SetAttributeI8Ptr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_SetAttributeI8"));
  function_pointers_.SetAttributeI8Array = reinterpret_cast<SetAttributeI8ArrayPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_SetAttributeI8Array"));
  function_pointers_.SetAttributeNIComplexDoubleArray = reinterpret_cast<SetAttributeNIComplexDoubleArrayPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_SetAttributeNIComplexDoubleArray"));
  function_pointers_.SetAttributeNIComplexSingleArray = reinterpret_cast<SetAttributeNIComplexSingleArrayPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_SetAttributeNIComplexSingleArray"));
  function_pointers_.SetAttributeString = reinterpret_cast<SetAttributeStringPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_SetAttributeString"));
  function_pointers_.SetAttributeU16 = reinterpret_cast<SetAttributeU16Ptr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_SetAttributeU16"));
  function_pointers_.SetAttributeU32 = reinterpret_cast<SetAttributeU32Ptr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_SetAttributeU32"));
  function_pointers_.SetAttributeU32Array = reinterpret_cast<SetAttributeU32ArrayPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_SetAttributeU32Array"));
  function_pointers_.SetAttributeU64Array = reinterpret_cast<SetAttributeU64ArrayPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_SetAttributeU64Array"));
  function_pointers_.SetAttributeU8 = reinterpret_cast<SetAttributeU8Ptr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_SetAttributeU8"));
  function_pointers_.SetAttributeU8Array = reinterpret_cast<SetAttributeU8ArrayPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_SetAttributeU8Array"));
  function_pointers_.SlotPowerCfgMeasurementLength = reinterpret_cast<SlotPowerCfgMeasurementLengthPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_SlotPowerCfgMeasurementLength"));
  function_pointers_.SlotPowerFetchPowers = reinterpret_cast<SlotPowerFetchPowersPtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_SlotPowerFetchPowers"));
  function_pointers_.WaitForAcquisitionComplete = reinterpret_cast<WaitForAcquisitionCompletePtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_WaitForAcquisitionComplete"));
  function_pointers_.WaitForMeasurementComplete = reinterpret_cast<WaitForMeasurementCompletePtr>(p_shared_library_->get_function_pointer("RFmxTDSCDMA_WaitForMeasurementComplete"));
}
