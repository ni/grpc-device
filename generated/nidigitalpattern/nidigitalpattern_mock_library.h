...
class NiDigitalMockLibrary : public nidigitalpattern_grpc::NiDigitalLibraryInterface {
 public:
  ...
  MOCK_METHOD(ViStatus, GetAttributeViBoolean, (ViSession vi, ViConstString channelList, ViAttr attribute, ViBoolean* value), (override));
  ...
  MOCK_METHOD(ViStatus, ResetAttribute, (ViSession vi, ViConstString channelList, ViAttr attributeId), (override));
  ...
  MOCK_METHOD(ViStatus, SetAttributeViBoolean, (ViSession vi, ViConstString channelList, ViAttr attribute, ViBoolean value), (override));
  MOCK_METHOD(ViStatus, SetAttributeViInt32, (ViSession vi, ViConstString channelList, ViAttr attribute, ViInt32 value), (override));
  MOCK_METHOD(ViStatus, SetAttributeViInt64, (ViSession vi, ViConstString channelList, ViAttr attribute, ViInt64 value), (override));
  MOCK_METHOD(ViStatus, SetAttributeViReal64, (ViSession vi, ViConstString channelList, ViAttr attribute, ViReal64 value), (override));
  ...
  MOCK_METHOD(ViStatus, SetAttributeViString, (ViSession vi, ViConstString channelList, ViAttr attribute, ViConstString value), (override));
