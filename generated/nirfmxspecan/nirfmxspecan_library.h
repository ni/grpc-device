...
class NiRFmxSpecAnLibrary : public nirfmxspecan_grpc::NiRFmxSpecAnLibraryInterface {
 public:
  ...
  int32 AMPMCfgReferenceWaveformSplit(niRFmxInstrHandle instrumentHandle, char selectorString[], float64 x0, float64 dx, float32 I[], float32 Q[], int32 arraySize, int32 idleDurationPresent, int32 signalType);
  ...
  int32 AMPMFetchProcessedMeanAcquiredWaveformSplit(niRFmxInstrHandle instrumentHandle, char selectorString[], float64 timeout, float64* x0, float64* dx, float32 I[], float32 Q[], int32 arraySize, int32* actualArraySize);
  ...
  int32 AMPMFetchProcessedReferenceWaveformSplit(niRFmxInstrHandle instrumentHandle, char selectorString[], float64 timeout, float64* x0, float64* dx, float32 I[], float32 Q[], int32 arraySize, int32* actualArraySize);
  ...
  int32 DPDCfgApplyDPDUserDPDPolynomialSplit(niRFmxInstrHandle instrumentHandle, char selectorString[], float32 I[], float32 Q[], int32 arraySize);
  ...
  int32 DPDCfgApplyDPDUserLookupTableSplit(niRFmxInstrHandle instrumentHandle, char selectorString[], float32 lutInputPowers[], float32 I[], float32 Q[], int32 arraySize);
  ...
  int32 DPDCfgPreviousDPDPolynomialSplit(niRFmxInstrHandle instrumentHandle, char selectorString[], float32 I[], float32 Q[], int32 arraySize);
  ...
  int32 DPDCfgReferenceWaveformSplit(niRFmxInstrHandle instrumentHandle, char selectorString[], float64 x0, float64 dx, float32 I[], float32 Q[], int32 arraySize, int32 idleDurationPresent, int32 signalType);
  ...
  int32 DPDFetchDPDPolynomialSplit(niRFmxInstrHandle instrumentHandle, char selectorString[], float64 timeout, float32 I[], float32 Q[], int32 arraySize, int32* actualArraySize);
  ...
  int32 DPDFetchLookupTableSplit(niRFmxInstrHandle instrumentHandle, char selectorString[], float64 timeout, float32 inputPowers[], float32 I[], float32 Q[], int32 arraySize, int32* actualArraySize);
  ...
  int32 DPDFetchProcessedMeanAcquiredWaveformSplit(niRFmxInstrHandle instrumentHandle, char selectorString[], float64 timeout, float64* x0, float64* dx, float32 I[], float32 Q[], int32 arraySize, int32* actualArraySize);
  ...
  int32 DPDFetchProcessedReferenceWaveformSplit(niRFmxInstrHandle instrumentHandle, char selectorString[], float64 timeout, float64* x0, float64* dx, float32 I[], float32 Q[], int32 arraySize, int32* actualArraySize);
  ...
  int32 NFGetCalibrationSetupId(niRFmxInstrHandle instrumentHandle, char selectorString[], char attrVal[], int32 arraySize);
  ...
  int32 NFSetCalibrationSetupId(niRFmxInstrHandle instrumentHandle, char selectorString[], char attrVal[]);
