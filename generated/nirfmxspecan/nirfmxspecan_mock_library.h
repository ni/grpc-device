...
class NiRFmxSpecAnMockLibrary : public nirfmxspecan_grpc::NiRFmxSpecAnLibraryInterface {
 public:
  ...
  MOCK_METHOD(int32, AMPMCfgReferenceWaveformSplit, (niRFmxInstrHandle instrumentHandle, char selectorString[], float64 x0, float64 dx, float32 I[], float32 Q[], int32 arraySize, int32 idleDurationPresent, int32 signalType), (override));
  ...
  MOCK_METHOD(int32, AMPMFetchProcessedMeanAcquiredWaveformSplit, (niRFmxInstrHandle instrumentHandle, char selectorString[], float64 timeout, float64* x0, float64* dx, float32 I[], float32 Q[], int32 arraySize, int32* actualArraySize), (override));
  ...
  MOCK_METHOD(int32, AMPMFetchProcessedReferenceWaveformSplit, (niRFmxInstrHandle instrumentHandle, char selectorString[], float64 timeout, float64* x0, float64* dx, float32 I[], float32 Q[], int32 arraySize, int32* actualArraySize), (override));
  ...
  MOCK_METHOD(int32, DPDCfgApplyDPDUserDPDPolynomialSplit, (niRFmxInstrHandle instrumentHandle, char selectorString[], float32 I[], float32 Q[], int32 arraySize), (override));
  ...
  MOCK_METHOD(int32, DPDCfgApplyDPDUserLookupTableSplit, (niRFmxInstrHandle instrumentHandle, char selectorString[], float32 lutInputPowers[], float32 I[], float32 Q[], int32 arraySize), (override));
  ...
  MOCK_METHOD(int32, DPDCfgPreviousDPDPolynomialSplit, (niRFmxInstrHandle instrumentHandle, char selectorString[], float32 I[], float32 Q[], int32 arraySize), (override));
  ...
  MOCK_METHOD(int32, DPDCfgReferenceWaveformSplit, (niRFmxInstrHandle instrumentHandle, char selectorString[], float64 x0, float64 dx, float32 I[], float32 Q[], int32 arraySize, int32 idleDurationPresent, int32 signalType), (override));
  ...
  MOCK_METHOD(int32, DPDFetchDPDPolynomialSplit, (niRFmxInstrHandle instrumentHandle, char selectorString[], float64 timeout, float32 I[], float32 Q[], int32 arraySize, int32* actualArraySize), (override));
  ...
  MOCK_METHOD(int32, DPDFetchLookupTableSplit, (niRFmxInstrHandle instrumentHandle, char selectorString[], float64 timeout, float32 inputPowers[], float32 I[], float32 Q[], int32 arraySize, int32* actualArraySize), (override));
  ...
  MOCK_METHOD(int32, DPDFetchProcessedMeanAcquiredWaveformSplit, (niRFmxInstrHandle instrumentHandle, char selectorString[], float64 timeout, float64* x0, float64* dx, float32 I[], float32 Q[], int32 arraySize, int32* actualArraySize), (override));
  ...
  MOCK_METHOD(int32, DPDFetchProcessedReferenceWaveformSplit, (niRFmxInstrHandle instrumentHandle, char selectorString[], float64 timeout, float64* x0, float64* dx, float32 I[], float32 Q[], int32 arraySize, int32* actualArraySize), (override));
  ...
  MOCK_METHOD(int32, NFGetCalibrationSetupId, (niRFmxInstrHandle instrumentHandle, char selectorString[], char attrVal[], int32 arraySize), (override));
  ...
  MOCK_METHOD(int32, NFSetCalibrationSetupId, (niRFmxInstrHandle instrumentHandle, char selectorString[], char attrVal[]), (override));
