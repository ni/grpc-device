...
NiRFmxSpecAnLibrary::NiRFmxSpecAnLibrary(std::shared_ptr<nidevice_grpc::SharedLibraryInterface> pSharedLibrary) : p_shared_library_(pSharedLibrary)
{
  ...
  function_pointers_.ACPCfgAveraging = reinterpret_cast<ACPCfgAveragingPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_ACPCfgAveraging"));
  function_pointers_.ACPCfgCarrierAndOffsets = reinterpret_cast<ACPCfgCarrierAndOffsetsPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_ACPCfgCarrierAndOffsets"));
  function_pointers_.ACPCfgCarrierFrequency = reinterpret_cast<ACPCfgCarrierFrequencyPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_ACPCfgCarrierFrequency"));
  function_pointers_.ACPCfgCarrierIntegrationBandwidth = reinterpret_cast<ACPCfgCarrierIntegrationBandwidthPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_ACPCfgCarrierIntegrationBandwidth"));
  function_pointers_.ACPCfgCarrierMode = reinterpret_cast<ACPCfgCarrierModePtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_ACPCfgCarrierMode"));
  function_pointers_.ACPCfgCarrierRRCFilter = reinterpret_cast<ACPCfgCarrierRRCFilterPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_ACPCfgCarrierRRCFilter"));
  function_pointers_.ACPCfgDetector = reinterpret_cast<ACPCfgDetectorPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_ACPCfgDetector"));
  function_pointers_.ACPCfgFFT = reinterpret_cast<ACPCfgFFTPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_ACPCfgFFT"));
  function_pointers_.ACPCfgMeasurementMethod = reinterpret_cast<ACPCfgMeasurementMethodPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_ACPCfgMeasurementMethod"));
  function_pointers_.ACPCfgNoiseCompensationEnabled = reinterpret_cast<ACPCfgNoiseCompensationEnabledPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_ACPCfgNoiseCompensationEnabled"));
  function_pointers_.ACPCfgNumberOfCarriers = reinterpret_cast<ACPCfgNumberOfCarriersPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_ACPCfgNumberOfCarriers"));
  function_pointers_.ACPCfgNumberOfOffsets = reinterpret_cast<ACPCfgNumberOfOffsetsPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_ACPCfgNumberOfOffsets"));
  function_pointers_.ACPCfgOffset = reinterpret_cast<ACPCfgOffsetPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_ACPCfgOffset"));
  function_pointers_.ACPCfgOffsetArray = reinterpret_cast<ACPCfgOffsetArrayPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_ACPCfgOffsetArray"));
  function_pointers_.ACPCfgOffsetFrequencyDefinition = reinterpret_cast<ACPCfgOffsetFrequencyDefinitionPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_ACPCfgOffsetFrequencyDefinition"));
  function_pointers_.ACPCfgOffsetIntegrationBandwidth = reinterpret_cast<ACPCfgOffsetIntegrationBandwidthPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_ACPCfgOffsetIntegrationBandwidth"));
  function_pointers_.ACPCfgOffsetIntegrationBandwidthArray = reinterpret_cast<ACPCfgOffsetIntegrationBandwidthArrayPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_ACPCfgOffsetIntegrationBandwidthArray"));
  function_pointers_.ACPCfgOffsetPowerReference = reinterpret_cast<ACPCfgOffsetPowerReferencePtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_ACPCfgOffsetPowerReference"));
  function_pointers_.ACPCfgOffsetPowerReferenceArray = reinterpret_cast<ACPCfgOffsetPowerReferenceArrayPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_ACPCfgOffsetPowerReferenceArray"));
  function_pointers_.ACPCfgOffsetRRCFilter = reinterpret_cast<ACPCfgOffsetRRCFilterPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_ACPCfgOffsetRRCFilter"));
  function_pointers_.ACPCfgOffsetRRCFilterArray = reinterpret_cast<ACPCfgOffsetRRCFilterArrayPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_ACPCfgOffsetRRCFilterArray"));
  function_pointers_.ACPCfgOffsetRelativeAttenuation = reinterpret_cast<ACPCfgOffsetRelativeAttenuationPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_ACPCfgOffsetRelativeAttenuation"));
  function_pointers_.ACPCfgOffsetRelativeAttenuationArray = reinterpret_cast<ACPCfgOffsetRelativeAttenuationArrayPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_ACPCfgOffsetRelativeAttenuationArray"));
  function_pointers_.ACPCfgPowerUnits = reinterpret_cast<ACPCfgPowerUnitsPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_ACPCfgPowerUnits"));
  function_pointers_.ACPCfgRBWFilter = reinterpret_cast<ACPCfgRBWFilterPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_ACPCfgRBWFilter"));
  function_pointers_.ACPCfgSweepTime = reinterpret_cast<ACPCfgSweepTimePtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_ACPCfgSweepTime"));
  function_pointers_.ACPFetchAbsolutePowersTrace = reinterpret_cast<ACPFetchAbsolutePowersTracePtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_ACPFetchAbsolutePowersTrace"));
  function_pointers_.ACPFetchCarrierMeasurement = reinterpret_cast<ACPFetchCarrierMeasurementPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_ACPFetchCarrierMeasurement"));
  function_pointers_.ACPFetchFrequencyResolution = reinterpret_cast<ACPFetchFrequencyResolutionPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_ACPFetchFrequencyResolution"));
  function_pointers_.ACPFetchOffsetMeasurement = reinterpret_cast<ACPFetchOffsetMeasurementPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_ACPFetchOffsetMeasurement"));
  function_pointers_.ACPFetchOffsetMeasurementArray = reinterpret_cast<ACPFetchOffsetMeasurementArrayPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_ACPFetchOffsetMeasurementArray"));
  function_pointers_.ACPFetchRelativePowersTrace = reinterpret_cast<ACPFetchRelativePowersTracePtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_ACPFetchRelativePowersTrace"));
  function_pointers_.ACPFetchSpectrum = reinterpret_cast<ACPFetchSpectrumPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_ACPFetchSpectrum"));
  function_pointers_.ACPFetchTotalCarrierPower = reinterpret_cast<ACPFetchTotalCarrierPowerPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_ACPFetchTotalCarrierPower"));
  function_pointers_.ACPRead = reinterpret_cast<ACPReadPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_ACPRead"));
  function_pointers_.ACPValidateNoiseCalibrationData = reinterpret_cast<ACPValidateNoiseCalibrationDataPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_ACPValidateNoiseCalibrationData"));
  function_pointers_.AMPMCfgAMToAMCurveFit = reinterpret_cast<AMPMCfgAMToAMCurveFitPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_AMPMCfgAMToAMCurveFit"));
  function_pointers_.AMPMCfgAMToPMCurveFit = reinterpret_cast<AMPMCfgAMToPMCurveFitPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_AMPMCfgAMToPMCurveFit"));
  function_pointers_.AMPMCfgAveraging = reinterpret_cast<AMPMCfgAveragingPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_AMPMCfgAveraging"));
  function_pointers_.AMPMCfgCompressionPoints = reinterpret_cast<AMPMCfgCompressionPointsPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_AMPMCfgCompressionPoints"));
  function_pointers_.AMPMCfgDUTAverageInputPower = reinterpret_cast<AMPMCfgDUTAverageInputPowerPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_AMPMCfgDUTAverageInputPower"));
  function_pointers_.AMPMCfgMeasurementInterval = reinterpret_cast<AMPMCfgMeasurementIntervalPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_AMPMCfgMeasurementInterval"));
  function_pointers_.AMPMCfgMeasurementSampleRate = reinterpret_cast<AMPMCfgMeasurementSampleRatePtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_AMPMCfgMeasurementSampleRate"));
  function_pointers_.AMPMCfgReferencePowerType = reinterpret_cast<AMPMCfgReferencePowerTypePtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_AMPMCfgReferencePowerType"));
  function_pointers_.AMPMCfgReferenceWaveform = reinterpret_cast<AMPMCfgReferenceWaveformPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_AMPMCfgReferenceWaveform"));
  function_pointers_.AMPMCfgSynchronizationMethod = reinterpret_cast<AMPMCfgSynchronizationMethodPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_AMPMCfgSynchronizationMethod"));
  function_pointers_.AMPMCfgThreshold = reinterpret_cast<AMPMCfgThresholdPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_AMPMCfgThreshold"));
  function_pointers_.AMPMFetchAMToAMTrace = reinterpret_cast<AMPMFetchAMToAMTracePtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_AMPMFetchAMToAMTrace"));
  function_pointers_.AMPMFetchAMToPMTrace = reinterpret_cast<AMPMFetchAMToPMTracePtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_AMPMFetchAMToPMTrace"));
  function_pointers_.AMPMFetchCompressionPoints = reinterpret_cast<AMPMFetchCompressionPointsPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_AMPMFetchCompressionPoints"));
  function_pointers_.AMPMFetchCurveFitCoefficients = reinterpret_cast<AMPMFetchCurveFitCoefficientsPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_AMPMFetchCurveFitCoefficients"));
  function_pointers_.AMPMFetchCurveFitResidual = reinterpret_cast<AMPMFetchCurveFitResidualPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_AMPMFetchCurveFitResidual"));
  function_pointers_.AMPMFetchDUTCharacteristics = reinterpret_cast<AMPMFetchDUTCharacteristicsPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_AMPMFetchDUTCharacteristics"));
  function_pointers_.AMPMFetchError = reinterpret_cast<AMPMFetchErrorPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_AMPMFetchError"));
  function_pointers_.AMPMFetchProcessedMeanAcquiredWaveform = reinterpret_cast<AMPMFetchProcessedMeanAcquiredWaveformPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_AMPMFetchProcessedMeanAcquiredWaveform"));
  function_pointers_.AMPMFetchProcessedReferenceWaveform = reinterpret_cast<AMPMFetchProcessedReferenceWaveformPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_AMPMFetchProcessedReferenceWaveform"));
  function_pointers_.AMPMFetchRelativePhaseTrace = reinterpret_cast<AMPMFetchRelativePhaseTracePtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_AMPMFetchRelativePhaseTrace"));
  function_pointers_.AMPMFetchRelativePowerTrace = reinterpret_cast<AMPMFetchRelativePowerTracePtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_AMPMFetchRelativePowerTrace"));
  function_pointers_.AbortMeasurements = reinterpret_cast<AbortMeasurementsPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_AbortMeasurements"));
  function_pointers_.AnalyzeIQ1Waveform = reinterpret_cast<AnalyzeIQ1WaveformPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_AnalyzeIQ1Waveform"));
  function_pointers_.AnalyzeSpectrum1Waveform = reinterpret_cast<AnalyzeSpectrum1WaveformPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_AnalyzeSpectrum1Waveform"));
  function_pointers_.AutoLevel = reinterpret_cast<AutoLevelPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_AutoLevel"));
  function_pointers_.BuildCarrierString = reinterpret_cast<BuildCarrierStringPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_BuildCarrierString2"));
  function_pointers_.BuildHarmonicString = reinterpret_cast<BuildHarmonicStringPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_BuildHarmonicString2"));
  function_pointers_.BuildIntermodString = reinterpret_cast<BuildIntermodStringPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_BuildIntermodString"));
  function_pointers_.BuildListStepString = reinterpret_cast<BuildListStepStringPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_BuildListStepString"));
  function_pointers_.BuildListString = reinterpret_cast<BuildListStringPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_BuildListString"));
  function_pointers_.BuildMarkerString = reinterpret_cast<BuildMarkerStringPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_BuildMarkerString2"));
  function_pointers_.BuildOffsetString = reinterpret_cast<BuildOffsetStringPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_BuildOffsetString2"));
  function_pointers_.BuildRangeSpurString = reinterpret_cast<BuildRangeSpurStringPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_BuildRangeSpurString"));
  function_pointers_.BuildRangeString = reinterpret_cast<BuildRangeStringPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_BuildRangeString2"));
  function_pointers_.BuildSegmentString = reinterpret_cast<BuildSegmentStringPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_BuildSegmentString"));
  function_pointers_.BuildSignalString = reinterpret_cast<BuildSignalStringPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_BuildSignalString"));
  function_pointers_.BuildSpurString = reinterpret_cast<BuildSpurStringPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_BuildSpurString2"));
  function_pointers_.CCDFCfgMeasurementInterval = reinterpret_cast<CCDFCfgMeasurementIntervalPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_CCDFCfgMeasurementInterval"));
  function_pointers_.CCDFCfgNumberOfRecords = reinterpret_cast<CCDFCfgNumberOfRecordsPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_CCDFCfgNumberOfRecords"));
  function_pointers_.CCDFCfgRBWFilter = reinterpret_cast<CCDFCfgRBWFilterPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_CCDFCfgRBWFilter"));
  function_pointers_.CCDFCfgThreshold = reinterpret_cast<CCDFCfgThresholdPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_CCDFCfgThreshold"));
  function_pointers_.CCDFFetchBasicPowerProbabilities = reinterpret_cast<CCDFFetchBasicPowerProbabilitiesPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_CCDFFetchBasicPowerProbabilities"));
  function_pointers_.CCDFFetchGaussianProbabilitiesTrace = reinterpret_cast<CCDFFetchGaussianProbabilitiesTracePtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_CCDFFetchGaussianProbabilitiesTrace"));
  function_pointers_.CCDFFetchPower = reinterpret_cast<CCDFFetchPowerPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_CCDFFetchPower"));
  function_pointers_.CCDFFetchProbabilitiesTrace = reinterpret_cast<CCDFFetchProbabilitiesTracePtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_CCDFFetchProbabilitiesTrace"));
  function_pointers_.CCDFRead = reinterpret_cast<CCDFReadPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_CCDFRead"));
  function_pointers_.CHPCfgAveraging = reinterpret_cast<CHPCfgAveragingPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_CHPCfgAveraging"));
  function_pointers_.CHPCfgCarrierOffset = reinterpret_cast<CHPCfgCarrierOffsetPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_CHPCfgCarrierOffset"));
  function_pointers_.CHPCfgDetector = reinterpret_cast<CHPCfgDetectorPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_CHPCfgDetector"));
  function_pointers_.CHPCfgFFT = reinterpret_cast<CHPCfgFFTPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_CHPCfgFFT"));
  function_pointers_.CHPCfgIntegrationBandwidth = reinterpret_cast<CHPCfgIntegrationBandwidthPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_CHPCfgIntegrationBandwidth"));
  function_pointers_.CHPCfgNumberOfCarriers = reinterpret_cast<CHPCfgNumberOfCarriersPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_CHPCfgNumberOfCarriers"));
  function_pointers_.CHPCfgRBWFilter = reinterpret_cast<CHPCfgRBWFilterPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_CHPCfgRBWFilter"));
  function_pointers_.CHPCfgRRCFilter = reinterpret_cast<CHPCfgRRCFilterPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_CHPCfgRRCFilter"));
  function_pointers_.CHPCfgSpan = reinterpret_cast<CHPCfgSpanPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_CHPCfgSpan"));
  function_pointers_.CHPCfgSweepTime = reinterpret_cast<CHPCfgSweepTimePtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_CHPCfgSweepTime"));
  function_pointers_.CHPFetchCarrierMeasurement = reinterpret_cast<CHPFetchCarrierMeasurementPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_CHPFetchCarrierMeasurement"));
  function_pointers_.CHPFetchSpectrum = reinterpret_cast<CHPFetchSpectrumPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_CHPFetchSpectrum"));
  function_pointers_.CHPFetchTotalCarrierPower = reinterpret_cast<CHPFetchTotalCarrierPowerPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_CHPFetchTotalCarrierPower"));
  function_pointers_.CHPRead = reinterpret_cast<CHPReadPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_CHPRead"));
  function_pointers_.CHPValidateNoiseCalibrationData = reinterpret_cast<CHPValidateNoiseCalibrationDataPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_CHPValidateNoiseCalibrationData"));
  function_pointers_.CfgDigitalEdgeTrigger = reinterpret_cast<CfgDigitalEdgeTriggerPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_CfgDigitalEdgeTrigger"));
  function_pointers_.CfgExternalAttenuation = reinterpret_cast<CfgExternalAttenuationPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_CfgExternalAttenuation"));
  function_pointers_.CfgFrequency = reinterpret_cast<CfgFrequencyPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_CfgFrequency"));
  function_pointers_.CfgFrequencyReference = reinterpret_cast<CfgFrequencyReferencePtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_CfgFrequencyReference"));
  function_pointers_.CfgIQPowerEdgeTrigger = reinterpret_cast<CfgIQPowerEdgeTriggerPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_CfgIQPowerEdgeTrigger"));
  function_pointers_.CfgMechanicalAttenuation = reinterpret_cast<CfgMechanicalAttenuationPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_CfgMechanicalAttenuation"));
  function_pointers_.CfgRF = reinterpret_cast<CfgRFPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_CfgRF"));
  function_pointers_.CfgRFAttenuation = reinterpret_cast<CfgRFAttenuationPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_CfgRFAttenuation"));
  function_pointers_.CfgReferenceLevel = reinterpret_cast<CfgReferenceLevelPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_CfgReferenceLevel"));
  function_pointers_.CfgSoftwareEdgeTrigger = reinterpret_cast<CfgSoftwareEdgeTriggerPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_CfgSoftwareEdgeTrigger"));
  function_pointers_.CheckMeasurementStatus = reinterpret_cast<CheckMeasurementStatusPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_CheckMeasurementStatus"));
  function_pointers_.ClearAllNamedResults = reinterpret_cast<ClearAllNamedResultsPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_ClearAllNamedResults"));
  function_pointers_.ClearNamedResult = reinterpret_cast<ClearNamedResultPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_ClearNamedResult"));
  function_pointers_.ClearNoiseCalibrationDatabase = reinterpret_cast<ClearNoiseCalibrationDatabasePtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_ClearNoiseCalibrationDatabase"));
  function_pointers_.CloneSignalConfiguration = reinterpret_cast<CloneSignalConfigurationPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_CloneSignalConfiguration"));
  function_pointers_.Close = reinterpret_cast<ClosePtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_Close"));
  function_pointers_.Commit = reinterpret_cast<CommitPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_Commit"));
  function_pointers_.CreateList = reinterpret_cast<CreateListPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_CreateList"));
  function_pointers_.CreateListStep = reinterpret_cast<CreateListStepPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_CreateListStep"));
  function_pointers_.CreateSignalConfiguration = reinterpret_cast<CreateSignalConfigurationPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_CreateSignalConfiguration"));
  function_pointers_.DPDApplyDigitalPredistortion = reinterpret_cast<DPDApplyDigitalPredistortionPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_DPDApplyDigitalPredistortion"));
  function_pointers_.DPDApplyPreDPDSignalConditioning = reinterpret_cast<DPDApplyPreDPDSignalConditioningPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_DPDApplyPreDPDSignalConditioning"));
  function_pointers_.DPDCfgApplyDPDConfigurationInput = reinterpret_cast<DPDCfgApplyDPDConfigurationInputPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_DPDCfgApplyDPDConfigurationInput"));
  function_pointers_.DPDCfgApplyDPDLookupTableCorrectionType = reinterpret_cast<DPDCfgApplyDPDLookupTableCorrectionTypePtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_DPDCfgApplyDPDLookupTableCorrectionType"));
  function_pointers_.DPDCfgApplyDPDMemoryModelCorrectionType = reinterpret_cast<DPDCfgApplyDPDMemoryModelCorrectionTypePtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_DPDCfgApplyDPDMemoryModelCorrectionType"));
  function_pointers_.DPDCfgApplyDPDUserDPDPolynomial = reinterpret_cast<DPDCfgApplyDPDUserDPDPolynomialPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_DPDCfgApplyDPDUserDPDPolynomial"));
  function_pointers_.DPDCfgApplyDPDUserLookupTable = reinterpret_cast<DPDCfgApplyDPDUserLookupTablePtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_DPDCfgApplyDPDUserLookupTable"));
  function_pointers_.DPDCfgAveraging = reinterpret_cast<DPDCfgAveragingPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_DPDCfgAveraging"));
  function_pointers_.DPDCfgDPDModel = reinterpret_cast<DPDCfgDPDModelPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_DPDCfgDPDModel"));
  function_pointers_.DPDCfgDUTAverageInputPower = reinterpret_cast<DPDCfgDUTAverageInputPowerPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_DPDCfgDUTAverageInputPower"));
  function_pointers_.DPDCfgGeneralizedMemoryPolynomialCrossTerms = reinterpret_cast<DPDCfgGeneralizedMemoryPolynomialCrossTermsPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_DPDCfgGeneralizedMemoryPolynomialCrossTerms"));
  function_pointers_.DPDCfgIterativeDPDEnabled = reinterpret_cast<DPDCfgIterativeDPDEnabledPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_DPDCfgIterativeDPDEnabled"));
  function_pointers_.DPDCfgLookupTableAMToAMCurveFit = reinterpret_cast<DPDCfgLookupTableAMToAMCurveFitPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_DPDCfgLookupTableAMToAMCurveFit"));
  function_pointers_.DPDCfgLookupTableAMToPMCurveFit = reinterpret_cast<DPDCfgLookupTableAMToPMCurveFitPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_DPDCfgLookupTableAMToPMCurveFit"));
  function_pointers_.DPDCfgLookupTableStepSize = reinterpret_cast<DPDCfgLookupTableStepSizePtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_DPDCfgLookupTableStepSize"));
  function_pointers_.DPDCfgLookupTableThreshold = reinterpret_cast<DPDCfgLookupTableThresholdPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_DPDCfgLookupTableThreshold"));
  function_pointers_.DPDCfgLookupTableType = reinterpret_cast<DPDCfgLookupTableTypePtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_DPDCfgLookupTableType"));
  function_pointers_.DPDCfgMeasurementInterval = reinterpret_cast<DPDCfgMeasurementIntervalPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_DPDCfgMeasurementInterval"));
  function_pointers_.DPDCfgMeasurementSampleRate = reinterpret_cast<DPDCfgMeasurementSampleRatePtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_DPDCfgMeasurementSampleRate"));
  function_pointers_.DPDCfgMemoryPolynomial = reinterpret_cast<DPDCfgMemoryPolynomialPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_DPDCfgMemoryPolynomial"));
  function_pointers_.DPDCfgPreviousDPDPolynomial = reinterpret_cast<DPDCfgPreviousDPDPolynomialPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_DPDCfgPreviousDPDPolynomial"));
  function_pointers_.DPDCfgReferenceWaveform = reinterpret_cast<DPDCfgReferenceWaveformPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_DPDCfgReferenceWaveform"));
  function_pointers_.DPDCfgSynchronizationMethod = reinterpret_cast<DPDCfgSynchronizationMethodPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_DPDCfgSynchronizationMethod"));
  function_pointers_.DPDFetchApplyDPDPreCFRPAPR = reinterpret_cast<DPDFetchApplyDPDPreCFRPAPRPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_DPDFetchApplyDPDPreCFRPAPR"));
  function_pointers_.DPDFetchAverageGain = reinterpret_cast<DPDFetchAverageGainPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_DPDFetchAverageGain"));
  function_pointers_.DPDFetchDPDPolynomial = reinterpret_cast<DPDFetchDPDPolynomialPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_DPDFetchDPDPolynomial"));
  function_pointers_.DPDFetchLookupTable = reinterpret_cast<DPDFetchLookupTablePtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_DPDFetchLookupTable"));
  function_pointers_.DPDFetchNMSE = reinterpret_cast<DPDFetchNMSEPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_DPDFetchNMSE"));
  function_pointers_.DPDFetchProcessedMeanAcquiredWaveform = reinterpret_cast<DPDFetchProcessedMeanAcquiredWaveformPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_DPDFetchProcessedMeanAcquiredWaveform"));
  function_pointers_.DPDFetchProcessedReferenceWaveform = reinterpret_cast<DPDFetchProcessedReferenceWaveformPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_DPDFetchProcessedReferenceWaveform"));
  function_pointers_.DeleteList = reinterpret_cast<DeleteListPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_DeleteList"));
  function_pointers_.DeleteSignalConfiguration = reinterpret_cast<DeleteSignalConfigurationPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_DeleteSignalConfiguration"));
  function_pointers_.DisableTrigger = reinterpret_cast<DisableTriggerPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_DisableTrigger"));
  function_pointers_.FCntCfgAveraging = reinterpret_cast<FCntCfgAveragingPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_FCntCfgAveraging"));
  function_pointers_.FCntCfgMeasurementInterval = reinterpret_cast<FCntCfgMeasurementIntervalPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_FCntCfgMeasurementInterval"));
  function_pointers_.FCntCfgRBWFilter = reinterpret_cast<FCntCfgRBWFilterPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_FCntCfgRBWFilter"));
  function_pointers_.FCntCfgThreshold = reinterpret_cast<FCntCfgThresholdPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_FCntCfgThreshold"));
  function_pointers_.FCntFetchAllanDeviation = reinterpret_cast<FCntFetchAllanDeviationPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_FCntFetchAllanDeviation"));
  function_pointers_.FCntFetchFrequencyTrace = reinterpret_cast<FCntFetchFrequencyTracePtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_FCntFetchFrequencyTrace"));
  function_pointers_.FCntFetchMeasurement = reinterpret_cast<FCntFetchMeasurementPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_FCntFetchMeasurement"));
  function_pointers_.FCntFetchPhaseTrace = reinterpret_cast<FCntFetchPhaseTracePtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_FCntFetchPhaseTrace"));
  function_pointers_.FCntFetchPowerTrace = reinterpret_cast<FCntFetchPowerTracePtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_FCntFetchPowerTrace"));
  function_pointers_.FCntRead = reinterpret_cast<FCntReadPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_FCntRead"));
  function_pointers_.GetAllNamedResultNames = reinterpret_cast<GetAllNamedResultNamesPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_GetAllNamedResultNames"));
  function_pointers_.GetAttributeF32 = reinterpret_cast<GetAttributeF32Ptr>(p_shared_library_->get_function_pointer("RFmxSpecAn_GetAttributeF32"));
  function_pointers_.GetAttributeF32Array = reinterpret_cast<GetAttributeF32ArrayPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_GetAttributeF32Array"));
  function_pointers_.GetAttributeF64 = reinterpret_cast<GetAttributeF64Ptr>(p_shared_library_->get_function_pointer("RFmxSpecAn_GetAttributeF64"));
  function_pointers_.GetAttributeF64Array = reinterpret_cast<GetAttributeF64ArrayPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_GetAttributeF64Array"));
  function_pointers_.GetAttributeI16 = reinterpret_cast<GetAttributeI16Ptr>(p_shared_library_->get_function_pointer("RFmxSpecAn_GetAttributeI16"));
  function_pointers_.GetAttributeI32 = reinterpret_cast<GetAttributeI32Ptr>(p_shared_library_->get_function_pointer("RFmxSpecAn_GetAttributeI32"));
  function_pointers_.GetAttributeI32Array = reinterpret_cast<GetAttributeI32ArrayPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_GetAttributeI32Array"));
  function_pointers_.GetAttributeI64 = reinterpret_cast<GetAttributeI64Ptr>(p_shared_library_->get_function_pointer("RFmxSpecAn_GetAttributeI64"));
  function_pointers_.GetAttributeI64Array = reinterpret_cast<GetAttributeI64ArrayPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_GetAttributeI64Array"));
  function_pointers_.GetAttributeI8 = reinterpret_cast<GetAttributeI8Ptr>(p_shared_library_->get_function_pointer("RFmxSpecAn_GetAttributeI8"));
  function_pointers_.GetAttributeI8Array = reinterpret_cast<GetAttributeI8ArrayPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_GetAttributeI8Array"));
  function_pointers_.GetAttributeNIComplexDoubleArray = reinterpret_cast<GetAttributeNIComplexDoubleArrayPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_GetAttributeNIComplexDoubleArray"));
  function_pointers_.GetAttributeNIComplexSingleArray = reinterpret_cast<GetAttributeNIComplexSingleArrayPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_GetAttributeNIComplexSingleArray"));
  function_pointers_.GetAttributeString = reinterpret_cast<GetAttributeStringPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_GetAttributeString"));
  function_pointers_.GetAttributeU16 = reinterpret_cast<GetAttributeU16Ptr>(p_shared_library_->get_function_pointer("RFmxSpecAn_GetAttributeU16"));
  function_pointers_.GetAttributeU32 = reinterpret_cast<GetAttributeU32Ptr>(p_shared_library_->get_function_pointer("RFmxSpecAn_GetAttributeU32"));
  function_pointers_.GetAttributeU32Array = reinterpret_cast<GetAttributeU32ArrayPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_GetAttributeU32Array"));
  function_pointers_.GetAttributeU64Array = reinterpret_cast<GetAttributeU64ArrayPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_GetAttributeU64Array"));
  function_pointers_.GetAttributeU8 = reinterpret_cast<GetAttributeU8Ptr>(p_shared_library_->get_function_pointer("RFmxSpecAn_GetAttributeU8"));
  function_pointers_.GetAttributeU8Array = reinterpret_cast<GetAttributeU8ArrayPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_GetAttributeU8Array"));
  ...
  function_pointers_.HarmCfgAutoHarmonics = reinterpret_cast<HarmCfgAutoHarmonicsPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_HarmCfgAutoHarmonics"));
  function_pointers_.HarmCfgAveraging = reinterpret_cast<HarmCfgAveragingPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_HarmCfgAveraging"));
  function_pointers_.HarmCfgFundamentalMeasurementInterval = reinterpret_cast<HarmCfgFundamentalMeasurementIntervalPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_HarmCfgFundamentalMeasurementInterval"));
  function_pointers_.HarmCfgFundamentalRBW = reinterpret_cast<HarmCfgFundamentalRBWPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_HarmCfgFundamentalRBW"));
  function_pointers_.HarmCfgHarmonic = reinterpret_cast<HarmCfgHarmonicPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_HarmCfgHarmonic"));
  function_pointers_.HarmCfgHarmonicArray = reinterpret_cast<HarmCfgHarmonicArrayPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_HarmCfgHarmonicArray"));
  function_pointers_.HarmCfgNumberOfHarmonics = reinterpret_cast<HarmCfgNumberOfHarmonicsPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_HarmCfgNumberOfHarmonics"));
  function_pointers_.HarmFetchHarmonicMeasurement = reinterpret_cast<HarmFetchHarmonicMeasurementPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_HarmFetchHarmonicMeasurement"));
  function_pointers_.HarmFetchHarmonicMeasurementArray = reinterpret_cast<HarmFetchHarmonicMeasurementArrayPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_HarmFetchHarmonicMeasurementArray"));
  function_pointers_.HarmFetchHarmonicPowerTrace = reinterpret_cast<HarmFetchHarmonicPowerTracePtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_HarmFetchHarmonicPowerTrace"));
  function_pointers_.HarmFetchTHD = reinterpret_cast<HarmFetchTHDPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_HarmFetchTHD"));
  function_pointers_.HarmRead = reinterpret_cast<HarmReadPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_HarmRead"));
  function_pointers_.IDPDCfgEqualizerCoefficients = reinterpret_cast<IDPDCfgEqualizerCoefficientsPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_IDPDCfgEqualizerCoefficients"));
  function_pointers_.IDPDCfgPredistortedWaveform = reinterpret_cast<IDPDCfgPredistortedWaveformPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_IDPDCfgPredistortedWaveform"));
  function_pointers_.IDPDCfgReferenceWaveform = reinterpret_cast<IDPDCfgReferenceWaveformPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_IDPDCfgReferenceWaveform"));
  function_pointers_.IDPDFetchEqualizerCoefficients = reinterpret_cast<IDPDFetchEqualizerCoefficientsPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_IDPDFetchEqualizerCoefficients"));
  function_pointers_.IDPDFetchPredistortedWaveform = reinterpret_cast<IDPDFetchPredistortedWaveformPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_IDPDFetchPredistortedWaveform"));
  function_pointers_.IDPDFetchProcessedMeanAcquiredWaveform = reinterpret_cast<IDPDFetchProcessedMeanAcquiredWaveformPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_IDPDFetchProcessedMeanAcquiredWaveform"));
  function_pointers_.IDPDFetchProcessedReferenceWaveform = reinterpret_cast<IDPDFetchProcessedReferenceWaveformPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_IDPDFetchProcessedReferenceWaveform"));
  function_pointers_.IDPDGetEqualizerReferenceWaveform = reinterpret_cast<IDPDGetEqualizerReferenceWaveformPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_IDPDGetEqualizerReferenceWaveform"));
  function_pointers_.IMCfgAutoIntermodsSetup = reinterpret_cast<IMCfgAutoIntermodsSetupPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_IMCfgAutoIntermodsSetup"));
  function_pointers_.IMCfgAveraging = reinterpret_cast<IMCfgAveragingPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_IMCfgAveraging"));
  function_pointers_.IMCfgFFT = reinterpret_cast<IMCfgFFTPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_IMCfgFFT"));
  function_pointers_.IMCfgFrequencyDefinition = reinterpret_cast<IMCfgFrequencyDefinitionPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_IMCfgFrequencyDefinition"));
  function_pointers_.IMCfgFundamentalTones = reinterpret_cast<IMCfgFundamentalTonesPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_IMCfgFundamentalTones"));
  function_pointers_.IMCfgIntermod = reinterpret_cast<IMCfgIntermodPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_IMCfgIntermod"));
  function_pointers_.IMCfgIntermodArray = reinterpret_cast<IMCfgIntermodArrayPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_IMCfgIntermodArray"));
  function_pointers_.IMCfgMeasurementMethod = reinterpret_cast<IMCfgMeasurementMethodPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_IMCfgMeasurementMethod"));
  function_pointers_.IMCfgNumberOfIntermods = reinterpret_cast<IMCfgNumberOfIntermodsPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_IMCfgNumberOfIntermods"));
  function_pointers_.IMCfgRBWFilter = reinterpret_cast<IMCfgRBWFilterPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_IMCfgRBWFilter"));
  function_pointers_.IMCfgSweepTime = reinterpret_cast<IMCfgSweepTimePtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_IMCfgSweepTime"));
  function_pointers_.IMFetchFundamentalMeasurement = reinterpret_cast<IMFetchFundamentalMeasurementPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_IMFetchFundamentalMeasurement"));
  function_pointers_.IMFetchInterceptPower = reinterpret_cast<IMFetchInterceptPowerPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_IMFetchInterceptPower"));
  function_pointers_.IMFetchInterceptPowerArray = reinterpret_cast<IMFetchInterceptPowerArrayPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_IMFetchInterceptPowerArray"));
  function_pointers_.IMFetchIntermodMeasurement = reinterpret_cast<IMFetchIntermodMeasurementPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_IMFetchIntermodMeasurement"));
  function_pointers_.IMFetchIntermodMeasurementArray = reinterpret_cast<IMFetchIntermodMeasurementArrayPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_IMFetchIntermodMeasurementArray"));
  function_pointers_.IMFetchSpectrum = reinterpret_cast<IMFetchSpectrumPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_IMFetchSpectrum"));
  function_pointers_.IQCfgAcquisition = reinterpret_cast<IQCfgAcquisitionPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_IQCfgAcquisition"));
  function_pointers_.IQCfgBandwidth = reinterpret_cast<IQCfgBandwidthPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_IQCfgBandwidth"));
  function_pointers_.IQFetchData = reinterpret_cast<IQFetchDataPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_IQFetchData"));
  function_pointers_.IQGetRecordsDone = reinterpret_cast<IQGetRecordsDonePtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_IQGetRecordsDone"));
  function_pointers_.Initialize = reinterpret_cast<InitializePtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_Initialize"));
  function_pointers_.InitializeFromNIRFSASession = reinterpret_cast<InitializeFromNIRFSASessionPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_InitializeFromNIRFSASession"));
  function_pointers_.Initiate = reinterpret_cast<InitiatePtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_Initiate"));
  function_pointers_.MarkerCfgNumberOfMarkers = reinterpret_cast<MarkerCfgNumberOfMarkersPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_MarkerCfgNumberOfMarkers"));
  function_pointers_.MarkerCfgPeakExcursion = reinterpret_cast<MarkerCfgPeakExcursionPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_MarkerCfgPeakExcursion"));
  function_pointers_.MarkerCfgReferenceMarker = reinterpret_cast<MarkerCfgReferenceMarkerPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_MarkerCfgReferenceMarker"));
  function_pointers_.MarkerCfgThreshold = reinterpret_cast<MarkerCfgThresholdPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_MarkerCfgThreshold"));
  function_pointers_.MarkerCfgTrace = reinterpret_cast<MarkerCfgTracePtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_MarkerCfgTrace"));
  function_pointers_.MarkerCfgType = reinterpret_cast<MarkerCfgTypePtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_MarkerCfgType"));
  function_pointers_.MarkerCfgXLocation = reinterpret_cast<MarkerCfgXLocationPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_MarkerCfgXLocation"));
  function_pointers_.MarkerFetchXY = reinterpret_cast<MarkerFetchXYPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_MarkerFetchXY"));
  function_pointers_.MarkerNextPeak = reinterpret_cast<MarkerNextPeakPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_MarkerNextPeak"));
  function_pointers_.MarkerPeakSearch = reinterpret_cast<MarkerPeakSearchPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_MarkerPeakSearch"));
  function_pointers_.NFCfgAveraging = reinterpret_cast<NFCfgAveragingPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_NFCfgAveraging"));
  function_pointers_.NFCfgCalibrationLoss = reinterpret_cast<NFCfgCalibrationLossPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_NFCfgCalibrationLoss"));
  function_pointers_.NFCfgColdSourceDUTSParameters = reinterpret_cast<NFCfgColdSourceDUTSParametersPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_NFCfgColdSourceDUTSParameters"));
  function_pointers_.NFCfgColdSourceInputTermination = reinterpret_cast<NFCfgColdSourceInputTerminationPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_NFCfgColdSourceInputTermination"));
  function_pointers_.NFCfgColdSourceMode = reinterpret_cast<NFCfgColdSourceModePtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_NFCfgColdSourceMode"));
  function_pointers_.NFCfgDUTInputLoss = reinterpret_cast<NFCfgDUTInputLossPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_NFCfgDUTInputLoss"));
  function_pointers_.NFCfgDUTOutputLoss = reinterpret_cast<NFCfgDUTOutputLossPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_NFCfgDUTOutputLoss"));
  function_pointers_.NFCfgFrequencyList = reinterpret_cast<NFCfgFrequencyListPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_NFCfgFrequencyList"));
  function_pointers_.NFCfgFrequencyListStartStopPoints = reinterpret_cast<NFCfgFrequencyListStartStopPointsPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_NFCfgFrequencyList_StartStopPoints"));
  function_pointers_.NFCfgFrequencyListStartStopStep = reinterpret_cast<NFCfgFrequencyListStartStopStepPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_NFCfgFrequencyList_StartStopStep"));
  function_pointers_.NFCfgMeasurementBandwidth = reinterpret_cast<NFCfgMeasurementBandwidthPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_NFCfgMeasurementBandwidth"));
  function_pointers_.NFCfgMeasurementInterval = reinterpret_cast<NFCfgMeasurementIntervalPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_NFCfgMeasurementInterval"));
  function_pointers_.NFCfgMeasurementMethod = reinterpret_cast<NFCfgMeasurementMethodPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_NFCfgMeasurementMethod"));
  function_pointers_.NFCfgYFactorMode = reinterpret_cast<NFCfgYFactorModePtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_NFCfgYFactorMode"));
  function_pointers_.NFCfgYFactorNoiseSourceENR = reinterpret_cast<NFCfgYFactorNoiseSourceENRPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_NFCfgYFactorNoiseSourceENR"));
  function_pointers_.NFCfgYFactorNoiseSourceLoss = reinterpret_cast<NFCfgYFactorNoiseSourceLossPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_NFCfgYFactorNoiseSourceLoss"));
  function_pointers_.NFCfgYFactorNoiseSourceSettlingTime = reinterpret_cast<NFCfgYFactorNoiseSourceSettlingTimePtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_NFCfgYFactorNoiseSourceSettlingTime"));
  function_pointers_.NFClearCalibrationDatabase = reinterpret_cast<NFClearCalibrationDatabasePtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_NFClearCalibrationDatabase"));
  function_pointers_.NFFetchAnalyzerNoiseFigure = reinterpret_cast<NFFetchAnalyzerNoiseFigurePtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_NFFetchAnalyzerNoiseFigure"));
  function_pointers_.NFFetchColdSourcePower = reinterpret_cast<NFFetchColdSourcePowerPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_NFFetchColdSourcePower"));
  function_pointers_.NFFetchDUTNoiseFigureAndGain = reinterpret_cast<NFFetchDUTNoiseFigureAndGainPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_NFFetchDUTNoiseFigureAndGain"));
  function_pointers_.NFFetchYFactorPowers = reinterpret_cast<NFFetchYFactorPowersPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_NFFetchYFactorPowers"));
  function_pointers_.NFFetchYFactors = reinterpret_cast<NFFetchYFactorsPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_NFFetchYFactors"));
  function_pointers_.NFRecommendReferenceLevel = reinterpret_cast<NFRecommendReferenceLevelPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_NFRecommendReferenceLevel"));
  function_pointers_.NFValidateCalibrationData = reinterpret_cast<NFValidateCalibrationDataPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_NFValidateCalibrationData"));
  function_pointers_.OBWCfgAveraging = reinterpret_cast<OBWCfgAveragingPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_OBWCfgAveraging"));
  function_pointers_.OBWCfgBandwidthPercentage = reinterpret_cast<OBWCfgBandwidthPercentagePtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_OBWCfgBandwidthPercentage"));
  function_pointers_.OBWCfgFFT = reinterpret_cast<OBWCfgFFTPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_OBWCfgFFT"));
  function_pointers_.OBWCfgPowerUnits = reinterpret_cast<OBWCfgPowerUnitsPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_OBWCfgPowerUnits"));
  function_pointers_.OBWCfgRBWFilter = reinterpret_cast<OBWCfgRBWFilterPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_OBWCfgRBWFilter"));
  function_pointers_.OBWCfgSpan = reinterpret_cast<OBWCfgSpanPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_OBWCfgSpan"));
  function_pointers_.OBWCfgSweepTime = reinterpret_cast<OBWCfgSweepTimePtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_OBWCfgSweepTime"));
  function_pointers_.OBWFetchMeasurement = reinterpret_cast<OBWFetchMeasurementPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_OBWFetchMeasurement"));
  function_pointers_.OBWFetchSpectrumTrace = reinterpret_cast<OBWFetchSpectrumTracePtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_OBWFetchSpectrumTrace"));
  function_pointers_.OBWRead = reinterpret_cast<OBWReadPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_OBWRead"));
  function_pointers_.PAVTCfgMeasurementBandwidth = reinterpret_cast<PAVTCfgMeasurementBandwidthPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_PAVTCfgMeasurementBandwidth"));
  function_pointers_.PAVTCfgMeasurementInterval = reinterpret_cast<PAVTCfgMeasurementIntervalPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_PAVTCfgMeasurementInterval"));
  function_pointers_.PAVTCfgMeasurementIntervalMode = reinterpret_cast<PAVTCfgMeasurementIntervalModePtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_PAVTCfgMeasurementIntervalMode"));
  function_pointers_.PAVTCfgMeasurementLocationType = reinterpret_cast<PAVTCfgMeasurementLocationTypePtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_PAVTCfgMeasurementLocationType"));
  function_pointers_.PAVTCfgNumberOfSegments = reinterpret_cast<PAVTCfgNumberOfSegmentsPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_PAVTCfgNumberOfSegments"));
  function_pointers_.PAVTCfgSegmentMeasurementInterval = reinterpret_cast<PAVTCfgSegmentMeasurementIntervalPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_PAVTCfgSegmentMeasurementInterval"));
  function_pointers_.PAVTCfgSegmentMeasurementIntervalArray = reinterpret_cast<PAVTCfgSegmentMeasurementIntervalArrayPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_PAVTCfgSegmentMeasurementIntervalArray"));
  function_pointers_.PAVTCfgSegmentStartTimeList = reinterpret_cast<PAVTCfgSegmentStartTimeListPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_PAVTCfgSegmentStartTimeList"));
  function_pointers_.PAVTCfgSegmentStartTimeStep = reinterpret_cast<PAVTCfgSegmentStartTimeStepPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_PAVTCfgSegmentStartTimeStep"));
  function_pointers_.PAVTCfgSegmentType = reinterpret_cast<PAVTCfgSegmentTypePtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_PAVTCfgSegmentType"));
  function_pointers_.PAVTCfgSegmentTypeArray = reinterpret_cast<PAVTCfgSegmentTypeArrayPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_PAVTCfgSegmentTypeArray"));
  function_pointers_.PAVTFetchAmplitudeTrace = reinterpret_cast<PAVTFetchAmplitudeTracePtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_PAVTFetchAmplitudeTrace"));
  function_pointers_.PAVTFetchPhaseAndAmplitude = reinterpret_cast<PAVTFetchPhaseAndAmplitudePtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_PAVTFetchPhaseAndAmplitude"));
  function_pointers_.PAVTFetchPhaseAndAmplitudeArray = reinterpret_cast<PAVTFetchPhaseAndAmplitudeArrayPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_PAVTFetchPhaseAndAmplitudeArray"));
  function_pointers_.PAVTFetchPhaseTrace = reinterpret_cast<PAVTFetchPhaseTracePtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_PAVTFetchPhaseTrace"));
  function_pointers_.PhaseNoiseCfgAutoRange = reinterpret_cast<PhaseNoiseCfgAutoRangePtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_PhaseNoiseCfgAutoRange"));
  function_pointers_.PhaseNoiseCfgAveragingMultiplier = reinterpret_cast<PhaseNoiseCfgAveragingMultiplierPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_PhaseNoiseCfgAveragingMultiplier"));
  function_pointers_.PhaseNoiseCfgCancellation = reinterpret_cast<PhaseNoiseCfgCancellationPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_PhaseNoiseCfgCancellation"));
  function_pointers_.PhaseNoiseCfgIntegratedNoise = reinterpret_cast<PhaseNoiseCfgIntegratedNoisePtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_PhaseNoiseCfgIntegratedNoise"));
  function_pointers_.PhaseNoiseCfgNumberOfRanges = reinterpret_cast<PhaseNoiseCfgNumberOfRangesPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_PhaseNoiseCfgNumberOfRanges"));
  function_pointers_.PhaseNoiseCfgRangeArray = reinterpret_cast<PhaseNoiseCfgRangeArrayPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_PhaseNoiseCfgRangeArray"));
  function_pointers_.PhaseNoiseCfgRangeDefinition = reinterpret_cast<PhaseNoiseCfgRangeDefinitionPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_PhaseNoiseCfgRangeDefinition"));
  function_pointers_.PhaseNoiseCfgSmoothing = reinterpret_cast<PhaseNoiseCfgSmoothingPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_PhaseNoiseCfgSmoothing"));
  function_pointers_.PhaseNoiseCfgSpotNoiseFrequencyList = reinterpret_cast<PhaseNoiseCfgSpotNoiseFrequencyListPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_PhaseNoiseCfgSpotNoiseFrequencyList"));
  function_pointers_.PhaseNoiseCfgSpurRemoval = reinterpret_cast<PhaseNoiseCfgSpurRemovalPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_PhaseNoiseCfgSpurRemoval"));
  function_pointers_.PhaseNoiseFetchCarrierMeasurement = reinterpret_cast<PhaseNoiseFetchCarrierMeasurementPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_PhaseNoiseFetchCarrierMeasurement"));
  function_pointers_.PhaseNoiseFetchIntegratedNoise = reinterpret_cast<PhaseNoiseFetchIntegratedNoisePtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_PhaseNoiseFetchIntegratedNoise"));
  function_pointers_.PhaseNoiseFetchMeasuredLogPlotTrace = reinterpret_cast<PhaseNoiseFetchMeasuredLogPlotTracePtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_PhaseNoiseFetchMeasuredLogPlotTrace"));
  function_pointers_.PhaseNoiseFetchSmoothedLogPlotTrace = reinterpret_cast<PhaseNoiseFetchSmoothedLogPlotTracePtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_PhaseNoiseFetchSmoothedLogPlotTrace"));
  function_pointers_.PhaseNoiseFetchSpotNoise = reinterpret_cast<PhaseNoiseFetchSpotNoisePtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_PhaseNoiseFetchSpotNoise"));
  function_pointers_.ResetAttribute = reinterpret_cast<ResetAttributePtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_ResetAttribute"));
  function_pointers_.ResetToDefault = reinterpret_cast<ResetToDefaultPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_ResetToDefault"));
  function_pointers_.SEMCfgAveraging = reinterpret_cast<SEMCfgAveragingPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_SEMCfgAveraging"));
  function_pointers_.SEMCfgCarrierChannelBandwidth = reinterpret_cast<SEMCfgCarrierChannelBandwidthPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_SEMCfgCarrierChannelBandwidth"));
  function_pointers_.SEMCfgCarrierEnabled = reinterpret_cast<SEMCfgCarrierEnabledPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_SEMCfgCarrierEnabled"));
  function_pointers_.SEMCfgCarrierFrequency = reinterpret_cast<SEMCfgCarrierFrequencyPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_SEMCfgCarrierFrequency"));
  function_pointers_.SEMCfgCarrierIntegrationBandwidth = reinterpret_cast<SEMCfgCarrierIntegrationBandwidthPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_SEMCfgCarrierIntegrationBandwidth"));
  function_pointers_.SEMCfgCarrierRBWFilter = reinterpret_cast<SEMCfgCarrierRBWFilterPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_SEMCfgCarrierRBWFilter"));
  function_pointers_.SEMCfgCarrierRRCFilter = reinterpret_cast<SEMCfgCarrierRRCFilterPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_SEMCfgCarrierRRCFilter"));
  function_pointers_.SEMCfgFFT = reinterpret_cast<SEMCfgFFTPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_SEMCfgFFT"));
  function_pointers_.SEMCfgNumberOfCarriers = reinterpret_cast<SEMCfgNumberOfCarriersPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_SEMCfgNumberOfCarriers"));
  function_pointers_.SEMCfgNumberOfOffsets = reinterpret_cast<SEMCfgNumberOfOffsetsPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_SEMCfgNumberOfOffsets"));
  function_pointers_.SEMCfgOffsetAbsoluteLimit = reinterpret_cast<SEMCfgOffsetAbsoluteLimitPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_SEMCfgOffsetAbsoluteLimit"));
  function_pointers_.SEMCfgOffsetAbsoluteLimitArray = reinterpret_cast<SEMCfgOffsetAbsoluteLimitArrayPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_SEMCfgOffsetAbsoluteLimitArray"));
  function_pointers_.SEMCfgOffsetBandwidthIntegral = reinterpret_cast<SEMCfgOffsetBandwidthIntegralPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_SEMCfgOffsetBandwidthIntegral"));
  function_pointers_.SEMCfgOffsetFrequency = reinterpret_cast<SEMCfgOffsetFrequencyPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_SEMCfgOffsetFrequency"));
  function_pointers_.SEMCfgOffsetFrequencyArray = reinterpret_cast<SEMCfgOffsetFrequencyArrayPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_SEMCfgOffsetFrequencyArray"));
  function_pointers_.SEMCfgOffsetFrequencyDefinition = reinterpret_cast<SEMCfgOffsetFrequencyDefinitionPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_SEMCfgOffsetFrequencyDefinition"));
  function_pointers_.SEMCfgOffsetLimitFailMask = reinterpret_cast<SEMCfgOffsetLimitFailMaskPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_SEMCfgOffsetLimitFailMask"));
  function_pointers_.SEMCfgOffsetRBWFilter = reinterpret_cast<SEMCfgOffsetRBWFilterPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_SEMCfgOffsetRBWFilter"));
  function_pointers_.SEMCfgOffsetRBWFilterArray = reinterpret_cast<SEMCfgOffsetRBWFilterArrayPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_SEMCfgOffsetRBWFilterArray"));
  function_pointers_.SEMCfgOffsetRelativeAttenuation = reinterpret_cast<SEMCfgOffsetRelativeAttenuationPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_SEMCfgOffsetRelativeAttenuation"));
  function_pointers_.SEMCfgOffsetRelativeAttenuationArray = reinterpret_cast<SEMCfgOffsetRelativeAttenuationArrayPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_SEMCfgOffsetRelativeAttenuationArray"));
  function_pointers_.SEMCfgOffsetRelativeLimit = reinterpret_cast<SEMCfgOffsetRelativeLimitPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_SEMCfgOffsetRelativeLimit"));
  function_pointers_.SEMCfgOffsetRelativeLimitArray = reinterpret_cast<SEMCfgOffsetRelativeLimitArrayPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_SEMCfgOffsetRelativeLimitArray"));
  function_pointers_.SEMCfgPowerUnits = reinterpret_cast<SEMCfgPowerUnitsPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_SEMCfgPowerUnits"));
  function_pointers_.SEMCfgReferenceType = reinterpret_cast<SEMCfgReferenceTypePtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_SEMCfgReferenceType"));
  function_pointers_.SEMCfgSweepTime = reinterpret_cast<SEMCfgSweepTimePtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_SEMCfgSweepTime"));
  function_pointers_.SEMFetchAbsoluteMaskTrace = reinterpret_cast<SEMFetchAbsoluteMaskTracePtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_SEMFetchAbsoluteMaskTrace"));
  function_pointers_.SEMFetchCarrierMeasurement = reinterpret_cast<SEMFetchCarrierMeasurementPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_SEMFetchCarrierMeasurement"));
  function_pointers_.SEMFetchCompositeMeasurementStatus = reinterpret_cast<SEMFetchCompositeMeasurementStatusPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_SEMFetchCompositeMeasurementStatus"));
  function_pointers_.SEMFetchFrequencyResolution = reinterpret_cast<SEMFetchFrequencyResolutionPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_SEMFetchFrequencyResolution"));
  function_pointers_.SEMFetchLowerOffsetMargin = reinterpret_cast<SEMFetchLowerOffsetMarginPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_SEMFetchLowerOffsetMargin"));
  function_pointers_.SEMFetchLowerOffsetMarginArray = reinterpret_cast<SEMFetchLowerOffsetMarginArrayPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_SEMFetchLowerOffsetMarginArray"));
  function_pointers_.SEMFetchLowerOffsetPower = reinterpret_cast<SEMFetchLowerOffsetPowerPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_SEMFetchLowerOffsetPower"));
  function_pointers_.SEMFetchLowerOffsetPowerArray = reinterpret_cast<SEMFetchLowerOffsetPowerArrayPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_SEMFetchLowerOffsetPowerArray"));
  function_pointers_.SEMFetchRelativeMaskTrace = reinterpret_cast<SEMFetchRelativeMaskTracePtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_SEMFetchRelativeMaskTrace"));
  function_pointers_.SEMFetchSpectrum = reinterpret_cast<SEMFetchSpectrumPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_SEMFetchSpectrum"));
  function_pointers_.SEMFetchTotalCarrierPower = reinterpret_cast<SEMFetchTotalCarrierPowerPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_SEMFetchTotalCarrierPower"));
  function_pointers_.SEMFetchUpperOffsetMargin = reinterpret_cast<SEMFetchUpperOffsetMarginPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_SEMFetchUpperOffsetMargin"));
  function_pointers_.SEMFetchUpperOffsetMarginArray = reinterpret_cast<SEMFetchUpperOffsetMarginArrayPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_SEMFetchUpperOffsetMarginArray"));
  function_pointers_.SEMFetchUpperOffsetPower = reinterpret_cast<SEMFetchUpperOffsetPowerPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_SEMFetchUpperOffsetPower"));
  function_pointers_.SEMFetchUpperOffsetPowerArray = reinterpret_cast<SEMFetchUpperOffsetPowerArrayPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_SEMFetchUpperOffsetPowerArray"));
  function_pointers_.SelectMeasurements = reinterpret_cast<SelectMeasurementsPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_SelectMeasurements"));
  function_pointers_.SendSoftwareEdgeTrigger = reinterpret_cast<SendSoftwareEdgeTriggerPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_SendSoftwareEdgeTrigger"));
  function_pointers_.SetAttributeF32 = reinterpret_cast<SetAttributeF32Ptr>(p_shared_library_->get_function_pointer("RFmxSpecAn_SetAttributeF32"));
  function_pointers_.SetAttributeF32Array = reinterpret_cast<SetAttributeF32ArrayPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_SetAttributeF32Array"));
  function_pointers_.SetAttributeF64 = reinterpret_cast<SetAttributeF64Ptr>(p_shared_library_->get_function_pointer("RFmxSpecAn_SetAttributeF64"));
  function_pointers_.SetAttributeF64Array = reinterpret_cast<SetAttributeF64ArrayPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_SetAttributeF64Array"));
  function_pointers_.SetAttributeI16 = reinterpret_cast<SetAttributeI16Ptr>(p_shared_library_->get_function_pointer("RFmxSpecAn_SetAttributeI16"));
  function_pointers_.SetAttributeI32 = reinterpret_cast<SetAttributeI32Ptr>(p_shared_library_->get_function_pointer("RFmxSpecAn_SetAttributeI32"));
  function_pointers_.SetAttributeI32Array = reinterpret_cast<SetAttributeI32ArrayPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_SetAttributeI32Array"));
  function_pointers_.SetAttributeI64 = reinterpret_cast<SetAttributeI64Ptr>(p_shared_library_->get_function_pointer("RFmxSpecAn_SetAttributeI64"));
  function_pointers_.SetAttributeI64Array = reinterpret_cast<SetAttributeI64ArrayPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_SetAttributeI64Array"));
  function_pointers_.SetAttributeI8 = reinterpret_cast<SetAttributeI8Ptr>(p_shared_library_->get_function_pointer("RFmxSpecAn_SetAttributeI8"));
  function_pointers_.SetAttributeI8Array = reinterpret_cast<SetAttributeI8ArrayPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_SetAttributeI8Array"));
  function_pointers_.SetAttributeNIComplexDoubleArray = reinterpret_cast<SetAttributeNIComplexDoubleArrayPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_SetAttributeNIComplexDoubleArray"));
  function_pointers_.SetAttributeNIComplexSingleArray = reinterpret_cast<SetAttributeNIComplexSingleArrayPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_SetAttributeNIComplexSingleArray"));
  function_pointers_.SetAttributeString = reinterpret_cast<SetAttributeStringPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_SetAttributeString"));
  function_pointers_.SetAttributeU16 = reinterpret_cast<SetAttributeU16Ptr>(p_shared_library_->get_function_pointer("RFmxSpecAn_SetAttributeU16"));
  function_pointers_.SetAttributeU32 = reinterpret_cast<SetAttributeU32Ptr>(p_shared_library_->get_function_pointer("RFmxSpecAn_SetAttributeU32"));
  function_pointers_.SetAttributeU32Array = reinterpret_cast<SetAttributeU32ArrayPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_SetAttributeU32Array"));
  function_pointers_.SetAttributeU64Array = reinterpret_cast<SetAttributeU64ArrayPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_SetAttributeU64Array"));
  function_pointers_.SetAttributeU8 = reinterpret_cast<SetAttributeU8Ptr>(p_shared_library_->get_function_pointer("RFmxSpecAn_SetAttributeU8"));
  function_pointers_.SetAttributeU8Array = reinterpret_cast<SetAttributeU8ArrayPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_SetAttributeU8Array"));
  function_pointers_.SpectrumCfgAveraging = reinterpret_cast<SpectrumCfgAveragingPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_SpectrumCfgAveraging"));
  function_pointers_.SpectrumCfgDetector = reinterpret_cast<SpectrumCfgDetectorPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_SpectrumCfgDetector"));
  function_pointers_.SpectrumCfgFFT = reinterpret_cast<SpectrumCfgFFTPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_SpectrumCfgFFT"));
  function_pointers_.SpectrumCfgFrequencyStartStop = reinterpret_cast<SpectrumCfgFrequencyStartStopPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_SpectrumCfgFrequencyStartStop"));
  function_pointers_.SpectrumCfgNoiseCompensationEnabled = reinterpret_cast<SpectrumCfgNoiseCompensationEnabledPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_SpectrumCfgNoiseCompensationEnabled"));
  function_pointers_.SpectrumCfgPowerUnits = reinterpret_cast<SpectrumCfgPowerUnitsPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_SpectrumCfgPowerUnits"));
  function_pointers_.SpectrumCfgRBWFilter = reinterpret_cast<SpectrumCfgRBWFilterPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_SpectrumCfgRBWFilter"));
  function_pointers_.SpectrumCfgSpan = reinterpret_cast<SpectrumCfgSpanPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_SpectrumCfgSpan"));
  function_pointers_.SpectrumCfgSweepTime = reinterpret_cast<SpectrumCfgSweepTimePtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_SpectrumCfgSweepTime"));
  function_pointers_.SpectrumCfgVBWFilter = reinterpret_cast<SpectrumCfgVBWFilterPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_SpectrumCfgVBWFilter"));
  function_pointers_.SpectrumFetchMeasurement = reinterpret_cast<SpectrumFetchMeasurementPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_SpectrumFetchMeasurement"));
  function_pointers_.SpectrumFetchPowerTrace = reinterpret_cast<SpectrumFetchPowerTracePtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_SpectrumFetchPowerTrace"));
  function_pointers_.SpectrumFetchSpectrum = reinterpret_cast<SpectrumFetchSpectrumPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_SpectrumFetchSpectrum"));
  function_pointers_.SpectrumRead = reinterpret_cast<SpectrumReadPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_SpectrumRead"));
  function_pointers_.SpectrumValidateNoiseCalibrationData = reinterpret_cast<SpectrumValidateNoiseCalibrationDataPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_SpectrumValidateNoiseCalibrationData"));
  function_pointers_.SpurCfgAveraging = reinterpret_cast<SpurCfgAveragingPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_SpurCfgAveraging"));
  function_pointers_.SpurCfgFFTWindowType = reinterpret_cast<SpurCfgFFTWindowTypePtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_SpurCfgFFTWindowType"));
  function_pointers_.SpurCfgNumberOfRanges = reinterpret_cast<SpurCfgNumberOfRangesPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_SpurCfgNumberOfRanges"));
  function_pointers_.SpurCfgRangeAbsoluteLimit = reinterpret_cast<SpurCfgRangeAbsoluteLimitPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_SpurCfgRangeAbsoluteLimit"));
  function_pointers_.SpurCfgRangeAbsoluteLimitArray = reinterpret_cast<SpurCfgRangeAbsoluteLimitArrayPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_SpurCfgRangeAbsoluteLimitArray"));
  function_pointers_.SpurCfgRangeDetector = reinterpret_cast<SpurCfgRangeDetectorPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_SpurCfgRangeDetector"));
  function_pointers_.SpurCfgRangeDetectorArray = reinterpret_cast<SpurCfgRangeDetectorArrayPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_SpurCfgRangeDetectorArray"));
  function_pointers_.SpurCfgRangeFrequency = reinterpret_cast<SpurCfgRangeFrequencyPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_SpurCfgRangeFrequency"));
  function_pointers_.SpurCfgRangeFrequencyArray = reinterpret_cast<SpurCfgRangeFrequencyArrayPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_SpurCfgRangeFrequencyArray"));
  function_pointers_.SpurCfgRangeNumberOfSpursToReport = reinterpret_cast<SpurCfgRangeNumberOfSpursToReportPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_SpurCfgRangeNumberOfSpursToReport"));
  function_pointers_.SpurCfgRangeNumberOfSpursToReportArray = reinterpret_cast<SpurCfgRangeNumberOfSpursToReportArrayPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_SpurCfgRangeNumberOfSpursToReportArray"));
  function_pointers_.SpurCfgRangePeakCriteria = reinterpret_cast<SpurCfgRangePeakCriteriaPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_SpurCfgRangePeakCriteria"));
  function_pointers_.SpurCfgRangePeakCriteriaArray = reinterpret_cast<SpurCfgRangePeakCriteriaArrayPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_SpurCfgRangePeakCriteriaArray"));
  function_pointers_.SpurCfgRangeRBWArray = reinterpret_cast<SpurCfgRangeRBWArrayPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_SpurCfgRangeRBWArray"));
  function_pointers_.SpurCfgRangeRBWFilter = reinterpret_cast<SpurCfgRangeRBWFilterPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_SpurCfgRangeRBWFilter"));
  function_pointers_.SpurCfgRangeRelativeAttenuation = reinterpret_cast<SpurCfgRangeRelativeAttenuationPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_SpurCfgRangeRelativeAttenuation"));
  function_pointers_.SpurCfgRangeRelativeAttenuationArray = reinterpret_cast<SpurCfgRangeRelativeAttenuationArrayPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_SpurCfgRangeRelativeAttenuationArray"));
  function_pointers_.SpurCfgRangeSweepTime = reinterpret_cast<SpurCfgRangeSweepTimePtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_SpurCfgRangeSweepTime"));
  function_pointers_.SpurCfgRangeSweepTimeArray = reinterpret_cast<SpurCfgRangeSweepTimeArrayPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_SpurCfgRangeSweepTimeArray"));
  function_pointers_.SpurCfgRangeVBWFilter = reinterpret_cast<SpurCfgRangeVBWFilterPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_SpurCfgRangeVBWFilter"));
  function_pointers_.SpurCfgRangeVBWFilterArray = reinterpret_cast<SpurCfgRangeVBWFilterArrayPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_SpurCfgRangeVBWFilterArray"));
  function_pointers_.SpurCfgTraceRangeIndex = reinterpret_cast<SpurCfgTraceRangeIndexPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_SpurCfgTraceRangeIndex"));
  function_pointers_.SpurFetchAllSpurs = reinterpret_cast<SpurFetchAllSpursPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_SpurFetchAllSpurs"));
  function_pointers_.SpurFetchMeasurementStatus = reinterpret_cast<SpurFetchMeasurementStatusPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_SpurFetchMeasurementStatus"));
  function_pointers_.SpurFetchRangeAbsoluteLimitTrace = reinterpret_cast<SpurFetchRangeAbsoluteLimitTracePtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_SpurFetchRangeAbsoluteLimitTrace"));
  function_pointers_.SpurFetchRangeSpectrumTrace = reinterpret_cast<SpurFetchRangeSpectrumTracePtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_SpurFetchRangeSpectrumTrace"));
  function_pointers_.SpurFetchRangeStatus = reinterpret_cast<SpurFetchRangeStatusPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_SpurFetchRangeStatus"));
  function_pointers_.SpurFetchRangeStatusArray = reinterpret_cast<SpurFetchRangeStatusArrayPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_SpurFetchRangeStatusArray"));
  function_pointers_.SpurFetchSpurMeasurement = reinterpret_cast<SpurFetchSpurMeasurementPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_SpurFetchSpurMeasurement"));
  function_pointers_.SpurFetchSpurMeasurementArray = reinterpret_cast<SpurFetchSpurMeasurementArrayPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_SpurFetchSpurMeasurementArray"));
  function_pointers_.TXPCfgAveraging = reinterpret_cast<TXPCfgAveragingPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_TXPCfgAveraging"));
  function_pointers_.TXPCfgMeasurementInterval = reinterpret_cast<TXPCfgMeasurementIntervalPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_TXPCfgMeasurementInterval"));
  function_pointers_.TXPCfgRBWFilter = reinterpret_cast<TXPCfgRBWFilterPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_TXPCfgRBWFilter"));
  function_pointers_.TXPCfgThreshold = reinterpret_cast<TXPCfgThresholdPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_TXPCfgThreshold"));
  function_pointers_.TXPCfgVBWFilter = reinterpret_cast<TXPCfgVBWFilterPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_TXPCfgVBWFilter"));
  function_pointers_.TXPFetchMeasurement = reinterpret_cast<TXPFetchMeasurementPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_TXPFetchMeasurement"));
  function_pointers_.TXPFetchPowerTrace = reinterpret_cast<TXPFetchPowerTracePtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_TXPFetchPowerTrace"));
  function_pointers_.TXPRead = reinterpret_cast<TXPReadPtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_TXPRead"));
  function_pointers_.WaitForAcquisitionComplete = reinterpret_cast<WaitForAcquisitionCompletePtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_WaitForAcquisitionComplete"));
  function_pointers_.WaitForMeasurementComplete = reinterpret_cast<WaitForMeasurementCompletePtr>(p_shared_library_->get_function_pointer("RFmxSpecAn_WaitForMeasurementComplete"));
}
