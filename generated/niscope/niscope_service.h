...
private:
  ...
  std::map<std::int32_t, std::int64_t> niscopeint64attributevalues_input_map_ { {0, 0},{1, 0},{2, 1}, };
  std::map<std::int64_t, std::int32_t> niscopeint64attributevalues_output_map_ { {0, 0},{0, 1},{1, 2}, };
