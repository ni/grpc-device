...
class NiRFmxLTEMockLibrary : public nirfmxlte_grpc::NiRFmxLTELibraryInterface {
 public:
  ...
  MOCK_METHOD(int32, ModAccFetchPSSCHConstellationTraceInterleavedIQ, (niRFmxInstrHandle instrumentHandle, char selectorString[], float64 timeout, float32 dataConstellation[], float32 dmrsConstellation[], int32 arraySize, int32* actualArraySize), (override));
