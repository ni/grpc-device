...
NiRFmxLTELibrary::NiRFmxLTELibrary(std::shared_ptr<nidevice_grpc::SharedLibraryInterface> pSharedLibrary) : p_shared_library_(pSharedLibrary)
{
  ...
  function_pointers_.ACPCfgAveraging = reinterpret_cast<ACPCfgAveragingPtr>(p_shared_library_->get_function_pointer("RFmxLTE_ACPCfgAveraging"));
  function_pointers_.ACPCfgConfigurableNumberOfOffsetsEnabled = reinterpret_cast<ACPCfgConfigurableNumberOfOffsetsEnabledPtr>(p_shared_library_->get_function_pointer("RFmxLTE_ACPCfgConfigurableNumberOfOffsetsEnabled"));
  function_pointers_.ACPCfgMeasurementMethod = reinterpret_cast<ACPCfgMeasurementMethodPtr>(p_shared_library_->get_function_pointer("RFmxLTE_ACPCfgMeasurementMethod"));
  function_pointers_.ACPCfgNoiseCompensationEnabled = reinterpret_cast<ACPCfgNoiseCompensationEnabledPtr>(p_shared_library_->get_function_pointer("RFmxLTE_ACPCfgNoiseCompensationEnabled"));
  function_pointers_.ACPCfgNumberOfEUTRAOffsets = reinterpret_cast<ACPCfgNumberOfEUTRAOffsetsPtr>(p_shared_library_->get_function_pointer("RFmxLTE_ACPCfgNumberOfEUTRAOffsets"));
  function_pointers_.ACPCfgNumberOfGSMOffsets = reinterpret_cast<ACPCfgNumberOfGSMOffsetsPtr>(p_shared_library_->get_function_pointer("RFmxLTE_ACPCfgNumberOfGSMOffsets"));
  function_pointers_.ACPCfgNumberOfUTRAOffsets = reinterpret_cast<ACPCfgNumberOfUTRAOffsetsPtr>(p_shared_library_->get_function_pointer("RFmxLTE_ACPCfgNumberOfUTRAOffsets"));
  function_pointers_.ACPCfgPowerUnits = reinterpret_cast<ACPCfgPowerUnitsPtr>(p_shared_library_->get_function_pointer("RFmxLTE_ACPCfgPowerUnits"));
  function_pointers_.ACPCfgRBWFilter = reinterpret_cast<ACPCfgRBWFilterPtr>(p_shared_library_->get_function_pointer("RFmxLTE_ACPCfgRBWFilter"));
  function_pointers_.ACPCfgSweepTime = reinterpret_cast<ACPCfgSweepTimePtr>(p_shared_library_->get_function_pointer("RFmxLTE_ACPCfgSweepTime"));
  function_pointers_.ACPCfgUTRAAndEUTRAOffsets = reinterpret_cast<ACPCfgUTRAAndEUTRAOffsetsPtr>(p_shared_library_->get_function_pointer("RFmxLTE_ACPCfgUTRAAndEUTRAOffsets"));
  function_pointers_.ACPFetchAbsolutePowersTrace = reinterpret_cast<ACPFetchAbsolutePowersTracePtr>(p_shared_library_->get_function_pointer("RFmxLTE_ACPFetchAbsolutePowersTrace"));
  function_pointers_.ACPFetchComponentCarrierMeasurement = reinterpret_cast<ACPFetchComponentCarrierMeasurementPtr>(p_shared_library_->get_function_pointer("RFmxLTE_ACPFetchComponentCarrierMeasurement"));
  function_pointers_.ACPFetchComponentCarrierMeasurementArray = reinterpret_cast<ACPFetchComponentCarrierMeasurementArrayPtr>(p_shared_library_->get_function_pointer("RFmxLTE_ACPFetchComponentCarrierMeasurementArray"));
  function_pointers_.ACPFetchOffsetMeasurement = reinterpret_cast<ACPFetchOffsetMeasurementPtr>(p_shared_library_->get_function_pointer("RFmxLTE_ACPFetchOffsetMeasurement"));
  function_pointers_.ACPFetchOffsetMeasurementArray = reinterpret_cast<ACPFetchOffsetMeasurementArrayPtr>(p_shared_library_->get_function_pointer("RFmxLTE_ACPFetchOffsetMeasurementArray"));
  function_pointers_.ACPFetchRelativePowersTrace = reinterpret_cast<ACPFetchRelativePowersTracePtr>(p_shared_library_->get_function_pointer("RFmxLTE_ACPFetchRelativePowersTrace"));
  function_pointers_.ACPFetchSpectrum = reinterpret_cast<ACPFetchSpectrumPtr>(p_shared_library_->get_function_pointer("RFmxLTE_ACPFetchSpectrum"));
  function_pointers_.ACPFetchSubblockMeasurement = reinterpret_cast<ACPFetchSubblockMeasurementPtr>(p_shared_library_->get_function_pointer("RFmxLTE_ACPFetchSubblockMeasurement"));
  function_pointers_.ACPFetchTotalAggregatedPower = reinterpret_cast<ACPFetchTotalAggregatedPowerPtr>(p_shared_library_->get_function_pointer("RFmxLTE_ACPFetchTotalAggregatedPower"));
  function_pointers_.ACPValidateNoiseCalibrationData = reinterpret_cast<ACPValidateNoiseCalibrationDataPtr>(p_shared_library_->get_function_pointer("RFmxLTE_ACPValidateNoiseCalibrationData"));
  function_pointers_.AbortMeasurements = reinterpret_cast<AbortMeasurementsPtr>(p_shared_library_->get_function_pointer("RFmxLTE_AbortMeasurements"));
  function_pointers_.AnalyzeIQ1Waveform = reinterpret_cast<AnalyzeIQ1WaveformPtr>(p_shared_library_->get_function_pointer("RFmxLTE_AnalyzeIQ1Waveform"));
  function_pointers_.AnalyzeSpectrum1Waveform = reinterpret_cast<AnalyzeSpectrum1WaveformPtr>(p_shared_library_->get_function_pointer("RFmxLTE_AnalyzeSpectrum1Waveform"));
  function_pointers_.AutoLevel = reinterpret_cast<AutoLevelPtr>(p_shared_library_->get_function_pointer("RFmxLTE_AutoLevel"));
  function_pointers_.BuildCarrierString = reinterpret_cast<BuildCarrierStringPtr>(p_shared_library_->get_function_pointer("RFmxLTE_BuildCarrierString"));
  function_pointers_.BuildClusterString = reinterpret_cast<BuildClusterStringPtr>(p_shared_library_->get_function_pointer("RFmxLTE_BuildClusterString"));
  function_pointers_.BuildOffsetString = reinterpret_cast<BuildOffsetStringPtr>(p_shared_library_->get_function_pointer("RFmxLTE_BuildOffsetString"));
  function_pointers_.BuildPDSCHString = reinterpret_cast<BuildPDSCHStringPtr>(p_shared_library_->get_function_pointer("RFmxLTE_BuildPDSCHString"));
  function_pointers_.BuildSignalString = reinterpret_cast<BuildSignalStringPtr>(p_shared_library_->get_function_pointer("RFmxLTE_BuildSignalString"));
  function_pointers_.BuildSubblockString = reinterpret_cast<BuildSubblockStringPtr>(p_shared_library_->get_function_pointer("RFmxLTE_BuildSubblockString"));
  function_pointers_.BuildSubframeString = reinterpret_cast<BuildSubframeStringPtr>(p_shared_library_->get_function_pointer("RFmxLTE_BuildSubframeString"));
  function_pointers_.CHPCfgAveraging = reinterpret_cast<CHPCfgAveragingPtr>(p_shared_library_->get_function_pointer("RFmxLTE_CHPCfgAveraging"));
  function_pointers_.CHPCfgIntegrationBandwidthType = reinterpret_cast<CHPCfgIntegrationBandwidthTypePtr>(p_shared_library_->get_function_pointer("RFmxLTE_CHPCfgIntegrationBandwidthType"));
  function_pointers_.CHPCfgRBWFilter = reinterpret_cast<CHPCfgRBWFilterPtr>(p_shared_library_->get_function_pointer("RFmxLTE_CHPCfgRBWFilter"));
  function_pointers_.CHPCfgSweepTime = reinterpret_cast<CHPCfgSweepTimePtr>(p_shared_library_->get_function_pointer("RFmxLTE_CHPCfgSweepTime"));
  function_pointers_.CHPFetchComponentCarrierMeasurement = reinterpret_cast<CHPFetchComponentCarrierMeasurementPtr>(p_shared_library_->get_function_pointer("RFmxLTE_CHPFetchComponentCarrierMeasurement"));
  function_pointers_.CHPFetchComponentCarrierMeasurementArray = reinterpret_cast<CHPFetchComponentCarrierMeasurementArrayPtr>(p_shared_library_->get_function_pointer("RFmxLTE_CHPFetchComponentCarrierMeasurementArray"));
  function_pointers_.CHPFetchSpectrum = reinterpret_cast<CHPFetchSpectrumPtr>(p_shared_library_->get_function_pointer("RFmxLTE_CHPFetchSpectrum"));
  function_pointers_.CHPFetchSubblockMeasurement = reinterpret_cast<CHPFetchSubblockMeasurementPtr>(p_shared_library_->get_function_pointer("RFmxLTE_CHPFetchSubblockMeasurement"));
  function_pointers_.CHPFetchTotalAggregatedPower = reinterpret_cast<CHPFetchTotalAggregatedPowerPtr>(p_shared_library_->get_function_pointer("RFmxLTE_CHPFetchTotalAggregatedPower"));
  function_pointers_.CHPValidateNoiseCalibrationData = reinterpret_cast<CHPValidateNoiseCalibrationDataPtr>(p_shared_library_->get_function_pointer("RFmxLTE_CHPValidateNoiseCalibrationData"));
  function_pointers_.CfgAutoDMRSDetectionEnabled = reinterpret_cast<CfgAutoDMRSDetectionEnabledPtr>(p_shared_library_->get_function_pointer("RFmxLTE_CfgAutoDMRSDetectionEnabled"));
  function_pointers_.CfgAutoNPUSCHChannelDetectionEnabled = reinterpret_cast<CfgAutoNPUSCHChannelDetectionEnabledPtr>(p_shared_library_->get_function_pointer("RFmxLTE_CfgAutoNPUSCHChannelDetectionEnabled"));
  function_pointers_.CfgAutoResourceBlockDetectionEnabled = reinterpret_cast<CfgAutoResourceBlockDetectionEnabledPtr>(p_shared_library_->get_function_pointer("RFmxLTE_CfgAutoResourceBlockDetectionEnabled"));
  function_pointers_.CfgBand = reinterpret_cast<CfgBandPtr>(p_shared_library_->get_function_pointer("RFmxLTE_CfgBand"));
  function_pointers_.CfgCellSpecificRatio = reinterpret_cast<CfgCellSpecificRatioPtr>(p_shared_library_->get_function_pointer("RFmxLTE_CfgCellSpecificRatio"));
  function_pointers_.CfgComponentCarrier = reinterpret_cast<CfgComponentCarrierPtr>(p_shared_library_->get_function_pointer("RFmxLTE_CfgComponentCarrier"));
  function_pointers_.CfgComponentCarrierArray = reinterpret_cast<CfgComponentCarrierArrayPtr>(p_shared_library_->get_function_pointer("RFmxLTE_CfgComponentCarrierArray"));
  function_pointers_.CfgComponentCarrierSpacing = reinterpret_cast<CfgComponentCarrierSpacingPtr>(p_shared_library_->get_function_pointer("RFmxLTE_CfgComponentCarrierSpacing"));
  function_pointers_.CfgDigitalEdgeTrigger = reinterpret_cast<CfgDigitalEdgeTriggerPtr>(p_shared_library_->get_function_pointer("RFmxLTE_CfgDigitalEdgeTrigger"));
  function_pointers_.CfgDownlinkAutoCellIDDetectionEnabled = reinterpret_cast<CfgDownlinkAutoCellIDDetectionEnabledPtr>(p_shared_library_->get_function_pointer("RFmxLTE_CfgDownlinkAutoCellIDDetectionEnabled"));
  function_pointers_.CfgDownlinkAutoChannelDetection = reinterpret_cast<CfgDownlinkAutoChannelDetectionPtr>(p_shared_library_->get_function_pointer("RFmxLTE_CfgDownlinkAutoChannelDetection"));
  function_pointers_.CfgDownlinkChannelConfigurationMode = reinterpret_cast<CfgDownlinkChannelConfigurationModePtr>(p_shared_library_->get_function_pointer("RFmxLTE_CfgDownlinkChannelConfigurationMode"));
  function_pointers_.CfgDownlinkNumberOfSubframes = reinterpret_cast<CfgDownlinkNumberOfSubframesPtr>(p_shared_library_->get_function_pointer("RFmxLTE_CfgDownlinkNumberOfSubframes"));
  function_pointers_.CfgDownlinkSynchronizationSignal = reinterpret_cast<CfgDownlinkSynchronizationSignalPtr>(p_shared_library_->get_function_pointer("RFmxLTE_CfgDownlinkSynchronizationSignal"));
  function_pointers_.CfgDownlinkTestModel = reinterpret_cast<CfgDownlinkTestModelPtr>(p_shared_library_->get_function_pointer("RFmxLTE_CfgDownlinkTestModel"));
  function_pointers_.CfgDownlinkTestModelArray = reinterpret_cast<CfgDownlinkTestModelArrayPtr>(p_shared_library_->get_function_pointer("RFmxLTE_CfgDownlinkTestModelArray"));
  function_pointers_.CfgDuplexScheme = reinterpret_cast<CfgDuplexSchemePtr>(p_shared_library_->get_function_pointer("RFmxLTE_CfgDuplexScheme"));
  function_pointers_.CfgEMTCAnalysisEnabled = reinterpret_cast<CfgEMTCAnalysisEnabledPtr>(p_shared_library_->get_function_pointer("RFmxLTE_CfgEMTCAnalysisEnabled"));
  function_pointers_.CfgExternalAttenuation = reinterpret_cast<CfgExternalAttenuationPtr>(p_shared_library_->get_function_pointer("RFmxLTE_CfgExternalAttenuation"));
  function_pointers_.CfgFrequency = reinterpret_cast<CfgFrequencyPtr>(p_shared_library_->get_function_pointer("RFmxLTE_CfgFrequency"));
  function_pointers_.CfgFrequencyEARFCN = reinterpret_cast<CfgFrequencyEARFCNPtr>(p_shared_library_->get_function_pointer("RFmxLTE_CfgFrequencyEARFCN"));
  function_pointers_.CfgFrequencyReference = reinterpret_cast<CfgFrequencyReferencePtr>(p_shared_library_->get_function_pointer("RFmxLTE_CfgFrequencyReference"));
  function_pointers_.CfgIQPowerEdgeTrigger = reinterpret_cast<CfgIQPowerEdgeTriggerPtr>(p_shared_library_->get_function_pointer("RFmxLTE_CfgIQPowerEdgeTrigger"));
  function_pointers_.CfgLinkDirection = reinterpret_cast<CfgLinkDirectionPtr>(p_shared_library_->get_function_pointer("RFmxLTE_CfgLinkDirection"));
  function_pointers_.CfgMechanicalAttenuation = reinterpret_cast<CfgMechanicalAttenuationPtr>(p_shared_library_->get_function_pointer("RFmxLTE_CfgMechanicalAttenuation"));
  function_pointers_.CfgNBIoTComponentCarrier = reinterpret_cast<CfgNBIoTComponentCarrierPtr>(p_shared_library_->get_function_pointer("RFmxLTE_CfgNBIoTComponentCarrier"));
  function_pointers_.CfgNPUSCHDMRS = reinterpret_cast<CfgNPUSCHDMRSPtr>(p_shared_library_->get_function_pointer("RFmxLTE_CfgNPUSCHDMRS"));
  function_pointers_.CfgNPUSCHFormat = reinterpret_cast<CfgNPUSCHFormatPtr>(p_shared_library_->get_function_pointer("RFmxLTE_CfgNPUSCHFormat"));
  function_pointers_.CfgNPUSCHStartingSlot = reinterpret_cast<CfgNPUSCHStartingSlotPtr>(p_shared_library_->get_function_pointer("RFmxLTE_CfgNPUSCHStartingSlot"));
  function_pointers_.CfgNPUSCHTones = reinterpret_cast<CfgNPUSCHTonesPtr>(p_shared_library_->get_function_pointer("RFmxLTE_CfgNPUSCHTones"));
  function_pointers_.CfgNumberOfComponentCarriers = reinterpret_cast<CfgNumberOfComponentCarriersPtr>(p_shared_library_->get_function_pointer("RFmxLTE_CfgNumberOfComponentCarriers"));
  function_pointers_.CfgNumberOfDUTAntennas = reinterpret_cast<CfgNumberOfDUTAntennasPtr>(p_shared_library_->get_function_pointer("RFmxLTE_CfgNumberOfDUTAntennas"));
  function_pointers_.CfgNumberOfPDSCHChannels = reinterpret_cast<CfgNumberOfPDSCHChannelsPtr>(p_shared_library_->get_function_pointer("RFmxLTE_CfgNumberOfPDSCHChannels"));
  function_pointers_.CfgNumberOfPUSCHResourceBlockClusters = reinterpret_cast<CfgNumberOfPUSCHResourceBlockClustersPtr>(p_shared_library_->get_function_pointer("RFmxLTE_CfgNumberOfPUSCHResourceBlockClusters"));
  function_pointers_.CfgNumberOfSubblocks = reinterpret_cast<CfgNumberOfSubblocksPtr>(p_shared_library_->get_function_pointer("RFmxLTE_CfgNumberOfSubblocks"));
  function_pointers_.CfgPBCH = reinterpret_cast<CfgPBCHPtr>(p_shared_library_->get_function_pointer("RFmxLTE_CfgPBCH"));
  function_pointers_.CfgPCFICH = reinterpret_cast<CfgPCFICHPtr>(p_shared_library_->get_function_pointer("RFmxLTE_CfgPCFICH"));
  function_pointers_.CfgPDCCH = reinterpret_cast<CfgPDCCHPtr>(p_shared_library_->get_function_pointer("RFmxLTE_CfgPDCCH"));
  function_pointers_.CfgPDSCH = reinterpret_cast<CfgPDSCHPtr>(p_shared_library_->get_function_pointer("RFmxLTE_CfgPDSCH"));
  function_pointers_.CfgPHICH = reinterpret_cast<CfgPHICHPtr>(p_shared_library_->get_function_pointer("RFmxLTE_CfgPHICH"));
  function_pointers_.CfgPSSCHModulationType = reinterpret_cast<CfgPSSCHModulationTypePtr>(p_shared_library_->get_function_pointer("RFmxLTE_CfgPSSCHModulationType"));
  function_pointers_.CfgPSSCHResourceBlocks = reinterpret_cast<CfgPSSCHResourceBlocksPtr>(p_shared_library_->get_function_pointer("RFmxLTE_CfgPSSCHResourceBlocks"));
  function_pointers_.CfgPUSCHModulationType = reinterpret_cast<CfgPUSCHModulationTypePtr>(p_shared_library_->get_function_pointer("RFmxLTE_CfgPUSCHModulationType"));
  function_pointers_.CfgPUSCHResourceBlocks = reinterpret_cast<CfgPUSCHResourceBlocksPtr>(p_shared_library_->get_function_pointer("RFmxLTE_CfgPUSCHResourceBlocks"));
  function_pointers_.CfgRF = reinterpret_cast<CfgRFPtr>(p_shared_library_->get_function_pointer("RFmxLTE_CfgRF"));
  function_pointers_.CfgRFAttenuation = reinterpret_cast<CfgRFAttenuationPtr>(p_shared_library_->get_function_pointer("RFmxLTE_CfgRFAttenuation"));
  function_pointers_.CfgReferenceLevel = reinterpret_cast<CfgReferenceLevelPtr>(p_shared_library_->get_function_pointer("RFmxLTE_CfgReferenceLevel"));
  function_pointers_.CfgSoftwareEdgeTrigger = reinterpret_cast<CfgSoftwareEdgeTriggerPtr>(p_shared_library_->get_function_pointer("RFmxLTE_CfgSoftwareEdgeTrigger"));
  function_pointers_.CfgTransmitAntennaToAnalyze = reinterpret_cast<CfgTransmitAntennaToAnalyzePtr>(p_shared_library_->get_function_pointer("RFmxLTE_CfgTransmitAntennaToAnalyze"));
  function_pointers_.CfgeNodeBCategory = reinterpret_cast<CfgeNodeBCategoryPtr>(p_shared_library_->get_function_pointer("RFmxLTE_CfgeNodeBCategory"));
  function_pointers_.CheckMeasurementStatus = reinterpret_cast<CheckMeasurementStatusPtr>(p_shared_library_->get_function_pointer("RFmxLTE_CheckMeasurementStatus"));
  function_pointers_.ClearAllNamedResults = reinterpret_cast<ClearAllNamedResultsPtr>(p_shared_library_->get_function_pointer("RFmxLTE_ClearAllNamedResults"));
  function_pointers_.ClearNamedResult = reinterpret_cast<ClearNamedResultPtr>(p_shared_library_->get_function_pointer("RFmxLTE_ClearNamedResult"));
  function_pointers_.ClearNoiseCalibrationDatabase = reinterpret_cast<ClearNoiseCalibrationDatabasePtr>(p_shared_library_->get_function_pointer("RFmxLTE_ClearNoiseCalibrationDatabase"));
  function_pointers_.CloneSignalConfiguration = reinterpret_cast<CloneSignalConfigurationPtr>(p_shared_library_->get_function_pointer("RFmxLTE_CloneSignalConfiguration"));
  function_pointers_.Close = reinterpret_cast<ClosePtr>(p_shared_library_->get_function_pointer("RFmxLTE_Close"));
  function_pointers_.Commit = reinterpret_cast<CommitPtr>(p_shared_library_->get_function_pointer("RFmxLTE_Commit"));
  function_pointers_.CreateSignalConfiguration = reinterpret_cast<CreateSignalConfigurationPtr>(p_shared_library_->get_function_pointer("RFmxLTE_CreateSignalConfiguration"));
  function_pointers_.DeleteSignalConfiguration = reinterpret_cast<DeleteSignalConfigurationPtr>(p_shared_library_->get_function_pointer("RFmxLTE_DeleteSignalConfiguration"));
  function_pointers_.DisableTrigger = reinterpret_cast<DisableTriggerPtr>(p_shared_library_->get_function_pointer("RFmxLTE_DisableTrigger"));
  function_pointers_.GetAllNamedResultNames = reinterpret_cast<GetAllNamedResultNamesPtr>(p_shared_library_->get_function_pointer("RFmxLTE_GetAllNamedResultNames"));
  function_pointers_.GetAttributeF32 = reinterpret_cast<GetAttributeF32Ptr>(p_shared_library_->get_function_pointer("RFmxLTE_GetAttributeF32"));
  function_pointers_.GetAttributeF32Array = reinterpret_cast<GetAttributeF32ArrayPtr>(p_shared_library_->get_function_pointer("RFmxLTE_GetAttributeF32Array"));
  function_pointers_.GetAttributeF64 = reinterpret_cast<GetAttributeF64Ptr>(p_shared_library_->get_function_pointer("RFmxLTE_GetAttributeF64"));
  function_pointers_.GetAttributeF64Array = reinterpret_cast<GetAttributeF64ArrayPtr>(p_shared_library_->get_function_pointer("RFmxLTE_GetAttributeF64Array"));
  function_pointers_.GetAttributeI16 = reinterpret_cast<GetAttributeI16Ptr>(p_shared_library_->get_function_pointer("RFmxLTE_GetAttributeI16"));
  function_pointers_.GetAttributeI32 = reinterpret_cast<GetAttributeI32Ptr>(p_shared_library_->get_function_pointer("RFmxLTE_GetAttributeI32"));
  function_pointers_.GetAttributeI32Array = reinterpret_cast<GetAttributeI32ArrayPtr>(p_shared_library_->get_function_pointer("RFmxLTE_GetAttributeI32Array"));
  function_pointers_.GetAttributeI64 = reinterpret_cast<GetAttributeI64Ptr>(p_shared_library_->get_function_pointer("RFmxLTE_GetAttributeI64"));
  function_pointers_.GetAttributeI64Array = reinterpret_cast<GetAttributeI64ArrayPtr>(p_shared_library_->get_function_pointer("RFmxLTE_GetAttributeI64Array"));
  function_pointers_.GetAttributeI8 = reinterpret_cast<GetAttributeI8Ptr>(p_shared_library_->get_function_pointer("RFmxLTE_GetAttributeI8"));
  function_pointers_.GetAttributeI8Array = reinterpret_cast<GetAttributeI8ArrayPtr>(p_shared_library_->get_function_pointer("RFmxLTE_GetAttributeI8Array"));
  function_pointers_.GetAttributeNIComplexDoubleArray = reinterpret_cast<GetAttributeNIComplexDoubleArrayPtr>(p_shared_library_->get_function_pointer("RFmxLTE_GetAttributeNIComplexDoubleArray"));
  function_pointers_.GetAttributeNIComplexSingleArray = reinterpret_cast<GetAttributeNIComplexSingleArrayPtr>(p_shared_library_->get_function_pointer("RFmxLTE_GetAttributeNIComplexSingleArray"));
  function_pointers_.GetAttributeString = reinterpret_cast<GetAttributeStringPtr>(p_shared_library_->get_function_pointer("RFmxLTE_GetAttributeString"));
  function_pointers_.GetAttributeU16 = reinterpret_cast<GetAttributeU16Ptr>(p_shared_library_->get_function_pointer("RFmxLTE_GetAttributeU16"));
  function_pointers_.GetAttributeU32 = reinterpret_cast<GetAttributeU32Ptr>(p_shared_library_->get_function_pointer("RFmxLTE_GetAttributeU32"));
  function_pointers_.GetAttributeU32Array = reinterpret_cast<GetAttributeU32ArrayPtr>(p_shared_library_->get_function_pointer("RFmxLTE_GetAttributeU32Array"));
  function_pointers_.GetAttributeU64Array = reinterpret_cast<GetAttributeU64ArrayPtr>(p_shared_library_->get_function_pointer("RFmxLTE_GetAttributeU64Array"));
  function_pointers_.GetAttributeU8 = reinterpret_cast<GetAttributeU8Ptr>(p_shared_library_->get_function_pointer("RFmxLTE_GetAttributeU8"));
  function_pointers_.GetAttributeU8Array = reinterpret_cast<GetAttributeU8ArrayPtr>(p_shared_library_->get_function_pointer("RFmxLTE_GetAttributeU8Array"));
  function_pointers_.GetError = reinterpret_cast<GetErrorPtr>(p_shared_library_->get_function_pointer("RFmxLTE_GetError"));
  function_pointers_.GetErrorString = reinterpret_cast<GetErrorStringPtr>(p_shared_library_->get_function_pointer("RFmxLTE_GetErrorString"));
  function_pointers_.Initialize = reinterpret_cast<InitializePtr>(p_shared_library_->get_function_pointer("RFmxLTE_Initialize"));
  function_pointers_.InitializeFromNIRFSASession = reinterpret_cast<InitializeFromNIRFSASessionPtr>(p_shared_library_->get_function_pointer("RFmxLTE_InitializeFromNIRFSASession"));
  function_pointers_.Initiate = reinterpret_cast<InitiatePtr>(p_shared_library_->get_function_pointer("RFmxLTE_Initiate"));
  function_pointers_.ModAccCfgAveraging = reinterpret_cast<ModAccCfgAveragingPtr>(p_shared_library_->get_function_pointer("RFmxLTE_ModAccCfgAveraging"));
  function_pointers_.ModAccCfgCommonClockSourceEnabled = reinterpret_cast<ModAccCfgCommonClockSourceEnabledPtr>(p_shared_library_->get_function_pointer("RFmxLTE_ModAccCfgCommonClockSourceEnabled"));
  function_pointers_.ModAccCfgEVMUnit = reinterpret_cast<ModAccCfgEVMUnitPtr>(p_shared_library_->get_function_pointer("RFmxLTE_ModAccCfgEVMUnit"));
  function_pointers_.ModAccCfgFFTWindowOffset = reinterpret_cast<ModAccCfgFFTWindowOffsetPtr>(p_shared_library_->get_function_pointer("RFmxLTE_ModAccCfgFFTWindowOffset"));
  function_pointers_.ModAccCfgFFTWindowPosition = reinterpret_cast<ModAccCfgFFTWindowPositionPtr>(p_shared_library_->get_function_pointer("RFmxLTE_ModAccCfgFFTWindowPosition"));
  function_pointers_.ModAccCfgInBandEmissionMaskType = reinterpret_cast<ModAccCfgInBandEmissionMaskTypePtr>(p_shared_library_->get_function_pointer("RFmxLTE_ModAccCfgInBandEmissionMaskType"));
  function_pointers_.ModAccCfgSynchronizationModeAndInterval = reinterpret_cast<ModAccCfgSynchronizationModeAndIntervalPtr>(p_shared_library_->get_function_pointer("RFmxLTE_ModAccCfgSynchronizationModeAndInterval"));
  function_pointers_.ModAccFetchCSRSConstellation = reinterpret_cast<ModAccFetchCSRSConstellationPtr>(p_shared_library_->get_function_pointer("RFmxLTE_ModAccFetchCSRSConstellation"));
  function_pointers_.ModAccFetchCSRSEVM = reinterpret_cast<ModAccFetchCSRSEVMPtr>(p_shared_library_->get_function_pointer("RFmxLTE_ModAccFetchCSRSEVM"));
  function_pointers_.ModAccFetchCSRSEVMArray = reinterpret_cast<ModAccFetchCSRSEVMArrayPtr>(p_shared_library_->get_function_pointer("RFmxLTE_ModAccFetchCSRSEVMArray"));
  function_pointers_.ModAccFetchCompositeEVM = reinterpret_cast<ModAccFetchCompositeEVMPtr>(p_shared_library_->get_function_pointer("RFmxLTE_ModAccFetchCompositeEVM"));
  function_pointers_.ModAccFetchCompositeEVMArray = reinterpret_cast<ModAccFetchCompositeEVMArrayPtr>(p_shared_library_->get_function_pointer("RFmxLTE_ModAccFetchCompositeEVMArray"));
  function_pointers_.ModAccFetchCompositeMagnitudeAndPhaseError = reinterpret_cast<ModAccFetchCompositeMagnitudeAndPhaseErrorPtr>(p_shared_library_->get_function_pointer("RFmxLTE_ModAccFetchCompositeMagnitudeAndPhaseError"));
  function_pointers_.ModAccFetchCompositeMagnitudeAndPhaseErrorArray = reinterpret_cast<ModAccFetchCompositeMagnitudeAndPhaseErrorArrayPtr>(p_shared_library_->get_function_pointer("RFmxLTE_ModAccFetchCompositeMagnitudeAndPhaseErrorArray"));
  function_pointers_.ModAccFetchDownlinkDetectedCellID = reinterpret_cast<ModAccFetchDownlinkDetectedCellIDPtr>(p_shared_library_->get_function_pointer("RFmxLTE_ModAccFetchDownlinkDetectedCellID"));
  function_pointers_.ModAccFetchDownlinkDetectedCellIDArray = reinterpret_cast<ModAccFetchDownlinkDetectedCellIDArrayPtr>(p_shared_library_->get_function_pointer("RFmxLTE_ModAccFetchDownlinkDetectedCellIDArray"));
  function_pointers_.ModAccFetchDownlinkPBCHConstellation = reinterpret_cast<ModAccFetchDownlinkPBCHConstellationPtr>(p_shared_library_->get_function_pointer("RFmxLTE_ModAccFetchDownlinkPBCHConstellation"));
  function_pointers_.ModAccFetchDownlinkPCFICHConstellation = reinterpret_cast<ModAccFetchDownlinkPCFICHConstellationPtr>(p_shared_library_->get_function_pointer("RFmxLTE_ModAccFetchDownlinkPCFICHConstellation"));
  function_pointers_.ModAccFetchDownlinkPDCCHConstellation = reinterpret_cast<ModAccFetchDownlinkPDCCHConstellationPtr>(p_shared_library_->get_function_pointer("RFmxLTE_ModAccFetchDownlinkPDCCHConstellation"));
  function_pointers_.ModAccFetchDownlinkPHICHConstellation = reinterpret_cast<ModAccFetchDownlinkPHICHConstellationPtr>(p_shared_library_->get_function_pointer("RFmxLTE_ModAccFetchDownlinkPHICHConstellation"));
  function_pointers_.ModAccFetchDownlinkTransmitPower = reinterpret_cast<ModAccFetchDownlinkTransmitPowerPtr>(p_shared_library_->get_function_pointer("RFmxLTE_ModAccFetchDownlinkTransmitPower"));
  function_pointers_.ModAccFetchDownlinkTransmitPowerArray = reinterpret_cast<ModAccFetchDownlinkTransmitPowerArrayPtr>(p_shared_library_->get_function_pointer("RFmxLTE_ModAccFetchDownlinkTransmitPowerArray"));
  function_pointers_.ModAccFetchEVMHighPerSymbolTrace = reinterpret_cast<ModAccFetchEVMHighPerSymbolTracePtr>(p_shared_library_->get_function_pointer("RFmxLTE_ModAccFetchEVMHighPerSymbolTrace"));
  function_pointers_.ModAccFetchEVMLowPerSymbolTrace = reinterpret_cast<ModAccFetchEVMLowPerSymbolTracePtr>(p_shared_library_->get_function_pointer("RFmxLTE_ModAccFetchEVMLowPerSymbolTrace"));
  function_pointers_.ModAccFetchEVMPerSlotTrace = reinterpret_cast<ModAccFetchEVMPerSlotTracePtr>(p_shared_library_->get_function_pointer("RFmxLTE_ModAccFetchEVMPerSlotTrace"));
  function_pointers_.ModAccFetchEVMPerSubcarrierTrace = reinterpret_cast<ModAccFetchEVMPerSubcarrierTracePtr>(p_shared_library_->get_function_pointer("RFmxLTE_ModAccFetchEVMPerSubcarrierTrace"));
  function_pointers_.ModAccFetchEVMPerSymbolTrace = reinterpret_cast<ModAccFetchEVMPerSymbolTracePtr>(p_shared_library_->get_function_pointer("RFmxLTE_ModAccFetchEVMPerSymbolTrace"));
  function_pointers_.ModAccFetchIQImpairments = reinterpret_cast<ModAccFetchIQImpairmentsPtr>(p_shared_library_->get_function_pointer("RFmxLTE_ModAccFetchIQImpairments"));
  function_pointers_.ModAccFetchIQImpairmentsArray = reinterpret_cast<ModAccFetchIQImpairmentsArrayPtr>(p_shared_library_->get_function_pointer("RFmxLTE_ModAccFetchIQImpairmentsArray"));
  function_pointers_.ModAccFetchInBandEmissionMargin = reinterpret_cast<ModAccFetchInBandEmissionMarginPtr>(p_shared_library_->get_function_pointer("RFmxLTE_ModAccFetchInBandEmissionMargin"));
  function_pointers_.ModAccFetchInBandEmissionMarginArray = reinterpret_cast<ModAccFetchInBandEmissionMarginArrayPtr>(p_shared_library_->get_function_pointer("RFmxLTE_ModAccFetchInBandEmissionMarginArray"));
  function_pointers_.ModAccFetchInBandEmissionTrace = reinterpret_cast<ModAccFetchInBandEmissionTracePtr>(p_shared_library_->get_function_pointer("RFmxLTE_ModAccFetchInBandEmissionTrace"));
  function_pointers_.ModAccFetchMaximumEVMPerSlotTrace = reinterpret_cast<ModAccFetchMaximumEVMPerSlotTracePtr>(p_shared_library_->get_function_pointer("RFmxLTE_ModAccFetchMaximumEVMPerSlotTrace"));
  function_pointers_.ModAccFetchMaximumEVMPerSubcarrierTrace = reinterpret_cast<ModAccFetchMaximumEVMPerSubcarrierTracePtr>(p_shared_library_->get_function_pointer("RFmxLTE_ModAccFetchMaximumEVMPerSubcarrierTrace"));
  function_pointers_.ModAccFetchMaximumEVMPerSymbolTrace = reinterpret_cast<ModAccFetchMaximumEVMPerSymbolTracePtr>(p_shared_library_->get_function_pointer("RFmxLTE_ModAccFetchMaximumEVMPerSymbolTrace"));
  function_pointers_.ModAccFetchMaximumFrequencyErrorPerSlotTrace = reinterpret_cast<ModAccFetchMaximumFrequencyErrorPerSlotTracePtr>(p_shared_library_->get_function_pointer("RFmxLTE_ModAccFetchMaximumFrequencyErrorPerSlotTrace"));
  function_pointers_.ModAccFetchMaximumMagnitudeErrorPerSymbolTrace = reinterpret_cast<ModAccFetchMaximumMagnitudeErrorPerSymbolTracePtr>(p_shared_library_->get_function_pointer("RFmxLTE_ModAccFetchMaximumMagnitudeErrorPerSymbolTrace"));
  function_pointers_.ModAccFetchMaximumPhaseErrorPerSymbolTrace = reinterpret_cast<ModAccFetchMaximumPhaseErrorPerSymbolTracePtr>(p_shared_library_->get_function_pointer("RFmxLTE_ModAccFetchMaximumPhaseErrorPerSymbolTrace"));
  function_pointers_.ModAccFetchNPUSCHConstellationTrace = reinterpret_cast<ModAccFetchNPUSCHConstellationTracePtr>(p_shared_library_->get_function_pointer("RFmxLTE_ModAccFetchNPUSCHConstellationTrace"));
  function_pointers_.ModAccFetchNPUSCHDMRSEVM = reinterpret_cast<ModAccFetchNPUSCHDMRSEVMPtr>(p_shared_library_->get_function_pointer("RFmxLTE_ModAccFetchNPUSCHDMRSEVM"));
  function_pointers_.ModAccFetchNPUSCHDataEVM = reinterpret_cast<ModAccFetchNPUSCHDataEVMPtr>(p_shared_library_->get_function_pointer("RFmxLTE_ModAccFetchNPUSCHDataEVM"));
  function_pointers_.ModAccFetchNPUSCHSymbolPower = reinterpret_cast<ModAccFetchNPUSCHSymbolPowerPtr>(p_shared_library_->get_function_pointer("RFmxLTE_ModAccFetchNPUSCHSymbolPower"));
  function_pointers_.ModAccFetchPDSCH1024QAMConstellation = reinterpret_cast<ModAccFetchPDSCH1024QAMConstellationPtr>(p_shared_library_->get_function_pointer("RFmxLTE_ModAccFetchPDSCH1024QAMConstellation"));
  function_pointers_.ModAccFetchPDSCH1024QAMEVM = reinterpret_cast<ModAccFetchPDSCH1024QAMEVMPtr>(p_shared_library_->get_function_pointer("RFmxLTE_ModAccFetchPDSCH1024QAMEVM"));
  function_pointers_.ModAccFetchPDSCH1024QAMEVMArray = reinterpret_cast<ModAccFetchPDSCH1024QAMEVMArrayPtr>(p_shared_library_->get_function_pointer("RFmxLTE_ModAccFetchPDSCH1024QAMEVMArray"));
  function_pointers_.ModAccFetchPDSCH16QAMConstellation = reinterpret_cast<ModAccFetchPDSCH16QAMConstellationPtr>(p_shared_library_->get_function_pointer("RFmxLTE_ModAccFetchPDSCH16QAMConstellation"));
  function_pointers_.ModAccFetchPDSCH256QAMConstellation = reinterpret_cast<ModAccFetchPDSCH256QAMConstellationPtr>(p_shared_library_->get_function_pointer("RFmxLTE_ModAccFetchPDSCH256QAMConstellation"));
  function_pointers_.ModAccFetchPDSCH64QAMConstellation = reinterpret_cast<ModAccFetchPDSCH64QAMConstellationPtr>(p_shared_library_->get_function_pointer("RFmxLTE_ModAccFetchPDSCH64QAMConstellation"));
  function_pointers_.ModAccFetchPDSCHEVM = reinterpret_cast<ModAccFetchPDSCHEVMPtr>(p_shared_library_->get_function_pointer("RFmxLTE_ModAccFetchPDSCHEVM"));
  function_pointers_.ModAccFetchPDSCHEVMArray = reinterpret_cast<ModAccFetchPDSCHEVMArrayPtr>(p_shared_library_->get_function_pointer("RFmxLTE_ModAccFetchPDSCHEVMArray"));
  function_pointers_.ModAccFetchPDSCHQPSKConstellation = reinterpret_cast<ModAccFetchPDSCHQPSKConstellationPtr>(p_shared_library_->get_function_pointer("RFmxLTE_ModAccFetchPDSCHQPSKConstellation"));
  function_pointers_.ModAccFetchPSSCHConstellationTrace = reinterpret_cast<ModAccFetchPSSCHConstellationTracePtr>(p_shared_library_->get_function_pointer("RFmxLTE_ModAccFetchPSSCHConstellationTrace"));
  function_pointers_.ModAccFetchPSSCHDMRSEVM = reinterpret_cast<ModAccFetchPSSCHDMRSEVMPtr>(p_shared_library_->get_function_pointer("RFmxLTE_ModAccFetchPSSCHDMRSEVM"));
  function_pointers_.ModAccFetchPSSCHDMRSEVMArray = reinterpret_cast<ModAccFetchPSSCHDMRSEVMArrayPtr>(p_shared_library_->get_function_pointer("RFmxLTE_ModAccFetchPSSCHDMRSEVMArray"));
  function_pointers_.ModAccFetchPSSCHDataEVM = reinterpret_cast<ModAccFetchPSSCHDataEVMPtr>(p_shared_library_->get_function_pointer("RFmxLTE_ModAccFetchPSSCHDataEVM"));
  function_pointers_.ModAccFetchPSSCHDataEVMArray = reinterpret_cast<ModAccFetchPSSCHDataEVMArrayPtr>(p_shared_library_->get_function_pointer("RFmxLTE_ModAccFetchPSSCHDataEVMArray"));
  function_pointers_.ModAccFetchPSSCHSymbolPower = reinterpret_cast<ModAccFetchPSSCHSymbolPowerPtr>(p_shared_library_->get_function_pointer("RFmxLTE_ModAccFetchPSSCHSymbolPower"));
  function_pointers_.ModAccFetchPSSCHSymbolPowerArray = reinterpret_cast<ModAccFetchPSSCHSymbolPowerArrayPtr>(p_shared_library_->get_function_pointer("RFmxLTE_ModAccFetchPSSCHSymbolPowerArray"));
  function_pointers_.ModAccFetchPUSCHConstellationTrace = reinterpret_cast<ModAccFetchPUSCHConstellationTracePtr>(p_shared_library_->get_function_pointer("RFmxLTE_ModAccFetchPUSCHConstellationTrace"));
  function_pointers_.ModAccFetchPUSCHDMRSEVM = reinterpret_cast<ModAccFetchPUSCHDMRSEVMPtr>(p_shared_library_->get_function_pointer("RFmxLTE_ModAccFetchPUSCHDMRSEVM"));
  function_pointers_.ModAccFetchPUSCHDMRSEVMArray = reinterpret_cast<ModAccFetchPUSCHDMRSEVMArrayPtr>(p_shared_library_->get_function_pointer("RFmxLTE_ModAccFetchPUSCHDMRSEVMArray"));
  function_pointers_.ModAccFetchPUSCHDataEVM = reinterpret_cast<ModAccFetchPUSCHDataEVMPtr>(p_shared_library_->get_function_pointer("RFmxLTE_ModAccFetchPUSCHDataEVM"));
  function_pointers_.ModAccFetchPUSCHDataEVMArray = reinterpret_cast<ModAccFetchPUSCHDataEVMArrayPtr>(p_shared_library_->get_function_pointer("RFmxLTE_ModAccFetchPUSCHDataEVMArray"));
  function_pointers_.ModAccFetchPUSCHDemodulatedBits = reinterpret_cast<ModAccFetchPUSCHDemodulatedBitsPtr>(p_shared_library_->get_function_pointer("RFmxLTE_ModAccFetchPUSCHDemodulatedBits"));
  function_pointers_.ModAccFetchPUSCHSymbolPower = reinterpret_cast<ModAccFetchPUSCHSymbolPowerPtr>(p_shared_library_->get_function_pointer("RFmxLTE_ModAccFetchPUSCHSymbolPower"));
  function_pointers_.ModAccFetchPUSCHSymbolPowerArray = reinterpret_cast<ModAccFetchPUSCHSymbolPowerArrayPtr>(p_shared_library_->get_function_pointer("RFmxLTE_ModAccFetchPUSCHSymbolPowerArray"));
  function_pointers_.ModAccFetchRMSMagnitudeErrorPerSymbolTrace = reinterpret_cast<ModAccFetchRMSMagnitudeErrorPerSymbolTracePtr>(p_shared_library_->get_function_pointer("RFmxLTE_ModAccFetchRMSMagnitudeErrorPerSymbolTrace"));
  function_pointers_.ModAccFetchRMSPhaseErrorPerSymbolTrace = reinterpret_cast<ModAccFetchRMSPhaseErrorPerSymbolTracePtr>(p_shared_library_->get_function_pointer("RFmxLTE_ModAccFetchRMSPhaseErrorPerSymbolTrace"));
  function_pointers_.ModAccFetchSRSConstellation = reinterpret_cast<ModAccFetchSRSConstellationPtr>(p_shared_library_->get_function_pointer("RFmxLTE_ModAccFetchSRSConstellation"));
  function_pointers_.ModAccFetchSRSEVM = reinterpret_cast<ModAccFetchSRSEVMPtr>(p_shared_library_->get_function_pointer("RFmxLTE_ModAccFetchSRSEVM"));
  function_pointers_.ModAccFetchSRSEVMArray = reinterpret_cast<ModAccFetchSRSEVMArrayPtr>(p_shared_library_->get_function_pointer("RFmxLTE_ModAccFetchSRSEVMArray"));
  function_pointers_.ModAccFetchSpectralFlatness = reinterpret_cast<ModAccFetchSpectralFlatnessPtr>(p_shared_library_->get_function_pointer("RFmxLTE_ModAccFetchSpectralFlatness"));
  function_pointers_.ModAccFetchSpectralFlatnessArray = reinterpret_cast<ModAccFetchSpectralFlatnessArrayPtr>(p_shared_library_->get_function_pointer("RFmxLTE_ModAccFetchSpectralFlatnessArray"));
  function_pointers_.ModAccFetchSpectralFlatnessTrace = reinterpret_cast<ModAccFetchSpectralFlatnessTracePtr>(p_shared_library_->get_function_pointer("RFmxLTE_ModAccFetchSpectralFlatnessTrace"));
  function_pointers_.ModAccFetchSubblockIQImpairments = reinterpret_cast<ModAccFetchSubblockIQImpairmentsPtr>(p_shared_library_->get_function_pointer("RFmxLTE_ModAccFetchSubblockIQImpairments"));
  function_pointers_.ModAccFetchSubblockInBandEmissionMargin = reinterpret_cast<ModAccFetchSubblockInBandEmissionMarginPtr>(p_shared_library_->get_function_pointer("RFmxLTE_ModAccFetchSubblockInBandEmissionMargin"));
  function_pointers_.ModAccFetchSubblockInBandEmissionTrace = reinterpret_cast<ModAccFetchSubblockInBandEmissionTracePtr>(p_shared_library_->get_function_pointer("RFmxLTE_ModAccFetchSubblockInBandEmissionTrace"));
  function_pointers_.ModAccFetchSynchronizationSignalConstellation = reinterpret_cast<ModAccFetchSynchronizationSignalConstellationPtr>(p_shared_library_->get_function_pointer("RFmxLTE_ModAccFetchSynchronizationSignalConstellation"));
  function_pointers_.ModAccFetchSynchronizationSignalEVM = reinterpret_cast<ModAccFetchSynchronizationSignalEVMPtr>(p_shared_library_->get_function_pointer("RFmxLTE_ModAccFetchSynchronizationSignalEVM"));
  function_pointers_.ModAccFetchSynchronizationSignalEVMArray = reinterpret_cast<ModAccFetchSynchronizationSignalEVMArrayPtr>(p_shared_library_->get_function_pointer("RFmxLTE_ModAccFetchSynchronizationSignalEVMArray"));
  function_pointers_.OBWCfgAveraging = reinterpret_cast<OBWCfgAveragingPtr>(p_shared_library_->get_function_pointer("RFmxLTE_OBWCfgAveraging"));
  function_pointers_.OBWCfgRBWFilter = reinterpret_cast<OBWCfgRBWFilterPtr>(p_shared_library_->get_function_pointer("RFmxLTE_OBWCfgRBWFilter"));
  function_pointers_.OBWCfgSweepTime = reinterpret_cast<OBWCfgSweepTimePtr>(p_shared_library_->get_function_pointer("RFmxLTE_OBWCfgSweepTime"));
  function_pointers_.OBWFetchMeasurement = reinterpret_cast<OBWFetchMeasurementPtr>(p_shared_library_->get_function_pointer("RFmxLTE_OBWFetchMeasurement"));
  function_pointers_.OBWFetchSpectrum = reinterpret_cast<OBWFetchSpectrumPtr>(p_shared_library_->get_function_pointer("RFmxLTE_OBWFetchSpectrum"));
  function_pointers_.PVTCfgAveraging = reinterpret_cast<PVTCfgAveragingPtr>(p_shared_library_->get_function_pointer("RFmxLTE_PVTCfgAveraging"));
  function_pointers_.PVTCfgMeasurementMethod = reinterpret_cast<PVTCfgMeasurementMethodPtr>(p_shared_library_->get_function_pointer("RFmxLTE_PVTCfgMeasurementMethod"));
  function_pointers_.PVTCfgOFFPowerExclusionPeriods = reinterpret_cast<PVTCfgOFFPowerExclusionPeriodsPtr>(p_shared_library_->get_function_pointer("RFmxLTE_PVTCfgOFFPowerExclusionPeriods"));
  function_pointers_.PVTFetchMeasurement = reinterpret_cast<PVTFetchMeasurementPtr>(p_shared_library_->get_function_pointer("RFmxLTE_PVTFetchMeasurement"));
  function_pointers_.PVTFetchMeasurementArray = reinterpret_cast<PVTFetchMeasurementArrayPtr>(p_shared_library_->get_function_pointer("RFmxLTE_PVTFetchMeasurementArray"));
  function_pointers_.PVTFetchSignalPowerTrace = reinterpret_cast<PVTFetchSignalPowerTracePtr>(p_shared_library_->get_function_pointer("RFmxLTE_PVTFetchSignalPowerTrace"));
  function_pointers_.ResetAttribute = reinterpret_cast<ResetAttributePtr>(p_shared_library_->get_function_pointer("RFmxLTE_ResetAttribute"));
  function_pointers_.ResetToDefault = reinterpret_cast<ResetToDefaultPtr>(p_shared_library_->get_function_pointer("RFmxLTE_ResetToDefault"));
  function_pointers_.SEMCfgAveraging = reinterpret_cast<SEMCfgAveragingPtr>(p_shared_library_->get_function_pointer("RFmxLTE_SEMCfgAveraging"));
  function_pointers_.SEMCfgComponentCarrierMaximumOutputPower = reinterpret_cast<SEMCfgComponentCarrierMaximumOutputPowerPtr>(p_shared_library_->get_function_pointer("RFmxLTE_SEMCfgComponentCarrierMaximumOutputPower"));
  function_pointers_.SEMCfgComponentCarrierMaximumOutputPowerArray = reinterpret_cast<SEMCfgComponentCarrierMaximumOutputPowerArrayPtr>(p_shared_library_->get_function_pointer("RFmxLTE_SEMCfgComponentCarrierMaximumOutputPowerArray"));
  function_pointers_.SEMCfgDownlinkMask = reinterpret_cast<SEMCfgDownlinkMaskPtr>(p_shared_library_->get_function_pointer("RFmxLTE_SEMCfgDownlinkMask"));
  function_pointers_.SEMCfgNumberOfOffsets = reinterpret_cast<SEMCfgNumberOfOffsetsPtr>(p_shared_library_->get_function_pointer("RFmxLTE_SEMCfgNumberOfOffsets"));
  function_pointers_.SEMCfgOffsetAbsoluteLimit = reinterpret_cast<SEMCfgOffsetAbsoluteLimitPtr>(p_shared_library_->get_function_pointer("RFmxLTE_SEMCfgOffsetAbsoluteLimit"));
  function_pointers_.SEMCfgOffsetAbsoluteLimitArray = reinterpret_cast<SEMCfgOffsetAbsoluteLimitArrayPtr>(p_shared_library_->get_function_pointer("RFmxLTE_SEMCfgOffsetAbsoluteLimitArray"));
  function_pointers_.SEMCfgOffsetBandwidthIntegral = reinterpret_cast<SEMCfgOffsetBandwidthIntegralPtr>(p_shared_library_->get_function_pointer("RFmxLTE_SEMCfgOffsetBandwidthIntegral"));
  function_pointers_.SEMCfgOffsetBandwidthIntegralArray = reinterpret_cast<SEMCfgOffsetBandwidthIntegralArrayPtr>(p_shared_library_->get_function_pointer("RFmxLTE_SEMCfgOffsetBandwidthIntegralArray"));
  function_pointers_.SEMCfgOffsetFrequency = reinterpret_cast<SEMCfgOffsetFrequencyPtr>(p_shared_library_->get_function_pointer("RFmxLTE_SEMCfgOffsetFrequency"));
  function_pointers_.SEMCfgOffsetFrequencyArray = reinterpret_cast<SEMCfgOffsetFrequencyArrayPtr>(p_shared_library_->get_function_pointer("RFmxLTE_SEMCfgOffsetFrequencyArray"));
  function_pointers_.SEMCfgOffsetLimitFailMask = reinterpret_cast<SEMCfgOffsetLimitFailMaskPtr>(p_shared_library_->get_function_pointer("RFmxLTE_SEMCfgOffsetLimitFailMask"));
  function_pointers_.SEMCfgOffsetLimitFailMaskArray = reinterpret_cast<SEMCfgOffsetLimitFailMaskArrayPtr>(p_shared_library_->get_function_pointer("RFmxLTE_SEMCfgOffsetLimitFailMaskArray"));
  function_pointers_.SEMCfgOffsetRBWFilter = reinterpret_cast<SEMCfgOffsetRBWFilterPtr>(p_shared_library_->get_function_pointer("RFmxLTE_SEMCfgOffsetRBWFilter"));
  function_pointers_.SEMCfgOffsetRBWFilterArray = reinterpret_cast<SEMCfgOffsetRBWFilterArrayPtr>(p_shared_library_->get_function_pointer("RFmxLTE_SEMCfgOffsetRBWFilterArray"));
  function_pointers_.SEMCfgOffsetRelativeLimit = reinterpret_cast<SEMCfgOffsetRelativeLimitPtr>(p_shared_library_->get_function_pointer("RFmxLTE_SEMCfgOffsetRelativeLimit"));
  function_pointers_.SEMCfgOffsetRelativeLimitArray = reinterpret_cast<SEMCfgOffsetRelativeLimitArrayPtr>(p_shared_library_->get_function_pointer("RFmxLTE_SEMCfgOffsetRelativeLimitArray"));
  function_pointers_.SEMCfgSweepTime = reinterpret_cast<SEMCfgSweepTimePtr>(p_shared_library_->get_function_pointer("RFmxLTE_SEMCfgSweepTime"));
  function_pointers_.SEMCfgUplinkMaskType = reinterpret_cast<SEMCfgUplinkMaskTypePtr>(p_shared_library_->get_function_pointer("RFmxLTE_SEMCfgUplinkMaskType"));
  function_pointers_.SEMFetchComponentCarrierMeasurement = reinterpret_cast<SEMFetchComponentCarrierMeasurementPtr>(p_shared_library_->get_function_pointer("RFmxLTE_SEMFetchComponentCarrierMeasurement"));
  function_pointers_.SEMFetchComponentCarrierMeasurementArray = reinterpret_cast<SEMFetchComponentCarrierMeasurementArrayPtr>(p_shared_library_->get_function_pointer("RFmxLTE_SEMFetchComponentCarrierMeasurementArray"));
  function_pointers_.SEMFetchLowerOffsetMargin = reinterpret_cast<SEMFetchLowerOffsetMarginPtr>(p_shared_library_->get_function_pointer("RFmxLTE_SEMFetchLowerOffsetMargin"));
  function_pointers_.SEMFetchLowerOffsetMarginArray = reinterpret_cast<SEMFetchLowerOffsetMarginArrayPtr>(p_shared_library_->get_function_pointer("RFmxLTE_SEMFetchLowerOffsetMarginArray"));
  function_pointers_.SEMFetchLowerOffsetPower = reinterpret_cast<SEMFetchLowerOffsetPowerPtr>(p_shared_library_->get_function_pointer("RFmxLTE_SEMFetchLowerOffsetPower"));
  function_pointers_.SEMFetchLowerOffsetPowerArray = reinterpret_cast<SEMFetchLowerOffsetPowerArrayPtr>(p_shared_library_->get_function_pointer("RFmxLTE_SEMFetchLowerOffsetPowerArray"));
  function_pointers_.SEMFetchMeasurementStatus = reinterpret_cast<SEMFetchMeasurementStatusPtr>(p_shared_library_->get_function_pointer("RFmxLTE_SEMFetchMeasurementStatus"));
  function_pointers_.SEMFetchSpectrum = reinterpret_cast<SEMFetchSpectrumPtr>(p_shared_library_->get_function_pointer("RFmxLTE_SEMFetchSpectrum"));
  function_pointers_.SEMFetchSubblockMeasurement = reinterpret_cast<SEMFetchSubblockMeasurementPtr>(p_shared_library_->get_function_pointer("RFmxLTE_SEMFetchSubblockMeasurement"));
  function_pointers_.SEMFetchTotalAggregatedPower = reinterpret_cast<SEMFetchTotalAggregatedPowerPtr>(p_shared_library_->get_function_pointer("RFmxLTE_SEMFetchTotalAggregatedPower"));
  function_pointers_.SEMFetchUpperOffsetMargin = reinterpret_cast<SEMFetchUpperOffsetMarginPtr>(p_shared_library_->get_function_pointer("RFmxLTE_SEMFetchUpperOffsetMargin"));
  function_pointers_.SEMFetchUpperOffsetMarginArray = reinterpret_cast<SEMFetchUpperOffsetMarginArrayPtr>(p_shared_library_->get_function_pointer("RFmxLTE_SEMFetchUpperOffsetMarginArray"));
  function_pointers_.SEMFetchUpperOffsetPower = reinterpret_cast<SEMFetchUpperOffsetPowerPtr>(p_shared_library_->get_function_pointer("RFmxLTE_SEMFetchUpperOffsetPower"));
  function_pointers_.SEMFetchUpperOffsetPowerArray = reinterpret_cast<SEMFetchUpperOffsetPowerArrayPtr>(p_shared_library_->get_function_pointer("RFmxLTE_SEMFetchUpperOffsetPowerArray"));
  function_pointers_.SelectMeasurements = reinterpret_cast<SelectMeasurementsPtr>(p_shared_library_->get_function_pointer("RFmxLTE_SelectMeasurements"));
  function_pointers_.SendSoftwareEdgeTrigger = reinterpret_cast<SendSoftwareEdgeTriggerPtr>(p_shared_library_->get_function_pointer("RFmxLTE_SendSoftwareEdgeTrigger"));
  function_pointers_.SetAttributeF32 = reinterpret_cast<SetAttributeF32Ptr>(p_shared_library_->get_function_pointer("RFmxLTE_SetAttributeF32"));
  function_pointers_.SetAttributeF32Array = reinterpret_cast<SetAttributeF32ArrayPtr>(p_shared_library_->get_function_pointer("RFmxLTE_SetAttributeF32Array"));
  function_pointers_.SetAttributeF64 = reinterpret_cast<SetAttributeF64Ptr>(p_shared_library_->get_function_pointer("RFmxLTE_SetAttributeF64"));
  function_pointers_.SetAttributeF64Array = reinterpret_cast<SetAttributeF64ArrayPtr>(p_shared_library_->get_function_pointer("RFmxLTE_SetAttributeF64Array"));
  function_pointers_.SetAttributeI16 = reinterpret_cast<SetAttributeI16Ptr>(p_shared_library_->get_function_pointer("RFmxLTE_SetAttributeI16"));
  function_pointers_.SetAttributeI32 = reinterpret_cast<SetAttributeI32Ptr>(p_shared_library_->get_function_pointer("RFmxLTE_SetAttributeI32"));
  function_pointers_.SetAttributeI32Array = reinterpret_cast<SetAttributeI32ArrayPtr>(p_shared_library_->get_function_pointer("RFmxLTE_SetAttributeI32Array"));
  function_pointers_.SetAttributeI64 = reinterpret_cast<SetAttributeI64Ptr>(p_shared_library_->get_function_pointer("RFmxLTE_SetAttributeI64"));
  function_pointers_.SetAttributeI64Array = reinterpret_cast<SetAttributeI64ArrayPtr>(p_shared_library_->get_function_pointer("RFmxLTE_SetAttributeI64Array"));
  function_pointers_.SetAttributeI8 = reinterpret_cast<SetAttributeI8Ptr>(p_shared_library_->get_function_pointer("RFmxLTE_SetAttributeI8"));
  function_pointers_.SetAttributeI8Array = reinterpret_cast<SetAttributeI8ArrayPtr>(p_shared_library_->get_function_pointer("RFmxLTE_SetAttributeI8Array"));
  function_pointers_.SetAttributeNIComplexDoubleArray = reinterpret_cast<SetAttributeNIComplexDoubleArrayPtr>(p_shared_library_->get_function_pointer("RFmxLTE_SetAttributeNIComplexDoubleArray"));
  function_pointers_.SetAttributeNIComplexSingleArray = reinterpret_cast<SetAttributeNIComplexSingleArrayPtr>(p_shared_library_->get_function_pointer("RFmxLTE_SetAttributeNIComplexSingleArray"));
  function_pointers_.SetAttributeString = reinterpret_cast<SetAttributeStringPtr>(p_shared_library_->get_function_pointer("RFmxLTE_SetAttributeString"));
  function_pointers_.SetAttributeU16 = reinterpret_cast<SetAttributeU16Ptr>(p_shared_library_->get_function_pointer("RFmxLTE_SetAttributeU16"));
  function_pointers_.SetAttributeU32 = reinterpret_cast<SetAttributeU32Ptr>(p_shared_library_->get_function_pointer("RFmxLTE_SetAttributeU32"));
  function_pointers_.SetAttributeU32Array = reinterpret_cast<SetAttributeU32ArrayPtr>(p_shared_library_->get_function_pointer("RFmxLTE_SetAttributeU32Array"));
  function_pointers_.SetAttributeU64Array = reinterpret_cast<SetAttributeU64ArrayPtr>(p_shared_library_->get_function_pointer("RFmxLTE_SetAttributeU64Array"));
  function_pointers_.SetAttributeU8 = reinterpret_cast<SetAttributeU8Ptr>(p_shared_library_->get_function_pointer("RFmxLTE_SetAttributeU8"));
  function_pointers_.SetAttributeU8Array = reinterpret_cast<SetAttributeU8ArrayPtr>(p_shared_library_->get_function_pointer("RFmxLTE_SetAttributeU8Array"));
  function_pointers_.SlotPhaseCfgSynchronizationModeAndInterval = reinterpret_cast<SlotPhaseCfgSynchronizationModeAndIntervalPtr>(p_shared_library_->get_function_pointer("RFmxLTE_SlotPhaseCfgSynchronizationModeAndInterval"));
  function_pointers_.SlotPhaseFetchMaximumPhaseDiscontinuity = reinterpret_cast<SlotPhaseFetchMaximumPhaseDiscontinuityPtr>(p_shared_library_->get_function_pointer("RFmxLTE_SlotPhaseFetchMaximumPhaseDiscontinuity"));
  function_pointers_.SlotPhaseFetchMaximumPhaseDiscontinuityArray = reinterpret_cast<SlotPhaseFetchMaximumPhaseDiscontinuityArrayPtr>(p_shared_library_->get_function_pointer("RFmxLTE_SlotPhaseFetchMaximumPhaseDiscontinuityArray"));
  function_pointers_.SlotPhaseFetchPhaseDiscontinuities = reinterpret_cast<SlotPhaseFetchPhaseDiscontinuitiesPtr>(p_shared_library_->get_function_pointer("RFmxLTE_SlotPhaseFetchPhaseDiscontinuities"));
  function_pointers_.SlotPhaseFetchSamplePhaseError = reinterpret_cast<SlotPhaseFetchSamplePhaseErrorPtr>(p_shared_library_->get_function_pointer("RFmxLTE_SlotPhaseFetchSamplePhaseError"));
  function_pointers_.SlotPhaseFetchSamplePhaseErrorLinearFitTrace = reinterpret_cast<SlotPhaseFetchSamplePhaseErrorLinearFitTracePtr>(p_shared_library_->get_function_pointer("RFmxLTE_SlotPhaseFetchSamplePhaseErrorLinearFitTrace"));
  function_pointers_.SlotPowerCfgMeasurementInterval = reinterpret_cast<SlotPowerCfgMeasurementIntervalPtr>(p_shared_library_->get_function_pointer("RFmxLTE_SlotPowerCfgMeasurementInterval"));
  function_pointers_.SlotPowerFetchPowers = reinterpret_cast<SlotPowerFetchPowersPtr>(p_shared_library_->get_function_pointer("RFmxLTE_SlotPowerFetchPowers"));
  function_pointers_.WaitForAcquisitionComplete = reinterpret_cast<WaitForAcquisitionCompletePtr>(p_shared_library_->get_function_pointer("RFmxLTE_WaitForAcquisitionComplete"));
  function_pointers_.WaitForMeasurementComplete = reinterpret_cast<WaitForMeasurementCompletePtr>(p_shared_library_->get_function_pointer("RFmxLTE_WaitForMeasurementComplete"));
}
