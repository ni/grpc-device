...
namespace nirfmxlte_grpc {
  ...
  //---------------------------------------------------------------------
  //---------------------------------------------------------------------
  ::grpc::Status NiRFmxLTEService::AnalyzeIQ1WaveformInterleavedIQ(::grpc::ServerContext* context, const AnalyzeIQ1WaveformInterleavedIQRequest* request, AnalyzeIQ1WaveformInterleavedIQResponse* response)
  {
    if (context->IsCancelled()) {
      return ::grpc::Status::CANCELLED;
    }
  ...
  //---------------------------------------------------------------------
  //---------------------------------------------------------------------
  ::grpc::Status NiRFmxLTEService::AnalyzeIQ1WaveformSplit(::grpc::ServerContext* context, const AnalyzeIQ1WaveformSplitRequest* request, AnalyzeIQ1WaveformSplitResponse* response)
  {
    if (context->IsCancelled()) {
      return ::grpc::Status::CANCELLED;
    }
  ...
  ::grpc::Status NiRFmxLTEService::CfgDownlinkTestModelArray(::grpc::ServerContext* context, const CfgDownlinkTestModelArrayRequest* request, CfgDownlinkTestModelArrayResponse* response)
  {
    ...
    try {
      ...
      auto number_of_elements_raw = request->downlink_test_model().size();
  ...
  ::grpc::Status NiRFmxLTEService::Initialize(::grpc::ServerContext* context, const InitializeRequest* request, InitializeResponse* response)
  {
    ...
    try {
      ...
      auto cleanup_lambda = [library] (niRFmxInstrHandle id) { library->Close(id, RFMXLTE_VAL_FALSE); };
  ...
  //---------------------------------------------------------------------
  //---------------------------------------------------------------------
  ::grpc::Status NiRFmxLTEService::ModAccFetchCSRSConstellationInterleavedIQ(::grpc::ServerContext* context, const ModAccFetchCSRSConstellationInterleavedIQRequest* request, ModAccFetchCSRSConstellationInterleavedIQResponse* response)
  {
    if (context->IsCancelled()) {
      return ::grpc::Status::CANCELLED;
    }
    try {
      ...
      int32 actual_array_size {};
      while (true) {
        auto status = library_->ModAccFetchCSRSConstellationInterleavedIQ(instrument, selector_string, timeout, nullptr, 0, &actual_array_size);
        if (!status_ok(status)) {
          return ConvertApiErrorStatusForNiRFmxInstrHandle(context, status, instrument);
        }
        response->mutable_csrs_constellation()->Resize(actual_array_size * 2, 0);
        float32* csrs_constellation = response->mutable_csrs_constellation()->mutable_data();
        auto array_size = actual_array_size;
        status = library_->ModAccFetchCSRSConstellationInterleavedIQ(instrument, selector_string, timeout, csrs_constellation, array_size, &actual_array_size);
        if (status == kErrorReadBufferTooSmall || status == kWarningCAPIStringTruncatedToFitBuffer) {
          // buffer is now too small, try again
          continue;
        }
  ...
  //---------------------------------------------------------------------
  //---------------------------------------------------------------------
  ::grpc::Status NiRFmxLTEService::ModAccFetchCSRSConstellationSplit(::grpc::ServerContext* context, const ModAccFetchCSRSConstellationSplitRequest* request, ModAccFetchCSRSConstellationSplitResponse* response)
  {
    if (context->IsCancelled()) {
      return ::grpc::Status::CANCELLED;
    }
    try {
      ...
      int32 actual_array_size {};
      while (true) {
        auto status = library_->ModAccFetchCSRSConstellationSplit(instrument, selector_string, timeout, nullptr, nullptr, 0, &actual_array_size);
        if (!status_ok(status)) {
          return ConvertApiErrorStatusForNiRFmxInstrHandle(context, status, instrument);
        }
        response->mutable_csrs_constellation_i()->Resize(actual_array_size, 0);
        float32* csrs_constellation_i = response->mutable_csrs_constellation_i()->mutable_data();
        response->mutable_csrs_constellation_q()->Resize(actual_array_size, 0);
        float32* csrs_constellation_q = response->mutable_csrs_constellation_q()->mutable_data();
        auto array_size = actual_array_size;
        status = library_->ModAccFetchCSRSConstellationSplit(instrument, selector_string, timeout, csrs_constellation_i, csrs_constellation_q, array_size, &actual_array_size);
        if (status == kErrorReadBufferTooSmall || status == kWarningCAPIStringTruncatedToFitBuffer) {
          // buffer is now too small, try again
          continue;
        }
  ...
  //---------------------------------------------------------------------
  //---------------------------------------------------------------------
  ::grpc::Status NiRFmxLTEService::ModAccFetchDownlinkPBCHConstellationInterleavedIQ(::grpc::ServerContext* context, const ModAccFetchDownlinkPBCHConstellationInterleavedIQRequest* request, ModAccFetchDownlinkPBCHConstellationInterleavedIQResponse* response)
  {
    if (context->IsCancelled()) {
      return ::grpc::Status::CANCELLED;
    }
    try {
      ...
      int32 actual_array_size {};
      while (true) {
        auto status = library_->ModAccFetchDownlinkPBCHConstellationInterleavedIQ(instrument, selector_string, timeout, nullptr, 0, &actual_array_size);
        if (!status_ok(status)) {
          return ConvertApiErrorStatusForNiRFmxInstrHandle(context, status, instrument);
        }
        response->mutable_pbch_constellation()->Resize(actual_array_size * 2, 0);
        float32* pbch_constellation = response->mutable_pbch_constellation()->mutable_data();
        auto array_size = actual_array_size;
        status = library_->ModAccFetchDownlinkPBCHConstellationInterleavedIQ(instrument, selector_string, timeout, pbch_constellation, array_size, &actual_array_size);
        if (status == kErrorReadBufferTooSmall || status == kWarningCAPIStringTruncatedToFitBuffer) {
          // buffer is now too small, try again
          continue;
        }
  ...
  //---------------------------------------------------------------------
  //---------------------------------------------------------------------
  ::grpc::Status NiRFmxLTEService::ModAccFetchDownlinkPBCHConstellationSplit(::grpc::ServerContext* context, const ModAccFetchDownlinkPBCHConstellationSplitRequest* request, ModAccFetchDownlinkPBCHConstellationSplitResponse* response)
  {
    if (context->IsCancelled()) {
      return ::grpc::Status::CANCELLED;
    }
    try {
      ...
      int32 actual_array_size {};
      while (true) {
        auto status = library_->ModAccFetchDownlinkPBCHConstellationSplit(instrument, selector_string, timeout, nullptr, nullptr, 0, &actual_array_size);
        if (!status_ok(status)) {
          return ConvertApiErrorStatusForNiRFmxInstrHandle(context, status, instrument);
        }
        response->mutable_pbch_constellation_i()->Resize(actual_array_size, 0);
        float32* pbch_constellation_i = response->mutable_pbch_constellation_i()->mutable_data();
        response->mutable_pbch_constellation_q()->Resize(actual_array_size, 0);
        float32* pbch_constellation_q = response->mutable_pbch_constellation_q()->mutable_data();
        auto array_size = actual_array_size;
        status = library_->ModAccFetchDownlinkPBCHConstellationSplit(instrument, selector_string, timeout, pbch_constellation_i, pbch_constellation_q, array_size, &actual_array_size);
        if (status == kErrorReadBufferTooSmall || status == kWarningCAPIStringTruncatedToFitBuffer) {
          // buffer is now too small, try again
          continue;
        }
  ...
  //---------------------------------------------------------------------
  //---------------------------------------------------------------------
  ::grpc::Status NiRFmxLTEService::ModAccFetchDownlinkPCFICHConstellationInterleavedIQ(::grpc::ServerContext* context, const ModAccFetchDownlinkPCFICHConstellationInterleavedIQRequest* request, ModAccFetchDownlinkPCFICHConstellationInterleavedIQResponse* response)
  {
    if (context->IsCancelled()) {
      return ::grpc::Status::CANCELLED;
    }
    try {
      ...
      int32 actual_array_size {};
      while (true) {
        auto status = library_->ModAccFetchDownlinkPCFICHConstellationInterleavedIQ(instrument, selector_string, timeout, nullptr, 0, &actual_array_size);
        if (!status_ok(status)) {
          return ConvertApiErrorStatusForNiRFmxInstrHandle(context, status, instrument);
        }
        response->mutable_pcfich_constellation()->Resize(actual_array_size * 2, 0);
        float32* pcfich_constellation = response->mutable_pcfich_constellation()->mutable_data();
        auto array_size = actual_array_size;
        status = library_->ModAccFetchDownlinkPCFICHConstellationInterleavedIQ(instrument, selector_string, timeout, pcfich_constellation, array_size, &actual_array_size);
        if (status == kErrorReadBufferTooSmall || status == kWarningCAPIStringTruncatedToFitBuffer) {
          // buffer is now too small, try again
          continue;
        }
  ...
  //---------------------------------------------------------------------
  //---------------------------------------------------------------------
  ::grpc::Status NiRFmxLTEService::ModAccFetchDownlinkPCFICHConstellationSplit(::grpc::ServerContext* context, const ModAccFetchDownlinkPCFICHConstellationSplitRequest* request, ModAccFetchDownlinkPCFICHConstellationSplitResponse* response)
  {
    if (context->IsCancelled()) {
      return ::grpc::Status::CANCELLED;
    }
    try {
      ...
      int32 actual_array_size {};
      while (true) {
        auto status = library_->ModAccFetchDownlinkPCFICHConstellationSplit(instrument, selector_string, timeout, nullptr, nullptr, 0, &actual_array_size);
        if (!status_ok(status)) {
          return ConvertApiErrorStatusForNiRFmxInstrHandle(context, status, instrument);
        }
        response->mutable_pcfich_constellation_i()->Resize(actual_array_size, 0);
        float32* pcfich_constellation_i = response->mutable_pcfich_constellation_i()->mutable_data();
        response->mutable_pcfich_constellation_q()->Resize(actual_array_size, 0);
        float32* pcfich_constellation_q = response->mutable_pcfich_constellation_q()->mutable_data();
        auto array_size = actual_array_size;
        status = library_->ModAccFetchDownlinkPCFICHConstellationSplit(instrument, selector_string, timeout, pcfich_constellation_i, pcfich_constellation_q, array_size, &actual_array_size);
        if (status == kErrorReadBufferTooSmall || status == kWarningCAPIStringTruncatedToFitBuffer) {
          // buffer is now too small, try again
          continue;
        }
  ...
  //---------------------------------------------------------------------
  //---------------------------------------------------------------------
  ::grpc::Status NiRFmxLTEService::ModAccFetchDownlinkPDCCHConstellationInterleavedIQ(::grpc::ServerContext* context, const ModAccFetchDownlinkPDCCHConstellationInterleavedIQRequest* request, ModAccFetchDownlinkPDCCHConstellationInterleavedIQResponse* response)
  {
    if (context->IsCancelled()) {
      return ::grpc::Status::CANCELLED;
    }
    try {
      ...
      int32 actual_array_size {};
      while (true) {
        auto status = library_->ModAccFetchDownlinkPDCCHConstellationInterleavedIQ(instrument, selector_string, timeout, nullptr, 0, &actual_array_size);
        if (!status_ok(status)) {
          return ConvertApiErrorStatusForNiRFmxInstrHandle(context, status, instrument);
        }
        response->mutable_pdcch_constellation()->Resize(actual_array_size * 2, 0);
        float32* pdcch_constellation = response->mutable_pdcch_constellation()->mutable_data();
        auto array_size = actual_array_size;
        status = library_->ModAccFetchDownlinkPDCCHConstellationInterleavedIQ(instrument, selector_string, timeout, pdcch_constellation, array_size, &actual_array_size);
        if (status == kErrorReadBufferTooSmall || status == kWarningCAPIStringTruncatedToFitBuffer) {
          // buffer is now too small, try again
          continue;
        }
  ...
  //---------------------------------------------------------------------
  //---------------------------------------------------------------------
  ::grpc::Status NiRFmxLTEService::ModAccFetchDownlinkPDCCHConstellationSplit(::grpc::ServerContext* context, const ModAccFetchDownlinkPDCCHConstellationSplitRequest* request, ModAccFetchDownlinkPDCCHConstellationSplitResponse* response)
  {
    if (context->IsCancelled()) {
      return ::grpc::Status::CANCELLED;
    }
    try {
      ...
      int32 actual_array_size {};
      while (true) {
        auto status = library_->ModAccFetchDownlinkPDCCHConstellationSplit(instrument, selector_string, timeout, nullptr, nullptr, 0, &actual_array_size);
        if (!status_ok(status)) {
          return ConvertApiErrorStatusForNiRFmxInstrHandle(context, status, instrument);
        }
        response->mutable_pdcch_constellation_i()->Resize(actual_array_size, 0);
        float32* pdcch_constellation_i = response->mutable_pdcch_constellation_i()->mutable_data();
        response->mutable_pdcch_constellation_q()->Resize(actual_array_size, 0);
        float32* pdcch_constellation_q = response->mutable_pdcch_constellation_q()->mutable_data();
        auto array_size = actual_array_size;
        status = library_->ModAccFetchDownlinkPDCCHConstellationSplit(instrument, selector_string, timeout, pdcch_constellation_i, pdcch_constellation_q, array_size, &actual_array_size);
        if (status == kErrorReadBufferTooSmall || status == kWarningCAPIStringTruncatedToFitBuffer) {
          // buffer is now too small, try again
          continue;
        }
  ...
  //---------------------------------------------------------------------
  //---------------------------------------------------------------------
  ::grpc::Status NiRFmxLTEService::ModAccFetchDownlinkPHICHConstellationInterleavedIQ(::grpc::ServerContext* context, const ModAccFetchDownlinkPHICHConstellationInterleavedIQRequest* request, ModAccFetchDownlinkPHICHConstellationInterleavedIQResponse* response)
  {
    if (context->IsCancelled()) {
      return ::grpc::Status::CANCELLED;
    }
    try {
      ...
      int32 actual_array_size {};
      while (true) {
        auto status = library_->ModAccFetchDownlinkPHICHConstellationInterleavedIQ(instrument, selector_string, timeout, nullptr, 0, &actual_array_size);
        if (!status_ok(status)) {
          return ConvertApiErrorStatusForNiRFmxInstrHandle(context, status, instrument);
        }
        response->mutable_phich_constellation()->Resize(actual_array_size * 2, 0);
        float32* phich_constellation = response->mutable_phich_constellation()->mutable_data();
        auto array_size = actual_array_size;
        status = library_->ModAccFetchDownlinkPHICHConstellationInterleavedIQ(instrument, selector_string, timeout, phich_constellation, array_size, &actual_array_size);
        if (status == kErrorReadBufferTooSmall || status == kWarningCAPIStringTruncatedToFitBuffer) {
          // buffer is now too small, try again
          continue;
        }
  ...
  //---------------------------------------------------------------------
  //---------------------------------------------------------------------
  ::grpc::Status NiRFmxLTEService::ModAccFetchDownlinkPHICHConstellationSplit(::grpc::ServerContext* context, const ModAccFetchDownlinkPHICHConstellationSplitRequest* request, ModAccFetchDownlinkPHICHConstellationSplitResponse* response)
  {
    if (context->IsCancelled()) {
      return ::grpc::Status::CANCELLED;
    }
    try {
      ...
      int32 actual_array_size {};
      while (true) {
        auto status = library_->ModAccFetchDownlinkPHICHConstellationSplit(instrument, selector_string, timeout, nullptr, nullptr, 0, &actual_array_size);
        if (!status_ok(status)) {
          return ConvertApiErrorStatusForNiRFmxInstrHandle(context, status, instrument);
        }
        response->mutable_phich_constellation_i()->Resize(actual_array_size, 0);
        float32* phich_constellation_i = response->mutable_phich_constellation_i()->mutable_data();
        response->mutable_phich_constellation_q()->Resize(actual_array_size, 0);
        float32* phich_constellation_q = response->mutable_phich_constellation_q()->mutable_data();
        auto array_size = actual_array_size;
        status = library_->ModAccFetchDownlinkPHICHConstellationSplit(instrument, selector_string, timeout, phich_constellation_i, phich_constellation_q, array_size, &actual_array_size);
        if (status == kErrorReadBufferTooSmall || status == kWarningCAPIStringTruncatedToFitBuffer) {
          // buffer is now too small, try again
          continue;
        }
  ...
  //---------------------------------------------------------------------
  //---------------------------------------------------------------------
  ::grpc::Status NiRFmxLTEService::ModAccFetchMaximumEVMHighPerSymbolTrace(::grpc::ServerContext* context, const ModAccFetchMaximumEVMHighPerSymbolTraceRequest* request, ModAccFetchMaximumEVMHighPerSymbolTraceResponse* response)
  {
    if (context->IsCancelled()) {
      return ::grpc::Status::CANCELLED;
    }
    try {
      ...
      int32 actual_array_size {};
      while (true) {
        auto status = library_->ModAccFetchMaximumEVMHighPerSymbolTrace(instrument, selector_string, timeout, &x0, &dx, nullptr, 0, &actual_array_size);
        if (!status_ok(status)) {
          return ConvertApiErrorStatusForNiRFmxInstrHandle(context, status, instrument);
        }
        response->mutable_maximum_evm_high_per_symbol()->Resize(actual_array_size, 0);
        float32* maximum_evm_high_per_symbol = response->mutable_maximum_evm_high_per_symbol()->mutable_data();
        auto array_size = actual_array_size;
        status = library_->ModAccFetchMaximumEVMHighPerSymbolTrace(instrument, selector_string, timeout, &x0, &dx, maximum_evm_high_per_symbol, array_size, &actual_array_size);
        if (status == kErrorReadBufferTooSmall || status == kWarningCAPIStringTruncatedToFitBuffer) {
          // buffer is now too small, try again
          continue;
        }
  ...
  //---------------------------------------------------------------------
  //---------------------------------------------------------------------
  ::grpc::Status NiRFmxLTEService::ModAccFetchMaximumEVMLowPerSymbolTrace(::grpc::ServerContext* context, const ModAccFetchMaximumEVMLowPerSymbolTraceRequest* request, ModAccFetchMaximumEVMLowPerSymbolTraceResponse* response)
  {
    if (context->IsCancelled()) {
      return ::grpc::Status::CANCELLED;
    }
    try {
      ...
      int32 actual_array_size {};
      while (true) {
        auto status = library_->ModAccFetchMaximumEVMLowPerSymbolTrace(instrument, selector_string, timeout, &x0, &dx, nullptr, 0, &actual_array_size);
        if (!status_ok(status)) {
          return ConvertApiErrorStatusForNiRFmxInstrHandle(context, status, instrument);
        }
        response->mutable_maximum_evm_low_per_symbol()->Resize(actual_array_size, 0);
        float32* maximum_evm_low_per_symbol = response->mutable_maximum_evm_low_per_symbol()->mutable_data();
        auto array_size = actual_array_size;
        status = library_->ModAccFetchMaximumEVMLowPerSymbolTrace(instrument, selector_string, timeout, &x0, &dx, maximum_evm_low_per_symbol, array_size, &actual_array_size);
        if (status == kErrorReadBufferTooSmall || status == kWarningCAPIStringTruncatedToFitBuffer) {
          // buffer is now too small, try again
          continue;
        }
  ...
  //---------------------------------------------------------------------
  //---------------------------------------------------------------------
  ::grpc::Status NiRFmxLTEService::ModAccFetchNBSynchronizationSignalConstellation(::grpc::ServerContext* context, const ModAccFetchNBSynchronizationSignalConstellationRequest* request, ModAccFetchNBSynchronizationSignalConstellationResponse* response)
  {
    if (context->IsCancelled()) {
      return ::grpc::Status::CANCELLED;
    }
    try {
      ...
      char* selector_string = (char*)selector_string_mbcs.c_str();
      float64 timeout = request->timeout();
      int32 nsss_constellation_actual_array_size {};
      int32 npss_constellation_actual_array_size {};
      while (true) {
        auto status = library_->ModAccFetchNBSynchronizationSignalConstellation(instrument, selector_string, timeout, nullptr, 0, &nsss_constellation_actual_array_size, nullptr, 0, &npss_constellation_actual_array_size);
        if (!status_ok(status)) {
          return ConvertApiErrorStatusForNiRFmxInstrHandle(context, status, instrument);
        }
        std::vector<NIComplexSingle> nsss_constellation(nsss_constellation_actual_array_size, NIComplexSingle());
        std::vector<NIComplexSingle> npss_constellation(npss_constellation_actual_array_size, NIComplexSingle());
        auto npss_constellation_array_size = npss_constellation_actual_array_size;
        auto nsss_constellation_array_size = nsss_constellation_actual_array_size;
        status = library_->ModAccFetchNBSynchronizationSignalConstellation(instrument, selector_string, timeout, nsss_constellation.data(), nsss_constellation_array_size, &nsss_constellation_actual_array_size, npss_constellation.data(), npss_constellation_array_size, &npss_constellation_actual_array_size);
        if (status == kErrorReadBufferTooSmall || status == kWarningCAPIStringTruncatedToFitBuffer) {
          // buffer is now too small, try again
          continue;
        }
        ...
        response->set_status(status);
        convert_to_grpc(nsss_constellation, response->mutable_nsss_constellation());
        {
          auto shrunk_size = nsss_constellation_actual_array_size;
          auto current_size = response->mutable_nsss_constellation()->size();
          if (shrunk_size != current_size) {
            response->mutable_nsss_constellation()->DeleteSubrange(shrunk_size, current_size - shrunk_size);
          }
        }
        response->set_nsss_constellation_actual_array_size(nsss_constellation_actual_array_size);
        convert_to_grpc(npss_constellation, response->mutable_npss_constellation());
        {
          auto shrunk_size = npss_constellation_actual_array_size;
          auto current_size = response->mutable_npss_constellation()->size();
          if (shrunk_size != current_size) {
            response->mutable_npss_constellation()->DeleteSubrange(shrunk_size, current_size - shrunk_size);
          }
        }
        response->set_npss_constellation_actual_array_size(npss_constellation_actual_array_size);
        return ::grpc::Status::OK;
      }
    }
    catch (nidevice_grpc::NonDriverException& ex) {
  ...
  //---------------------------------------------------------------------
  //---------------------------------------------------------------------
  ::grpc::Status NiRFmxLTEService::ModAccFetchNBSynchronizationSignalConstellationInterleavedIQ(::grpc::ServerContext* context, const ModAccFetchNBSynchronizationSignalConstellationInterleavedIQRequest* request, ModAccFetchNBSynchronizationSignalConstellationInterleavedIQResponse* response)
  {
    if (context->IsCancelled()) {
      return ::grpc::Status::CANCELLED;
    }
    try {
      ...
      int32 npss_constellation_actual_array_size {};
      while (true) {
        auto status = library_->ModAccFetchNBSynchronizationSignalConstellationInterleavedIQ(instrument, selector_string, timeout, nullptr, 0, &nsss_constellation_actual_array_size, nullptr, 0, &npss_constellation_actual_array_size);
        if (!status_ok(status)) {
          return ConvertApiErrorStatusForNiRFmxInstrHandle(context, status, instrument);
        }
        response->mutable_nsss_constellation()->Resize(nsss_constellation_actual_array_size * 2, 0);
        float32* nsss_constellation = response->mutable_nsss_constellation()->mutable_data();
        response->mutable_npss_constellation()->Resize(npss_constellation_actual_array_size * 2, 0);
        float32* npss_constellation = response->mutable_npss_constellation()->mutable_data();
        auto npss_constellation_array_size = npss_constellation_actual_array_size;
        auto nsss_constellation_array_size = nsss_constellation_actual_array_size;
        status = library_->ModAccFetchNBSynchronizationSignalConstellationInterleavedIQ(instrument, selector_string, timeout, nsss_constellation, nsss_constellation_array_size, &nsss_constellation_actual_array_size, npss_constellation, npss_constellation_array_size, &npss_constellation_actual_array_size);
        if (status == kErrorReadBufferTooSmall || status == kWarningCAPIStringTruncatedToFitBuffer) {
          // buffer is now too small, try again
          continue;
        }
        ...
        response->set_status(status);
        response->mutable_nsss_constellation()->Resize(nsss_constellation_actual_array_size * 2, 0);
        response->set_nsss_constellation_actual_array_size(nsss_constellation_actual_array_size * 2);
        response->mutable_npss_constellation()->Resize(npss_constellation_actual_array_size * 2, 0);
        response->set_npss_constellation_actual_array_size(npss_constellation_actual_array_size * 2);
        return ::grpc::Status::OK;
      }
    }
    catch (nidevice_grpc::NonDriverException& ex) {
  ...
  //---------------------------------------------------------------------
  //---------------------------------------------------------------------
  ::grpc::Status NiRFmxLTEService::ModAccFetchNBSynchronizationSignalConstellationSplit(::grpc::ServerContext* context, const ModAccFetchNBSynchronizationSignalConstellationSplitRequest* request, ModAccFetchNBSynchronizationSignalConstellationSplitResponse* response)
  {
    if (context->IsCancelled()) {
      return ::grpc::Status::CANCELLED;
    }
    try {
      ...
      int32 npss_constellation_actual_array_size {};
      while (true) {
        auto status = library_->ModAccFetchNBSynchronizationSignalConstellationSplit(instrument, selector_string, timeout, nullptr, nullptr, 0, &nsss_constellation_actual_array_size, nullptr, nullptr, 0, &npss_constellation_actual_array_size);
        if (!status_ok(status)) {
          return ConvertApiErrorStatusForNiRFmxInstrHandle(context, status, instrument);
        }
        response->mutable_nsss_constellation_i()->Resize(nsss_constellation_actual_array_size, 0);
        float32* nsss_constellation_i = response->mutable_nsss_constellation_i()->mutable_data();
        response->mutable_nsss_constellation_q()->Resize(nsss_constellation_actual_array_size, 0);
        float32* nsss_constellation_q = response->mutable_nsss_constellation_q()->mutable_data();
        response->mutable_npss_constellation_i()->Resize(npss_constellation_actual_array_size, 0);
        float32* npss_constellation_i = response->mutable_npss_constellation_i()->mutable_data();
        response->mutable_npss_constellation_q()->Resize(npss_constellation_actual_array_size, 0);
        float32* npss_constellation_q = response->mutable_npss_constellation_q()->mutable_data();
        auto npss_constellation_array_size = npss_constellation_actual_array_size;
        auto nsss_constellation_array_size = nsss_constellation_actual_array_size;
        status = library_->ModAccFetchNBSynchronizationSignalConstellationSplit(instrument, selector_string, timeout, nsss_constellation_i, nsss_constellation_q, nsss_constellation_array_size, &nsss_constellation_actual_array_size, npss_constellation_i, npss_constellation_q, npss_constellation_array_size, &npss_constellation_actual_array_size);
        if (status == kErrorReadBufferTooSmall || status == kWarningCAPIStringTruncatedToFitBuffer) {
          // buffer is now too small, try again
          continue;
        }
  ...
  //---------------------------------------------------------------------
  //---------------------------------------------------------------------
  ::grpc::Status NiRFmxLTEService::ModAccFetchNPDSCH16QAMConstellation(::grpc::ServerContext* context, const ModAccFetchNPDSCH16QAMConstellationRequest* request, ModAccFetchNPDSCH16QAMConstellationResponse* response)
  {
    if (context->IsCancelled()) {
      return ::grpc::Status::CANCELLED;
    }
    try {
      ...
      int32 actual_array_size {};
      while (true) {
        auto status = library_->ModAccFetchNPDSCH16QAMConstellation(instrument, selector_string, timeout, nullptr, 0, &actual_array_size);
        if (!status_ok(status)) {
          return ConvertApiErrorStatusForNiRFmxInstrHandle(context, status, instrument);
        }
        std::vector<NIComplexSingle> qam16_constellation(actual_array_size, NIComplexSingle());
        auto array_size = actual_array_size;
        status = library_->ModAccFetchNPDSCH16QAMConstellation(instrument, selector_string, timeout, qam16_constellation.data(), array_size, &actual_array_size);
        if (status == kErrorReadBufferTooSmall || status == kWarningCAPIStringTruncatedToFitBuffer) {
          // buffer is now too small, try again
          continue;
        }
  ...
  //---------------------------------------------------------------------
  //---------------------------------------------------------------------
  ::grpc::Status NiRFmxLTEService::ModAccFetchNPDSCH16QAMConstellationInterleavedIQ(::grpc::ServerContext* context, const ModAccFetchNPDSCH16QAMConstellationInterleavedIQRequest* request, ModAccFetchNPDSCH16QAMConstellationInterleavedIQResponse* response)
  {
    if (context->IsCancelled()) {
      return ::grpc::Status::CANCELLED;
    }
    try {
      ...
      int32 actual_array_size {};
      while (true) {
        auto status = library_->ModAccFetchNPDSCH16QAMConstellationInterleavedIQ(instrument, selector_string, timeout, nullptr, 0, &actual_array_size);
        if (!status_ok(status)) {
          return ConvertApiErrorStatusForNiRFmxInstrHandle(context, status, instrument);
        }
        ...
        auto array_size = actual_array_size;
        status = library_->ModAccFetchNPDSCH16QAMConstellationInterleavedIQ(instrument, selector_string, timeout, qam16_constellation, array_size, &actual_array_size);
        if (status == kErrorReadBufferTooSmall || status == kWarningCAPIStringTruncatedToFitBuffer) {
          // buffer is now too small, try again
          continue;
        }
  ...
  //---------------------------------------------------------------------
  //---------------------------------------------------------------------
  ::grpc::Status NiRFmxLTEService::ModAccFetchNPDSCH16QAMConstellationSplit(::grpc::ServerContext* context, const ModAccFetchNPDSCH16QAMConstellationSplitRequest* request, ModAccFetchNPDSCH16QAMConstellationSplitResponse* response)
  {
    if (context->IsCancelled()) {
      return ::grpc::Status::CANCELLED;
    }
    try {
      ...
      int32 actual_array_size {};
      while (true) {
        auto status = library_->ModAccFetchNPDSCH16QAMConstellationSplit(instrument, selector_string, timeout, nullptr, nullptr, 0, &actual_array_size);
        if (!status_ok(status)) {
          return ConvertApiErrorStatusForNiRFmxInstrHandle(context, status, instrument);
        }
        ...
        auto array_size = actual_array_size;
        status = library_->ModAccFetchNPDSCH16QAMConstellationSplit(instrument, selector_string, timeout, qam16_constellation_i, qam16_constellation_q, array_size, &actual_array_size);
        if (status == kErrorReadBufferTooSmall || status == kWarningCAPIStringTruncatedToFitBuffer) {
          // buffer is now too small, try again
          continue;
        }
  ...
  //---------------------------------------------------------------------
  //---------------------------------------------------------------------
  ::grpc::Status NiRFmxLTEService::ModAccFetchNPDSCHQPSKConstellation(::grpc::ServerContext* context, const ModAccFetchNPDSCHQPSKConstellationRequest* request, ModAccFetchNPDSCHQPSKConstellationResponse* response)
  {
    if (context->IsCancelled()) {
      return ::grpc::Status::CANCELLED;
    }
    try {
      ...
      int32 actual_array_size {};
      while (true) {
        auto status = library_->ModAccFetchNPDSCHQPSKConstellation(instrument, selector_string, timeout, nullptr, 0, &actual_array_size);
        if (!status_ok(status)) {
          return ConvertApiErrorStatusForNiRFmxInstrHandle(context, status, instrument);
        }
        std::vector<NIComplexSingle> qpsk_constellation(actual_array_size, NIComplexSingle());
        auto array_size = actual_array_size;
        status = library_->ModAccFetchNPDSCHQPSKConstellation(instrument, selector_string, timeout, qpsk_constellation.data(), array_size, &actual_array_size);
        if (status == kErrorReadBufferTooSmall || status == kWarningCAPIStringTruncatedToFitBuffer) {
          // buffer is now too small, try again
          continue;
        }
  ...
  //---------------------------------------------------------------------
  //---------------------------------------------------------------------
  ::grpc::Status NiRFmxLTEService::ModAccFetchNPDSCHQPSKConstellationInterleavedIQ(::grpc::ServerContext* context, const ModAccFetchNPDSCHQPSKConstellationInterleavedIQRequest* request, ModAccFetchNPDSCHQPSKConstellationInterleavedIQResponse* response)
  {
    if (context->IsCancelled()) {
      return ::grpc::Status::CANCELLED;
    }
    try {
      ...
      int32 actual_array_size {};
      while (true) {
        auto status = library_->ModAccFetchNPDSCHQPSKConstellationInterleavedIQ(instrument, selector_string, timeout, nullptr, 0, &actual_array_size);
        if (!status_ok(status)) {
          return ConvertApiErrorStatusForNiRFmxInstrHandle(context, status, instrument);
        }
        ...
        auto array_size = actual_array_size;
        status = library_->ModAccFetchNPDSCHQPSKConstellationInterleavedIQ(instrument, selector_string, timeout, qpsk_constellation, array_size, &actual_array_size);
        if (status == kErrorReadBufferTooSmall || status == kWarningCAPIStringTruncatedToFitBuffer) {
          // buffer is now too small, try again
          continue;
        }
  ...
  //---------------------------------------------------------------------
  //---------------------------------------------------------------------
  ::grpc::Status NiRFmxLTEService::ModAccFetchNPDSCHQPSKConstellationSplit(::grpc::ServerContext* context, const ModAccFetchNPDSCHQPSKConstellationSplitRequest* request, ModAccFetchNPDSCHQPSKConstellationSplitResponse* response)
  {
    if (context->IsCancelled()) {
      return ::grpc::Status::CANCELLED;
    }
    try {
      ...
      int32 actual_array_size {};
      while (true) {
        auto status = library_->ModAccFetchNPDSCHQPSKConstellationSplit(instrument, selector_string, timeout, nullptr, nullptr, 0, &actual_array_size);
        if (!status_ok(status)) {
          return ConvertApiErrorStatusForNiRFmxInstrHandle(context, status, instrument);
        }
        ...
        auto array_size = actual_array_size;
        status = library_->ModAccFetchNPDSCHQPSKConstellationSplit(instrument, selector_string, timeout, qpsk_constellation_i, qpsk_constellation_q, array_size, &actual_array_size);
        if (status == kErrorReadBufferTooSmall || status == kWarningCAPIStringTruncatedToFitBuffer) {
          // buffer is now too small, try again
          continue;
        }
  ...
  //---------------------------------------------------------------------
  //---------------------------------------------------------------------
  ::grpc::Status NiRFmxLTEService::ModAccFetchNPUSCHConstellationTraceInterleavedIQ(::grpc::ServerContext* context, const ModAccFetchNPUSCHConstellationTraceInterleavedIQRequest* request, ModAccFetchNPUSCHConstellationTraceInterleavedIQResponse* response)
  {
    if (context->IsCancelled()) {
      return ::grpc::Status::CANCELLED;
    }
    try {
      ...
      int32 dmrs_constellation_actual_array_size {};
      while (true) {
        auto status = library_->ModAccFetchNPUSCHConstellationTraceInterleavedIQ(instrument, selector_string, timeout, nullptr, 0, &data_constellation_actual_array_size, nullptr, 0, &dmrs_constellation_actual_array_size);
        if (!status_ok(status)) {
          return ConvertApiErrorStatusForNiRFmxInstrHandle(context, status, instrument);
        }
        ...
        auto data_constellation_array_size = data_constellation_actual_array_size;
        auto dmrs_constellation_array_size = dmrs_constellation_actual_array_size;
        status = library_->ModAccFetchNPUSCHConstellationTraceInterleavedIQ(instrument, selector_string, timeout, data_constellation, data_constellation_array_size, &data_constellation_actual_array_size, dmrs_constellation, dmrs_constellation_array_size, &dmrs_constellation_actual_array_size);
        if (status == kErrorReadBufferTooSmall || status == kWarningCAPIStringTruncatedToFitBuffer) {
          // buffer is now too small, try again
          continue;
        }
  ...
  //---------------------------------------------------------------------
  //---------------------------------------------------------------------
  ::grpc::Status NiRFmxLTEService::ModAccFetchNPUSCHConstellationTraceSplit(::grpc::ServerContext* context, const ModAccFetchNPUSCHConstellationTraceSplitRequest* request, ModAccFetchNPUSCHConstellationTraceSplitResponse* response)
  {
    if (context->IsCancelled()) {
      return ::grpc::Status::CANCELLED;
    }
    try {
      ...
      int32 dmrs_constellation_actual_array_size {};
      while (true) {
        auto status = library_->ModAccFetchNPUSCHConstellationTraceSplit(instrument, selector_string, timeout, nullptr, nullptr, 0, &data_constellation_actual_array_size, nullptr, nullptr, 0, &dmrs_constellation_actual_array_size);
        if (!status_ok(status)) {
          return ConvertApiErrorStatusForNiRFmxInstrHandle(context, status, instrument);
        }
        response->mutable_data_constellation_i()->Resize(data_constellation_actual_array_size, 0);
        float32* data_constellation_i = response->mutable_data_constellation_i()->mutable_data();
        response->mutable_data_constellation_q()->Resize(data_constellation_actual_array_size, 0);
        float32* data_constellation_q = response->mutable_data_constellation_q()->mutable_data();
        response->mutable_dmrs_constellation_i()->Resize(dmrs_constellation_actual_array_size, 0);
        float32* dmrs_constellation_i = response->mutable_dmrs_constellation_i()->mutable_data();
        response->mutable_dmrs_constellation_q()->Resize(dmrs_constellation_actual_array_size, 0);
        float32* dmrs_constellation_q = response->mutable_dmrs_constellation_q()->mutable_data();
        auto data_constellation_array_size = data_constellation_actual_array_size;
        auto dmrs_constellation_array_size = dmrs_constellation_actual_array_size;
        status = library_->ModAccFetchNPUSCHConstellationTraceSplit(instrument, selector_string, timeout, data_constellation_i, data_constellation_q, data_constellation_array_size, &data_constellation_actual_array_size, dmrs_constellation_i, dmrs_constellation_q, dmrs_constellation_array_size, &dmrs_constellation_actual_array_size);
        if (status == kErrorReadBufferTooSmall || status == kWarningCAPIStringTruncatedToFitBuffer) {
          // buffer is now too small, try again
          continue;
        }
  ...
  //---------------------------------------------------------------------
  //---------------------------------------------------------------------
  ::grpc::Status NiRFmxLTEService::ModAccFetchNRSConstellation(::grpc::ServerContext* context, const ModAccFetchNRSConstellationRequest* request, ModAccFetchNRSConstellationResponse* response)
  {
    if (context->IsCancelled()) {
      return ::grpc::Status::CANCELLED;
    }
    try {
      ...
      int32 actual_array_size {};
      while (true) {
        auto status = library_->ModAccFetchNRSConstellation(instrument, selector_string, timeout, nullptr, 0, &actual_array_size);
        if (!status_ok(status)) {
          return ConvertApiErrorStatusForNiRFmxInstrHandle(context, status, instrument);
        }
        std::vector<NIComplexSingle> nrs_constellation(actual_array_size, NIComplexSingle());
        auto array_size = actual_array_size;
        status = library_->ModAccFetchNRSConstellation(instrument, selector_string, timeout, nrs_constellation.data(), array_size, &actual_array_size);
        if (status == kErrorReadBufferTooSmall || status == kWarningCAPIStringTruncatedToFitBuffer) {
          // buffer is now too small, try again
          continue;
        }
        ...
        response->set_status(status);
        convert_to_grpc(nrs_constellation, response->mutable_nrs_constellation());
        {
          auto shrunk_size = actual_array_size;
          auto current_size = response->mutable_nrs_constellation()->size();
          if (shrunk_size != current_size) {
            response->mutable_nrs_constellation()->DeleteSubrange(shrunk_size, current_size - shrunk_size);
          }
        }
        response->set_actual_array_size(actual_array_size);
        return ::grpc::Status::OK;
  ...
  //---------------------------------------------------------------------
  //---------------------------------------------------------------------
  ::grpc::Status NiRFmxLTEService::ModAccFetchNRSConstellationInterleavedIQ(::grpc::ServerContext* context, const ModAccFetchNRSConstellationInterleavedIQRequest* request, ModAccFetchNRSConstellationInterleavedIQResponse* response)
  {
    if (context->IsCancelled()) {
      return ::grpc::Status::CANCELLED;
    }
    try {
      ...
      int32 actual_array_size {};
      while (true) {
        auto status = library_->ModAccFetchNRSConstellationInterleavedIQ(instrument, selector_string, timeout, nullptr, 0, &actual_array_size);
        if (!status_ok(status)) {
          return ConvertApiErrorStatusForNiRFmxInstrHandle(context, status, instrument);
        }
        response->mutable_nrs_constellation()->Resize(actual_array_size * 2, 0);
        float32* nrs_constellation = response->mutable_nrs_constellation()->mutable_data();
        auto array_size = actual_array_size;
        status = library_->ModAccFetchNRSConstellationInterleavedIQ(instrument, selector_string, timeout, nrs_constellation, array_size, &actual_array_size);
        if (status == kErrorReadBufferTooSmall || status == kWarningCAPIStringTruncatedToFitBuffer) {
          // buffer is now too small, try again
          continue;
        }
  ...
  //---------------------------------------------------------------------
  //---------------------------------------------------------------------
  ::grpc::Status NiRFmxLTEService::ModAccFetchNRSConstellationSplit(::grpc::ServerContext* context, const ModAccFetchNRSConstellationSplitRequest* request, ModAccFetchNRSConstellationSplitResponse* response)
  {
    if (context->IsCancelled()) {
      return ::grpc::Status::CANCELLED;
    }
    try {
      ...
      int32 actual_array_size {};
      while (true) {
        auto status = library_->ModAccFetchNRSConstellationSplit(instrument, selector_string, timeout, nullptr, nullptr, 0, &actual_array_size);
        if (!status_ok(status)) {
          return ConvertApiErrorStatusForNiRFmxInstrHandle(context, status, instrument);
        }
        response->mutable_nrs_constellation_i()->Resize(actual_array_size, 0);
        float32* nrs_constellation_i = response->mutable_nrs_constellation_i()->mutable_data();
        response->mutable_nrs_constellation_q()->Resize(actual_array_size, 0);
        float32* nrs_constellation_q = response->mutable_nrs_constellation_q()->mutable_data();
        auto array_size = actual_array_size;
        status = library_->ModAccFetchNRSConstellationSplit(instrument, selector_string, timeout, nrs_constellation_i, nrs_constellation_q, array_size, &actual_array_size);
        if (status == kErrorReadBufferTooSmall || status == kWarningCAPIStringTruncatedToFitBuffer) {
          // buffer is now too small, try again
          continue;
        }
  ...
  //---------------------------------------------------------------------
  //---------------------------------------------------------------------
  ::grpc::Status NiRFmxLTEService::ModAccFetchPDSCH1024QAMConstellationInterleavedIQ(::grpc::ServerContext* context, const ModAccFetchPDSCH1024QAMConstellationInterleavedIQRequest* request, ModAccFetchPDSCH1024QAMConstellationInterleavedIQResponse* response)
  {
    if (context->IsCancelled()) {
      return ::grpc::Status::CANCELLED;
    }
    try {
      ...
      int32 actual_array_size {};
      while (true) {
        auto status = library_->ModAccFetchPDSCH1024QAMConstellationInterleavedIQ(instrument, selector_string, timeout, nullptr, 0, &actual_array_size);
        if (!status_ok(status)) {
          return ConvertApiErrorStatusForNiRFmxInstrHandle(context, status, instrument);
        }
        ...
        auto array_size = actual_array_size;
        status = library_->ModAccFetchPDSCH1024QAMConstellationInterleavedIQ(instrument, selector_string, timeout, qam1024_constellation, array_size, &actual_array_size);
        if (status == kErrorReadBufferTooSmall || status == kWarningCAPIStringTruncatedToFitBuffer) {
          // buffer is now too small, try again
          continue;
        }
  ...
  //---------------------------------------------------------------------
  //---------------------------------------------------------------------
  ::grpc::Status NiRFmxLTEService::ModAccFetchPDSCH1024QAMConstellationSplit(::grpc::ServerContext* context, const ModAccFetchPDSCH1024QAMConstellationSplitRequest* request, ModAccFetchPDSCH1024QAMConstellationSplitResponse* response)
  {
    if (context->IsCancelled()) {
      return ::grpc::Status::CANCELLED;
    }
    try {
      ...
      int32 actual_array_size {};
      while (true) {
        auto status = library_->ModAccFetchPDSCH1024QAMConstellationSplit(instrument, selector_string, timeout, nullptr, nullptr, 0, &actual_array_size);
        if (!status_ok(status)) {
          return ConvertApiErrorStatusForNiRFmxInstrHandle(context, status, instrument);
        }
        ...
        auto array_size = actual_array_size;
        status = library_->ModAccFetchPDSCH1024QAMConstellationSplit(instrument, selector_string, timeout, qam1024_constellation_i, qam1024_constellation_q, array_size, &actual_array_size);
        if (status == kErrorReadBufferTooSmall || status == kWarningCAPIStringTruncatedToFitBuffer) {
          // buffer is now too small, try again
          continue;
        }
  ...
  //---------------------------------------------------------------------
  //---------------------------------------------------------------------
  ::grpc::Status NiRFmxLTEService::ModAccFetchPDSCH16QAMConstellationInterleavedIQ(::grpc::ServerContext* context, const ModAccFetchPDSCH16QAMConstellationInterleavedIQRequest* request, ModAccFetchPDSCH16QAMConstellationInterleavedIQResponse* response)
  {
    if (context->IsCancelled()) {
      return ::grpc::Status::CANCELLED;
    }
    try {
      ...
      int32 actual_array_size {};
      while (true) {
        auto status = library_->ModAccFetchPDSCH16QAMConstellationInterleavedIQ(instrument, selector_string, timeout, nullptr, 0, &actual_array_size);
        if (!status_ok(status)) {
          return ConvertApiErrorStatusForNiRFmxInstrHandle(context, status, instrument);
        }
        response->mutable_qam16_constellation()->Resize(actual_array_size * 2, 0);
        float32* qam16_constellation = response->mutable_qam16_constellation()->mutable_data();
        auto array_size = actual_array_size;
        status = library_->ModAccFetchPDSCH16QAMConstellationInterleavedIQ(instrument, selector_string, timeout, qam16_constellation, array_size, &actual_array_size);
        if (status == kErrorReadBufferTooSmall || status == kWarningCAPIStringTruncatedToFitBuffer) {
          // buffer is now too small, try again
          continue;
        }
  ...
  //---------------------------------------------------------------------
  //---------------------------------------------------------------------
  ::grpc::Status NiRFmxLTEService::ModAccFetchPDSCH16QAMConstellationSplit(::grpc::ServerContext* context, const ModAccFetchPDSCH16QAMConstellationSplitRequest* request, ModAccFetchPDSCH16QAMConstellationSplitResponse* response)
  {
    if (context->IsCancelled()) {
      return ::grpc::Status::CANCELLED;
    }
    try {
      ...
      int32 actual_array_size {};
      while (true) {
        auto status = library_->ModAccFetchPDSCH16QAMConstellationSplit(instrument, selector_string, timeout, nullptr, nullptr, 0, &actual_array_size);
        if (!status_ok(status)) {
          return ConvertApiErrorStatusForNiRFmxInstrHandle(context, status, instrument);
        }
        response->mutable_qam16_constellation_i()->Resize(actual_array_size, 0);
        ...
        float32* qam16_constellation_q = response->mutable_qam16_constellation_q()->mutable_data();
        auto array_size = actual_array_size;
        status = library_->ModAccFetchPDSCH16QAMConstellationSplit(instrument, selector_string, timeout, qam16_constellation_i, qam16_constellation_q, array_size, &actual_array_size);
        if (status == kErrorReadBufferTooSmall || status == kWarningCAPIStringTruncatedToFitBuffer) {
          // buffer is now too small, try again
          continue;
        }
  ...
  //---------------------------------------------------------------------
  //---------------------------------------------------------------------
  ::grpc::Status NiRFmxLTEService::ModAccFetchPDSCH256QAMConstellationInterleavedIQ(::grpc::ServerContext* context, const ModAccFetchPDSCH256QAMConstellationInterleavedIQRequest* request, ModAccFetchPDSCH256QAMConstellationInterleavedIQResponse* response)
  {
    if (context->IsCancelled()) {
      return ::grpc::Status::CANCELLED;
    }
    try {
      ...
      int32 actual_array_size {};
      while (true) {
        auto status = library_->ModAccFetchPDSCH256QAMConstellationInterleavedIQ(instrument, selector_string, timeout, nullptr, 0, &actual_array_size);
        if (!status_ok(status)) {
          return ConvertApiErrorStatusForNiRFmxInstrHandle(context, status, instrument);
        }
        ...
        auto array_size = actual_array_size;
        status = library_->ModAccFetchPDSCH256QAMConstellationInterleavedIQ(instrument, selector_string, timeout, qam256_constellation, array_size, &actual_array_size);
        if (status == kErrorReadBufferTooSmall || status == kWarningCAPIStringTruncatedToFitBuffer) {
          // buffer is now too small, try again
          continue;
        }
  ...
  //---------------------------------------------------------------------
  //---------------------------------------------------------------------
  ::grpc::Status NiRFmxLTEService::ModAccFetchPDSCH256QAMConstellationSplit(::grpc::ServerContext* context, const ModAccFetchPDSCH256QAMConstellationSplitRequest* request, ModAccFetchPDSCH256QAMConstellationSplitResponse* response)
  {
    if (context->IsCancelled()) {
      return ::grpc::Status::CANCELLED;
    }
    try {
      ...
      int32 actual_array_size {};
      while (true) {
        auto status = library_->ModAccFetchPDSCH256QAMConstellationSplit(instrument, selector_string, timeout, nullptr, nullptr, 0, &actual_array_size);
        if (!status_ok(status)) {
          return ConvertApiErrorStatusForNiRFmxInstrHandle(context, status, instrument);
        }
        ...
        auto array_size = actual_array_size;
        status = library_->ModAccFetchPDSCH256QAMConstellationSplit(instrument, selector_string, timeout, qam256_constellation_i, qam256_constellation_q, array_size, &actual_array_size);
        if (status == kErrorReadBufferTooSmall || status == kWarningCAPIStringTruncatedToFitBuffer) {
          // buffer is now too small, try again
          continue;
        }
  ...
  //---------------------------------------------------------------------
  //---------------------------------------------------------------------
  ::grpc::Status NiRFmxLTEService::ModAccFetchPDSCH64QAMConstellationInterleavedIQ(::grpc::ServerContext* context, const ModAccFetchPDSCH64QAMConstellationInterleavedIQRequest* request, ModAccFetchPDSCH64QAMConstellationInterleavedIQResponse* response)
  {
    if (context->IsCancelled()) {
      return ::grpc::Status::CANCELLED;
    }
    try {
      ...
      int32 actual_array_size {};
      while (true) {
        auto status = library_->ModAccFetchPDSCH64QAMConstellationInterleavedIQ(instrument, selector_string, timeout, nullptr, 0, &actual_array_size);
        if (!status_ok(status)) {
          return ConvertApiErrorStatusForNiRFmxInstrHandle(context, status, instrument);
        }
        ...
        auto array_size = actual_array_size;
        status = library_->ModAccFetchPDSCH64QAMConstellationInterleavedIQ(instrument, selector_string, timeout, qam64_constellation, array_size, &actual_array_size);
        if (status == kErrorReadBufferTooSmall || status == kWarningCAPIStringTruncatedToFitBuffer) {
          // buffer is now too small, try again
          continue;
        }
  ...
  //---------------------------------------------------------------------
  //---------------------------------------------------------------------
  ::grpc::Status NiRFmxLTEService::ModAccFetchPDSCH64QAMConstellationSplit(::grpc::ServerContext* context, const ModAccFetchPDSCH64QAMConstellationSplitRequest* request, ModAccFetchPDSCH64QAMConstellationSplitResponse* response)
  {
    if (context->IsCancelled()) {
      return ::grpc::Status::CANCELLED;
    }
    try {
      ...
      int32 actual_array_size {};
      while (true) {
        auto status = library_->ModAccFetchPDSCH64QAMConstellationSplit(instrument, selector_string, timeout, nullptr, nullptr, 0, &actual_array_size);
        if (!status_ok(status)) {
          return ConvertApiErrorStatusForNiRFmxInstrHandle(context, status, instrument);
        }
        ...
        auto array_size = actual_array_size;
        status = library_->ModAccFetchPDSCH64QAMConstellationSplit(instrument, selector_string, timeout, qam64_constellation_i, qam64_constellation_q, array_size, &actual_array_size);
        if (status == kErrorReadBufferTooSmall || status == kWarningCAPIStringTruncatedToFitBuffer) {
          // buffer is now too small, try again
          continue;
        }
  ...
  //---------------------------------------------------------------------
  //---------------------------------------------------------------------
  ::grpc::Status NiRFmxLTEService::ModAccFetchPDSCHQPSKConstellationInterleavedIQ(::grpc::ServerContext* context, const ModAccFetchPDSCHQPSKConstellationInterleavedIQRequest* request, ModAccFetchPDSCHQPSKConstellationInterleavedIQResponse* response)
  {
    if (context->IsCancelled()) {
      return ::grpc::Status::CANCELLED;
    }
    try {
      ...
      int32 actual_array_size {};
      while (true) {
        auto status = library_->ModAccFetchPDSCHQPSKConstellationInterleavedIQ(instrument, selector_string, timeout, nullptr, 0, &actual_array_size);
        if (!status_ok(status)) {
          return ConvertApiErrorStatusForNiRFmxInstrHandle(context, status, instrument);
        }
        response->mutable_qpsk_constellation()->Resize(actual_array_size * 2, 0);
        float32* qpsk_constellation = response->mutable_qpsk_constellation()->mutable_data();
        auto array_size = actual_array_size;
        status = library_->ModAccFetchPDSCHQPSKConstellationInterleavedIQ(instrument, selector_string, timeout, qpsk_constellation, array_size, &actual_array_size);
        if (status == kErrorReadBufferTooSmall || status == kWarningCAPIStringTruncatedToFitBuffer) {
          // buffer is now too small, try again
          continue;
        }
  ...
  //---------------------------------------------------------------------
  //---------------------------------------------------------------------
  ::grpc::Status NiRFmxLTEService::ModAccFetchPDSCHQPSKConstellationSplit(::grpc::ServerContext* context, const ModAccFetchPDSCHQPSKConstellationSplitRequest* request, ModAccFetchPDSCHQPSKConstellationSplitResponse* response)
  {
    if (context->IsCancelled()) {
      return ::grpc::Status::CANCELLED;
    }
    try {
      ...
      int32 actual_array_size {};
      while (true) {
        auto status = library_->ModAccFetchPDSCHQPSKConstellationSplit(instrument, selector_string, timeout, nullptr, nullptr, 0, &actual_array_size);
        if (!status_ok(status)) {
          return ConvertApiErrorStatusForNiRFmxInstrHandle(context, status, instrument);
        }
        response->mutable_qpsk_constellation_i()->Resize(actual_array_size, 0);
        ...
        float32* qpsk_constellation_q = response->mutable_qpsk_constellation_q()->mutable_data();
        auto array_size = actual_array_size;
        status = library_->ModAccFetchPDSCHQPSKConstellationSplit(instrument, selector_string, timeout, qpsk_constellation_i, qpsk_constellation_q, array_size, &actual_array_size);
        if (status == kErrorReadBufferTooSmall || status == kWarningCAPIStringTruncatedToFitBuffer) {
          // buffer is now too small, try again
          continue;
        }
  ...
  //---------------------------------------------------------------------
  //---------------------------------------------------------------------
  ::grpc::Status NiRFmxLTEService::ModAccFetchPSSCHConstellationTraceInterleavedIQ(::grpc::ServerContext* context, const ModAccFetchPSSCHConstellationTraceInterleavedIQRequest* request, ModAccFetchPSSCHConstellationTraceInterleavedIQResponse* response)
  {
    if (context->IsCancelled()) {
      return ::grpc::Status::CANCELLED;
    }
  ...
  //---------------------------------------------------------------------
  //---------------------------------------------------------------------
  ::grpc::Status NiRFmxLTEService::ModAccFetchPSSCHConstellationTraceSplit(::grpc::ServerContext* context, const ModAccFetchPSSCHConstellationTraceSplitRequest* request, ModAccFetchPSSCHConstellationTraceSplitResponse* response)
  {
    if (context->IsCancelled()) {
      return ::grpc::Status::CANCELLED;
    }
    try {
      ...
      int32 dmrs_constellation_actual_array_size {};
      while (true) {
        auto status = library_->ModAccFetchPSSCHConstellationTraceSplit(instrument, selector_string, timeout, nullptr, nullptr, 0, &data_constellation_actual_array_size, nullptr, nullptr, 0, &dmrs_constellation_actual_array_size);
        if (!status_ok(status)) {
          return ConvertApiErrorStatusForNiRFmxInstrHandle(context, status, instrument);
        }
        response->mutable_data_constellation_i()->Resize(data_constellation_actual_array_size, 0);
        ...
        auto data_constellation_array_size = data_constellation_actual_array_size;
        auto dmrs_constellation_array_size = dmrs_constellation_actual_array_size;
        status = library_->ModAccFetchPSSCHConstellationTraceSplit(instrument, selector_string, timeout, data_constellation_i, data_constellation_q, data_constellation_array_size, &data_constellation_actual_array_size, dmrs_constellation_i, dmrs_constellation_q, dmrs_constellation_array_size, &dmrs_constellation_actual_array_size);
        if (status == kErrorReadBufferTooSmall || status == kWarningCAPIStringTruncatedToFitBuffer) {
          // buffer is now too small, try again
          continue;
        }
  ...
  //---------------------------------------------------------------------
  //---------------------------------------------------------------------
  ::grpc::Status NiRFmxLTEService::ModAccFetchPUSCHConstellationTraceInterleavedIQ(::grpc::ServerContext* context, const ModAccFetchPUSCHConstellationTraceInterleavedIQRequest* request, ModAccFetchPUSCHConstellationTraceInterleavedIQResponse* response)
  {
    if (context->IsCancelled()) {
      return ::grpc::Status::CANCELLED;
    }
    try {
      ...
      int32 dmrs_constellation_actual_array_size {};
      while (true) {
        auto status = library_->ModAccFetchPUSCHConstellationTraceInterleavedIQ(instrument, selector_string, timeout, nullptr, 0, &data_constellation_actual_array_size, nullptr, 0, &dmrs_constellation_actual_array_size);
        if (!status_ok(status)) {
          return ConvertApiErrorStatusForNiRFmxInstrHandle(context, status, instrument);
        }
        response->mutable_data_constellation()->Resize(data_constellation_actual_array_size * 2, 0);
        ...
        auto data_constellation_array_size = data_constellation_actual_array_size;
        auto dmrs_constellation_array_size = dmrs_constellation_actual_array_size;
        status = library_->ModAccFetchPUSCHConstellationTraceInterleavedIQ(instrument, selector_string, timeout, data_constellation, data_constellation_array_size, &data_constellation_actual_array_size, dmrs_constellation, dmrs_constellation_array_size, &dmrs_constellation_actual_array_size);
        if (status == kErrorReadBufferTooSmall || status == kWarningCAPIStringTruncatedToFitBuffer) {
          // buffer is now too small, try again
          continue;
        }
  ...
  //---------------------------------------------------------------------
  //---------------------------------------------------------------------
  ::grpc::Status NiRFmxLTEService::ModAccFetchPUSCHConstellationTraceSplit(::grpc::ServerContext* context, const ModAccFetchPUSCHConstellationTraceSplitRequest* request, ModAccFetchPUSCHConstellationTraceSplitResponse* response)
  {
    if (context->IsCancelled()) {
      return ::grpc::Status::CANCELLED;
    }
    try {
      ...
      int32 dmrs_constellation_actual_array_size {};
      while (true) {
        auto status = library_->ModAccFetchPUSCHConstellationTraceSplit(instrument, selector_string, timeout, nullptr, nullptr, 0, &data_constellation_actual_array_size, nullptr, nullptr, 0, &dmrs_constellation_actual_array_size);
        if (!status_ok(status)) {
          return ConvertApiErrorStatusForNiRFmxInstrHandle(context, status, instrument);
        }
        response->mutable_data_constellation_i()->Resize(data_constellation_actual_array_size, 0);
        ...
        auto data_constellation_array_size = data_constellation_actual_array_size;
        auto dmrs_constellation_array_size = dmrs_constellation_actual_array_size;
        status = library_->ModAccFetchPUSCHConstellationTraceSplit(instrument, selector_string, timeout, data_constellation_i, data_constellation_q, data_constellation_array_size, &data_constellation_actual_array_size, dmrs_constellation_i, dmrs_constellation_q, dmrs_constellation_array_size, &dmrs_constellation_actual_array_size);
        if (status == kErrorReadBufferTooSmall || status == kWarningCAPIStringTruncatedToFitBuffer) {
          // buffer is now too small, try again
          continue;
        }
  ...
  //---------------------------------------------------------------------
  //---------------------------------------------------------------------
  ::grpc::Status NiRFmxLTEService::ModAccFetchSRSConstellationInterleavedIQ(::grpc::ServerContext* context, const ModAccFetchSRSConstellationInterleavedIQRequest* request, ModAccFetchSRSConstellationInterleavedIQResponse* response)
  {
    if (context->IsCancelled()) {
      return ::grpc::Status::CANCELLED;
    }
    try {
      ...
      int32 actual_array_size {};
      while (true) {
        auto status = library_->ModAccFetchSRSConstellationInterleavedIQ(instrument, selector_string, timeout, nullptr, 0, &actual_array_size);
        if (!status_ok(status)) {
          return ConvertApiErrorStatusForNiRFmxInstrHandle(context, status, instrument);
        }
        response->mutable_srs_constellation()->Resize(actual_array_size * 2, 0);
        float32* srs_constellation = response->mutable_srs_constellation()->mutable_data();
        auto array_size = actual_array_size;
        status = library_->ModAccFetchSRSConstellationInterleavedIQ(instrument, selector_string, timeout, srs_constellation, array_size, &actual_array_size);
        if (status == kErrorReadBufferTooSmall || status == kWarningCAPIStringTruncatedToFitBuffer) {
          // buffer is now too small, try again
          continue;
        }
  ...
  //---------------------------------------------------------------------
  //---------------------------------------------------------------------
  ::grpc::Status NiRFmxLTEService::ModAccFetchSRSConstellationSplit(::grpc::ServerContext* context, const ModAccFetchSRSConstellationSplitRequest* request, ModAccFetchSRSConstellationSplitResponse* response)
  {
    if (context->IsCancelled()) {
      return ::grpc::Status::CANCELLED;
    }
    try {
      ...
      int32 actual_array_size {};
      while (true) {
        auto status = library_->ModAccFetchSRSConstellationSplit(instrument, selector_string, timeout, nullptr, nullptr, 0, &actual_array_size);
        if (!status_ok(status)) {
          return ConvertApiErrorStatusForNiRFmxInstrHandle(context, status, instrument);
        }
        response->mutable_srs_constellation_i()->Resize(actual_array_size, 0);
        float32* srs_constellation_i = response->mutable_srs_constellation_i()->mutable_data();
        response->mutable_srs_constellation_q()->Resize(actual_array_size, 0);
        float32* srs_constellation_q = response->mutable_srs_constellation_q()->mutable_data();
        auto array_size = actual_array_size;
        status = library_->ModAccFetchSRSConstellationSplit(instrument, selector_string, timeout, srs_constellation_i, srs_constellation_q, array_size, &actual_array_size);
        if (status == kErrorReadBufferTooSmall || status == kWarningCAPIStringTruncatedToFitBuffer) {
          // buffer is now too small, try again
          continue;
        }
  ...
  //---------------------------------------------------------------------
  //---------------------------------------------------------------------
  ::grpc::Status NiRFmxLTEService::ModAccFetchSynchronizationSignalConstellationInterleavedIQ(::grpc::ServerContext* context, const ModAccFetchSynchronizationSignalConstellationInterleavedIQRequest* request, ModAccFetchSynchronizationSignalConstellationInterleavedIQResponse* response)
  {
    if (context->IsCancelled()) {
      return ::grpc::Status::CANCELLED;
    }
    try {
      ...
      int32 actual_array_size {};
      while (true) {
        auto status = library_->ModAccFetchSynchronizationSignalConstellationInterleavedIQ(instrument, selector_string, timeout, nullptr, nullptr, 0, &actual_array_size);
        if (!status_ok(status)) {
          return ConvertApiErrorStatusForNiRFmxInstrHandle(context, status, instrument);
        }
        ...
        auto array_size = actual_array_size;
        status = library_->ModAccFetchSynchronizationSignalConstellationInterleavedIQ(instrument, selector_string, timeout, sss_constellation, pss_constellation, array_size, &actual_array_size);
        if (status == kErrorReadBufferTooSmall || status == kWarningCAPIStringTruncatedToFitBuffer) {
          // buffer is now too small, try again
          continue;
        }
  ...
  //---------------------------------------------------------------------
  //---------------------------------------------------------------------
  ::grpc::Status NiRFmxLTEService::ModAccFetchSynchronizationSignalConstellationSplit(::grpc::ServerContext* context, const ModAccFetchSynchronizationSignalConstellationSplitRequest* request, ModAccFetchSynchronizationSignalConstellationSplitResponse* response)
  {
    if (context->IsCancelled()) {
      return ::grpc::Status::CANCELLED;
    }
    try {
      ...
      int32 actual_array_size {};
      while (true) {
        auto status = library_->ModAccFetchSynchronizationSignalConstellationSplit(instrument, selector_string, timeout, nullptr, nullptr, nullptr, nullptr, 0, &actual_array_size);
        if (!status_ok(status)) {
          return ConvertApiErrorStatusForNiRFmxInstrHandle(context, status, instrument);
        }
        ...
        auto array_size = actual_array_size;
        status = library_->ModAccFetchSynchronizationSignalConstellationSplit(instrument, selector_string, timeout, sss_constellation_i, sss_constellation_q, pss_constellation_i, pss_constellation_q, array_size, &actual_array_size);
        if (status == kErrorReadBufferTooSmall || status == kWarningCAPIStringTruncatedToFitBuffer) {
          // buffer is now too small, try again
          continue;
        }
  ...
  ::grpc::Status NiRFmxLTEService::SEMCfgComponentCarrierMaximumOutputPowerArray(::grpc::ServerContext* context, const SEMCfgComponentCarrierMaximumOutputPowerArrayRequest* request, SEMCfgComponentCarrierMaximumOutputPowerArrayResponse* response)
  {
    ...
    try {
      ...
      auto number_of_elements_raw = request->component_carrier_maximum_output_power().size();
      int32 number_of_elements = nidevice_grpc::converters::convert_size<int32>(number_of_elements_raw, "number_of_elements");
  ...
  ::grpc::Status NiRFmxLTEService::SEMCfgOffsetBandwidthIntegralArray(::grpc::ServerContext* context, const SEMCfgOffsetBandwidthIntegralArrayRequest* request, SEMCfgOffsetBandwidthIntegralArrayResponse* response)
  {
    ...
    try {
      ...
      auto number_of_elements_raw = request->offset_bandwidth_integral().size();
      int32 number_of_elements = nidevice_grpc::converters::convert_size<int32>(number_of_elements_raw, "number_of_elements");
  ...
  //---------------------------------------------------------------------
  //---------------------------------------------------------------------
  ::grpc::Status NiRFmxLTEService::TXPCfgAveraging(::grpc::ServerContext* context, const TXPCfgAveragingRequest* request, TXPCfgAveragingResponse* response)
  {
    if (context->IsCancelled()) {
      return ::grpc::Status::CANCELLED;
    }
    try {
      ...
      int32 averaging_enabled;
      switch (request->averaging_enabled_enum_case()) {
        case nirfmxlte_grpc::TXPCfgAveragingRequest::AveragingEnabledEnumCase::kAveragingEnabled: {
          averaging_enabled = static_cast<int32>(request->averaging_enabled());
          break;
        }
        case nirfmxlte_grpc::TXPCfgAveragingRequest::AveragingEnabledEnumCase::kAveragingEnabledRaw: {
          averaging_enabled = static_cast<int32>(request->averaging_enabled_raw());
          break;
        }
        case nirfmxlte_grpc::TXPCfgAveragingRequest::AveragingEnabledEnumCase::AVERAGING_ENABLED_ENUM_NOT_SET: {
          return ::grpc::Status(::grpc::INVALID_ARGUMENT, "The value for averaging_enabled was not specified or out of range");
          break;
        }
      }
  ...
  //---------------------------------------------------------------------
  //---------------------------------------------------------------------
  ::grpc::Status NiRFmxLTEService::TXPCfgMeasurementOffsetAndInterval(::grpc::ServerContext* context, const TXPCfgMeasurementOffsetAndIntervalRequest* request, TXPCfgMeasurementOffsetAndIntervalResponse* response)
  {
    if (context->IsCancelled()) {
      return ::grpc::Status::CANCELLED;
    }
    try {
      ...
      float64 measurement_interval = request->measurement_interval();
      auto status = library_->TXPCfgMeasurementOffsetAndInterval(instrument, selector_string, measurement_offset, measurement_interval);
      if (!status_ok(status)) {
        return ConvertApiErrorStatusForNiRFmxInstrHandle(context, status, instrument);
      }
      response->set_status(status);
  ...
  //---------------------------------------------------------------------
  //---------------------------------------------------------------------
  ::grpc::Status NiRFmxLTEService::TXPFetchMeasurement(::grpc::ServerContext* context, const TXPFetchMeasurementRequest* request, TXPFetchMeasurementResponse* response)
  {
    if (context->IsCancelled()) {
      return ::grpc::Status::CANCELLED;
    }
  ...
  //---------------------------------------------------------------------
  //---------------------------------------------------------------------
  ::grpc::Status NiRFmxLTEService::TXPFetchPowerTrace(::grpc::ServerContext* context, const TXPFetchPowerTraceRequest* request, TXPFetchPowerTraceResponse* response)
  {
    if (context->IsCancelled()) {
      return ::grpc::Status::CANCELLED;
    }
