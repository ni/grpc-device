...
NiRFmxDemodLibrary::NiRFmxDemodLibrary(std::shared_ptr<nidevice_grpc::SharedLibraryInterface> pSharedLibrary) : p_shared_library_(pSharedLibrary)
{
  ...
  function_pointers_.ADemodCfgAMCarrierSuppressed = reinterpret_cast<ADemodCfgAMCarrierSuppressedPtr>(p_shared_library_->get_function_pointer("RFmxDemod_ADemodCfgAMCarrierSuppressed"));
  function_pointers_.ADemodCfgAudioFilter = reinterpret_cast<ADemodCfgAudioFilterPtr>(p_shared_library_->get_function_pointer("RFmxDemod_ADemodCfgAudioFilter"));
  function_pointers_.ADemodCfgAveraging = reinterpret_cast<ADemodCfgAveragingPtr>(p_shared_library_->get_function_pointer("RFmxDemod_ADemodCfgAveraging"));
  function_pointers_.ADemodCfgCarrierCorrection = reinterpret_cast<ADemodCfgCarrierCorrectionPtr>(p_shared_library_->get_function_pointer("RFmxDemod_ADemodCfgCarrierCorrection"));
  function_pointers_.ADemodCfgFMDeEmphasis = reinterpret_cast<ADemodCfgFMDeEmphasisPtr>(p_shared_library_->get_function_pointer("RFmxDemod_ADemodCfgFMDeEmphasis"));
  function_pointers_.ADemodCfgMeasurementInterval = reinterpret_cast<ADemodCfgMeasurementIntervalPtr>(p_shared_library_->get_function_pointer("RFmxDemod_ADemodCfgMeasurementInterval"));
  function_pointers_.ADemodCfgModulationType = reinterpret_cast<ADemodCfgModulationTypePtr>(p_shared_library_->get_function_pointer("RFmxDemod_ADemodCfgModulationType"));
  function_pointers_.ADemodCfgRBWFilter = reinterpret_cast<ADemodCfgRBWFilterPtr>(p_shared_library_->get_function_pointer("RFmxDemod_ADemodCfgRBWFilter"));
  function_pointers_.ADemodFetchAMMaximumModulationDepth = reinterpret_cast<ADemodFetchAMMaximumModulationDepthPtr>(p_shared_library_->get_function_pointer("RFmxDemod_ADemodFetchAMMaximumModulationDepth"));
  function_pointers_.ADemodFetchAMMeanModulationDepth = reinterpret_cast<ADemodFetchAMMeanModulationDepthPtr>(p_shared_library_->get_function_pointer("RFmxDemod_ADemodFetchAMMeanModulationDepth"));
  function_pointers_.ADemodFetchCarrierMeasurement = reinterpret_cast<ADemodFetchCarrierMeasurementPtr>(p_shared_library_->get_function_pointer("RFmxDemod_ADemodFetchCarrierMeasurement"));
  function_pointers_.ADemodFetchDemodSignalTrace = reinterpret_cast<ADemodFetchDemodSignalTracePtr>(p_shared_library_->get_function_pointer("RFmxDemod_ADemodFetchDemodSignalTrace"));
  function_pointers_.ADemodFetchDemodSpectrumTrace = reinterpret_cast<ADemodFetchDemodSpectrumTracePtr>(p_shared_library_->get_function_pointer("RFmxDemod_ADemodFetchDemodSpectrumTrace"));
  function_pointers_.ADemodFetchDistortions = reinterpret_cast<ADemodFetchDistortionsPtr>(p_shared_library_->get_function_pointer("RFmxDemod_ADemodFetchDistortions"));
  function_pointers_.ADemodFetchFMMaximumDeviation = reinterpret_cast<ADemodFetchFMMaximumDeviationPtr>(p_shared_library_->get_function_pointer("RFmxDemod_ADemodFetchFMMaximumDeviation"));
  function_pointers_.ADemodFetchFMMeanDeviation = reinterpret_cast<ADemodFetchFMMeanDeviationPtr>(p_shared_library_->get_function_pointer("RFmxDemod_ADemodFetchFMMeanDeviation"));
  function_pointers_.ADemodFetchMeanModulationFrequency = reinterpret_cast<ADemodFetchMeanModulationFrequencyPtr>(p_shared_library_->get_function_pointer("RFmxDemod_ADemodFetchMeanModulationFrequency"));
  function_pointers_.ADemodFetchPMMaximumDeviation = reinterpret_cast<ADemodFetchPMMaximumDeviationPtr>(p_shared_library_->get_function_pointer("RFmxDemod_ADemodFetchPMMaximumDeviation"));
  function_pointers_.ADemodFetchPMMeanDeviation = reinterpret_cast<ADemodFetchPMMeanDeviationPtr>(p_shared_library_->get_function_pointer("RFmxDemod_ADemodFetchPMMeanDeviation"));
  function_pointers_.ADemodReadAM = reinterpret_cast<ADemodReadAMPtr>(p_shared_library_->get_function_pointer("RFmxDemod_ADemodReadAM"));
  function_pointers_.ADemodReadFM = reinterpret_cast<ADemodReadFMPtr>(p_shared_library_->get_function_pointer("RFmxDemod_ADemodReadFM"));
  function_pointers_.ADemodReadPM = reinterpret_cast<ADemodReadPMPtr>(p_shared_library_->get_function_pointer("RFmxDemod_ADemodReadPM"));
  function_pointers_.AbortMeasurements = reinterpret_cast<AbortMeasurementsPtr>(p_shared_library_->get_function_pointer("RFmxDemod_AbortMeasurements"));
  function_pointers_.AnalyzeIQ1Waveform = reinterpret_cast<AnalyzeIQ1WaveformPtr>(p_shared_library_->get_function_pointer("RFmxDemod_AnalyzeIQ1Waveform"));
  function_pointers_.AutoLevel = reinterpret_cast<AutoLevelPtr>(p_shared_library_->get_function_pointer("RFmxDemod_AutoLevel"));
  function_pointers_.BuildSignalString = reinterpret_cast<BuildSignalStringPtr>(p_shared_library_->get_function_pointer("RFmxDemod_BuildSignalString"));
  function_pointers_.CfgDigitalEdgeTrigger = reinterpret_cast<CfgDigitalEdgeTriggerPtr>(p_shared_library_->get_function_pointer("RFmxDemod_CfgDigitalEdgeTrigger"));
  function_pointers_.CfgExternalAttenuation = reinterpret_cast<CfgExternalAttenuationPtr>(p_shared_library_->get_function_pointer("RFmxDemod_CfgExternalAttenuation"));
  function_pointers_.CfgFrequency = reinterpret_cast<CfgFrequencyPtr>(p_shared_library_->get_function_pointer("RFmxDemod_CfgFrequency"));
  function_pointers_.CfgFrequencyReference = reinterpret_cast<CfgFrequencyReferencePtr>(p_shared_library_->get_function_pointer("RFmxDemod_CfgFrequencyReference"));
  function_pointers_.CfgIQPowerEdgeTrigger = reinterpret_cast<CfgIQPowerEdgeTriggerPtr>(p_shared_library_->get_function_pointer("RFmxDemod_CfgIQPowerEdgeTrigger"));
  function_pointers_.CfgMechanicalAttenuation = reinterpret_cast<CfgMechanicalAttenuationPtr>(p_shared_library_->get_function_pointer("RFmxDemod_CfgMechanicalAttenuation"));
  function_pointers_.CfgRF = reinterpret_cast<CfgRFPtr>(p_shared_library_->get_function_pointer("RFmxDemod_CfgRF"));
  function_pointers_.CfgRFAttenuation = reinterpret_cast<CfgRFAttenuationPtr>(p_shared_library_->get_function_pointer("RFmxDemod_CfgRFAttenuation"));
  function_pointers_.CfgReferenceLevel = reinterpret_cast<CfgReferenceLevelPtr>(p_shared_library_->get_function_pointer("RFmxDemod_CfgReferenceLevel"));
  function_pointers_.CfgSoftwareEdgeTrigger = reinterpret_cast<CfgSoftwareEdgeTriggerPtr>(p_shared_library_->get_function_pointer("RFmxDemod_CfgSoftwareEdgeTrigger"));
  function_pointers_.CheckMeasurementStatus = reinterpret_cast<CheckMeasurementStatusPtr>(p_shared_library_->get_function_pointer("RFmxDemod_CheckMeasurementStatus"));
  function_pointers_.ClearAllNamedResults = reinterpret_cast<ClearAllNamedResultsPtr>(p_shared_library_->get_function_pointer("RFmxDemod_ClearAllNamedResults"));
  function_pointers_.ClearNamedResult = reinterpret_cast<ClearNamedResultPtr>(p_shared_library_->get_function_pointer("RFmxDemod_ClearNamedResult"));
  function_pointers_.CloneSignalConfiguration = reinterpret_cast<CloneSignalConfigurationPtr>(p_shared_library_->get_function_pointer("RFmxDemod_CloneSignalConfiguration"));
  function_pointers_.Close = reinterpret_cast<ClosePtr>(p_shared_library_->get_function_pointer("RFmxDemod_Close"));
  function_pointers_.Commit = reinterpret_cast<CommitPtr>(p_shared_library_->get_function_pointer("RFmxDemod_Commit"));
  function_pointers_.CreateSignalConfiguration = reinterpret_cast<CreateSignalConfigurationPtr>(p_shared_library_->get_function_pointer("RFmxDemod_CreateSignalConfiguration"));
  function_pointers_.DDemodCfgAveraging = reinterpret_cast<DDemodCfgAveragingPtr>(p_shared_library_->get_function_pointer("RFmxDemod_DDemodCfgAveraging"));
  function_pointers_.DDemodCfgEVMNormalizationReference = reinterpret_cast<DDemodCfgEVMNormalizationReferencePtr>(p_shared_library_->get_function_pointer("RFmxDemod_DDemodCfgEVMNormalizationReference"));
  function_pointers_.DDemodCfgEqualizer = reinterpret_cast<DDemodCfgEqualizerPtr>(p_shared_library_->get_function_pointer("RFmxDemod_DDemodCfgEqualizer"));
  function_pointers_.DDemodCfgEqualizerInitialCoefficients = reinterpret_cast<DDemodCfgEqualizerInitialCoefficientsPtr>(p_shared_library_->get_function_pointer("RFmxDemod_DDemodCfgEqualizerInitialCoefficients"));
  function_pointers_.DDemodCfgFSKDeviation = reinterpret_cast<DDemodCfgFSKDeviationPtr>(p_shared_library_->get_function_pointer("RFmxDemod_DDemodCfgFSKDeviation"));
  function_pointers_.DDemodCfgM = reinterpret_cast<DDemodCfgMPtr>(p_shared_library_->get_function_pointer("RFmxDemod_DDemodCfgM"));
  function_pointers_.DDemodCfgMeasurementFilter = reinterpret_cast<DDemodCfgMeasurementFilterPtr>(p_shared_library_->get_function_pointer("RFmxDemod_DDemodCfgMeasurementFilter"));
  function_pointers_.DDemodCfgMeasurementFilterCustomCoefficients = reinterpret_cast<DDemodCfgMeasurementFilterCustomCoefficientsPtr>(p_shared_library_->get_function_pointer("RFmxDemod_DDemodCfgMeasurementFilterCustomCoefficients"));
  function_pointers_.DDemodCfgModulationType = reinterpret_cast<DDemodCfgModulationTypePtr>(p_shared_library_->get_function_pointer("RFmxDemod_DDemodCfgModulationType"));
  function_pointers_.DDemodCfgNumberOfSymbols = reinterpret_cast<DDemodCfgNumberOfSymbolsPtr>(p_shared_library_->get_function_pointer("RFmxDemod_DDemodCfgNumberOfSymbols"));
  function_pointers_.DDemodCfgPSKFormat = reinterpret_cast<DDemodCfgPSKFormatPtr>(p_shared_library_->get_function_pointer("RFmxDemod_DDemodCfgPSKFormat"));
  function_pointers_.DDemodCfgPulseShapingFilter = reinterpret_cast<DDemodCfgPulseShapingFilterPtr>(p_shared_library_->get_function_pointer("RFmxDemod_DDemodCfgPulseShapingFilter"));
  function_pointers_.DDemodCfgPulseShapingFilterCustomCoefficients = reinterpret_cast<DDemodCfgPulseShapingFilterCustomCoefficientsPtr>(p_shared_library_->get_function_pointer("RFmxDemod_DDemodCfgPulseShapingFilterCustomCoefficients"));
  function_pointers_.DDemodCfgSamplesPerSymbol = reinterpret_cast<DDemodCfgSamplesPerSymbolPtr>(p_shared_library_->get_function_pointer("RFmxDemod_DDemodCfgSamplesPerSymbol"));
  function_pointers_.DDemodCfgSignalStructure = reinterpret_cast<DDemodCfgSignalStructurePtr>(p_shared_library_->get_function_pointer("RFmxDemod_DDemodCfgSignalStructure"));
  function_pointers_.DDemodCfgSpectrumInverted = reinterpret_cast<DDemodCfgSpectrumInvertedPtr>(p_shared_library_->get_function_pointer("RFmxDemod_DDemodCfgSpectrumInverted"));
  function_pointers_.DDemodCfgSymbolMap = reinterpret_cast<DDemodCfgSymbolMapPtr>(p_shared_library_->get_function_pointer("RFmxDemod_DDemodCfgSymbolMap"));
  function_pointers_.DDemodCfgSymbolRate = reinterpret_cast<DDemodCfgSymbolRatePtr>(p_shared_library_->get_function_pointer("RFmxDemod_DDemodCfgSymbolRate"));
  function_pointers_.DDemodCfgSynchronization = reinterpret_cast<DDemodCfgSynchronizationPtr>(p_shared_library_->get_function_pointer("RFmxDemod_DDemodCfgSynchronization"));
  function_pointers_.DDemodFetchCarrierMeasurement = reinterpret_cast<DDemodFetchCarrierMeasurementPtr>(p_shared_library_->get_function_pointer("RFmxDemod_DDemodFetchCarrierMeasurement"));
  function_pointers_.DDemodFetchConstellationTrace = reinterpret_cast<DDemodFetchConstellationTracePtr>(p_shared_library_->get_function_pointer("RFmxDemod_DDemodFetchConstellationTrace"));
  function_pointers_.DDemodFetchDemodulatedBits = reinterpret_cast<DDemodFetchDemodulatedBitsPtr>(p_shared_library_->get_function_pointer("RFmxDemod_DDemodFetchDemodulatedBits"));
  function_pointers_.DDemodFetchEVM = reinterpret_cast<DDemodFetchEVMPtr>(p_shared_library_->get_function_pointer("RFmxDemod_DDemodFetchEVM"));
  function_pointers_.DDemodFetchEVMTrace = reinterpret_cast<DDemodFetchEVMTracePtr>(p_shared_library_->get_function_pointer("RFmxDemod_DDemodFetchEVMTrace"));
  function_pointers_.DDemodFetchEqualizerCoefficients = reinterpret_cast<DDemodFetchEqualizerCoefficientsPtr>(p_shared_library_->get_function_pointer("RFmxDemod_DDemodFetchEqualizerCoefficients"));
  function_pointers_.DDemodFetchFSKDeviationTrace = reinterpret_cast<DDemodFetchFSKDeviationTracePtr>(p_shared_library_->get_function_pointer("RFmxDemod_DDemodFetchFSKDeviationTrace"));
  function_pointers_.DDemodFetchFSKResults = reinterpret_cast<DDemodFetchFSKResultsPtr>(p_shared_library_->get_function_pointer("RFmxDemod_DDemodFetchFSKResults"));
  function_pointers_.DDemodFetchIQImpairments = reinterpret_cast<DDemodFetchIQImpairmentsPtr>(p_shared_library_->get_function_pointer("RFmxDemod_DDemodFetchIQImpairments"));
  function_pointers_.DDemodFetchMagnitudeError = reinterpret_cast<DDemodFetchMagnitudeErrorPtr>(p_shared_library_->get_function_pointer("RFmxDemod_DDemodFetchMagnitudeError"));
  function_pointers_.DDemodFetchMagnitudeErrorTrace = reinterpret_cast<DDemodFetchMagnitudeErrorTracePtr>(p_shared_library_->get_function_pointer("RFmxDemod_DDemodFetchMagnitudeErrorTrace"));
  function_pointers_.DDemodFetchMeanAmplitudeDroop = reinterpret_cast<DDemodFetchMeanAmplitudeDroopPtr>(p_shared_library_->get_function_pointer("RFmxDemod_DDemodFetchMeanAmplitudeDroop"));
  function_pointers_.DDemodFetchMeanIQOriginOffset = reinterpret_cast<DDemodFetchMeanIQOriginOffsetPtr>(p_shared_library_->get_function_pointer("RFmxDemod_DDemodFetchMeanIQOriginOffset"));
  function_pointers_.DDemodFetchMeanQuadratureSkew = reinterpret_cast<DDemodFetchMeanQuadratureSkewPtr>(p_shared_library_->get_function_pointer("RFmxDemod_DDemodFetchMeanQuadratureSkew"));
  function_pointers_.DDemodFetchMeanRhoFactor = reinterpret_cast<DDemodFetchMeanRhoFactorPtr>(p_shared_library_->get_function_pointer("RFmxDemod_DDemodFetchMeanRhoFactor"));
  function_pointers_.DDemodFetchMeasurementWaveform = reinterpret_cast<DDemodFetchMeasurementWaveformPtr>(p_shared_library_->get_function_pointer("RFmxDemod_DDemodFetchMeasurementWaveform"));
  function_pointers_.DDemodFetchOffsetConstellationTrace = reinterpret_cast<DDemodFetchOffsetConstellationTracePtr>(p_shared_library_->get_function_pointer("RFmxDemod_DDemodFetchOffsetConstellationTrace"));
  function_pointers_.DDemodFetchOffsetEVM = reinterpret_cast<DDemodFetchOffsetEVMPtr>(p_shared_library_->get_function_pointer("RFmxDemod_DDemodFetchOffsetEVM"));
  function_pointers_.DDemodFetchOffsetEVMTrace = reinterpret_cast<DDemodFetchOffsetEVMTracePtr>(p_shared_library_->get_function_pointer("RFmxDemod_DDemodFetchOffsetEVMTrace"));
  function_pointers_.DDemodFetchPhaseError = reinterpret_cast<DDemodFetchPhaseErrorPtr>(p_shared_library_->get_function_pointer("RFmxDemod_DDemodFetchPhaseError"));
  function_pointers_.DDemodFetchPhaseErrorTrace = reinterpret_cast<DDemodFetchPhaseErrorTracePtr>(p_shared_library_->get_function_pointer("RFmxDemod_DDemodFetchPhaseErrorTrace"));
  function_pointers_.DDemodFetchReferenceWaveform = reinterpret_cast<DDemodFetchReferenceWaveformPtr>(p_shared_library_->get_function_pointer("RFmxDemod_DDemodFetchReferenceWaveform"));
  function_pointers_.DDemodFetchSyncFound = reinterpret_cast<DDemodFetchSyncFoundPtr>(p_shared_library_->get_function_pointer("RFmxDemod_DDemodFetchSyncFound"));
  function_pointers_.DDemodGetEqualizerInitialCoefficients = reinterpret_cast<DDemodGetEqualizerInitialCoefficientsPtr>(p_shared_library_->get_function_pointer("RFmxDemod_DDemodGetEqualizerInitialCoefficients"));
  function_pointers_.DDemodGetSymbolMap = reinterpret_cast<DDemodGetSymbolMapPtr>(p_shared_library_->get_function_pointer("RFmxDemod_DDemodGetSymbolMap"));
  function_pointers_.DDemodRead = reinterpret_cast<DDemodReadPtr>(p_shared_library_->get_function_pointer("RFmxDemod_DDemodRead"));
  function_pointers_.DDemodSetSymbolMap = reinterpret_cast<DDemodSetSymbolMapPtr>(p_shared_library_->get_function_pointer("RFmxDemod_DDemodSetSymbolMap"));
  function_pointers_.DeleteSignalConfiguration = reinterpret_cast<DeleteSignalConfigurationPtr>(p_shared_library_->get_function_pointer("RFmxDemod_DeleteSignalConfiguration"));
  function_pointers_.DisableTrigger = reinterpret_cast<DisableTriggerPtr>(p_shared_library_->get_function_pointer("RFmxDemod_DisableTrigger"));
  function_pointers_.GetAllNamedResultNames = reinterpret_cast<GetAllNamedResultNamesPtr>(p_shared_library_->get_function_pointer("RFmxDemod_GetAllNamedResultNames"));
  function_pointers_.GetAttributeF32 = reinterpret_cast<GetAttributeF32Ptr>(p_shared_library_->get_function_pointer("RFmxDemod_GetAttributeF32"));
  function_pointers_.GetAttributeF32Array = reinterpret_cast<GetAttributeF32ArrayPtr>(p_shared_library_->get_function_pointer("RFmxDemod_GetAttributeF32Array"));
  function_pointers_.GetAttributeF64 = reinterpret_cast<GetAttributeF64Ptr>(p_shared_library_->get_function_pointer("RFmxDemod_GetAttributeF64"));
  function_pointers_.GetAttributeF64Array = reinterpret_cast<GetAttributeF64ArrayPtr>(p_shared_library_->get_function_pointer("RFmxDemod_GetAttributeF64Array"));
  function_pointers_.GetAttributeI16 = reinterpret_cast<GetAttributeI16Ptr>(p_shared_library_->get_function_pointer("RFmxDemod_GetAttributeI16"));
  function_pointers_.GetAttributeI32 = reinterpret_cast<GetAttributeI32Ptr>(p_shared_library_->get_function_pointer("RFmxDemod_GetAttributeI32"));
  function_pointers_.GetAttributeI32Array = reinterpret_cast<GetAttributeI32ArrayPtr>(p_shared_library_->get_function_pointer("RFmxDemod_GetAttributeI32Array"));
  function_pointers_.GetAttributeI64 = reinterpret_cast<GetAttributeI64Ptr>(p_shared_library_->get_function_pointer("RFmxDemod_GetAttributeI64"));
  function_pointers_.GetAttributeI64Array = reinterpret_cast<GetAttributeI64ArrayPtr>(p_shared_library_->get_function_pointer("RFmxDemod_GetAttributeI64Array"));
  function_pointers_.GetAttributeI8 = reinterpret_cast<GetAttributeI8Ptr>(p_shared_library_->get_function_pointer("RFmxDemod_GetAttributeI8"));
  function_pointers_.GetAttributeI8Array = reinterpret_cast<GetAttributeI8ArrayPtr>(p_shared_library_->get_function_pointer("RFmxDemod_GetAttributeI8Array"));
  function_pointers_.GetAttributeNIComplexDouble = reinterpret_cast<GetAttributeNIComplexDoublePtr>(p_shared_library_->get_function_pointer("RFmxDemod_GetAttributeNIComplexDouble"));
  function_pointers_.GetAttributeNIComplexDoubleArray = reinterpret_cast<GetAttributeNIComplexDoubleArrayPtr>(p_shared_library_->get_function_pointer("RFmxDemod_GetAttributeNIComplexDoubleArray"));
  function_pointers_.GetAttributeNIComplexSingle = reinterpret_cast<GetAttributeNIComplexSinglePtr>(p_shared_library_->get_function_pointer("RFmxDemod_GetAttributeNIComplexSingle"));
  function_pointers_.GetAttributeNIComplexSingleArray = reinterpret_cast<GetAttributeNIComplexSingleArrayPtr>(p_shared_library_->get_function_pointer("RFmxDemod_GetAttributeNIComplexSingleArray"));
  function_pointers_.GetAttributeString = reinterpret_cast<GetAttributeStringPtr>(p_shared_library_->get_function_pointer("RFmxDemod_GetAttributeString"));
  function_pointers_.GetAttributeU16 = reinterpret_cast<GetAttributeU16Ptr>(p_shared_library_->get_function_pointer("RFmxDemod_GetAttributeU16"));
  function_pointers_.GetAttributeU32 = reinterpret_cast<GetAttributeU32Ptr>(p_shared_library_->get_function_pointer("RFmxDemod_GetAttributeU32"));
  function_pointers_.GetAttributeU32Array = reinterpret_cast<GetAttributeU32ArrayPtr>(p_shared_library_->get_function_pointer("RFmxDemod_GetAttributeU32Array"));
  function_pointers_.GetAttributeU64Array = reinterpret_cast<GetAttributeU64ArrayPtr>(p_shared_library_->get_function_pointer("RFmxDemod_GetAttributeU64Array"));
  function_pointers_.GetAttributeU8 = reinterpret_cast<GetAttributeU8Ptr>(p_shared_library_->get_function_pointer("RFmxDemod_GetAttributeU8"));
  function_pointers_.GetAttributeU8Array = reinterpret_cast<GetAttributeU8ArrayPtr>(p_shared_library_->get_function_pointer("RFmxDemod_GetAttributeU8Array"));
  function_pointers_.GetError = reinterpret_cast<GetErrorPtr>(p_shared_library_->get_function_pointer("RFmxDemod_GetError"));
  function_pointers_.GetErrorString = reinterpret_cast<GetErrorStringPtr>(p_shared_library_->get_function_pointer("RFmxDemod_GetErrorString"));
  function_pointers_.Initialize = reinterpret_cast<InitializePtr>(p_shared_library_->get_function_pointer("RFmxDemod_Initialize"));
  function_pointers_.InitializeFromNIRFSASession = reinterpret_cast<InitializeFromNIRFSASessionPtr>(p_shared_library_->get_function_pointer("RFmxDemod_InitializeFromNIRFSASession"));
  function_pointers_.Initiate = reinterpret_cast<InitiatePtr>(p_shared_library_->get_function_pointer("RFmxDemod_Initiate"));
  function_pointers_.ResetAttribute = reinterpret_cast<ResetAttributePtr>(p_shared_library_->get_function_pointer("RFmxDemod_ResetAttribute"));
  function_pointers_.ResetToDefault = reinterpret_cast<ResetToDefaultPtr>(p_shared_library_->get_function_pointer("RFmxDemod_ResetToDefault"));
  function_pointers_.SelectMeasurements = reinterpret_cast<SelectMeasurementsPtr>(p_shared_library_->get_function_pointer("RFmxDemod_SelectMeasurements"));
  function_pointers_.SendSoftwareEdgeTrigger = reinterpret_cast<SendSoftwareEdgeTriggerPtr>(p_shared_library_->get_function_pointer("RFmxDemod_SendSoftwareEdgeTrigger"));
  function_pointers_.SetAttributeF32 = reinterpret_cast<SetAttributeF32Ptr>(p_shared_library_->get_function_pointer("RFmxDemod_SetAttributeF32"));
  function_pointers_.SetAttributeF32Array = reinterpret_cast<SetAttributeF32ArrayPtr>(p_shared_library_->get_function_pointer("RFmxDemod_SetAttributeF32Array"));
  function_pointers_.SetAttributeF64 = reinterpret_cast<SetAttributeF64Ptr>(p_shared_library_->get_function_pointer("RFmxDemod_SetAttributeF64"));
  function_pointers_.SetAttributeF64Array = reinterpret_cast<SetAttributeF64ArrayPtr>(p_shared_library_->get_function_pointer("RFmxDemod_SetAttributeF64Array"));
  function_pointers_.SetAttributeI16 = reinterpret_cast<SetAttributeI16Ptr>(p_shared_library_->get_function_pointer("RFmxDemod_SetAttributeI16"));
  function_pointers_.SetAttributeI32 = reinterpret_cast<SetAttributeI32Ptr>(p_shared_library_->get_function_pointer("RFmxDemod_SetAttributeI32"));
  function_pointers_.SetAttributeI32Array = reinterpret_cast<SetAttributeI32ArrayPtr>(p_shared_library_->get_function_pointer("RFmxDemod_SetAttributeI32Array"));
  function_pointers_.SetAttributeI64 = reinterpret_cast<SetAttributeI64Ptr>(p_shared_library_->get_function_pointer("RFmxDemod_SetAttributeI64"));
  function_pointers_.SetAttributeI64Array = reinterpret_cast<SetAttributeI64ArrayPtr>(p_shared_library_->get_function_pointer("RFmxDemod_SetAttributeI64Array"));
  function_pointers_.SetAttributeI8 = reinterpret_cast<SetAttributeI8Ptr>(p_shared_library_->get_function_pointer("RFmxDemod_SetAttributeI8"));
  function_pointers_.SetAttributeI8Array = reinterpret_cast<SetAttributeI8ArrayPtr>(p_shared_library_->get_function_pointer("RFmxDemod_SetAttributeI8Array"));
  function_pointers_.SetAttributeNIComplexDouble = reinterpret_cast<SetAttributeNIComplexDoublePtr>(p_shared_library_->get_function_pointer("RFmxDemod_SetAttributeNIComplexDouble"));
  function_pointers_.SetAttributeNIComplexDoubleArray = reinterpret_cast<SetAttributeNIComplexDoubleArrayPtr>(p_shared_library_->get_function_pointer("RFmxDemod_SetAttributeNIComplexDoubleArray"));
  function_pointers_.SetAttributeNIComplexSingle = reinterpret_cast<SetAttributeNIComplexSinglePtr>(p_shared_library_->get_function_pointer("RFmxDemod_SetAttributeNIComplexSingle"));
  function_pointers_.SetAttributeNIComplexSingleArray = reinterpret_cast<SetAttributeNIComplexSingleArrayPtr>(p_shared_library_->get_function_pointer("RFmxDemod_SetAttributeNIComplexSingleArray"));
  function_pointers_.SetAttributeString = reinterpret_cast<SetAttributeStringPtr>(p_shared_library_->get_function_pointer("RFmxDemod_SetAttributeString"));
  function_pointers_.SetAttributeU16 = reinterpret_cast<SetAttributeU16Ptr>(p_shared_library_->get_function_pointer("RFmxDemod_SetAttributeU16"));
  function_pointers_.SetAttributeU32 = reinterpret_cast<SetAttributeU32Ptr>(p_shared_library_->get_function_pointer("RFmxDemod_SetAttributeU32"));
  function_pointers_.SetAttributeU32Array = reinterpret_cast<SetAttributeU32ArrayPtr>(p_shared_library_->get_function_pointer("RFmxDemod_SetAttributeU32Array"));
  function_pointers_.SetAttributeU64Array = reinterpret_cast<SetAttributeU64ArrayPtr>(p_shared_library_->get_function_pointer("RFmxDemod_SetAttributeU64Array"));
  function_pointers_.SetAttributeU8 = reinterpret_cast<SetAttributeU8Ptr>(p_shared_library_->get_function_pointer("RFmxDemod_SetAttributeU8"));
  function_pointers_.SetAttributeU8Array = reinterpret_cast<SetAttributeU8ArrayPtr>(p_shared_library_->get_function_pointer("RFmxDemod_SetAttributeU8Array"));
  function_pointers_.WaitForAcquisitionComplete = reinterpret_cast<WaitForAcquisitionCompletePtr>(p_shared_library_->get_function_pointer("RFmxDemod_WaitForAcquisitionComplete"));
  function_pointers_.WaitForMeasurementComplete = reinterpret_cast<WaitForMeasurementCompletePtr>(p_shared_library_->get_function_pointer("RFmxDemod_WaitForMeasurementComplete"));
}
