...
//---------------------------------------------------------------------
// Service header for the NI-rfmxofdm Metadata
//---------------------------------------------------------------------
#ifndef NIRFMXOFDM_GRPC_SERVICE_H
#define NIRFMXOFDM_GRPC_SERVICE_H
...
struct NiRFmxOFDMFeatureToggles
{
  using CodeReadiness = nidevice_grpc::FeatureToggles::CodeReadiness;
  NiRFmxOFDMFeatureToggles(const nidevice_grpc::FeatureToggles& feature_toggles = {});

  bool is_enabled;
};

class NiRFmxOFDMService final : public NiRFmxOFDM::Service {
public:
  using LibrarySharedPtr = std::shared_ptr<NiRFmxOFDMLibraryInterface>;
  ...
  ::grpc::Status BuildAllocationString(::grpc::ServerContext* context, const BuildAllocationStringRequest* request, BuildAllocationStringResponse* response) override;
  ...
  ::grpc::Status LoadResourceAllocationCustomIQValuesFromFile(::grpc::ServerContext* context, const LoadResourceAllocationCustomIQValuesFromFileRequest* request, LoadResourceAllocationCustomIQValuesFromFileResponse* response) override;
  ::grpc::Status ModAccFetchChannelFrequencyResponseMeanTrace(::grpc::ServerContext* context, const ModAccFetchChannelFrequencyResponseMeanTraceRequest* request, ModAccFetchChannelFrequencyResponseMeanTraceResponse* response) override;
  ::grpc::Status ModAccFetchDataConstellationTrace(::grpc::ServerContext* context, const ModAccFetchDataConstellationTraceRequest* request, ModAccFetchDataConstellationTraceResponse* response) override;
  ::grpc::Status ModAccFetchDataConstellationTraceInterleavedIQ(::grpc::ServerContext* context, const ModAccFetchDataConstellationTraceInterleavedIQRequest* request, ModAccFetchDataConstellationTraceInterleavedIQResponse* response) override;
  ::grpc::Status ModAccFetchDataConstellationTraceSplit(::grpc::ServerContext* context, const ModAccFetchDataConstellationTraceSplitRequest* request, ModAccFetchDataConstellationTraceSplitResponse* response) override;
  ::grpc::Status ModAccFetchDataRMSEVMPerSymbolMeanTrace(::grpc::ServerContext* context, const ModAccFetchDataRMSEVMPerSymbolMeanTraceRequest* request, ModAccFetchDataRMSEVMPerSymbolMeanTraceResponse* response) override;
  ::grpc::Status ModAccFetchEVMSubcarrierIndices(::grpc::ServerContext* context, const ModAccFetchEVMSubcarrierIndicesRequest* request, ModAccFetchEVMSubcarrierIndicesResponse* response) override;
  ::grpc::Status ModAccFetchPilotConstellationTrace(::grpc::ServerContext* context, const ModAccFetchPilotConstellationTraceRequest* request, ModAccFetchPilotConstellationTraceResponse* response) override;
  ::grpc::Status ModAccFetchPilotConstellationTraceInterleavedIQ(::grpc::ServerContext* context, const ModAccFetchPilotConstellationTraceInterleavedIQRequest* request, ModAccFetchPilotConstellationTraceInterleavedIQResponse* response) override;
  ::grpc::Status ModAccFetchPilotConstellationTraceSplit(::grpc::ServerContext* context, const ModAccFetchPilotConstellationTraceSplitRequest* request, ModAccFetchPilotConstellationTraceSplitResponse* response) override;
  ::grpc::Status ModAccFetchPilotRMSEVMPerSymbolMeanTrace(::grpc::ServerContext* context, const ModAccFetchPilotRMSEVMPerSymbolMeanTraceRequest* request, ModAccFetchPilotRMSEVMPerSymbolMeanTraceResponse* response) override;
...
private:
  ...
  std::map<std::int32_t, std::string> nirfmxofdmstringattributevaluesmapped_input_map_ { {1, "PFI0"},{2, "PFI1"},{3, "PXI_Trig0"},{4, "PXI_Trig1"},{5, "PXI_Trig2"},{6, "PXI_Trig3"},{7, "PXI_Trig4"},{8, "PXI_Trig5"},{9, "PXI_Trig6"},{10, "PXI_Trig7"},{11, "PXI_STAR"},{12, "PXIe_DStarB"},{13, "TimerEvent"},{14, "PulseIn"},{15, "DIO/PFI0"},{16, "DIO/PFI1"},{17, "DIO/PFI2"},{18, "DIO/PFI3"},{19, "DIO/PFI4"},{20, "DIO/PFI5"},{21, "DIO/PFI6"},{22, "DIO/PFI7"}, };
  std::map<std::string, std::int32_t> nirfmxofdmstringattributevaluesmapped_output_map_ { {"PFI0", 1},{"PFI1", 2},{"PXI_Trig0", 3},{"PXI_Trig1", 4},{"PXI_Trig2", 5},{"PXI_Trig3", 6},{"PXI_Trig4", 7},{"PXI_Trig5", 8},{"PXI_Trig6", 9},{"PXI_Trig7", 10},{"PXI_STAR", 11},{"PXIe_DStarB", 12},{"TimerEvent", 13},{"PulseIn", 14},{"DIO/PFI0", 15},{"DIO/PFI1", 16},{"DIO/PFI2", 17},{"DIO/PFI3", 18},{"DIO/PFI4", 19},{"DIO/PFI5", 20},{"DIO/PFI6", 21},{"DIO/PFI7", 22}, };

  NiRFmxOFDMFeatureToggles feature_toggles_;
};

} // namespace nirfmxofdm_grpc

#endif  // NIRFMXOFDM_GRPC_SERVICE_H
