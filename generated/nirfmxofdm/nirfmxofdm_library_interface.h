...
//---------------------------------------------------------------------
// Library wrapper for implementing interactions with NI-rfmxofdm
//---------------------------------------------------------------------
#ifndef NIRFMXOFDM_GRPC_LIBRARY_WRAPPER_H
#define NIRFMXOFDM_GRPC_LIBRARY_WRAPPER_H

#include <grpcpp/grpcpp.h>
#include <niRFmxOFDM.h>

namespace nirfmxofdm_grpc {

class NiRFmxOFDMLibraryInterface {
 public:
  virtual ~NiRFmxOFDMLibraryInterface() {}
  ...
  virtual int32 BuildAllocationString(char selectorString[], int32 allocationNumber, int32 selectorStringOutLength, char selectorStringOut[]) = 0;
  ...
  virtual int32 LoadResourceAllocationCustomIQValuesFromFile(niRFmxInstrHandle instrumentHandle, char selectorString[], char filePath[]) = 0;
  virtual int32 ModAccFetchChannelFrequencyResponseMeanTrace(niRFmxInstrHandle instrumentHandle, char selectorString[], float64 timeout, float64* x0, float64* dx, float32 channelFrequencyResponseMeanMagnitude[], float32 channelFrequencyResponseMeanPhase[], int32 arraySize, int32* actualArraySize) = 0;
  virtual int32 ModAccFetchDataConstellationTrace(niRFmxInstrHandle instrumentHandle, char selectorString[], float64 timeout, NIComplexSingle dataConstellation[], int32 arraySize, int32* actualArraySize) = 0;
  virtual int32 ModAccFetchDataConstellationTraceInterleavedIQ(niRFmxInstrHandle instrumentHandle, char selectorString[], float64 timeout, float32 dataConstellation[], int32 arraySize, int32* actualArraySize) = 0;
  virtual int32 ModAccFetchDataConstellationTraceSplit(niRFmxInstrHandle instrumentHandle, char selectorString[], float64 timeout, float32 dataConstellationI[], float32 dataConstellationQ[], int32 arraySize, int32* actualArraySize) = 0;
  virtual int32 ModAccFetchDataRMSEVMPerSymbolMeanTrace(niRFmxInstrHandle instrumentHandle, char selectorString[], float64 timeout, float64* x0, float64* dx, float32 dataRMSEVMPerSymbolMean[], int32 arraySize, int32* actualArraySize) = 0;
  virtual int32 ModAccFetchEVMSubcarrierIndices(niRFmxInstrHandle instrumentHandle, char selectorString[], float64 timeout, int32 subcarrierIndices[], int32 arraySize, int32* actualArraySize) = 0;
  virtual int32 ModAccFetchPilotConstellationTrace(niRFmxInstrHandle instrumentHandle, char selectorString[], float64 timeout, NIComplexSingle pilotConstellation[], int32 arraySize, int32* actualArraySize) = 0;
  virtual int32 ModAccFetchPilotConstellationTraceInterleavedIQ(niRFmxInstrHandle instrumentHandle, char selectorString[], float64 timeout, float32 pilotConstellation[], int32 arraySize, int32* actualArraySize) = 0;
  virtual int32 ModAccFetchPilotConstellationTraceSplit(niRFmxInstrHandle instrumentHandle, char selectorString[], float64 timeout, float32 pilotConstellationI[], float32 pilotConstellationQ[], int32 arraySize, int32* actualArraySize) = 0;
  virtual int32 ModAccFetchPilotRMSEVMPerSymbolMeanTrace(niRFmxInstrHandle instrumentHandle, char selectorString[], float64 timeout, float64* x0, float64* dx, float32 pilotRMSEVMPerSymbolMean[], int32 arraySize, int32* actualArraySize) = 0;
...
#endif  // NIRFMXOFDM_GRPC_LIBRARY_WRAPPER_H
