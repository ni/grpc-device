...
CheckAttributeViReal64Response check_attribute_vi_real64(const StubPtr& stub, const nidevice_grpc::Session& vi, const pb::string& channel_name, const NiRFSGAttributes& attribute, const simple_variant<NiRFSGReal64AttributeValues, double>& value);
...
ConfigureDigitalEdgeConfigurationListStepTriggerResponse configure_digital_edge_configuration_list_step_trigger(const StubPtr& stub, const nidevice_grpc::Session& vi, const simple_variant<DigitalEdgeConfigurationListStepTriggerSource, std::string>& source, const simple_variant<DigitalEdgeEdgeRangeTable, pb::int32>& edge);
ConfigureDigitalEdgeScriptTriggerResponse configure_digital_edge_script_trigger(const StubPtr& stub, const nidevice_grpc::Session& vi, const simple_variant<DigitalEdgeScriptTriggerIdentifier, std::string>& trigger_id, const simple_variant<TriggerSourceRangeTable, std::string>& source, const simple_variant<DigitalEdgeEdgeRangeTable, pb::int32>& edge);
ConfigureDigitalEdgeStartTriggerResponse configure_digital_edge_start_trigger(const StubPtr& stub, const nidevice_grpc::Session& vi, const simple_variant<TriggerSourceRangeTable, std::string>& source, const simple_variant<DigitalEdgeEdgeRangeTable, pb::int32>& edge);
ConfigureDigitalLevelScriptTriggerResponse configure_digital_level_script_trigger(const StubPtr& stub, const nidevice_grpc::Session& vi, const simple_variant<DigitalEdgeScriptTriggerIdentifier, std::string>& trigger_id, const simple_variant<TriggerSourceRangeTable, std::string>& source, const simple_variant<DigitalLevelActiveLevelRangeTable, pb::int32>& level);
...
ConfigureGenerationModeResponse configure_generation_mode(const StubPtr& stub, const nidevice_grpc::Session& vi, const simple_variant<GenerationModeRangeTable, pb::int32>& generation_mode);
...
ConfigurePXIChassisClk10Response configure_pxi_chassis_clk10(const StubPtr& stub, const nidevice_grpc::Session& vi, const simple_variant<PXIChassisClk10RangeTable, std::string>& pxi_clk10_source);
ConfigurePowerLevelTypeResponse configure_power_level_type(const StubPtr& stub, const nidevice_grpc::Session& vi, const simple_variant<PowerLevelTypeRangeTable, pb::int32>& power_level_type);
...
ConfigureRefClockResponse configure_ref_clock(const StubPtr& stub, const nidevice_grpc::Session& vi, const simple_variant<RefClockSourceRangeTable, std::string>& ref_clock_source, const double& ref_clock_rate);
...
SetAttributeViReal64Response set_attribute_vi_real64(const StubPtr& stub, const nidevice_grpc::Session& vi, const pb::string& channel_name, const NiRFSGAttributes& attribute, const simple_variant<NiRFSGReal64AttributeValues, double>& value);
