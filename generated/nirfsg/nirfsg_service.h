...
private:
  ...
  std::map<std::int32_t, std::string> starttriggersource_input_map_ { {1, "PFI0"},{2, "PFI1"},{3, "PFI2"},{4, "PFI3"},{5, "PXI_Trig0"},{6, "PXI_Trig1"},{7, "PXI_Trig2"},{8, "PXI_Trig3"},{9, "PXI_Trig4"},{10, "PXI_Trig5"},{11, "PXI_Trig6"},{12, "PXI_Trig7"},{13, "PXI_STAR"},{14, "PXIe_DStarB"},{15, "Sync_Start"},{16, "Sync_Script"},{17, "TrigIn"},{18, "DIO/PFI0"},{19, "DIO/PFI1"},{20, "DIO/PFI2"},{21, "DIO/PFI3"},{22, "DIO/PFI4"},{23, "DIO/PFI5"},{24, "DIO/PFI6"},{25, "DIO/PFI7"}, };
  std::map<std::string, std::int32_t> starttriggersource_output_map_ { {"PFI0", 1},{"PFI1", 2},{"PFI2", 3},{"PFI3", 4},{"PXI_Trig0", 5},{"PXI_Trig1", 6},{"PXI_Trig2", 7},{"PXI_Trig3", 8},{"PXI_Trig4", 9},{"PXI_Trig5", 10},{"PXI_Trig6", 11},{"PXI_Trig7", 12},{"PXI_STAR", 13},{"PXIe_DStarB", 14},{"Sync_Start", 15},{"Sync_Script", 16},{"TrigIn", 17},{"DIO/PFI0", 18},{"DIO/PFI1", 19},{"DIO/PFI2", 20},{"DIO/PFI3", 21},{"DIO/PFI4", 22},{"DIO/PFI5", 23},{"DIO/PFI6", 24},{"DIO/PFI7", 25}, };
