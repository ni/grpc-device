...
NiRFmxBluetoothLibrary::NiRFmxBluetoothLibrary(std::shared_ptr<nidevice_grpc::SharedLibraryInterface> pSharedLibrary) : p_shared_library_(pSharedLibrary)
{
  ...
  function_pointers_.ACPCfgAveraging = reinterpret_cast<ACPCfgAveragingPtr>(p_shared_library_->get_function_pointer("RFmxBT_ACPCfgAveraging"));
  function_pointers_.ACPCfgBurstSynchronizationType = reinterpret_cast<ACPCfgBurstSynchronizationTypePtr>(p_shared_library_->get_function_pointer("RFmxBT_ACPCfgBurstSynchronizationType"));
  function_pointers_.ACPCfgNumberOfOffsets = reinterpret_cast<ACPCfgNumberOfOffsetsPtr>(p_shared_library_->get_function_pointer("RFmxBT_ACPCfgNumberOfOffsets"));
  function_pointers_.ACPCfgOffsetChannelMode = reinterpret_cast<ACPCfgOffsetChannelModePtr>(p_shared_library_->get_function_pointer("RFmxBT_ACPCfgOffsetChannelMode"));
  function_pointers_.ACPFetchAbsolutePowerTrace = reinterpret_cast<ACPFetchAbsolutePowerTracePtr>(p_shared_library_->get_function_pointer("RFmxBT_ACPFetchAbsolutePowerTrace"));
  function_pointers_.ACPFetchMaskTrace = reinterpret_cast<ACPFetchMaskTracePtr>(p_shared_library_->get_function_pointer("RFmxBT_ACPFetchMaskTrace"));
  function_pointers_.ACPFetchMeasurementStatus = reinterpret_cast<ACPFetchMeasurementStatusPtr>(p_shared_library_->get_function_pointer("RFmxBT_ACPFetchMeasurementStatus"));
  function_pointers_.ACPFetchOffsetMeasurement = reinterpret_cast<ACPFetchOffsetMeasurementPtr>(p_shared_library_->get_function_pointer("RFmxBT_ACPFetchOffsetMeasurement"));
  function_pointers_.ACPFetchOffsetMeasurementArray = reinterpret_cast<ACPFetchOffsetMeasurementArrayPtr>(p_shared_library_->get_function_pointer("RFmxBT_ACPFetchOffsetMeasurementArray"));
  function_pointers_.ACPFetchReferenceChannelPower = reinterpret_cast<ACPFetchReferenceChannelPowerPtr>(p_shared_library_->get_function_pointer("RFmxBT_ACPFetchReferenceChannelPower"));
  function_pointers_.ACPFetchSpectrum = reinterpret_cast<ACPFetchSpectrumPtr>(p_shared_library_->get_function_pointer("RFmxBT_ACPFetchSpectrum"));
  function_pointers_.AbortMeasurements = reinterpret_cast<AbortMeasurementsPtr>(p_shared_library_->get_function_pointer("RFmxBT_AbortMeasurements"));
  function_pointers_.AnalyzeIQ1Waveform = reinterpret_cast<AnalyzeIQ1WaveformPtr>(p_shared_library_->get_function_pointer("RFmxBT_AnalyzeIQ1Waveform"));
  function_pointers_.AutoDetectSignal = reinterpret_cast<AutoDetectSignalPtr>(p_shared_library_->get_function_pointer("RFmxBT_AutoDetectSignal"));
  function_pointers_.AutoLevel = reinterpret_cast<AutoLevelPtr>(p_shared_library_->get_function_pointer("RFmxBT_AutoLevel"));
  function_pointers_.BuildOffsetString = reinterpret_cast<BuildOffsetStringPtr>(p_shared_library_->get_function_pointer("RFmxBT_BuildOffsetString"));
  function_pointers_.BuildSignalString = reinterpret_cast<BuildSignalStringPtr>(p_shared_library_->get_function_pointer("RFmxBT_BuildSignalString"));
  function_pointers_.BuildSlotString = reinterpret_cast<BuildSlotStringPtr>(p_shared_library_->get_function_pointer("RFmxBT_BuildSlotString"));
  function_pointers_.CfgChannelNumber = reinterpret_cast<CfgChannelNumberPtr>(p_shared_library_->get_function_pointer("RFmxBT_CfgChannelNumber"));
  function_pointers_.CfgDataRate = reinterpret_cast<CfgDataRatePtr>(p_shared_library_->get_function_pointer("RFmxBT_CfgDataRate"));
  function_pointers_.CfgDigitalEdgeTrigger = reinterpret_cast<CfgDigitalEdgeTriggerPtr>(p_shared_library_->get_function_pointer("RFmxBT_CfgDigitalEdgeTrigger"));
  function_pointers_.CfgExternalAttenuation = reinterpret_cast<CfgExternalAttenuationPtr>(p_shared_library_->get_function_pointer("RFmxBT_CfgExternalAttenuation"));
  function_pointers_.CfgFrequency = reinterpret_cast<CfgFrequencyPtr>(p_shared_library_->get_function_pointer("RFmxBT_CfgFrequency"));
  function_pointers_.CfgFrequencyChannelNumber = reinterpret_cast<CfgFrequencyChannelNumberPtr>(p_shared_library_->get_function_pointer("RFmxBT_CfgFrequencyChannelNumber"));
  function_pointers_.CfgFrequencyReference = reinterpret_cast<CfgFrequencyReferencePtr>(p_shared_library_->get_function_pointer("RFmxBT_CfgFrequencyReference"));
  function_pointers_.CfgIQPowerEdgeTrigger = reinterpret_cast<CfgIQPowerEdgeTriggerPtr>(p_shared_library_->get_function_pointer("RFmxBT_CfgIQPowerEdgeTrigger"));
  function_pointers_.CfgLEDirectionFinding = reinterpret_cast<CfgLEDirectionFindingPtr>(p_shared_library_->get_function_pointer("RFmxBT_CfgLEDirectionFinding"));
  function_pointers_.CfgMechanicalAttenuation = reinterpret_cast<CfgMechanicalAttenuationPtr>(p_shared_library_->get_function_pointer("RFmxBT_CfgMechanicalAttenuation"));
  function_pointers_.CfgPacketType = reinterpret_cast<CfgPacketTypePtr>(p_shared_library_->get_function_pointer("RFmxBT_CfgPacketType"));
  function_pointers_.CfgPayloadBitPattern = reinterpret_cast<CfgPayloadBitPatternPtr>(p_shared_library_->get_function_pointer("RFmxBT_CfgPayloadBitPattern"));
  function_pointers_.CfgPayloadLength = reinterpret_cast<CfgPayloadLengthPtr>(p_shared_library_->get_function_pointer("RFmxBT_CfgPayloadLength"));
  function_pointers_.CfgRF = reinterpret_cast<CfgRFPtr>(p_shared_library_->get_function_pointer("RFmxBT_CfgRF"));
  function_pointers_.CfgRFAttenuation = reinterpret_cast<CfgRFAttenuationPtr>(p_shared_library_->get_function_pointer("RFmxBT_CfgRFAttenuation"));
  function_pointers_.CfgReferenceLevel = reinterpret_cast<CfgReferenceLevelPtr>(p_shared_library_->get_function_pointer("RFmxBT_CfgReferenceLevel"));
  function_pointers_.CfgSoftwareEdgeTrigger = reinterpret_cast<CfgSoftwareEdgeTriggerPtr>(p_shared_library_->get_function_pointer("RFmxBT_CfgSoftwareEdgeTrigger"));
  function_pointers_.CheckMeasurementStatus = reinterpret_cast<CheckMeasurementStatusPtr>(p_shared_library_->get_function_pointer("RFmxBT_CheckMeasurementStatus"));
  function_pointers_.ClearAllNamedResults = reinterpret_cast<ClearAllNamedResultsPtr>(p_shared_library_->get_function_pointer("RFmxBT_ClearAllNamedResults"));
  function_pointers_.ClearNamedResult = reinterpret_cast<ClearNamedResultPtr>(p_shared_library_->get_function_pointer("RFmxBT_ClearNamedResult"));
  function_pointers_.CloneSignalConfiguration = reinterpret_cast<CloneSignalConfigurationPtr>(p_shared_library_->get_function_pointer("RFmxBT_CloneSignalConfiguration"));
  function_pointers_.Close = reinterpret_cast<ClosePtr>(p_shared_library_->get_function_pointer("RFmxBT_Close"));
  function_pointers_.Commit = reinterpret_cast<CommitPtr>(p_shared_library_->get_function_pointer("RFmxBT_Commit"));
  function_pointers_.CreateSignalConfiguration = reinterpret_cast<CreateSignalConfigurationPtr>(p_shared_library_->get_function_pointer("RFmxBT_CreateSignalConfiguration"));
  function_pointers_.DeleteSignalConfiguration = reinterpret_cast<DeleteSignalConfigurationPtr>(p_shared_library_->get_function_pointer("RFmxBT_DeleteSignalConfiguration"));
  function_pointers_.DisableTrigger = reinterpret_cast<DisableTriggerPtr>(p_shared_library_->get_function_pointer("RFmxBT_DisableTrigger"));
  function_pointers_.FrequencyRangeCfgAveraging = reinterpret_cast<FrequencyRangeCfgAveragingPtr>(p_shared_library_->get_function_pointer("RFmxBT_FrequencyRangeCfgAveraging"));
  function_pointers_.FrequencyRangeCfgSpan = reinterpret_cast<FrequencyRangeCfgSpanPtr>(p_shared_library_->get_function_pointer("RFmxBT_FrequencyRangeCfgSpan"));
  function_pointers_.FrequencyRangeFetchMeasurement = reinterpret_cast<FrequencyRangeFetchMeasurementPtr>(p_shared_library_->get_function_pointer("RFmxBT_FrequencyRangeFetchMeasurement"));
  function_pointers_.FrequencyRangeFetchSpectrum = reinterpret_cast<FrequencyRangeFetchSpectrumPtr>(p_shared_library_->get_function_pointer("RFmxBT_FrequencyRangeFetchSpectrum"));
  function_pointers_.GetAllNamedResultNames = reinterpret_cast<GetAllNamedResultNamesPtr>(p_shared_library_->get_function_pointer("RFmxBT_GetAllNamedResultNames"));
  function_pointers_.GetAttributeF32 = reinterpret_cast<GetAttributeF32Ptr>(p_shared_library_->get_function_pointer("RFmxBT_GetAttributeF32"));
  function_pointers_.GetAttributeF32Array = reinterpret_cast<GetAttributeF32ArrayPtr>(p_shared_library_->get_function_pointer("RFmxBT_GetAttributeF32Array"));
  function_pointers_.GetAttributeF64 = reinterpret_cast<GetAttributeF64Ptr>(p_shared_library_->get_function_pointer("RFmxBT_GetAttributeF64"));
  function_pointers_.GetAttributeF64Array = reinterpret_cast<GetAttributeF64ArrayPtr>(p_shared_library_->get_function_pointer("RFmxBT_GetAttributeF64Array"));
  function_pointers_.GetAttributeI16 = reinterpret_cast<GetAttributeI16Ptr>(p_shared_library_->get_function_pointer("RFmxBT_GetAttributeI16"));
  function_pointers_.GetAttributeI32 = reinterpret_cast<GetAttributeI32Ptr>(p_shared_library_->get_function_pointer("RFmxBT_GetAttributeI32"));
  function_pointers_.GetAttributeI32Array = reinterpret_cast<GetAttributeI32ArrayPtr>(p_shared_library_->get_function_pointer("RFmxBT_GetAttributeI32Array"));
  function_pointers_.GetAttributeI64 = reinterpret_cast<GetAttributeI64Ptr>(p_shared_library_->get_function_pointer("RFmxBT_GetAttributeI64"));
  function_pointers_.GetAttributeI64Array = reinterpret_cast<GetAttributeI64ArrayPtr>(p_shared_library_->get_function_pointer("RFmxBT_GetAttributeI64Array"));
  function_pointers_.GetAttributeI8 = reinterpret_cast<GetAttributeI8Ptr>(p_shared_library_->get_function_pointer("RFmxBT_GetAttributeI8"));
  function_pointers_.GetAttributeI8Array = reinterpret_cast<GetAttributeI8ArrayPtr>(p_shared_library_->get_function_pointer("RFmxBT_GetAttributeI8Array"));
  function_pointers_.GetAttributeNIComplexDoubleArray = reinterpret_cast<GetAttributeNIComplexDoubleArrayPtr>(p_shared_library_->get_function_pointer("RFmxBT_GetAttributeNIComplexDoubleArray"));
  function_pointers_.GetAttributeNIComplexSingleArray = reinterpret_cast<GetAttributeNIComplexSingleArrayPtr>(p_shared_library_->get_function_pointer("RFmxBT_GetAttributeNIComplexSingleArray"));
  function_pointers_.GetAttributeString = reinterpret_cast<GetAttributeStringPtr>(p_shared_library_->get_function_pointer("RFmxBT_GetAttributeString"));
  function_pointers_.GetAttributeU16 = reinterpret_cast<GetAttributeU16Ptr>(p_shared_library_->get_function_pointer("RFmxBT_GetAttributeU16"));
  function_pointers_.GetAttributeU32 = reinterpret_cast<GetAttributeU32Ptr>(p_shared_library_->get_function_pointer("RFmxBT_GetAttributeU32"));
  function_pointers_.GetAttributeU32Array = reinterpret_cast<GetAttributeU32ArrayPtr>(p_shared_library_->get_function_pointer("RFmxBT_GetAttributeU32Array"));
  function_pointers_.GetAttributeU64Array = reinterpret_cast<GetAttributeU64ArrayPtr>(p_shared_library_->get_function_pointer("RFmxBT_GetAttributeU64Array"));
  function_pointers_.GetAttributeU8 = reinterpret_cast<GetAttributeU8Ptr>(p_shared_library_->get_function_pointer("RFmxBT_GetAttributeU8"));
  function_pointers_.GetAttributeU8Array = reinterpret_cast<GetAttributeU8ArrayPtr>(p_shared_library_->get_function_pointer("RFmxBT_GetAttributeU8Array"));
  function_pointers_.GetError = reinterpret_cast<GetErrorPtr>(p_shared_library_->get_function_pointer("RFmxBT_GetError"));
  function_pointers_.GetErrorString = reinterpret_cast<GetErrorStringPtr>(p_shared_library_->get_function_pointer("RFmxBT_GetErrorString"));
  function_pointers_.Initialize = reinterpret_cast<InitializePtr>(p_shared_library_->get_function_pointer("RFmxBT_Initialize"));
  function_pointers_.InitializeFromNIRFSASession = reinterpret_cast<InitializeFromNIRFSASessionPtr>(p_shared_library_->get_function_pointer("RFmxBT_InitializeFromNIRFSASession"));
  function_pointers_.Initiate = reinterpret_cast<InitiatePtr>(p_shared_library_->get_function_pointer("RFmxBT_Initiate"));
  function_pointers_.ModAccCfgAveraging = reinterpret_cast<ModAccCfgAveragingPtr>(p_shared_library_->get_function_pointer("RFmxBT_ModAccCfgAveraging"));
  function_pointers_.ModAccCfgBurstSynchronizationType = reinterpret_cast<ModAccCfgBurstSynchronizationTypePtr>(p_shared_library_->get_function_pointer("RFmxBT_ModAccCfgBurstSynchronizationType"));
  function_pointers_.ModAccFetchConstellationTrace = reinterpret_cast<ModAccFetchConstellationTracePtr>(p_shared_library_->get_function_pointer("RFmxBT_ModAccFetchConstellationTrace"));
  function_pointers_.ModAccFetchDEVM = reinterpret_cast<ModAccFetchDEVMPtr>(p_shared_library_->get_function_pointer("RFmxBT_ModAccFetchDEVM"));
  function_pointers_.ModAccFetchDEVMMagnitudeError = reinterpret_cast<ModAccFetchDEVMMagnitudeErrorPtr>(p_shared_library_->get_function_pointer("RFmxBT_ModAccFetchDEVMMagnitudeError"));
  function_pointers_.ModAccFetchDEVMPerSymbolTrace = reinterpret_cast<ModAccFetchDEVMPerSymbolTracePtr>(p_shared_library_->get_function_pointer("RFmxBT_ModAccFetchDEVMPerSymbolTrace"));
  function_pointers_.ModAccFetchDEVMPhaseError = reinterpret_cast<ModAccFetchDEVMPhaseErrorPtr>(p_shared_library_->get_function_pointer("RFmxBT_ModAccFetchDEVMPhaseError"));
  function_pointers_.ModAccFetchDemodulatedBitTrace = reinterpret_cast<ModAccFetchDemodulatedBitTracePtr>(p_shared_library_->get_function_pointer("RFmxBT_ModAccFetchDemodulatedBitTrace"));
  function_pointers_.ModAccFetchDf1 = reinterpret_cast<ModAccFetchDf1Ptr>(p_shared_library_->get_function_pointer("RFmxBT_ModAccFetchDf1"));
  function_pointers_.ModAccFetchDf1maxTrace = reinterpret_cast<ModAccFetchDf1maxTracePtr>(p_shared_library_->get_function_pointer("RFmxBT_ModAccFetchDf1maxTrace"));
  function_pointers_.ModAccFetchDf2 = reinterpret_cast<ModAccFetchDf2Ptr>(p_shared_library_->get_function_pointer("RFmxBT_ModAccFetchDf2"));
  function_pointers_.ModAccFetchDf2maxTrace = reinterpret_cast<ModAccFetchDf2maxTracePtr>(p_shared_library_->get_function_pointer("RFmxBT_ModAccFetchDf2maxTrace"));
  function_pointers_.ModAccFetchFrequencyErrorBR = reinterpret_cast<ModAccFetchFrequencyErrorBRPtr>(p_shared_library_->get_function_pointer("RFmxBT_ModAccFetchFrequencyErrorBR"));
  function_pointers_.ModAccFetchFrequencyErrorEDR = reinterpret_cast<ModAccFetchFrequencyErrorEDRPtr>(p_shared_library_->get_function_pointer("RFmxBT_ModAccFetchFrequencyErrorEDR"));
  function_pointers_.ModAccFetchFrequencyErrorLE = reinterpret_cast<ModAccFetchFrequencyErrorLEPtr>(p_shared_library_->get_function_pointer("RFmxBT_ModAccFetchFrequencyErrorLE"));
  function_pointers_.ModAccFetchFrequencyErrorTraceBR = reinterpret_cast<ModAccFetchFrequencyErrorTraceBRPtr>(p_shared_library_->get_function_pointer("RFmxBT_ModAccFetchFrequencyErrorTraceBR"));
  function_pointers_.ModAccFetchFrequencyErrorTraceLE = reinterpret_cast<ModAccFetchFrequencyErrorTraceLEPtr>(p_shared_library_->get_function_pointer("RFmxBT_ModAccFetchFrequencyErrorTraceLE"));
  function_pointers_.ModAccFetchFrequencyErrorWiPlusW0TraceEDR = reinterpret_cast<ModAccFetchFrequencyErrorWiPlusW0TraceEDRPtr>(p_shared_library_->get_function_pointer("RFmxBT_ModAccFetchFrequencyErrorWiPlusW0TraceEDR"));
  function_pointers_.ModAccFetchFrequencyTrace = reinterpret_cast<ModAccFetchFrequencyTracePtr>(p_shared_library_->get_function_pointer("RFmxBT_ModAccFetchFrequencyTrace"));
  function_pointers_.ModAccFetchRMSDEVMTrace = reinterpret_cast<ModAccFetchRMSDEVMTracePtr>(p_shared_library_->get_function_pointer("RFmxBT_ModAccFetchRMSDEVMTrace"));
  function_pointers_.ResetAttribute = reinterpret_cast<ResetAttributePtr>(p_shared_library_->get_function_pointer("RFmxBT_ResetAttribute"));
  function_pointers_.ResetToDefault = reinterpret_cast<ResetToDefaultPtr>(p_shared_library_->get_function_pointer("RFmxBT_ResetToDefault"));
  function_pointers_.SelectMeasurements = reinterpret_cast<SelectMeasurementsPtr>(p_shared_library_->get_function_pointer("RFmxBT_SelectMeasurements"));
  function_pointers_.SendSoftwareEdgeTrigger = reinterpret_cast<SendSoftwareEdgeTriggerPtr>(p_shared_library_->get_function_pointer("RFmxBT_SendSoftwareEdgeTrigger"));
  function_pointers_.SetAttributeF32 = reinterpret_cast<SetAttributeF32Ptr>(p_shared_library_->get_function_pointer("RFmxBT_SetAttributeF32"));
  function_pointers_.SetAttributeF32Array = reinterpret_cast<SetAttributeF32ArrayPtr>(p_shared_library_->get_function_pointer("RFmxBT_SetAttributeF32Array"));
  function_pointers_.SetAttributeF64 = reinterpret_cast<SetAttributeF64Ptr>(p_shared_library_->get_function_pointer("RFmxBT_SetAttributeF64"));
  function_pointers_.SetAttributeF64Array = reinterpret_cast<SetAttributeF64ArrayPtr>(p_shared_library_->get_function_pointer("RFmxBT_SetAttributeF64Array"));
  function_pointers_.SetAttributeI16 = reinterpret_cast<SetAttributeI16Ptr>(p_shared_library_->get_function_pointer("RFmxBT_SetAttributeI16"));
  function_pointers_.SetAttributeI32 = reinterpret_cast<SetAttributeI32Ptr>(p_shared_library_->get_function_pointer("RFmxBT_SetAttributeI32"));
  function_pointers_.SetAttributeI32Array = reinterpret_cast<SetAttributeI32ArrayPtr>(p_shared_library_->get_function_pointer("RFmxBT_SetAttributeI32Array"));
  function_pointers_.SetAttributeI64 = reinterpret_cast<SetAttributeI64Ptr>(p_shared_library_->get_function_pointer("RFmxBT_SetAttributeI64"));
  function_pointers_.SetAttributeI64Array = reinterpret_cast<SetAttributeI64ArrayPtr>(p_shared_library_->get_function_pointer("RFmxBT_SetAttributeI64Array"));
  function_pointers_.SetAttributeI8 = reinterpret_cast<SetAttributeI8Ptr>(p_shared_library_->get_function_pointer("RFmxBT_SetAttributeI8"));
  function_pointers_.SetAttributeI8Array = reinterpret_cast<SetAttributeI8ArrayPtr>(p_shared_library_->get_function_pointer("RFmxBT_SetAttributeI8Array"));
  function_pointers_.SetAttributeNIComplexDoubleArray = reinterpret_cast<SetAttributeNIComplexDoubleArrayPtr>(p_shared_library_->get_function_pointer("RFmxBT_SetAttributeNIComplexDoubleArray"));
  function_pointers_.SetAttributeNIComplexSingleArray = reinterpret_cast<SetAttributeNIComplexSingleArrayPtr>(p_shared_library_->get_function_pointer("RFmxBT_SetAttributeNIComplexSingleArray"));
  function_pointers_.SetAttributeString = reinterpret_cast<SetAttributeStringPtr>(p_shared_library_->get_function_pointer("RFmxBT_SetAttributeString"));
  function_pointers_.SetAttributeU16 = reinterpret_cast<SetAttributeU16Ptr>(p_shared_library_->get_function_pointer("RFmxBT_SetAttributeU16"));
  function_pointers_.SetAttributeU32 = reinterpret_cast<SetAttributeU32Ptr>(p_shared_library_->get_function_pointer("RFmxBT_SetAttributeU32"));
  function_pointers_.SetAttributeU32Array = reinterpret_cast<SetAttributeU32ArrayPtr>(p_shared_library_->get_function_pointer("RFmxBT_SetAttributeU32Array"));
  function_pointers_.SetAttributeU64Array = reinterpret_cast<SetAttributeU64ArrayPtr>(p_shared_library_->get_function_pointer("RFmxBT_SetAttributeU64Array"));
  function_pointers_.SetAttributeU8 = reinterpret_cast<SetAttributeU8Ptr>(p_shared_library_->get_function_pointer("RFmxBT_SetAttributeU8"));
  function_pointers_.SetAttributeU8Array = reinterpret_cast<SetAttributeU8ArrayPtr>(p_shared_library_->get_function_pointer("RFmxBT_SetAttributeU8Array"));
  function_pointers_.TXPCfgAveraging = reinterpret_cast<TXPCfgAveragingPtr>(p_shared_library_->get_function_pointer("RFmxBT_TXPCfgAveraging"));
  function_pointers_.TXPCfgBurstSynchronizationType = reinterpret_cast<TXPCfgBurstSynchronizationTypePtr>(p_shared_library_->get_function_pointer("RFmxBT_TXPCfgBurstSynchronizationType"));
  function_pointers_.TXPFetchEDRPowers = reinterpret_cast<TXPFetchEDRPowersPtr>(p_shared_library_->get_function_pointer("RFmxBT_TXPFetchEDRPowers"));
  function_pointers_.TXPFetchLECTEReferencePeriodPowers = reinterpret_cast<TXPFetchLECTEReferencePeriodPowersPtr>(p_shared_library_->get_function_pointer("RFmxBT_TXPFetchLECTEReferencePeriodPowers"));
  function_pointers_.TXPFetchLECTETransmitSlotPowers = reinterpret_cast<TXPFetchLECTETransmitSlotPowersPtr>(p_shared_library_->get_function_pointer("RFmxBT_TXPFetchLECTETransmitSlotPowers"));
  function_pointers_.TXPFetchLECTETransmitSlotPowersArray = reinterpret_cast<TXPFetchLECTETransmitSlotPowersArrayPtr>(p_shared_library_->get_function_pointer("RFmxBT_TXPFetchLECTETransmitSlotPowersArray"));
  function_pointers_.TXPFetchPowerTrace = reinterpret_cast<TXPFetchPowerTracePtr>(p_shared_library_->get_function_pointer("RFmxBT_TXPFetchPowerTrace"));
  function_pointers_.TXPFetchPowers = reinterpret_cast<TXPFetchPowersPtr>(p_shared_library_->get_function_pointer("RFmxBT_TXPFetchPowers"));
  function_pointers_.TwentydBBandwidthCfgAveraging = reinterpret_cast<TwentydBBandwidthCfgAveragingPtr>(p_shared_library_->get_function_pointer("RFmxBT_20dBBandwidthCfgAveraging"));
  function_pointers_.TwentydBBandwidthFetchMeasurement = reinterpret_cast<TwentydBBandwidthFetchMeasurementPtr>(p_shared_library_->get_function_pointer("RFmxBT_20dBBandwidthFetchMeasurement"));
  function_pointers_.TwentydBBandwidthFetchSpectrum = reinterpret_cast<TwentydBBandwidthFetchSpectrumPtr>(p_shared_library_->get_function_pointer("RFmxBT_20dBBandwidthFetchSpectrum"));
  function_pointers_.WaitForAcquisitionComplete = reinterpret_cast<WaitForAcquisitionCompletePtr>(p_shared_library_->get_function_pointer("RFmxBT_WaitForAcquisitionComplete"));
  function_pointers_.WaitForMeasurementComplete = reinterpret_cast<WaitForMeasurementCompletePtr>(p_shared_library_->get_function_pointer("RFmxBT_WaitForMeasurementComplete"));
}
