    ...
    try {
      ...
      if (status_ok(status)) {
        auto checked_convert_attr_val = [](auto raw_value) {
          bool raw_value_is_valid = nirfmxbluetooth_grpc::NiRFmxBTInt32AttributeValues_IsValid(raw_value);
          auto valid_enum_value = raw_value_is_valid ? raw_value : 0;
          return static_cast<nirfmxbluetooth_grpc::NiRFmxBTInt32AttributeValues>(valid_enum_value);
        };
