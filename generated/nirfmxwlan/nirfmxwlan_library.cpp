...
NiRFmxWLANLibrary::NiRFmxWLANLibrary(std::shared_ptr<nidevice_grpc::SharedLibraryInterface> pSharedLibrary) : p_shared_library_(pSharedLibrary)
{
  ...
  function_pointers_.AbortMeasurements = reinterpret_cast<AbortMeasurementsPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_AbortMeasurements"));
  function_pointers_.AnalyzeIQ1Waveform = reinterpret_cast<AnalyzeIQ1WaveformPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_AnalyzeIQ1Waveform"));
  function_pointers_.AnalyzeNWaveformsIQ = reinterpret_cast<AnalyzeNWaveformsIQPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_AnalyzeNWaveformsIQ"));
  function_pointers_.AnalyzeNWaveformsSpectrum = reinterpret_cast<AnalyzeNWaveformsSpectrumPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_AnalyzeNWaveformsSpectrum"));
  function_pointers_.AnalyzeSpectrum1Waveform = reinterpret_cast<AnalyzeSpectrum1WaveformPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_AnalyzeSpectrum1Waveform"));
  function_pointers_.AutoDetectSignal = reinterpret_cast<AutoDetectSignalPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_AutoDetectSignal"));
  function_pointers_.AutoDetectSignalAnalysisOnly = reinterpret_cast<AutoDetectSignalAnalysisOnlyPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_AutoDetectSignalAnalysisOnly"));
  function_pointers_.AutoLevel = reinterpret_cast<AutoLevelPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_AutoLevel"));
  function_pointers_.BuildChainString = reinterpret_cast<BuildChainStringPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_BuildChainString"));
  function_pointers_.BuildGateString = reinterpret_cast<BuildGateStringPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_BuildGateString"));
  function_pointers_.BuildOffsetString = reinterpret_cast<BuildOffsetStringPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_BuildOffsetString"));
  function_pointers_.BuildSegmentString = reinterpret_cast<BuildSegmentStringPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_BuildSegmentString"));
  function_pointers_.BuildSignalString = reinterpret_cast<BuildSignalStringPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_BuildSignalString"));
  function_pointers_.BuildStreamString = reinterpret_cast<BuildStreamStringPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_BuildStreamString"));
  function_pointers_.BuildUserString = reinterpret_cast<BuildUserStringPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_BuildUserString"));
  function_pointers_.CfgChannelBandwidth = reinterpret_cast<CfgChannelBandwidthPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_CfgChannelBandwidth"));
  function_pointers_.CfgDigitalEdgeTrigger = reinterpret_cast<CfgDigitalEdgeTriggerPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_CfgDigitalEdgeTrigger"));
  function_pointers_.CfgExternalAttenuation = reinterpret_cast<CfgExternalAttenuationPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_CfgExternalAttenuation"));
  function_pointers_.CfgFrequency = reinterpret_cast<CfgFrequencyPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_CfgFrequency"));
  function_pointers_.CfgFrequencyArray = reinterpret_cast<CfgFrequencyArrayPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_CfgFrequencyArray"));
  function_pointers_.CfgFrequencyReference = reinterpret_cast<CfgFrequencyReferencePtr>(p_shared_library_->get_function_pointer("RFmxWLAN_CfgFrequencyReference"));
  function_pointers_.CfgIQPowerEdgeTrigger = reinterpret_cast<CfgIQPowerEdgeTriggerPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_CfgIQPowerEdgeTrigger"));
  function_pointers_.CfgMechanicalAttenuation = reinterpret_cast<CfgMechanicalAttenuationPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_CfgMechanicalAttenuation"));
  function_pointers_.CfgNumberOfFrequencySegmentsAndReceiveChains = reinterpret_cast<CfgNumberOfFrequencySegmentsAndReceiveChainsPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_CfgNumberOfFrequencySegmentsAndReceiveChains"));
  function_pointers_.CfgRFAttenuation = reinterpret_cast<CfgRFAttenuationPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_CfgRFAttenuation"));
  function_pointers_.CfgReferenceLevel = reinterpret_cast<CfgReferenceLevelPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_CfgReferenceLevel"));
  function_pointers_.CfgSelectedPortsMultiple = reinterpret_cast<CfgSelectedPortsMultiplePtr>(p_shared_library_->get_function_pointer("RFmxWLAN_CfgSelectedPortsMultiple"));
  function_pointers_.CfgSoftwareEdgeTrigger = reinterpret_cast<CfgSoftwareEdgeTriggerPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_CfgSoftwareEdgeTrigger"));
  function_pointers_.CfgStandard = reinterpret_cast<CfgStandardPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_CfgStandard"));
  function_pointers_.CheckMeasurementStatus = reinterpret_cast<CheckMeasurementStatusPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_CheckMeasurementStatus"));
  function_pointers_.ClearAllNamedResults = reinterpret_cast<ClearAllNamedResultsPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_ClearAllNamedResults"));
  function_pointers_.ClearNamedResult = reinterpret_cast<ClearNamedResultPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_ClearNamedResult"));
  function_pointers_.CloneSignalConfiguration = reinterpret_cast<CloneSignalConfigurationPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_CloneSignalConfiguration"));
  function_pointers_.Close = reinterpret_cast<ClosePtr>(p_shared_library_->get_function_pointer("RFmxWLAN_Close"));
  function_pointers_.Commit = reinterpret_cast<CommitPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_Commit"));
  function_pointers_.CreateSignalConfiguration = reinterpret_cast<CreateSignalConfigurationPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_CreateSignalConfiguration"));
  function_pointers_.DSSSModAccCfgAcquisitionLength = reinterpret_cast<DSSSModAccCfgAcquisitionLengthPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_DSSSModAccCfgAcquisitionLength"));
  function_pointers_.DSSSModAccCfgAveraging = reinterpret_cast<DSSSModAccCfgAveragingPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_DSSSModAccCfgAveraging"));
  function_pointers_.DSSSModAccCfgEVMUnit = reinterpret_cast<DSSSModAccCfgEVMUnitPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_DSSSModAccCfgEVMUnit"));
  function_pointers_.DSSSModAccCfgMeasurementLength = reinterpret_cast<DSSSModAccCfgMeasurementLengthPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_DSSSModAccCfgMeasurementLength"));
  function_pointers_.DSSSModAccCfgPowerMeasurementCustomGateArray = reinterpret_cast<DSSSModAccCfgPowerMeasurementCustomGateArrayPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_DSSSModAccCfgPowerMeasurementCustomGateArray"));
  function_pointers_.DSSSModAccCfgPowerMeasurementEnabled = reinterpret_cast<DSSSModAccCfgPowerMeasurementEnabledPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_DSSSModAccCfgPowerMeasurementEnabled"));
  function_pointers_.DSSSModAccCfgPowerMeasurementNumberOfCustomGates = reinterpret_cast<DSSSModAccCfgPowerMeasurementNumberOfCustomGatesPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_DSSSModAccCfgPowerMeasurementNumberOfCustomGates"));
  function_pointers_.DSSSModAccFetchAveragePowers = reinterpret_cast<DSSSModAccFetchAveragePowersPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_DSSSModAccFetchAveragePowers"));
  function_pointers_.DSSSModAccFetchConstellationTrace = reinterpret_cast<DSSSModAccFetchConstellationTracePtr>(p_shared_library_->get_function_pointer("RFmxWLAN_DSSSModAccFetchConstellationTrace"));
  function_pointers_.DSSSModAccFetchCustomGatePowersArray = reinterpret_cast<DSSSModAccFetchCustomGatePowersArrayPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_DSSSModAccFetchCustomGatePowersArray"));
  function_pointers_.DSSSModAccFetchDecodedHeaderBitsTrace = reinterpret_cast<DSSSModAccFetchDecodedHeaderBitsTracePtr>(p_shared_library_->get_function_pointer("RFmxWLAN_DSSSModAccFetchDecodedHeaderBitsTrace"));
  function_pointers_.DSSSModAccFetchDecodedPSDUBitsTrace = reinterpret_cast<DSSSModAccFetchDecodedPSDUBitsTracePtr>(p_shared_library_->get_function_pointer("RFmxWLAN_DSSSModAccFetchDecodedPSDUBitsTrace"));
  function_pointers_.DSSSModAccFetchEVM = reinterpret_cast<DSSSModAccFetchEVMPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_DSSSModAccFetchEVM"));
  function_pointers_.DSSSModAccFetchEVMPerChipMeanTrace = reinterpret_cast<DSSSModAccFetchEVMPerChipMeanTracePtr>(p_shared_library_->get_function_pointer("RFmxWLAN_DSSSModAccFetchEVMPerChipMeanTrace"));
  function_pointers_.DSSSModAccFetchIQImpairments = reinterpret_cast<DSSSModAccFetchIQImpairmentsPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_DSSSModAccFetchIQImpairments"));
  function_pointers_.DSSSModAccFetchPPDUInformation = reinterpret_cast<DSSSModAccFetchPPDUInformationPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_DSSSModAccFetchPPDUInformation"));
  function_pointers_.DSSSModAccFetchPeakPowers = reinterpret_cast<DSSSModAccFetchPeakPowersPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_DSSSModAccFetchPeakPowers"));
  function_pointers_.DeleteSignalConfiguration = reinterpret_cast<DeleteSignalConfigurationPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_DeleteSignalConfiguration"));
  function_pointers_.DisableTrigger = reinterpret_cast<DisableTriggerPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_DisableTrigger"));
  function_pointers_.GetAllNamedResultNames = reinterpret_cast<GetAllNamedResultNamesPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_GetAllNamedResultNames"));
  function_pointers_.GetAttributeF32 = reinterpret_cast<GetAttributeF32Ptr>(p_shared_library_->get_function_pointer("RFmxWLAN_GetAttributeF32"));
  function_pointers_.GetAttributeF32Array = reinterpret_cast<GetAttributeF32ArrayPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_GetAttributeF32Array"));
  function_pointers_.GetAttributeF64 = reinterpret_cast<GetAttributeF64Ptr>(p_shared_library_->get_function_pointer("RFmxWLAN_GetAttributeF64"));
  function_pointers_.GetAttributeF64Array = reinterpret_cast<GetAttributeF64ArrayPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_GetAttributeF64Array"));
  function_pointers_.GetAttributeI16 = reinterpret_cast<GetAttributeI16Ptr>(p_shared_library_->get_function_pointer("RFmxWLAN_GetAttributeI16"));
  function_pointers_.GetAttributeI32 = reinterpret_cast<GetAttributeI32Ptr>(p_shared_library_->get_function_pointer("RFmxWLAN_GetAttributeI32"));
  function_pointers_.GetAttributeI32Array = reinterpret_cast<GetAttributeI32ArrayPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_GetAttributeI32Array"));
  function_pointers_.GetAttributeI64 = reinterpret_cast<GetAttributeI64Ptr>(p_shared_library_->get_function_pointer("RFmxWLAN_GetAttributeI64"));
  function_pointers_.GetAttributeI64Array = reinterpret_cast<GetAttributeI64ArrayPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_GetAttributeI64Array"));
  function_pointers_.GetAttributeI8 = reinterpret_cast<GetAttributeI8Ptr>(p_shared_library_->get_function_pointer("RFmxWLAN_GetAttributeI8"));
  function_pointers_.GetAttributeI8Array = reinterpret_cast<GetAttributeI8ArrayPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_GetAttributeI8Array"));
  function_pointers_.GetAttributeNIComplexDoubleArray = reinterpret_cast<GetAttributeNIComplexDoubleArrayPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_GetAttributeNIComplexDoubleArray"));
  function_pointers_.GetAttributeNIComplexSingleArray = reinterpret_cast<GetAttributeNIComplexSingleArrayPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_GetAttributeNIComplexSingleArray"));
  function_pointers_.GetAttributeString = reinterpret_cast<GetAttributeStringPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_GetAttributeString"));
  function_pointers_.GetAttributeU16 = reinterpret_cast<GetAttributeU16Ptr>(p_shared_library_->get_function_pointer("RFmxWLAN_GetAttributeU16"));
  function_pointers_.GetAttributeU32 = reinterpret_cast<GetAttributeU32Ptr>(p_shared_library_->get_function_pointer("RFmxWLAN_GetAttributeU32"));
  function_pointers_.GetAttributeU32Array = reinterpret_cast<GetAttributeU32ArrayPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_GetAttributeU32Array"));
  function_pointers_.GetAttributeU64Array = reinterpret_cast<GetAttributeU64ArrayPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_GetAttributeU64Array"));
  function_pointers_.GetAttributeU8 = reinterpret_cast<GetAttributeU8Ptr>(p_shared_library_->get_function_pointer("RFmxWLAN_GetAttributeU8"));
  function_pointers_.GetAttributeU8Array = reinterpret_cast<GetAttributeU8ArrayPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_GetAttributeU8Array"));
  function_pointers_.GetError = reinterpret_cast<GetErrorPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_GetError"));
  function_pointers_.GetErrorString = reinterpret_cast<GetErrorStringPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_GetErrorString"));
  function_pointers_.Initialize = reinterpret_cast<InitializePtr>(p_shared_library_->get_function_pointer("RFmxWLAN_Initialize"));
  function_pointers_.InitializeFromNIRFSASession = reinterpret_cast<InitializeFromNIRFSASessionPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_InitializeFromNIRFSASession"));
  function_pointers_.Initiate = reinterpret_cast<InitiatePtr>(p_shared_library_->get_function_pointer("RFmxWLAN_Initiate"));
  function_pointers_.OFDMModAccAutoLevel = reinterpret_cast<OFDMModAccAutoLevelPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_OFDMModAccAutoLevel"));
  function_pointers_.OFDMModAccCfg1ReferenceWaveform = reinterpret_cast<OFDMModAccCfg1ReferenceWaveformPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_OFDMModAccCfg1ReferenceWaveform"));
  function_pointers_.OFDMModAccCfgAcquisitionLength = reinterpret_cast<OFDMModAccCfgAcquisitionLengthPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_OFDMModAccCfgAcquisitionLength"));
  function_pointers_.OFDMModAccCfgAmplitudeTrackingEnabled = reinterpret_cast<OFDMModAccCfgAmplitudeTrackingEnabledPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_OFDMModAccCfgAmplitudeTrackingEnabled"));
  function_pointers_.OFDMModAccCfgAveraging = reinterpret_cast<OFDMModAccCfgAveragingPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_OFDMModAccCfgAveraging"));
  function_pointers_.OFDMModAccCfgChannelEstimationType = reinterpret_cast<OFDMModAccCfgChannelEstimationTypePtr>(p_shared_library_->get_function_pointer("RFmxWLAN_OFDMModAccCfgChannelEstimationType"));
  function_pointers_.OFDMModAccCfgCommonClockSourceEnabled = reinterpret_cast<OFDMModAccCfgCommonClockSourceEnabledPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_OFDMModAccCfgCommonClockSourceEnabled"));
  function_pointers_.OFDMModAccCfgEVMUnit = reinterpret_cast<OFDMModAccCfgEVMUnitPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_OFDMModAccCfgEVMUnit"));
  function_pointers_.OFDMModAccCfgFrequencyErrorEstimationMethod = reinterpret_cast<OFDMModAccCfgFrequencyErrorEstimationMethodPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_OFDMModAccCfgFrequencyErrorEstimationMethod"));
  function_pointers_.OFDMModAccCfgMeasurementLength = reinterpret_cast<OFDMModAccCfgMeasurementLengthPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_OFDMModAccCfgMeasurementLength"));
  function_pointers_.OFDMModAccCfgMeasurementMode = reinterpret_cast<OFDMModAccCfgMeasurementModePtr>(p_shared_library_->get_function_pointer("RFmxWLAN_OFDMModAccCfgMeasurementMode"));
  function_pointers_.OFDMModAccCfgNReferenceWaveforms = reinterpret_cast<OFDMModAccCfgNReferenceWaveformsPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_OFDMModAccCfgNReferenceWaveforms"));
  function_pointers_.OFDMModAccCfgNoiseCompensationEnabled = reinterpret_cast<OFDMModAccCfgNoiseCompensationEnabledPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_OFDMModAccCfgNoiseCompensationEnabled"));
  function_pointers_.OFDMModAccCfgOptimizeDynamicRangeForEVM = reinterpret_cast<OFDMModAccCfgOptimizeDynamicRangeForEVMPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_OFDMModAccCfgOptimizeDynamicRangeForEVM"));
  function_pointers_.OFDMModAccCfgPhaseTrackingEnabled = reinterpret_cast<OFDMModAccCfgPhaseTrackingEnabledPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_OFDMModAccCfgPhaseTrackingEnabled"));
  function_pointers_.OFDMModAccCfgSymbolClockErrorCorrectionEnabled = reinterpret_cast<OFDMModAccCfgSymbolClockErrorCorrectionEnabledPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_OFDMModAccCfgSymbolClockErrorCorrectionEnabled"));
  function_pointers_.OFDMModAccClearNoiseCalibrationDatabase = reinterpret_cast<OFDMModAccClearNoiseCalibrationDatabasePtr>(p_shared_library_->get_function_pointer("RFmxWLAN_OFDMModAccClearNoiseCalibrationDatabase"));
  function_pointers_.OFDMModAccFetchChainDataRMSEVMPerSymbolMeanTrace = reinterpret_cast<OFDMModAccFetchChainDataRMSEVMPerSymbolMeanTracePtr>(p_shared_library_->get_function_pointer("RFmxWLAN_OFDMModAccFetchChainDataRMSEVMPerSymbolMeanTrace"));
  function_pointers_.OFDMModAccFetchChainPilotRMSEVMPerSymbolMeanTrace = reinterpret_cast<OFDMModAccFetchChainPilotRMSEVMPerSymbolMeanTracePtr>(p_shared_library_->get_function_pointer("RFmxWLAN_OFDMModAccFetchChainPilotRMSEVMPerSymbolMeanTrace"));
  function_pointers_.OFDMModAccFetchChainRMSEVM = reinterpret_cast<OFDMModAccFetchChainRMSEVMPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_OFDMModAccFetchChainRMSEVM"));
  function_pointers_.OFDMModAccFetchChainRMSEVMPerSubcarrierMeanTrace = reinterpret_cast<OFDMModAccFetchChainRMSEVMPerSubcarrierMeanTracePtr>(p_shared_library_->get_function_pointer("RFmxWLAN_OFDMModAccFetchChainRMSEVMPerSubcarrierMeanTrace"));
  function_pointers_.OFDMModAccFetchChainRMSEVMPerSymbolMeanTrace = reinterpret_cast<OFDMModAccFetchChainRMSEVMPerSymbolMeanTracePtr>(p_shared_library_->get_function_pointer("RFmxWLAN_OFDMModAccFetchChainRMSEVMPerSymbolMeanTrace"));
  function_pointers_.OFDMModAccFetchChannelFrequencyResponseMeanTrace = reinterpret_cast<OFDMModAccFetchChannelFrequencyResponseMeanTracePtr>(p_shared_library_->get_function_pointer("RFmxWLAN_OFDMModAccFetchChannelFrequencyResponseMeanTrace"));
  function_pointers_.OFDMModAccFetchCommonPilotErrorTrace = reinterpret_cast<OFDMModAccFetchCommonPilotErrorTracePtr>(p_shared_library_->get_function_pointer("RFmxWLAN_OFDMModAccFetchCommonPilotErrorTrace"));
  function_pointers_.OFDMModAccFetchCompositeRMSEVM = reinterpret_cast<OFDMModAccFetchCompositeRMSEVMPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_OFDMModAccFetchCompositeRMSEVM"));
  function_pointers_.OFDMModAccFetchCrossPower = reinterpret_cast<OFDMModAccFetchCrossPowerPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_OFDMModAccFetchCrossPower"));
  function_pointers_.OFDMModAccFetchCustomGatePowersArray = reinterpret_cast<OFDMModAccFetchCustomGatePowersArrayPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_OFDMModAccFetchCustomGatePowersArray"));
  function_pointers_.OFDMModAccFetchDataAveragePower = reinterpret_cast<OFDMModAccFetchDataAveragePowerPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_OFDMModAccFetchDataAveragePower"));
  function_pointers_.OFDMModAccFetchDataConstellationTrace = reinterpret_cast<OFDMModAccFetchDataConstellationTracePtr>(p_shared_library_->get_function_pointer("RFmxWLAN_OFDMModAccFetchDataConstellationTrace"));
  function_pointers_.OFDMModAccFetchDataPeakPower = reinterpret_cast<OFDMModAccFetchDataPeakPowerPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_OFDMModAccFetchDataPeakPower"));
  function_pointers_.OFDMModAccFetchDecodedEHTSIGBitsTrace = reinterpret_cast<OFDMModAccFetchDecodedEHTSIGBitsTracePtr>(p_shared_library_->get_function_pointer("RFmxWLAN_OFDMModAccFetchDecodedEHTSIGBitsTrace"));
  function_pointers_.OFDMModAccFetchDecodedLSIGBitsTrace = reinterpret_cast<OFDMModAccFetchDecodedLSIGBitsTracePtr>(p_shared_library_->get_function_pointer("RFmxWLAN_OFDMModAccFetchDecodedLSIGBitsTrace"));
  function_pointers_.OFDMModAccFetchDecodedPSDUBitsTrace = reinterpret_cast<OFDMModAccFetchDecodedPSDUBitsTracePtr>(p_shared_library_->get_function_pointer("RFmxWLAN_OFDMModAccFetchDecodedPSDUBitsTrace"));
  function_pointers_.OFDMModAccFetchDecodedSIGBBitsTrace = reinterpret_cast<OFDMModAccFetchDecodedSIGBBitsTracePtr>(p_shared_library_->get_function_pointer("RFmxWLAN_OFDMModAccFetchDecodedSIGBBitsTrace"));
  function_pointers_.OFDMModAccFetchDecodedSIGBitsTrace = reinterpret_cast<OFDMModAccFetchDecodedSIGBitsTracePtr>(p_shared_library_->get_function_pointer("RFmxWLAN_OFDMModAccFetchDecodedSIGBitsTrace"));
  function_pointers_.OFDMModAccFetchDecodedServiceBitsTrace = reinterpret_cast<OFDMModAccFetchDecodedServiceBitsTracePtr>(p_shared_library_->get_function_pointer("RFmxWLAN_OFDMModAccFetchDecodedServiceBitsTrace"));
  function_pointers_.OFDMModAccFetchDecodedUSIGBitsTrace = reinterpret_cast<OFDMModAccFetchDecodedUSIGBitsTracePtr>(p_shared_library_->get_function_pointer("RFmxWLAN_OFDMModAccFetchDecodedUSIGBitsTrace"));
  function_pointers_.OFDMModAccFetchEVMSubcarrierIndices = reinterpret_cast<OFDMModAccFetchEVMSubcarrierIndicesPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_OFDMModAccFetchEVMSubcarrierIndices"));
  function_pointers_.OFDMModAccFetchFrequencyErrorCCDF10Percent = reinterpret_cast<OFDMModAccFetchFrequencyErrorCCDF10PercentPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_OFDMModAccFetchFrequencyErrorCCDF10Percent"));
  function_pointers_.OFDMModAccFetchFrequencyErrorMean = reinterpret_cast<OFDMModAccFetchFrequencyErrorMeanPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_OFDMModAccFetchFrequencyErrorMean"));
  function_pointers_.OFDMModAccFetchGroupDelayMeanTrace = reinterpret_cast<OFDMModAccFetchGroupDelayMeanTracePtr>(p_shared_library_->get_function_pointer("RFmxWLAN_OFDMModAccFetchGroupDelayMeanTrace"));
  function_pointers_.OFDMModAccFetchGuardIntervalType = reinterpret_cast<OFDMModAccFetchGuardIntervalTypePtr>(p_shared_library_->get_function_pointer("RFmxWLAN_OFDMModAccFetchGuardIntervalType"));
  function_pointers_.OFDMModAccFetchIQGainImbalancePerSubcarrierMeanTrace = reinterpret_cast<OFDMModAccFetchIQGainImbalancePerSubcarrierMeanTracePtr>(p_shared_library_->get_function_pointer("RFmxWLAN_OFDMModAccFetchIQGainImbalancePerSubcarrierMeanTrace"));
  function_pointers_.OFDMModAccFetchIQImpairments = reinterpret_cast<OFDMModAccFetchIQImpairmentsPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_OFDMModAccFetchIQImpairments"));
  function_pointers_.OFDMModAccFetchIQQuadratureErrorPerSubcarrierMeanTrace = reinterpret_cast<OFDMModAccFetchIQQuadratureErrorPerSubcarrierMeanTracePtr>(p_shared_library_->get_function_pointer("RFmxWLAN_OFDMModAccFetchIQQuadratureErrorPerSubcarrierMeanTrace"));
  function_pointers_.OFDMModAccFetchLSIGParityCheckStatus = reinterpret_cast<OFDMModAccFetchLSIGParityCheckStatusPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_OFDMModAccFetchLSIGParityCheckStatus"));
  function_pointers_.OFDMModAccFetchLTFSize = reinterpret_cast<OFDMModAccFetchLTFSizePtr>(p_shared_library_->get_function_pointer("RFmxWLAN_OFDMModAccFetchLTFSize"));
  function_pointers_.OFDMModAccFetchMCSIndex = reinterpret_cast<OFDMModAccFetchMCSIndexPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_OFDMModAccFetchMCSIndex"));
  function_pointers_.OFDMModAccFetchNumberOfHESIGBSymbols = reinterpret_cast<OFDMModAccFetchNumberOfHESIGBSymbolsPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_OFDMModAccFetchNumberOfHESIGBSymbols"));
  function_pointers_.OFDMModAccFetchNumberOfSpaceTimeStreams = reinterpret_cast<OFDMModAccFetchNumberOfSpaceTimeStreamsPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_OFDMModAccFetchNumberOfSpaceTimeStreams"));
  function_pointers_.OFDMModAccFetchNumberOfUsers = reinterpret_cast<OFDMModAccFetchNumberOfUsersPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_OFDMModAccFetchNumberOfUsers"));
  function_pointers_.OFDMModAccFetchNumberofSymbolsUsed = reinterpret_cast<OFDMModAccFetchNumberofSymbolsUsedPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_OFDMModAccFetchNumberofSymbolsUsed"));
  function_pointers_.OFDMModAccFetchPEAveragePower = reinterpret_cast<OFDMModAccFetchPEAveragePowerPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_OFDMModAccFetchPEAveragePower"));
  function_pointers_.OFDMModAccFetchPEDuration = reinterpret_cast<OFDMModAccFetchPEDurationPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_OFDMModAccFetchPEDuration"));
  function_pointers_.OFDMModAccFetchPEPeakPower = reinterpret_cast<OFDMModAccFetchPEPeakPowerPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_OFDMModAccFetchPEPeakPower"));
  function_pointers_.OFDMModAccFetchPPDUAveragePower = reinterpret_cast<OFDMModAccFetchPPDUAveragePowerPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_OFDMModAccFetchPPDUAveragePower"));
  function_pointers_.OFDMModAccFetchPPDUPeakPower = reinterpret_cast<OFDMModAccFetchPPDUPeakPowerPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_OFDMModAccFetchPPDUPeakPower"));
  function_pointers_.OFDMModAccFetchPPDUType = reinterpret_cast<OFDMModAccFetchPPDUTypePtr>(p_shared_library_->get_function_pointer("RFmxWLAN_OFDMModAccFetchPPDUType"));
  function_pointers_.OFDMModAccFetchPSDUCRCStatus = reinterpret_cast<OFDMModAccFetchPSDUCRCStatusPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_OFDMModAccFetchPSDUCRCStatus"));
  function_pointers_.OFDMModAccFetchPhaseNoisePSDMeanTrace = reinterpret_cast<OFDMModAccFetchPhaseNoisePSDMeanTracePtr>(p_shared_library_->get_function_pointer("RFmxWLAN_OFDMModAccFetchPhaseNoisePSDMeanTrace"));
  function_pointers_.OFDMModAccFetchPilotConstellationTrace = reinterpret_cast<OFDMModAccFetchPilotConstellationTracePtr>(p_shared_library_->get_function_pointer("RFmxWLAN_OFDMModAccFetchPilotConstellationTrace"));
  function_pointers_.OFDMModAccFetchPreambleAveragePowers80211ac = reinterpret_cast<OFDMModAccFetchPreambleAveragePowers80211acPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_OFDMModAccFetchPreambleAveragePowers802_11ac"));
  function_pointers_.OFDMModAccFetchPreambleAveragePowers80211ax = reinterpret_cast<OFDMModAccFetchPreambleAveragePowers80211axPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_OFDMModAccFetchPreambleAveragePowers802_11ax"));
  function_pointers_.OFDMModAccFetchPreambleAveragePowers80211be = reinterpret_cast<OFDMModAccFetchPreambleAveragePowers80211bePtr>(p_shared_library_->get_function_pointer("RFmxWLAN_OFDMModAccFetchPreambleAveragePowers802_11be"));
  function_pointers_.OFDMModAccFetchPreambleAveragePowers80211n = reinterpret_cast<OFDMModAccFetchPreambleAveragePowers80211nPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_OFDMModAccFetchPreambleAveragePowers802_11n"));
  function_pointers_.OFDMModAccFetchPreambleAveragePowersCommon = reinterpret_cast<OFDMModAccFetchPreambleAveragePowersCommonPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_OFDMModAccFetchPreambleAveragePowersCommon"));
  function_pointers_.OFDMModAccFetchPreambleFrequencyErrorTrace = reinterpret_cast<OFDMModAccFetchPreambleFrequencyErrorTracePtr>(p_shared_library_->get_function_pointer("RFmxWLAN_OFDMModAccFetchPreambleFrequencyErrorTrace"));
  function_pointers_.OFDMModAccFetchPreamblePeakPowers80211ac = reinterpret_cast<OFDMModAccFetchPreamblePeakPowers80211acPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_OFDMModAccFetchPreamblePeakPowers802_11ac"));
  function_pointers_.OFDMModAccFetchPreamblePeakPowers80211ax = reinterpret_cast<OFDMModAccFetchPreamblePeakPowers80211axPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_OFDMModAccFetchPreamblePeakPowers802_11ax"));
  function_pointers_.OFDMModAccFetchPreamblePeakPowers80211be = reinterpret_cast<OFDMModAccFetchPreamblePeakPowers80211bePtr>(p_shared_library_->get_function_pointer("RFmxWLAN_OFDMModAccFetchPreamblePeakPowers802_11be"));
  function_pointers_.OFDMModAccFetchPreamblePeakPowers80211n = reinterpret_cast<OFDMModAccFetchPreamblePeakPowers80211nPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_OFDMModAccFetchPreamblePeakPowers802_11n"));
  function_pointers_.OFDMModAccFetchPreamblePeakPowersCommon = reinterpret_cast<OFDMModAccFetchPreamblePeakPowersCommonPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_OFDMModAccFetchPreamblePeakPowersCommon"));
  function_pointers_.OFDMModAccFetchRUOffsetAndSize = reinterpret_cast<OFDMModAccFetchRUOffsetAndSizePtr>(p_shared_library_->get_function_pointer("RFmxWLAN_OFDMModAccFetchRUOffsetAndSize"));
  function_pointers_.OFDMModAccFetchSIGBCRCStatus = reinterpret_cast<OFDMModAccFetchSIGBCRCStatusPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_OFDMModAccFetchSIGBCRCStatus"));
  function_pointers_.OFDMModAccFetchSIGCRCStatus = reinterpret_cast<OFDMModAccFetchSIGCRCStatusPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_OFDMModAccFetchSIGCRCStatus"));
  function_pointers_.OFDMModAccFetchSpectralFlatness = reinterpret_cast<OFDMModAccFetchSpectralFlatnessPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_OFDMModAccFetchSpectralFlatness"));
  function_pointers_.OFDMModAccFetchSpectralFlatnessMeanTrace = reinterpret_cast<OFDMModAccFetchSpectralFlatnessMeanTracePtr>(p_shared_library_->get_function_pointer("RFmxWLAN_OFDMModAccFetchSpectralFlatnessMeanTrace"));
  function_pointers_.OFDMModAccFetchStreamDataRMSEVMPerSymbolMeanTrace = reinterpret_cast<OFDMModAccFetchStreamDataRMSEVMPerSymbolMeanTracePtr>(p_shared_library_->get_function_pointer("RFmxWLAN_OFDMModAccFetchStreamDataRMSEVMPerSymbolMeanTrace"));
  function_pointers_.OFDMModAccFetchStreamPilotRMSEVMPerSymbolMeanTrace = reinterpret_cast<OFDMModAccFetchStreamPilotRMSEVMPerSymbolMeanTracePtr>(p_shared_library_->get_function_pointer("RFmxWLAN_OFDMModAccFetchStreamPilotRMSEVMPerSymbolMeanTrace"));
  function_pointers_.OFDMModAccFetchStreamRMSEVM = reinterpret_cast<OFDMModAccFetchStreamRMSEVMPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_OFDMModAccFetchStreamRMSEVM"));
  function_pointers_.OFDMModAccFetchStreamRMSEVMPerSubcarrierMeanTrace = reinterpret_cast<OFDMModAccFetchStreamRMSEVMPerSubcarrierMeanTracePtr>(p_shared_library_->get_function_pointer("RFmxWLAN_OFDMModAccFetchStreamRMSEVMPerSubcarrierMeanTrace"));
  function_pointers_.OFDMModAccFetchStreamRMSEVMPerSymbolMeanTrace = reinterpret_cast<OFDMModAccFetchStreamRMSEVMPerSymbolMeanTracePtr>(p_shared_library_->get_function_pointer("RFmxWLAN_OFDMModAccFetchStreamRMSEVMPerSymbolMeanTrace"));
  function_pointers_.OFDMModAccFetchSubcarrierChainEVMPerSymbolTrace = reinterpret_cast<OFDMModAccFetchSubcarrierChainEVMPerSymbolTracePtr>(p_shared_library_->get_function_pointer("RFmxWLAN_OFDMModAccFetchSubcarrierChainEVMPerSymbolTrace"));
  function_pointers_.OFDMModAccFetchSubcarrierStreamEVMPerSymbolTrace = reinterpret_cast<OFDMModAccFetchSubcarrierStreamEVMPerSymbolTracePtr>(p_shared_library_->get_function_pointer("RFmxWLAN_OFDMModAccFetchSubcarrierStreamEVMPerSymbolTrace"));
  function_pointers_.OFDMModAccFetchSymbolChainEVMPerSubcarrierTrace = reinterpret_cast<OFDMModAccFetchSymbolChainEVMPerSubcarrierTracePtr>(p_shared_library_->get_function_pointer("RFmxWLAN_OFDMModAccFetchSymbolChainEVMPerSubcarrierTrace"));
  function_pointers_.OFDMModAccFetchSymbolClockErrorMean = reinterpret_cast<OFDMModAccFetchSymbolClockErrorMeanPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_OFDMModAccFetchSymbolClockErrorMean"));
  function_pointers_.OFDMModAccFetchSymbolStreamEVMPerSubcarrierTrace = reinterpret_cast<OFDMModAccFetchSymbolStreamEVMPerSubcarrierTracePtr>(p_shared_library_->get_function_pointer("RFmxWLAN_OFDMModAccFetchSymbolStreamEVMPerSubcarrierTrace"));
  function_pointers_.OFDMModAccFetchUnusedToneError = reinterpret_cast<OFDMModAccFetchUnusedToneErrorPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_OFDMModAccFetchUnusedToneError"));
  function_pointers_.OFDMModAccFetchUnusedToneErrorMarginPerRU = reinterpret_cast<OFDMModAccFetchUnusedToneErrorMarginPerRUPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_OFDMModAccFetchUnusedToneErrorMarginPerRU"));
  function_pointers_.OFDMModAccFetchUnusedToneErrorMeanTrace = reinterpret_cast<OFDMModAccFetchUnusedToneErrorMeanTracePtr>(p_shared_library_->get_function_pointer("RFmxWLAN_OFDMModAccFetchUnusedToneErrorMeanTrace"));
  function_pointers_.OFDMModAccFetchUserDataConstellationTrace = reinterpret_cast<OFDMModAccFetchUserDataConstellationTracePtr>(p_shared_library_->get_function_pointer("RFmxWLAN_OFDMModAccFetchUserDataConstellationTrace"));
  function_pointers_.OFDMModAccFetchUserPilotConstellationTrace = reinterpret_cast<OFDMModAccFetchUserPilotConstellationTracePtr>(p_shared_library_->get_function_pointer("RFmxWLAN_OFDMModAccFetchUserPilotConstellationTrace"));
  function_pointers_.OFDMModAccFetchUserPower = reinterpret_cast<OFDMModAccFetchUserPowerPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_OFDMModAccFetchUserPower"));
  function_pointers_.OFDMModAccFetchUserStreamDataRMSEVMPerSymbolMeanTrace = reinterpret_cast<OFDMModAccFetchUserStreamDataRMSEVMPerSymbolMeanTracePtr>(p_shared_library_->get_function_pointer("RFmxWLAN_OFDMModAccFetchUserStreamDataRMSEVMPerSymbolMeanTrace"));
  function_pointers_.OFDMModAccFetchUserStreamPilotRMSEVMPerSymbolMeanTrace = reinterpret_cast<OFDMModAccFetchUserStreamPilotRMSEVMPerSymbolMeanTracePtr>(p_shared_library_->get_function_pointer("RFmxWLAN_OFDMModAccFetchUserStreamPilotRMSEVMPerSymbolMeanTrace"));
  function_pointers_.OFDMModAccFetchUserStreamRMSEVM = reinterpret_cast<OFDMModAccFetchUserStreamRMSEVMPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_OFDMModAccFetchUserStreamRMSEVM"));
  function_pointers_.OFDMModAccFetchUserStreamRMSEVMPerSubcarrierMeanTrace = reinterpret_cast<OFDMModAccFetchUserStreamRMSEVMPerSubcarrierMeanTracePtr>(p_shared_library_->get_function_pointer("RFmxWLAN_OFDMModAccFetchUserStreamRMSEVMPerSubcarrierMeanTrace"));
  function_pointers_.OFDMModAccFetchUserStreamRMSEVMPerSymbolMeanTrace = reinterpret_cast<OFDMModAccFetchUserStreamRMSEVMPerSymbolMeanTracePtr>(p_shared_library_->get_function_pointer("RFmxWLAN_OFDMModAccFetchUserStreamRMSEVMPerSymbolMeanTrace"));
  function_pointers_.OFDMModAccValidateCalibrationData = reinterpret_cast<OFDMModAccValidateCalibrationDataPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_OFDMModAccValidateCalibrationData"));
  function_pointers_.PowerRampCfgAcquisitionLength = reinterpret_cast<PowerRampCfgAcquisitionLengthPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_PowerRampCfgAcquisitionLength"));
  function_pointers_.PowerRampCfgAveraging = reinterpret_cast<PowerRampCfgAveragingPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_PowerRampCfgAveraging"));
  function_pointers_.PowerRampFetchFallTrace = reinterpret_cast<PowerRampFetchFallTracePtr>(p_shared_library_->get_function_pointer("RFmxWLAN_PowerRampFetchFallTrace"));
  function_pointers_.PowerRampFetchMeasurement = reinterpret_cast<PowerRampFetchMeasurementPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_PowerRampFetchMeasurement"));
  function_pointers_.PowerRampFetchRiseTrace = reinterpret_cast<PowerRampFetchRiseTracePtr>(p_shared_library_->get_function_pointer("RFmxWLAN_PowerRampFetchRiseTrace"));
  function_pointers_.ResetAttribute = reinterpret_cast<ResetAttributePtr>(p_shared_library_->get_function_pointer("RFmxWLAN_ResetAttribute"));
  function_pointers_.ResetToDefault = reinterpret_cast<ResetToDefaultPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_ResetToDefault"));
  function_pointers_.SEMCfgAveraging = reinterpret_cast<SEMCfgAveragingPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_SEMCfgAveraging"));
  function_pointers_.SEMCfgMaskType = reinterpret_cast<SEMCfgMaskTypePtr>(p_shared_library_->get_function_pointer("RFmxWLAN_SEMCfgMaskType"));
  function_pointers_.SEMCfgNumberOfOffsets = reinterpret_cast<SEMCfgNumberOfOffsetsPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_SEMCfgNumberOfOffsets"));
  function_pointers_.SEMCfgOffsetFrequencyArray = reinterpret_cast<SEMCfgOffsetFrequencyArrayPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_SEMCfgOffsetFrequencyArray"));
  function_pointers_.SEMCfgOffsetRelativeLimitArray = reinterpret_cast<SEMCfgOffsetRelativeLimitArrayPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_SEMCfgOffsetRelativeLimitArray"));
  function_pointers_.SEMCfgSpan = reinterpret_cast<SEMCfgSpanPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_SEMCfgSpan"));
  function_pointers_.SEMCfgSweepTime = reinterpret_cast<SEMCfgSweepTimePtr>(p_shared_library_->get_function_pointer("RFmxWLAN_SEMCfgSweepTime"));
  function_pointers_.SEMFetchCarrierMeasurement = reinterpret_cast<SEMFetchCarrierMeasurementPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_SEMFetchCarrierMeasurement"));
  function_pointers_.SEMFetchLowerOffsetMargin = reinterpret_cast<SEMFetchLowerOffsetMarginPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_SEMFetchLowerOffsetMargin"));
  function_pointers_.SEMFetchLowerOffsetMarginArray = reinterpret_cast<SEMFetchLowerOffsetMarginArrayPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_SEMFetchLowerOffsetMarginArray"));
  function_pointers_.SEMFetchLowerOffsetPower = reinterpret_cast<SEMFetchLowerOffsetPowerPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_SEMFetchLowerOffsetPower"));
  function_pointers_.SEMFetchLowerOffsetPowerArray = reinterpret_cast<SEMFetchLowerOffsetPowerArrayPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_SEMFetchLowerOffsetPowerArray"));
  function_pointers_.SEMFetchMeasurementStatus = reinterpret_cast<SEMFetchMeasurementStatusPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_SEMFetchMeasurementStatus"));
  function_pointers_.SEMFetchSpectrum = reinterpret_cast<SEMFetchSpectrumPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_SEMFetchSpectrum"));
  function_pointers_.SEMFetchUpperOffsetMargin = reinterpret_cast<SEMFetchUpperOffsetMarginPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_SEMFetchUpperOffsetMargin"));
  function_pointers_.SEMFetchUpperOffsetMarginArray = reinterpret_cast<SEMFetchUpperOffsetMarginArrayPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_SEMFetchUpperOffsetMarginArray"));
  function_pointers_.SEMFetchUpperOffsetPower = reinterpret_cast<SEMFetchUpperOffsetPowerPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_SEMFetchUpperOffsetPower"));
  function_pointers_.SEMFetchUpperOffsetPowerArray = reinterpret_cast<SEMFetchUpperOffsetPowerArrayPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_SEMFetchUpperOffsetPowerArray"));
  function_pointers_.SelectMeasurements = reinterpret_cast<SelectMeasurementsPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_SelectMeasurements"));
  function_pointers_.SendSoftwareEdgeTrigger = reinterpret_cast<SendSoftwareEdgeTriggerPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_SendSoftwareEdgeTrigger"));
  function_pointers_.SetAttributeF32 = reinterpret_cast<SetAttributeF32Ptr>(p_shared_library_->get_function_pointer("RFmxWLAN_SetAttributeF32"));
  function_pointers_.SetAttributeF32Array = reinterpret_cast<SetAttributeF32ArrayPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_SetAttributeF32Array"));
  function_pointers_.SetAttributeF64 = reinterpret_cast<SetAttributeF64Ptr>(p_shared_library_->get_function_pointer("RFmxWLAN_SetAttributeF64"));
  function_pointers_.SetAttributeF64Array = reinterpret_cast<SetAttributeF64ArrayPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_SetAttributeF64Array"));
  function_pointers_.SetAttributeI16 = reinterpret_cast<SetAttributeI16Ptr>(p_shared_library_->get_function_pointer("RFmxWLAN_SetAttributeI16"));
  function_pointers_.SetAttributeI32 = reinterpret_cast<SetAttributeI32Ptr>(p_shared_library_->get_function_pointer("RFmxWLAN_SetAttributeI32"));
  function_pointers_.SetAttributeI32Array = reinterpret_cast<SetAttributeI32ArrayPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_SetAttributeI32Array"));
  function_pointers_.SetAttributeI64 = reinterpret_cast<SetAttributeI64Ptr>(p_shared_library_->get_function_pointer("RFmxWLAN_SetAttributeI64"));
  function_pointers_.SetAttributeI64Array = reinterpret_cast<SetAttributeI64ArrayPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_SetAttributeI64Array"));
  function_pointers_.SetAttributeI8 = reinterpret_cast<SetAttributeI8Ptr>(p_shared_library_->get_function_pointer("RFmxWLAN_SetAttributeI8"));
  function_pointers_.SetAttributeI8Array = reinterpret_cast<SetAttributeI8ArrayPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_SetAttributeI8Array"));
  function_pointers_.SetAttributeNIComplexDoubleArray = reinterpret_cast<SetAttributeNIComplexDoubleArrayPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_SetAttributeNIComplexDoubleArray"));
  function_pointers_.SetAttributeNIComplexSingleArray = reinterpret_cast<SetAttributeNIComplexSingleArrayPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_SetAttributeNIComplexSingleArray"));
  function_pointers_.SetAttributeString = reinterpret_cast<SetAttributeStringPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_SetAttributeString"));
  function_pointers_.SetAttributeU16 = reinterpret_cast<SetAttributeU16Ptr>(p_shared_library_->get_function_pointer("RFmxWLAN_SetAttributeU16"));
  function_pointers_.SetAttributeU32 = reinterpret_cast<SetAttributeU32Ptr>(p_shared_library_->get_function_pointer("RFmxWLAN_SetAttributeU32"));
  function_pointers_.SetAttributeU32Array = reinterpret_cast<SetAttributeU32ArrayPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_SetAttributeU32Array"));
  function_pointers_.SetAttributeU64Array = reinterpret_cast<SetAttributeU64ArrayPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_SetAttributeU64Array"));
  function_pointers_.SetAttributeU8 = reinterpret_cast<SetAttributeU8Ptr>(p_shared_library_->get_function_pointer("RFmxWLAN_SetAttributeU8"));
  function_pointers_.SetAttributeU8Array = reinterpret_cast<SetAttributeU8ArrayPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_SetAttributeU8Array"));
  function_pointers_.TXPCfgAveraging = reinterpret_cast<TXPCfgAveragingPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_TXPCfgAveraging"));
  function_pointers_.TXPCfgBurstDetectionEnabled = reinterpret_cast<TXPCfgBurstDetectionEnabledPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_TXPCfgBurstDetectionEnabled"));
  function_pointers_.TXPCfgMaximumMeasurementInterval = reinterpret_cast<TXPCfgMaximumMeasurementIntervalPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_TXPCfgMaximumMeasurementInterval"));
  function_pointers_.TXPFetchMeasurement = reinterpret_cast<TXPFetchMeasurementPtr>(p_shared_library_->get_function_pointer("RFmxWLAN_TXPFetchMeasurement"));
  function_pointers_.TXPFetchPowerTrace = reinterpret_cast<TXPFetchPowerTracePtr>(p_shared_library_->get_function_pointer("RFmxWLAN_TXPFetchPowerTrace"));
  function_pointers_.WaitForAcquisitionComplete = reinterpret_cast<WaitForAcquisitionCompletePtr>(p_shared_library_->get_function_pointer("RFmxWLAN_WaitForAcquisitionComplete"));
  function_pointers_.WaitForMeasurementComplete = reinterpret_cast<WaitForMeasurementCompletePtr>(p_shared_library_->get_function_pointer("RFmxWLAN_WaitForMeasurementComplete"));
}
