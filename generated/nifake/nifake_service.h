...
private:
  ...
  std::map<std::int32_t, float> nifakereal64attributevalues_input_map_ { {1, 3.5f},{2, 4.5f},{3, 5.5f},{4, 6.5f},{5, 7.5f}, };
  std::map<float, std::int32_t> nifakereal64attributevalues_output_map_ { {3.5f, 1},{4.5f, 2},{5.5f, 3},{6.5f, 4},{7.5f, 5}, };
