...
public:
  ...
  ni::hardware::grpc::internal::SessionRepository* session_repository_;
    ...
    std::map<std::int32_t, ViConstString> mobileosnames_input_map_ { {1, "Android"},{2, "iOS"},{3, "None"}, };
    std::map<ViConstString, std::int32_t> mobileosnames_output_map_ { {"Android", 1},{"iOS", 2},{"None", 3}, };
  };
} // namespace grpc
} // namespace fake
} // namespace ni
