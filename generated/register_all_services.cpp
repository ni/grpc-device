  ...
  const nidevice_grpc::FeatureToggles& feature_toggles)
{
  ...
  auto nx_device_ref_t_repository = std::make_shared<nidevice_grpc::SessionResourceRepository<nxDeviceRef_t>>(session_repository.get());
  auto nx_interface_ref_t_repository = std::make_shared<nidevice_grpc::SessionResourceRepository<nxInterfaceRef_t>>(session_repository.get());
  ...
  service_vector->push_back(
    nixnet_grpc::register_service(
      ...
      nx_device_ref_t_repository,
      nx_interface_ref_t_repository,
      feature_toggles));
  service_vector->push_back(
