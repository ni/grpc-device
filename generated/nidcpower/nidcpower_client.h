...
ConfigureCurrentLimitResponse configure_current_limit(const StubPtr& stub, const nidevice_grpc::Session& vi, const pb::string& channel_name, const pb::int32& behavior, const double& limit);
...
ConfigureDigitalEdgeMeasureTriggerResponse configure_digital_edge_measure_trigger(const StubPtr& stub, const nidevice_grpc::Session& vi, const pb::string& input_terminal, const pb::int32& edge);
ConfigureDigitalEdgeMeasureTriggerWithChannelsResponse configure_digital_edge_measure_trigger_with_channels(const StubPtr& stub, const nidevice_grpc::Session& vi, const pb::string& channel_name, const pb::string& input_terminal, const pb::int32& edge);
ConfigureDigitalEdgePulseTriggerResponse configure_digital_edge_pulse_trigger(const StubPtr& stub, const nidevice_grpc::Session& vi, const pb::string& input_terminal, const pb::int32& edge);
ConfigureDigitalEdgePulseTriggerWithChannelsResponse configure_digital_edge_pulse_trigger_with_channels(const StubPtr& stub, const nidevice_grpc::Session& vi, const pb::string& channel_name, const pb::string& input_terminal, const pb::int32& edge);
ConfigureDigitalEdgeSequenceAdvanceTriggerResponse configure_digital_edge_sequence_advance_trigger(const StubPtr& stub, const nidevice_grpc::Session& vi, const pb::string& input_terminal, const pb::int32& edge);
ConfigureDigitalEdgeSequenceAdvanceTriggerWithChannelsResponse configure_digital_edge_sequence_advance_trigger_with_channels(const StubPtr& stub, const nidevice_grpc::Session& vi, const pb::string& channel_name, const pb::string& input_terminal, const pb::int32& edge);
ConfigureDigitalEdgeShutdownTriggerWithChannelsResponse configure_digital_edge_shutdown_trigger_with_channels(const StubPtr& stub, const nidevice_grpc::Session& vi, const pb::string& channel_name, const pb::string& input_terminal, const pb::int32& edge);
ConfigureDigitalEdgeSourceTriggerResponse configure_digital_edge_source_trigger(const StubPtr& stub, const nidevice_grpc::Session& vi, const pb::string& input_terminal, const pb::int32& edge);
ConfigureDigitalEdgeSourceTriggerWithChannelsResponse configure_digital_edge_source_trigger_with_channels(const StubPtr& stub, const nidevice_grpc::Session& vi, const pb::string& channel_name, const pb::string& input_terminal, const pb::int32& edge);
ConfigureDigitalEdgeStartTriggerResponse configure_digital_edge_start_trigger(const StubPtr& stub, const nidevice_grpc::Session& vi, const pb::string& input_terminal, const pb::int32& edge);
ConfigureDigitalEdgeStartTriggerWithChannelsResponse configure_digital_edge_start_trigger_with_channels(const StubPtr& stub, const nidevice_grpc::Session& vi, const pb::string& channel_name, const pb::string& input_terminal, const pb::int32& edge);
...
ConfigurePowerLineFrequencyResponse configure_power_line_frequency(const StubPtr& stub, const nidevice_grpc::Session& vi, const double& powerline_frequency);
...
ConfigureSenseResponse configure_sense(const StubPtr& stub, const nidevice_grpc::Session& vi, const pb::string& channel_name, const pb::int32& sense);
...
ConfigureSourceModeResponse configure_source_mode(const StubPtr& stub, const nidevice_grpc::Session& vi, const pb::int32& source_mode);
ConfigureSourceModeWithChannelsResponse configure_source_mode_with_channels(const StubPtr& stub, const nidevice_grpc::Session& vi, const pb::string& channel_name, const pb::int32& source_mode);
...
ExportSignalWithChannelsResponse export_signal_with_channels(const StubPtr& stub, const nidevice_grpc::Session& vi, const pb::string& channel_name, const pb::int32& signal, const pb::string& signal_identifier, const pb::string& output_terminal);
...
SendSoftwareEdgeTriggerResponse send_software_edge_trigger(const StubPtr& stub, const nidevice_grpc::Session& vi, const pb::int32& trigger);
SendSoftwareEdgeTriggerWithChannelsResponse send_software_edge_trigger_with_channels(const StubPtr& stub, const nidevice_grpc::Session& vi, const pb::string& channel_name, const pb::int32& trigger);
...
WaitForEventWithChannelsResponse wait_for_event_with_channels(const StubPtr& stub, const nidevice_grpc::Session& vi, const pb::string& channel_name, const pb::int32& event_id, const double& timeout);
