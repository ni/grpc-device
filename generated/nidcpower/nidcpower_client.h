...
ClearLatchedOutputCutoffStateResponse clear_latched_output_cutoff_state(const StubPtr& stub, const nidevice_grpc::Session& vi, const pb::string& channel_name, const pb::int32& output_cutoff_reason);
...
QueryLatchedOutputCutoffStateResponse query_latched_output_cutoff_state(const StubPtr& stub, const nidevice_grpc::Session& vi, const pb::string& channel_name, const pb::int32& output_cutoff_reason);
