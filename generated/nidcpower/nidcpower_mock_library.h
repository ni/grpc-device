...
class NiDCPowerMockLibrary : public nidcpower_grpc::NiDCPowerLibraryInterface {
 public:
  ...
  MOCK_METHOD(ViStatus, ConfigureLCRCompensation, (ViSession vi, ViConstString channelName, ViInt32 compensationDataSize, ViAddr compensationData[]), (override));
  MOCK_METHOD(ViStatus, ConfigureLCRCustomCableCompensation, (ViSession vi, ViConstString channelName, ViInt32 customCableCompensationDataSize, ViAddr customCableCompensationData[]), (override));
  ...
  MOCK_METHOD(ViStatus, GetLCRCompensationData, (ViSession vi, ViConstString channelName, ViInt32 compensationDataSize, ViAddr compensationData[]), (override));
  ...
  MOCK_METHOD(ViStatus, GetLCRCustomCableCompensationData, (ViSession vi, ViConstString channelName, ViInt32 customCableCompensationDataSize, ViAddr customCableCompensationData[]), (override));
