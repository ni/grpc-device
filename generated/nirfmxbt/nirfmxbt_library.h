...
class NiRFmxBTLibrary : public nirfmxbt_grpc::NiRFmxBTLibraryInterface {
 ...
 private:
  ...
  using BuildBandwidthPartStringPtr = decltype(&RFmxBT_BuildBandwidthPartString);
  using BuildCORESETClusterStringPtr = decltype(&RFmxBT_BuildCORESETClusterString);
  using BuildCORESETStringPtr = decltype(&RFmxBT_BuildCORESETString);
  using BuildCarrierStringPtr = decltype(&RFmxBT_BuildCarrierString);
  using BuildListStepStringPtr = decltype(&RFmxBT_BuildListStepString);
  using BuildListStringPtr = decltype(&RFmxBT_BuildListString);
  using BuildOffsetStringPtr = decltype(&RFmxBT_BuildOffsetString);
  using BuildPDCCHStringPtr = decltype(&RFmxBT_BuildPDCCHString);
  using BuildPDSCHClusterStringPtr = decltype(&RFmxBT_BuildPDSCHClusterString);
  using BuildPDSCHStringPtr = decltype(&RFmxBT_BuildPDSCHString);
  using BuildPUSCHClusterStringPtr = decltype(&RFmxBT_BuildPUSCHClusterString);
  using BuildPUSCHStringPtr = decltype(&RFmxBT_BuildPUSCHString);
  using BuildSignalStringPtr = decltype(&RFmxBT_BuildSignalString);
  using BuildSubblockStringPtr = decltype(&RFmxBT_BuildSubblockString);
  using BuildUserStringPtr = decltype(&RFmxBT_BuildUserString);
