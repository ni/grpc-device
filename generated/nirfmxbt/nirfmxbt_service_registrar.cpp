...
//---------------------------------------------------------------------
// Service registrar implementation for the NI-RFMXBT Metadata
//---------------------------------------------------------------------
...
#include "nirfmxbt_service_registrar.h"
...
struct LibraryAndService {
  ...
  NiRFmxBTLibrary library;
  NiRFmxBTService service;
};
}
...
{
  auto toggles = NiRFmxBTFeatureToggles(feature_toggles);
