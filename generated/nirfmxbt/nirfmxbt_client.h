...
SetAttributeStringResponse set_attribute_string(const StubPtr& stub, const nidevice_grpc::Session& instrument, const pb::string& selector_string, const NiRFmxBTAttribute& attribute_id, const simple_variant<NiRFmxBTStringAttributeValuesMapped, std::string>& attr_val);
