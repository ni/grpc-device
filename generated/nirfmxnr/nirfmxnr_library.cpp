...
NiRFmxNRLibrary::NiRFmxNRLibrary(std::shared_ptr<nidevice_grpc::SharedLibraryInterface> pSharedLibrary) : p_shared_library_(pSharedLibrary)
{
  ...
  function_pointers_.ACPCfgAveraging = reinterpret_cast<ACPCfgAveragingPtr>(p_shared_library_->get_function_pointer("RFmxNR_ACPCfgAveraging"));
  function_pointers_.ACPCfgMeasurementMethod = reinterpret_cast<ACPCfgMeasurementMethodPtr>(p_shared_library_->get_function_pointer("RFmxNR_ACPCfgMeasurementMethod"));
  function_pointers_.ACPCfgNoiseCompensationEnabled = reinterpret_cast<ACPCfgNoiseCompensationEnabledPtr>(p_shared_library_->get_function_pointer("RFmxNR_ACPCfgNoiseCompensationEnabled"));
  function_pointers_.ACPCfgNumberOfENDCOffsets = reinterpret_cast<ACPCfgNumberOfENDCOffsetsPtr>(p_shared_library_->get_function_pointer("RFmxNR_ACPCfgNumberOfENDCOffsets"));
  function_pointers_.ACPCfgNumberOfEUTRAOffsets = reinterpret_cast<ACPCfgNumberOfEUTRAOffsetsPtr>(p_shared_library_->get_function_pointer("RFmxNR_ACPCfgNumberOfEUTRAOffsets"));
  function_pointers_.ACPCfgNumberOfNROffsets = reinterpret_cast<ACPCfgNumberOfNROffsetsPtr>(p_shared_library_->get_function_pointer("RFmxNR_ACPCfgNumberOfNROffsets"));
  function_pointers_.ACPCfgNumberOfUTRAOffsets = reinterpret_cast<ACPCfgNumberOfUTRAOffsetsPtr>(p_shared_library_->get_function_pointer("RFmxNR_ACPCfgNumberOfUTRAOffsets"));
  function_pointers_.ACPCfgPowerUnits = reinterpret_cast<ACPCfgPowerUnitsPtr>(p_shared_library_->get_function_pointer("RFmxNR_ACPCfgPowerUnits"));
  function_pointers_.ACPCfgRBWFilter = reinterpret_cast<ACPCfgRBWFilterPtr>(p_shared_library_->get_function_pointer("RFmxNR_ACPCfgRBWFilter"));
  function_pointers_.ACPCfgSweepTime = reinterpret_cast<ACPCfgSweepTimePtr>(p_shared_library_->get_function_pointer("RFmxNR_ACPCfgSweepTime"));
  function_pointers_.ACPFetchAbsolutePowersTrace = reinterpret_cast<ACPFetchAbsolutePowersTracePtr>(p_shared_library_->get_function_pointer("RFmxNR_ACPFetchAbsolutePowersTrace"));
  function_pointers_.ACPFetchComponentCarrierMeasurement = reinterpret_cast<ACPFetchComponentCarrierMeasurementPtr>(p_shared_library_->get_function_pointer("RFmxNR_ACPFetchComponentCarrierMeasurement"));
  function_pointers_.ACPFetchComponentCarrierMeasurementArray = reinterpret_cast<ACPFetchComponentCarrierMeasurementArrayPtr>(p_shared_library_->get_function_pointer("RFmxNR_ACPFetchComponentCarrierMeasurementArray"));
  function_pointers_.ACPFetchOffsetMeasurement = reinterpret_cast<ACPFetchOffsetMeasurementPtr>(p_shared_library_->get_function_pointer("RFmxNR_ACPFetchOffsetMeasurement"));
  function_pointers_.ACPFetchOffsetMeasurementArray = reinterpret_cast<ACPFetchOffsetMeasurementArrayPtr>(p_shared_library_->get_function_pointer("RFmxNR_ACPFetchOffsetMeasurementArray"));
  function_pointers_.ACPFetchRelativePowersTrace = reinterpret_cast<ACPFetchRelativePowersTracePtr>(p_shared_library_->get_function_pointer("RFmxNR_ACPFetchRelativePowersTrace"));
  function_pointers_.ACPFetchSpectrum = reinterpret_cast<ACPFetchSpectrumPtr>(p_shared_library_->get_function_pointer("RFmxNR_ACPFetchSpectrum"));
  function_pointers_.ACPFetchSubblockMeasurement = reinterpret_cast<ACPFetchSubblockMeasurementPtr>(p_shared_library_->get_function_pointer("RFmxNR_ACPFetchSubblockMeasurement"));
  function_pointers_.ACPFetchTotalAggregatedPower = reinterpret_cast<ACPFetchTotalAggregatedPowerPtr>(p_shared_library_->get_function_pointer("RFmxNR_ACPFetchTotalAggregatedPower"));
  function_pointers_.ACPValidateNoiseCalibrationData = reinterpret_cast<ACPValidateNoiseCalibrationDataPtr>(p_shared_library_->get_function_pointer("RFmxNR_ACPValidateNoiseCalibrationData"));
  function_pointers_.AbortMeasurements = reinterpret_cast<AbortMeasurementsPtr>(p_shared_library_->get_function_pointer("RFmxNR_AbortMeasurements"));
  function_pointers_.AnalyzeIQ1Waveform = reinterpret_cast<AnalyzeIQ1WaveformPtr>(p_shared_library_->get_function_pointer("RFmxNR_AnalyzeIQ1Waveform"));
  function_pointers_.AnalyzeSpectrum1Waveform = reinterpret_cast<AnalyzeSpectrum1WaveformPtr>(p_shared_library_->get_function_pointer("RFmxNR_AnalyzeSpectrum1Waveform"));
  function_pointers_.AutoLevel = reinterpret_cast<AutoLevelPtr>(p_shared_library_->get_function_pointer("RFmxNR_AutoLevel"));
  function_pointers_.BuildBandwidthPartString = reinterpret_cast<BuildBandwidthPartStringPtr>(p_shared_library_->get_function_pointer("RFmxNR_BuildBandwidthPartString"));
  function_pointers_.BuildCORESETClusterString = reinterpret_cast<BuildCORESETClusterStringPtr>(p_shared_library_->get_function_pointer("RFmxNR_BuildCORESETClusterString"));
  function_pointers_.BuildCORESETString = reinterpret_cast<BuildCORESETStringPtr>(p_shared_library_->get_function_pointer("RFmxNR_BuildCORESETString"));
  function_pointers_.BuildCarrierString = reinterpret_cast<BuildCarrierStringPtr>(p_shared_library_->get_function_pointer("RFmxNR_BuildCarrierString"));
  function_pointers_.BuildListStepString = reinterpret_cast<BuildListStepStringPtr>(p_shared_library_->get_function_pointer("RFmxNR_BuildListStepString"));
  function_pointers_.BuildListString = reinterpret_cast<BuildListStringPtr>(p_shared_library_->get_function_pointer("RFmxNR_BuildListString"));
  function_pointers_.BuildOffsetString = reinterpret_cast<BuildOffsetStringPtr>(p_shared_library_->get_function_pointer("RFmxNR_BuildOffsetString"));
  function_pointers_.BuildPDCCHString = reinterpret_cast<BuildPDCCHStringPtr>(p_shared_library_->get_function_pointer("RFmxNR_BuildPDCCHString"));
  function_pointers_.BuildPDSCHClusterString = reinterpret_cast<BuildPDSCHClusterStringPtr>(p_shared_library_->get_function_pointer("RFmxNR_BuildPDSCHClusterString"));
  function_pointers_.BuildPDSCHString = reinterpret_cast<BuildPDSCHStringPtr>(p_shared_library_->get_function_pointer("RFmxNR_BuildPDSCHString"));
  function_pointers_.BuildPUSCHClusterString = reinterpret_cast<BuildPUSCHClusterStringPtr>(p_shared_library_->get_function_pointer("RFmxNR_BuildPUSCHClusterString"));
  function_pointers_.BuildPUSCHString = reinterpret_cast<BuildPUSCHStringPtr>(p_shared_library_->get_function_pointer("RFmxNR_BuildPUSCHString"));
  function_pointers_.BuildSignalString = reinterpret_cast<BuildSignalStringPtr>(p_shared_library_->get_function_pointer("RFmxNR_BuildSignalString"));
  function_pointers_.BuildSubblockString = reinterpret_cast<BuildSubblockStringPtr>(p_shared_library_->get_function_pointer("RFmxNR_BuildSubblockString"));
  function_pointers_.BuildUserString = reinterpret_cast<BuildUserStringPtr>(p_shared_library_->get_function_pointer("RFmxNR_BuildUserString"));
  function_pointers_.CHPCfgAveraging = reinterpret_cast<CHPCfgAveragingPtr>(p_shared_library_->get_function_pointer("RFmxNR_CHPCfgAveraging"));
  function_pointers_.CHPCfgRBWFilter = reinterpret_cast<CHPCfgRBWFilterPtr>(p_shared_library_->get_function_pointer("RFmxNR_CHPCfgRBWFilter"));
  function_pointers_.CHPCfgSweepTime = reinterpret_cast<CHPCfgSweepTimePtr>(p_shared_library_->get_function_pointer("RFmxNR_CHPCfgSweepTime"));
  function_pointers_.CHPFetchComponentCarrierMeasurement = reinterpret_cast<CHPFetchComponentCarrierMeasurementPtr>(p_shared_library_->get_function_pointer("RFmxNR_CHPFetchComponentCarrierMeasurement"));
  function_pointers_.CHPFetchComponentCarrierMeasurementArray = reinterpret_cast<CHPFetchComponentCarrierMeasurementArrayPtr>(p_shared_library_->get_function_pointer("RFmxNR_CHPFetchComponentCarrierMeasurementArray"));
  function_pointers_.CHPFetchSpectrum = reinterpret_cast<CHPFetchSpectrumPtr>(p_shared_library_->get_function_pointer("RFmxNR_CHPFetchSpectrum"));
  function_pointers_.CHPFetchSubblockPower = reinterpret_cast<CHPFetchSubblockPowerPtr>(p_shared_library_->get_function_pointer("RFmxNR_CHPFetchSubblockPower"));
  function_pointers_.CHPFetchTotalAggregatedPower = reinterpret_cast<CHPFetchTotalAggregatedPowerPtr>(p_shared_library_->get_function_pointer("RFmxNR_CHPFetchTotalAggregatedPower"));
  function_pointers_.CHPValidateNoiseCalibrationData = reinterpret_cast<CHPValidateNoiseCalibrationDataPtr>(p_shared_library_->get_function_pointer("RFmxNR_CHPValidateNoiseCalibrationData"));
  function_pointers_.CfgDigitalEdgeTrigger = reinterpret_cast<CfgDigitalEdgeTriggerPtr>(p_shared_library_->get_function_pointer("RFmxNR_CfgDigitalEdgeTrigger"));
  function_pointers_.CfgExternalAttenuation = reinterpret_cast<CfgExternalAttenuationPtr>(p_shared_library_->get_function_pointer("RFmxNR_CfgExternalAttenuation"));
  function_pointers_.CfgFrequency = reinterpret_cast<CfgFrequencyPtr>(p_shared_library_->get_function_pointer("RFmxNR_CfgFrequency"));
  function_pointers_.CfgFrequencyReference = reinterpret_cast<CfgFrequencyReferencePtr>(p_shared_library_->get_function_pointer("RFmxNR_CfgFrequencyReference"));
  function_pointers_.CfgIQPowerEdgeTrigger = reinterpret_cast<CfgIQPowerEdgeTriggerPtr>(p_shared_library_->get_function_pointer("RFmxNR_CfgIQPowerEdgeTrigger"));
  function_pointers_.CfgMechanicalAttenuation = reinterpret_cast<CfgMechanicalAttenuationPtr>(p_shared_library_->get_function_pointer("RFmxNR_CfgMechanicalAttenuation"));
  function_pointers_.CfgRF = reinterpret_cast<CfgRFPtr>(p_shared_library_->get_function_pointer("RFmxNR_CfgRF"));
  function_pointers_.CfgRFAttenuation = reinterpret_cast<CfgRFAttenuationPtr>(p_shared_library_->get_function_pointer("RFmxNR_CfgRFAttenuation"));
  function_pointers_.CfgReferenceLevel = reinterpret_cast<CfgReferenceLevelPtr>(p_shared_library_->get_function_pointer("RFmxNR_CfgReferenceLevel"));
  function_pointers_.CfgSoftwareEdgeTrigger = reinterpret_cast<CfgSoftwareEdgeTriggerPtr>(p_shared_library_->get_function_pointer("RFmxNR_CfgSoftwareEdgeTrigger"));
  function_pointers_.CfggNodeBCategory = reinterpret_cast<CfggNodeBCategoryPtr>(p_shared_library_->get_function_pointer("RFmxNR_CfggNodeBCategory"));
  function_pointers_.CheckMeasurementStatus = reinterpret_cast<CheckMeasurementStatusPtr>(p_shared_library_->get_function_pointer("RFmxNR_CheckMeasurementStatus"));
  function_pointers_.ClearAllNamedResults = reinterpret_cast<ClearAllNamedResultsPtr>(p_shared_library_->get_function_pointer("RFmxNR_ClearAllNamedResults"));
  function_pointers_.ClearNamedResult = reinterpret_cast<ClearNamedResultPtr>(p_shared_library_->get_function_pointer("RFmxNR_ClearNamedResult"));
  function_pointers_.ClearNoiseCalibrationDatabase = reinterpret_cast<ClearNoiseCalibrationDatabasePtr>(p_shared_library_->get_function_pointer("RFmxNR_ClearNoiseCalibrationDatabase"));
  function_pointers_.CloneSignalConfiguration = reinterpret_cast<CloneSignalConfigurationPtr>(p_shared_library_->get_function_pointer("RFmxNR_CloneSignalConfiguration"));
  function_pointers_.Close = reinterpret_cast<ClosePtr>(p_shared_library_->get_function_pointer("RFmxNR_Close"));
  function_pointers_.Commit = reinterpret_cast<CommitPtr>(p_shared_library_->get_function_pointer("RFmxNR_Commit"));
  function_pointers_.CreateList = reinterpret_cast<CreateListPtr>(p_shared_library_->get_function_pointer("RFmxNR_CreateList"));
  function_pointers_.CreateListStep = reinterpret_cast<CreateListStepPtr>(p_shared_library_->get_function_pointer("RFmxNR_CreateListStep"));
  function_pointers_.CreateSignalConfiguration = reinterpret_cast<CreateSignalConfigurationPtr>(p_shared_library_->get_function_pointer("RFmxNR_CreateSignalConfiguration"));
  function_pointers_.DeleteList = reinterpret_cast<DeleteListPtr>(p_shared_library_->get_function_pointer("RFmxNR_DeleteList"));
  function_pointers_.DeleteSignalConfiguration = reinterpret_cast<DeleteSignalConfigurationPtr>(p_shared_library_->get_function_pointer("RFmxNR_DeleteSignalConfiguration"));
  function_pointers_.DisableTrigger = reinterpret_cast<DisableTriggerPtr>(p_shared_library_->get_function_pointer("RFmxNR_DisableTrigger"));
  function_pointers_.GetAllNamedResultNames = reinterpret_cast<GetAllNamedResultNamesPtr>(p_shared_library_->get_function_pointer("RFmxNR_GetAllNamedResultNames"));
  function_pointers_.GetAttributeF32 = reinterpret_cast<GetAttributeF32Ptr>(p_shared_library_->get_function_pointer("RFmxNR_GetAttributeF32"));
  function_pointers_.GetAttributeF32Array = reinterpret_cast<GetAttributeF32ArrayPtr>(p_shared_library_->get_function_pointer("RFmxNR_GetAttributeF32Array"));
  function_pointers_.GetAttributeF64 = reinterpret_cast<GetAttributeF64Ptr>(p_shared_library_->get_function_pointer("RFmxNR_GetAttributeF64"));
  function_pointers_.GetAttributeF64Array = reinterpret_cast<GetAttributeF64ArrayPtr>(p_shared_library_->get_function_pointer("RFmxNR_GetAttributeF64Array"));
  function_pointers_.GetAttributeI16 = reinterpret_cast<GetAttributeI16Ptr>(p_shared_library_->get_function_pointer("RFmxNR_GetAttributeI16"));
  function_pointers_.GetAttributeI32 = reinterpret_cast<GetAttributeI32Ptr>(p_shared_library_->get_function_pointer("RFmxNR_GetAttributeI32"));
  function_pointers_.GetAttributeI32Array = reinterpret_cast<GetAttributeI32ArrayPtr>(p_shared_library_->get_function_pointer("RFmxNR_GetAttributeI32Array"));
  function_pointers_.GetAttributeI64 = reinterpret_cast<GetAttributeI64Ptr>(p_shared_library_->get_function_pointer("RFmxNR_GetAttributeI64"));
  function_pointers_.GetAttributeI64Array = reinterpret_cast<GetAttributeI64ArrayPtr>(p_shared_library_->get_function_pointer("RFmxNR_GetAttributeI64Array"));
  function_pointers_.GetAttributeI8 = reinterpret_cast<GetAttributeI8Ptr>(p_shared_library_->get_function_pointer("RFmxNR_GetAttributeI8"));
  function_pointers_.GetAttributeI8Array = reinterpret_cast<GetAttributeI8ArrayPtr>(p_shared_library_->get_function_pointer("RFmxNR_GetAttributeI8Array"));
  function_pointers_.GetAttributeNIComplexDoubleArray = reinterpret_cast<GetAttributeNIComplexDoubleArrayPtr>(p_shared_library_->get_function_pointer("RFmxNR_GetAttributeNIComplexDoubleArray"));
  function_pointers_.GetAttributeNIComplexSingleArray = reinterpret_cast<GetAttributeNIComplexSingleArrayPtr>(p_shared_library_->get_function_pointer("RFmxNR_GetAttributeNIComplexSingleArray"));
  function_pointers_.GetAttributeString = reinterpret_cast<GetAttributeStringPtr>(p_shared_library_->get_function_pointer("RFmxNR_GetAttributeString"));
  function_pointers_.GetAttributeU16 = reinterpret_cast<GetAttributeU16Ptr>(p_shared_library_->get_function_pointer("RFmxNR_GetAttributeU16"));
  function_pointers_.GetAttributeU32 = reinterpret_cast<GetAttributeU32Ptr>(p_shared_library_->get_function_pointer("RFmxNR_GetAttributeU32"));
  function_pointers_.GetAttributeU32Array = reinterpret_cast<GetAttributeU32ArrayPtr>(p_shared_library_->get_function_pointer("RFmxNR_GetAttributeU32Array"));
  function_pointers_.GetAttributeU64Array = reinterpret_cast<GetAttributeU64ArrayPtr>(p_shared_library_->get_function_pointer("RFmxNR_GetAttributeU64Array"));
  function_pointers_.GetAttributeU8 = reinterpret_cast<GetAttributeU8Ptr>(p_shared_library_->get_function_pointer("RFmxNR_GetAttributeU8"));
  function_pointers_.GetAttributeU8Array = reinterpret_cast<GetAttributeU8ArrayPtr>(p_shared_library_->get_function_pointer("RFmxNR_GetAttributeU8Array"));
  function_pointers_.GetError = reinterpret_cast<GetErrorPtr>(p_shared_library_->get_function_pointer("RFmxNR_GetError"));
  function_pointers_.GetErrorString = reinterpret_cast<GetErrorStringPtr>(p_shared_library_->get_function_pointer("RFmxNR_GetErrorString"));
  function_pointers_.Initialize = reinterpret_cast<InitializePtr>(p_shared_library_->get_function_pointer("RFmxNR_Initialize"));
  function_pointers_.InitializeFromNIRFSASession = reinterpret_cast<InitializeFromNIRFSASessionPtr>(p_shared_library_->get_function_pointer("RFmxNR_InitializeFromNIRFSASession"));
  function_pointers_.Initiate = reinterpret_cast<InitiatePtr>(p_shared_library_->get_function_pointer("RFmxNR_Initiate"));
  function_pointers_.LoadFromGenerationConfigurationFile = reinterpret_cast<LoadFromGenerationConfigurationFilePtr>(p_shared_library_->get_function_pointer("RFmxNR_LoadFromGenerationConfigurationFile"));
  function_pointers_.ModAccAutoLevel = reinterpret_cast<ModAccAutoLevelPtr>(p_shared_library_->get_function_pointer("RFmxNR_ModAccAutoLevel"));
  function_pointers_.ModAccCfgMeasurementMode = reinterpret_cast<ModAccCfgMeasurementModePtr>(p_shared_library_->get_function_pointer("RFmxNR_ModAccCfgMeasurementMode"));
  function_pointers_.ModAccCfgNoiseCompensationEnabled = reinterpret_cast<ModAccCfgNoiseCompensationEnabledPtr>(p_shared_library_->get_function_pointer("RFmxNR_ModAccCfgNoiseCompensationEnabled"));
  function_pointers_.ModAccCfgReferenceWaveform = reinterpret_cast<ModAccCfgReferenceWaveformPtr>(p_shared_library_->get_function_pointer("RFmxNR_ModAccCfgReferenceWaveform"));
  function_pointers_.ModAccClearNoiseCalibrationDatabase = reinterpret_cast<ModAccClearNoiseCalibrationDatabasePtr>(p_shared_library_->get_function_pointer("RFmxNR_ModAccClearNoiseCalibrationDatabase"));
  function_pointers_.ModAccFetchCompositeEVM = reinterpret_cast<ModAccFetchCompositeEVMPtr>(p_shared_library_->get_function_pointer("RFmxNR_ModAccFetchCompositeEVM"));
  function_pointers_.ModAccFetchFrequencyErrorMean = reinterpret_cast<ModAccFetchFrequencyErrorMeanPtr>(p_shared_library_->get_function_pointer("RFmxNR_ModAccFetchFrequencyErrorMean"));
  function_pointers_.ModAccFetchFrequencyErrorPerSlotMaximumTrace = reinterpret_cast<ModAccFetchFrequencyErrorPerSlotMaximumTracePtr>(p_shared_library_->get_function_pointer("RFmxNR_ModAccFetchFrequencyErrorPerSlotMaximumTrace"));
  function_pointers_.ModAccFetchIQGainImbalancePerSubcarrierMeanTrace = reinterpret_cast<ModAccFetchIQGainImbalancePerSubcarrierMeanTracePtr>(p_shared_library_->get_function_pointer("RFmxNR_ModAccFetchIQGainImbalancePerSubcarrierMeanTrace"));
  function_pointers_.ModAccFetchIQQuadratureErrorPerSubcarrierMeanTrace = reinterpret_cast<ModAccFetchIQQuadratureErrorPerSubcarrierMeanTracePtr>(p_shared_library_->get_function_pointer("RFmxNR_ModAccFetchIQQuadratureErrorPerSubcarrierMeanTrace"));
  function_pointers_.ModAccFetchInBandEmissionTrace = reinterpret_cast<ModAccFetchInBandEmissionTracePtr>(p_shared_library_->get_function_pointer("RFmxNR_ModAccFetchInBandEmissionTrace"));
  function_pointers_.ModAccFetchPBCHDMRSConstellationTrace = reinterpret_cast<ModAccFetchPBCHDMRSConstellationTracePtr>(p_shared_library_->get_function_pointer("RFmxNR_ModAccFetchPBCHDMRSConstellationTrace"));
  function_pointers_.ModAccFetchPBCHDMRSRMSEVMPerSubcarrierMeanTrace = reinterpret_cast<ModAccFetchPBCHDMRSRMSEVMPerSubcarrierMeanTracePtr>(p_shared_library_->get_function_pointer("RFmxNR_ModAccFetchPBCHDMRSRMSEVMPerSubcarrierMeanTrace"));
  function_pointers_.ModAccFetchPBCHDMRSRMSEVMPerSymbolMeanTrace = reinterpret_cast<ModAccFetchPBCHDMRSRMSEVMPerSymbolMeanTracePtr>(p_shared_library_->get_function_pointer("RFmxNR_ModAccFetchPBCHDMRSRMSEVMPerSymbolMeanTrace"));
  function_pointers_.ModAccFetchPBCHDataConstellationTrace = reinterpret_cast<ModAccFetchPBCHDataConstellationTracePtr>(p_shared_library_->get_function_pointer("RFmxNR_ModAccFetchPBCHDataConstellationTrace"));
  function_pointers_.ModAccFetchPBCHDataRMSEVMPerSubcarrierMeanTrace = reinterpret_cast<ModAccFetchPBCHDataRMSEVMPerSubcarrierMeanTracePtr>(p_shared_library_->get_function_pointer("RFmxNR_ModAccFetchPBCHDataRMSEVMPerSubcarrierMeanTrace"));
  function_pointers_.ModAccFetchPBCHDataRMSEVMPerSymbolMeanTrace = reinterpret_cast<ModAccFetchPBCHDataRMSEVMPerSymbolMeanTracePtr>(p_shared_library_->get_function_pointer("RFmxNR_ModAccFetchPBCHDataRMSEVMPerSymbolMeanTrace"));
  function_pointers_.ModAccFetchPDSCH1024QAMConstellationTrace = reinterpret_cast<ModAccFetchPDSCH1024QAMConstellationTracePtr>(p_shared_library_->get_function_pointer("RFmxNR_ModAccFetchPDSCH1024QAMConstellationTrace"));
  function_pointers_.ModAccFetchPDSCH16QAMConstellationTrace = reinterpret_cast<ModAccFetchPDSCH16QAMConstellationTracePtr>(p_shared_library_->get_function_pointer("RFmxNR_ModAccFetchPDSCH16QAMConstellationTrace"));
  function_pointers_.ModAccFetchPDSCH256QAMConstellationTrace = reinterpret_cast<ModAccFetchPDSCH256QAMConstellationTracePtr>(p_shared_library_->get_function_pointer("RFmxNR_ModAccFetchPDSCH256QAMConstellationTrace"));
  function_pointers_.ModAccFetchPDSCH64QAMConstellationTrace = reinterpret_cast<ModAccFetchPDSCH64QAMConstellationTracePtr>(p_shared_library_->get_function_pointer("RFmxNR_ModAccFetchPDSCH64QAMConstellationTrace"));
  function_pointers_.ModAccFetchPDSCH8PSKConstellationTrace = reinterpret_cast<ModAccFetchPDSCH8PSKConstellationTracePtr>(p_shared_library_->get_function_pointer("RFmxNR_ModAccFetchPDSCH8PSKConstellationTrace"));
  function_pointers_.ModAccFetchPDSCHDMRSConstellationTrace = reinterpret_cast<ModAccFetchPDSCHDMRSConstellationTracePtr>(p_shared_library_->get_function_pointer("RFmxNR_ModAccFetchPDSCHDMRSConstellationTrace"));
  function_pointers_.ModAccFetchPDSCHDataConstellationTrace = reinterpret_cast<ModAccFetchPDSCHDataConstellationTracePtr>(p_shared_library_->get_function_pointer("RFmxNR_ModAccFetchPDSCHDataConstellationTrace"));
  function_pointers_.ModAccFetchPDSCHDemodulatedBits = reinterpret_cast<ModAccFetchPDSCHDemodulatedBitsPtr>(p_shared_library_->get_function_pointer("RFmxNR_ModAccFetchPDSCHDemodulatedBits"));
  function_pointers_.ModAccFetchPDSCHPTRSConstellationTrace = reinterpret_cast<ModAccFetchPDSCHPTRSConstellationTracePtr>(p_shared_library_->get_function_pointer("RFmxNR_ModAccFetchPDSCHPTRSConstellationTrace"));
  function_pointers_.ModAccFetchPDSCHQPSKConstellationTrace = reinterpret_cast<ModAccFetchPDSCHQPSKConstellationTracePtr>(p_shared_library_->get_function_pointer("RFmxNR_ModAccFetchPDSCHQPSKConstellationTrace"));
  function_pointers_.ModAccFetchPSSConstellationTrace = reinterpret_cast<ModAccFetchPSSConstellationTracePtr>(p_shared_library_->get_function_pointer("RFmxNR_ModAccFetchPSSConstellationTrace"));
  function_pointers_.ModAccFetchPSSRMSEVMPerSubcarrierMeanTrace = reinterpret_cast<ModAccFetchPSSRMSEVMPerSubcarrierMeanTracePtr>(p_shared_library_->get_function_pointer("RFmxNR_ModAccFetchPSSRMSEVMPerSubcarrierMeanTrace"));
  function_pointers_.ModAccFetchPSSRMSEVMPerSymbolMeanTrace = reinterpret_cast<ModAccFetchPSSRMSEVMPerSymbolMeanTracePtr>(p_shared_library_->get_function_pointer("RFmxNR_ModAccFetchPSSRMSEVMPerSymbolMeanTrace"));
  function_pointers_.ModAccFetchPUSCHDMRSConstellationTrace = reinterpret_cast<ModAccFetchPUSCHDMRSConstellationTracePtr>(p_shared_library_->get_function_pointer("RFmxNR_ModAccFetchPUSCHDMRSConstellationTrace"));
  function_pointers_.ModAccFetchPUSCHDataConstellationTrace = reinterpret_cast<ModAccFetchPUSCHDataConstellationTracePtr>(p_shared_library_->get_function_pointer("RFmxNR_ModAccFetchPUSCHDataConstellationTrace"));
  function_pointers_.ModAccFetchPUSCHDemodulatedBits = reinterpret_cast<ModAccFetchPUSCHDemodulatedBitsPtr>(p_shared_library_->get_function_pointer("RFmxNR_ModAccFetchPUSCHDemodulatedBits"));
  function_pointers_.ModAccFetchPUSCHPTRSConstellationTrace = reinterpret_cast<ModAccFetchPUSCHPTRSConstellationTracePtr>(p_shared_library_->get_function_pointer("RFmxNR_ModAccFetchPUSCHPTRSConstellationTrace"));
  function_pointers_.ModAccFetchPUSCHPhaseOffsetTrace = reinterpret_cast<ModAccFetchPUSCHPhaseOffsetTracePtr>(p_shared_library_->get_function_pointer("RFmxNR_ModAccFetchPUSCHPhaseOffsetTrace"));
  function_pointers_.ModAccFetchPeakEVMPerSlotMaximumTrace = reinterpret_cast<ModAccFetchPeakEVMPerSlotMaximumTracePtr>(p_shared_library_->get_function_pointer("RFmxNR_ModAccFetchPeakEVMPerSlotMaximumTrace"));
  function_pointers_.ModAccFetchPeakEVMPerSubcarrierMaximumTrace = reinterpret_cast<ModAccFetchPeakEVMPerSubcarrierMaximumTracePtr>(p_shared_library_->get_function_pointer("RFmxNR_ModAccFetchPeakEVMPerSubcarrierMaximumTrace"));
  function_pointers_.ModAccFetchPeakEVMPerSymbolMaximumTrace = reinterpret_cast<ModAccFetchPeakEVMPerSymbolMaximumTracePtr>(p_shared_library_->get_function_pointer("RFmxNR_ModAccFetchPeakEVMPerSymbolMaximumTrace"));
  function_pointers_.ModAccFetchRMSEVMHighPerSymbolMeanTrace = reinterpret_cast<ModAccFetchRMSEVMHighPerSymbolMeanTracePtr>(p_shared_library_->get_function_pointer("RFmxNR_ModAccFetchRMSEVMHighPerSymbolMeanTrace"));
  function_pointers_.ModAccFetchRMSEVMLowPerSymbolMeanTrace = reinterpret_cast<ModAccFetchRMSEVMLowPerSymbolMeanTracePtr>(p_shared_library_->get_function_pointer("RFmxNR_ModAccFetchRMSEVMLowPerSymbolMeanTrace"));
  function_pointers_.ModAccFetchRMSEVMPerSlotMeanTrace = reinterpret_cast<ModAccFetchRMSEVMPerSlotMeanTracePtr>(p_shared_library_->get_function_pointer("RFmxNR_ModAccFetchRMSEVMPerSlotMeanTrace"));
  function_pointers_.ModAccFetchRMSEVMPerSubcarrierMeanTrace = reinterpret_cast<ModAccFetchRMSEVMPerSubcarrierMeanTracePtr>(p_shared_library_->get_function_pointer("RFmxNR_ModAccFetchRMSEVMPerSubcarrierMeanTrace"));
  function_pointers_.ModAccFetchRMSEVMPerSymbolMeanTrace = reinterpret_cast<ModAccFetchRMSEVMPerSymbolMeanTracePtr>(p_shared_library_->get_function_pointer("RFmxNR_ModAccFetchRMSEVMPerSymbolMeanTrace"));
  function_pointers_.ModAccFetchSSSConstellationTrace = reinterpret_cast<ModAccFetchSSSConstellationTracePtr>(p_shared_library_->get_function_pointer("RFmxNR_ModAccFetchSSSConstellationTrace"));
  function_pointers_.ModAccFetchSSSRMSEVMPerSubcarrierMeanTrace = reinterpret_cast<ModAccFetchSSSRMSEVMPerSubcarrierMeanTracePtr>(p_shared_library_->get_function_pointer("RFmxNR_ModAccFetchSSSRMSEVMPerSubcarrierMeanTrace"));
  function_pointers_.ModAccFetchSSSRMSEVMPerSymbolMeanTrace = reinterpret_cast<ModAccFetchSSSRMSEVMPerSymbolMeanTracePtr>(p_shared_library_->get_function_pointer("RFmxNR_ModAccFetchSSSRMSEVMPerSymbolMeanTrace"));
  function_pointers_.ModAccFetchSpectralFlatnessTrace = reinterpret_cast<ModAccFetchSpectralFlatnessTracePtr>(p_shared_library_->get_function_pointer("RFmxNR_ModAccFetchSpectralFlatnessTrace"));
  function_pointers_.ModAccFetchSubblockInBandEmissionTrace = reinterpret_cast<ModAccFetchSubblockInBandEmissionTracePtr>(p_shared_library_->get_function_pointer("RFmxNR_ModAccFetchSubblockInBandEmissionTrace"));
  function_pointers_.ModAccFetchTransientPeriodLocationsTrace = reinterpret_cast<ModAccFetchTransientPeriodLocationsTracePtr>(p_shared_library_->get_function_pointer("RFmxNR_ModAccFetchTransientPeriodLocationsTrace"));
  function_pointers_.ModAccValidateCalibrationData = reinterpret_cast<ModAccValidateCalibrationDataPtr>(p_shared_library_->get_function_pointer("RFmxNR_ModAccValidateCalibrationData"));
  function_pointers_.OBWCfgAveraging = reinterpret_cast<OBWCfgAveragingPtr>(p_shared_library_->get_function_pointer("RFmxNR_OBWCfgAveraging"));
  function_pointers_.OBWCfgRBWFilter = reinterpret_cast<OBWCfgRBWFilterPtr>(p_shared_library_->get_function_pointer("RFmxNR_OBWCfgRBWFilter"));
  function_pointers_.OBWCfgSweepTime = reinterpret_cast<OBWCfgSweepTimePtr>(p_shared_library_->get_function_pointer("RFmxNR_OBWCfgSweepTime"));
  function_pointers_.OBWFetchMeasurement = reinterpret_cast<OBWFetchMeasurementPtr>(p_shared_library_->get_function_pointer("RFmxNR_OBWFetchMeasurement"));
  function_pointers_.OBWFetchSpectrum = reinterpret_cast<OBWFetchSpectrumPtr>(p_shared_library_->get_function_pointer("RFmxNR_OBWFetchSpectrum"));
  function_pointers_.PVTCfgAveraging = reinterpret_cast<PVTCfgAveragingPtr>(p_shared_library_->get_function_pointer("RFmxNR_PVTCfgAveraging"));
  function_pointers_.PVTCfgMeasurementMethod = reinterpret_cast<PVTCfgMeasurementMethodPtr>(p_shared_library_->get_function_pointer("RFmxNR_PVTCfgMeasurementMethod"));
  function_pointers_.PVTCfgOFFPowerExclusionPeriods = reinterpret_cast<PVTCfgOFFPowerExclusionPeriodsPtr>(p_shared_library_->get_function_pointer("RFmxNR_PVTCfgOFFPowerExclusionPeriods"));
  function_pointers_.PVTFetchMeasurement = reinterpret_cast<PVTFetchMeasurementPtr>(p_shared_library_->get_function_pointer("RFmxNR_PVTFetchMeasurement"));
  function_pointers_.PVTFetchMeasurementArray = reinterpret_cast<PVTFetchMeasurementArrayPtr>(p_shared_library_->get_function_pointer("RFmxNR_PVTFetchMeasurementArray"));
  function_pointers_.PVTFetchSignalPowerTrace = reinterpret_cast<PVTFetchSignalPowerTracePtr>(p_shared_library_->get_function_pointer("RFmxNR_PVTFetchSignalPowerTrace"));
  function_pointers_.PVTFetchWindowedSignalPowerTrace = reinterpret_cast<PVTFetchWindowedSignalPowerTracePtr>(p_shared_library_->get_function_pointer("RFmxNR_PVTFetchWindowedSignalPowerTrace"));
  function_pointers_.ResetAttribute = reinterpret_cast<ResetAttributePtr>(p_shared_library_->get_function_pointer("RFmxNR_ResetAttribute"));
  function_pointers_.ResetToDefault = reinterpret_cast<ResetToDefaultPtr>(p_shared_library_->get_function_pointer("RFmxNR_ResetToDefault"));
  function_pointers_.SEMCfgAveraging = reinterpret_cast<SEMCfgAveragingPtr>(p_shared_library_->get_function_pointer("RFmxNR_SEMCfgAveraging"));
  function_pointers_.SEMCfgComponentCarrierRatedOutputPower = reinterpret_cast<SEMCfgComponentCarrierRatedOutputPowerPtr>(p_shared_library_->get_function_pointer("RFmxNR_SEMCfgComponentCarrierRatedOutputPower"));
  function_pointers_.SEMCfgComponentCarrierRatedOutputPowerArray = reinterpret_cast<SEMCfgComponentCarrierRatedOutputPowerArrayPtr>(p_shared_library_->get_function_pointer("RFmxNR_SEMCfgComponentCarrierRatedOutputPowerArray"));
  function_pointers_.SEMCfgNumberOfOffsets = reinterpret_cast<SEMCfgNumberOfOffsetsPtr>(p_shared_library_->get_function_pointer("RFmxNR_SEMCfgNumberOfOffsets"));
  function_pointers_.SEMCfgOffsetAbsoluteLimit = reinterpret_cast<SEMCfgOffsetAbsoluteLimitPtr>(p_shared_library_->get_function_pointer("RFmxNR_SEMCfgOffsetAbsoluteLimit"));
  function_pointers_.SEMCfgOffsetAbsoluteLimitArray = reinterpret_cast<SEMCfgOffsetAbsoluteLimitArrayPtr>(p_shared_library_->get_function_pointer("RFmxNR_SEMCfgOffsetAbsoluteLimitArray"));
  function_pointers_.SEMCfgOffsetBandwidthIntegral = reinterpret_cast<SEMCfgOffsetBandwidthIntegralPtr>(p_shared_library_->get_function_pointer("RFmxNR_SEMCfgOffsetBandwidthIntegral"));
  function_pointers_.SEMCfgOffsetBandwidthIntegralArray = reinterpret_cast<SEMCfgOffsetBandwidthIntegralArrayPtr>(p_shared_library_->get_function_pointer("RFmxNR_SEMCfgOffsetBandwidthIntegralArray"));
  function_pointers_.SEMCfgOffsetFrequency = reinterpret_cast<SEMCfgOffsetFrequencyPtr>(p_shared_library_->get_function_pointer("RFmxNR_SEMCfgOffsetFrequency"));
  function_pointers_.SEMCfgOffsetFrequencyArray = reinterpret_cast<SEMCfgOffsetFrequencyArrayPtr>(p_shared_library_->get_function_pointer("RFmxNR_SEMCfgOffsetFrequencyArray"));
  function_pointers_.SEMCfgOffsetLimitFailMask = reinterpret_cast<SEMCfgOffsetLimitFailMaskPtr>(p_shared_library_->get_function_pointer("RFmxNR_SEMCfgOffsetLimitFailMask"));
  function_pointers_.SEMCfgOffsetLimitFailMaskArray = reinterpret_cast<SEMCfgOffsetLimitFailMaskArrayPtr>(p_shared_library_->get_function_pointer("RFmxNR_SEMCfgOffsetLimitFailMaskArray"));
  function_pointers_.SEMCfgOffsetRBWFilter = reinterpret_cast<SEMCfgOffsetRBWFilterPtr>(p_shared_library_->get_function_pointer("RFmxNR_SEMCfgOffsetRBWFilter"));
  function_pointers_.SEMCfgOffsetRBWFilterArray = reinterpret_cast<SEMCfgOffsetRBWFilterArrayPtr>(p_shared_library_->get_function_pointer("RFmxNR_SEMCfgOffsetRBWFilterArray"));
  function_pointers_.SEMCfgOffsetRelativeLimit = reinterpret_cast<SEMCfgOffsetRelativeLimitPtr>(p_shared_library_->get_function_pointer("RFmxNR_SEMCfgOffsetRelativeLimit"));
  function_pointers_.SEMCfgOffsetRelativeLimitArray = reinterpret_cast<SEMCfgOffsetRelativeLimitArrayPtr>(p_shared_library_->get_function_pointer("RFmxNR_SEMCfgOffsetRelativeLimitArray"));
  function_pointers_.SEMCfgSweepTime = reinterpret_cast<SEMCfgSweepTimePtr>(p_shared_library_->get_function_pointer("RFmxNR_SEMCfgSweepTime"));
  function_pointers_.SEMCfgUplinkMaskType = reinterpret_cast<SEMCfgUplinkMaskTypePtr>(p_shared_library_->get_function_pointer("RFmxNR_SEMCfgUplinkMaskType"));
  function_pointers_.SEMFetchComponentCarrierMeasurement = reinterpret_cast<SEMFetchComponentCarrierMeasurementPtr>(p_shared_library_->get_function_pointer("RFmxNR_SEMFetchComponentCarrierMeasurement"));
  function_pointers_.SEMFetchComponentCarrierMeasurementArray = reinterpret_cast<SEMFetchComponentCarrierMeasurementArrayPtr>(p_shared_library_->get_function_pointer("RFmxNR_SEMFetchComponentCarrierMeasurementArray"));
  function_pointers_.SEMFetchLowerOffsetMargin = reinterpret_cast<SEMFetchLowerOffsetMarginPtr>(p_shared_library_->get_function_pointer("RFmxNR_SEMFetchLowerOffsetMargin"));
  function_pointers_.SEMFetchLowerOffsetMarginArray = reinterpret_cast<SEMFetchLowerOffsetMarginArrayPtr>(p_shared_library_->get_function_pointer("RFmxNR_SEMFetchLowerOffsetMarginArray"));
  function_pointers_.SEMFetchLowerOffsetPower = reinterpret_cast<SEMFetchLowerOffsetPowerPtr>(p_shared_library_->get_function_pointer("RFmxNR_SEMFetchLowerOffsetPower"));
  function_pointers_.SEMFetchLowerOffsetPowerArray = reinterpret_cast<SEMFetchLowerOffsetPowerArrayPtr>(p_shared_library_->get_function_pointer("RFmxNR_SEMFetchLowerOffsetPowerArray"));
  function_pointers_.SEMFetchMeasurementStatus = reinterpret_cast<SEMFetchMeasurementStatusPtr>(p_shared_library_->get_function_pointer("RFmxNR_SEMFetchMeasurementStatus"));
  function_pointers_.SEMFetchSpectrum = reinterpret_cast<SEMFetchSpectrumPtr>(p_shared_library_->get_function_pointer("RFmxNR_SEMFetchSpectrum"));
  function_pointers_.SEMFetchSubblockMeasurement = reinterpret_cast<SEMFetchSubblockMeasurementPtr>(p_shared_library_->get_function_pointer("RFmxNR_SEMFetchSubblockMeasurement"));
  function_pointers_.SEMFetchTotalAggregatedPower = reinterpret_cast<SEMFetchTotalAggregatedPowerPtr>(p_shared_library_->get_function_pointer("RFmxNR_SEMFetchTotalAggregatedPower"));
  function_pointers_.SEMFetchUpperOffsetMargin = reinterpret_cast<SEMFetchUpperOffsetMarginPtr>(p_shared_library_->get_function_pointer("RFmxNR_SEMFetchUpperOffsetMargin"));
  function_pointers_.SEMFetchUpperOffsetMarginArray = reinterpret_cast<SEMFetchUpperOffsetMarginArrayPtr>(p_shared_library_->get_function_pointer("RFmxNR_SEMFetchUpperOffsetMarginArray"));
  function_pointers_.SEMFetchUpperOffsetPower = reinterpret_cast<SEMFetchUpperOffsetPowerPtr>(p_shared_library_->get_function_pointer("RFmxNR_SEMFetchUpperOffsetPower"));
  function_pointers_.SEMFetchUpperOffsetPowerArray = reinterpret_cast<SEMFetchUpperOffsetPowerArrayPtr>(p_shared_library_->get_function_pointer("RFmxNR_SEMFetchUpperOffsetPowerArray"));
  function_pointers_.SelectMeasurements = reinterpret_cast<SelectMeasurementsPtr>(p_shared_library_->get_function_pointer("RFmxNR_SelectMeasurements"));
  function_pointers_.SendSoftwareEdgeTrigger = reinterpret_cast<SendSoftwareEdgeTriggerPtr>(p_shared_library_->get_function_pointer("RFmxNR_SendSoftwareEdgeTrigger"));
  function_pointers_.SetAttributeF32 = reinterpret_cast<SetAttributeF32Ptr>(p_shared_library_->get_function_pointer("RFmxNR_SetAttributeF32"));
  function_pointers_.SetAttributeF32Array = reinterpret_cast<SetAttributeF32ArrayPtr>(p_shared_library_->get_function_pointer("RFmxNR_SetAttributeF32Array"));
  function_pointers_.SetAttributeF64 = reinterpret_cast<SetAttributeF64Ptr>(p_shared_library_->get_function_pointer("RFmxNR_SetAttributeF64"));
  function_pointers_.SetAttributeF64Array = reinterpret_cast<SetAttributeF64ArrayPtr>(p_shared_library_->get_function_pointer("RFmxNR_SetAttributeF64Array"));
  function_pointers_.SetAttributeI16 = reinterpret_cast<SetAttributeI16Ptr>(p_shared_library_->get_function_pointer("RFmxNR_SetAttributeI16"));
  function_pointers_.SetAttributeI32 = reinterpret_cast<SetAttributeI32Ptr>(p_shared_library_->get_function_pointer("RFmxNR_SetAttributeI32"));
  function_pointers_.SetAttributeI32Array = reinterpret_cast<SetAttributeI32ArrayPtr>(p_shared_library_->get_function_pointer("RFmxNR_SetAttributeI32Array"));
  function_pointers_.SetAttributeI64 = reinterpret_cast<SetAttributeI64Ptr>(p_shared_library_->get_function_pointer("RFmxNR_SetAttributeI64"));
  function_pointers_.SetAttributeI64Array = reinterpret_cast<SetAttributeI64ArrayPtr>(p_shared_library_->get_function_pointer("RFmxNR_SetAttributeI64Array"));
  function_pointers_.SetAttributeI8 = reinterpret_cast<SetAttributeI8Ptr>(p_shared_library_->get_function_pointer("RFmxNR_SetAttributeI8"));
  function_pointers_.SetAttributeI8Array = reinterpret_cast<SetAttributeI8ArrayPtr>(p_shared_library_->get_function_pointer("RFmxNR_SetAttributeI8Array"));
  function_pointers_.SetAttributeNIComplexDoubleArray = reinterpret_cast<SetAttributeNIComplexDoubleArrayPtr>(p_shared_library_->get_function_pointer("RFmxNR_SetAttributeNIComplexDoubleArray"));
  function_pointers_.SetAttributeNIComplexSingleArray = reinterpret_cast<SetAttributeNIComplexSingleArrayPtr>(p_shared_library_->get_function_pointer("RFmxNR_SetAttributeNIComplexSingleArray"));
  function_pointers_.SetAttributeString = reinterpret_cast<SetAttributeStringPtr>(p_shared_library_->get_function_pointer("RFmxNR_SetAttributeString"));
  function_pointers_.SetAttributeU16 = reinterpret_cast<SetAttributeU16Ptr>(p_shared_library_->get_function_pointer("RFmxNR_SetAttributeU16"));
  function_pointers_.SetAttributeU32 = reinterpret_cast<SetAttributeU32Ptr>(p_shared_library_->get_function_pointer("RFmxNR_SetAttributeU32"));
  function_pointers_.SetAttributeU32Array = reinterpret_cast<SetAttributeU32ArrayPtr>(p_shared_library_->get_function_pointer("RFmxNR_SetAttributeU32Array"));
  function_pointers_.SetAttributeU64Array = reinterpret_cast<SetAttributeU64ArrayPtr>(p_shared_library_->get_function_pointer("RFmxNR_SetAttributeU64Array"));
  function_pointers_.SetAttributeU8 = reinterpret_cast<SetAttributeU8Ptr>(p_shared_library_->get_function_pointer("RFmxNR_SetAttributeU8"));
  function_pointers_.SetAttributeU8Array = reinterpret_cast<SetAttributeU8ArrayPtr>(p_shared_library_->get_function_pointer("RFmxNR_SetAttributeU8Array"));
  function_pointers_.TXPFetchMeasurement = reinterpret_cast<TXPFetchMeasurementPtr>(p_shared_library_->get_function_pointer("RFmxNR_TXPFetchMeasurement"));
  function_pointers_.TXPFetchPowerTrace = reinterpret_cast<TXPFetchPowerTracePtr>(p_shared_library_->get_function_pointer("RFmxNR_TXPFetchPowerTrace"));
  function_pointers_.WaitForAcquisitionComplete = reinterpret_cast<WaitForAcquisitionCompletePtr>(p_shared_library_->get_function_pointer("RFmxNR_WaitForAcquisitionComplete"));
  function_pointers_.WaitForMeasurementComplete = reinterpret_cast<WaitForMeasurementCompletePtr>(p_shared_library_->get_function_pointer("RFmxNR_WaitForMeasurementComplete"));
}
