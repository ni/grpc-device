...
int32 NiDAQmxLibrary::GetAnalogPowerUpStates(const char deviceName[], const char channelName[], float64* state, int32 channelType)
{
  ...
  return function_pointers_.GetAnalogPowerUpStates(deviceName, channelName, state, channelType);
}
...
int32 NiDAQmxLibrary::GetDigitalPowerUpStates(const char deviceName[], const char channelName[], int32* state)
{
...
int32 NiDAQmxLibrary::GetDigitalPullUpPullDownStates(const char deviceName[], const char channelName[], int32* state)
{
...
int32 NiDAQmxLibrary::SetAnalogPowerUpStates(const char deviceName[], const char channelNames[], float64 state, int32 channelType)
{
  ...
  return function_pointers_.SetAnalogPowerUpStates(deviceName, channelNames, state, channelType);
}
...
int32 NiDAQmxLibrary::SetDigitalPowerUpStates(const char deviceName[], const char channelNames[], int32 state)
{
  ...
  return function_pointers_.SetDigitalPowerUpStates(deviceName, channelNames, state);
}

int32 NiDAQmxLibrary::SetDigitalPullUpPullDownStates(const char deviceName[], const char channelNames[], int32 state)
{
  ...
  return function_pointers_.SetDigitalPullUpPullDownStates(deviceName, channelNames, state);
}
