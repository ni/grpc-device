...
NiDAQmxLibrary::NiDAQmxLibrary(std::shared_ptr<nidevice_grpc::SharedLibraryInterface> pSharedLibrary) : p_shared_library_(pSharedLibrary)
{
  ...
  function_pointers_.AddCDAQSyncConnection = reinterpret_cast<AddCDAQSyncConnectionPtr>(p_shared_library_->get_function_pointer("DAQmxAddCDAQSyncConnection"));
  function_pointers_.AddGlobalChansToTask = reinterpret_cast<AddGlobalChansToTaskPtr>(p_shared_library_->get_function_pointer("DAQmxAddGlobalChansToTask"));
  function_pointers_.AddNetworkDevice = reinterpret_cast<AddNetworkDevicePtr>(p_shared_library_->get_function_pointer("DAQmxAddNetworkDevice"));
  function_pointers_.AreConfiguredCDAQSyncPortsDisconnected = reinterpret_cast<AreConfiguredCDAQSyncPortsDisconnectedPtr>(p_shared_library_->get_function_pointer("DAQmxAreConfiguredCDAQSyncPortsDisconnected"));
  function_pointers_.AutoConfigureCDAQSyncConnections = reinterpret_cast<AutoConfigureCDAQSyncConnectionsPtr>(p_shared_library_->get_function_pointer("DAQmxAutoConfigureCDAQSyncConnections"));
  function_pointers_.CalculateReversePolyCoeff = reinterpret_cast<CalculateReversePolyCoeffPtr>(p_shared_library_->get_function_pointer("DAQmxCalculateReversePolyCoeff"));
  function_pointers_.CfgAnlgEdgeRefTrig = reinterpret_cast<CfgAnlgEdgeRefTrigPtr>(p_shared_library_->get_function_pointer("DAQmxCfgAnlgEdgeRefTrig"));
  function_pointers_.CfgAnlgEdgeStartTrig = reinterpret_cast<CfgAnlgEdgeStartTrigPtr>(p_shared_library_->get_function_pointer("DAQmxCfgAnlgEdgeStartTrig"));
  function_pointers_.CfgAnlgMultiEdgeRefTrig = reinterpret_cast<CfgAnlgMultiEdgeRefTrigPtr>(p_shared_library_->get_function_pointer("DAQmxCfgAnlgMultiEdgeRefTrig"));
  function_pointers_.CfgAnlgMultiEdgeStartTrig = reinterpret_cast<CfgAnlgMultiEdgeStartTrigPtr>(p_shared_library_->get_function_pointer("DAQmxCfgAnlgMultiEdgeStartTrig"));
  function_pointers_.CfgAnlgWindowRefTrig = reinterpret_cast<CfgAnlgWindowRefTrigPtr>(p_shared_library_->get_function_pointer("DAQmxCfgAnlgWindowRefTrig"));
  function_pointers_.CfgAnlgWindowStartTrig = reinterpret_cast<CfgAnlgWindowStartTrigPtr>(p_shared_library_->get_function_pointer("DAQmxCfgAnlgWindowStartTrig"));
  function_pointers_.CfgBurstHandshakingTimingExportClock = reinterpret_cast<CfgBurstHandshakingTimingExportClockPtr>(p_shared_library_->get_function_pointer("DAQmxCfgBurstHandshakingTimingExportClock"));
  function_pointers_.CfgBurstHandshakingTimingImportClock = reinterpret_cast<CfgBurstHandshakingTimingImportClockPtr>(p_shared_library_->get_function_pointer("DAQmxCfgBurstHandshakingTimingImportClock"));
  function_pointers_.CfgChangeDetectionTiming = reinterpret_cast<CfgChangeDetectionTimingPtr>(p_shared_library_->get_function_pointer("DAQmxCfgChangeDetectionTiming"));
  function_pointers_.CfgDigEdgeRefTrig = reinterpret_cast<CfgDigEdgeRefTrigPtr>(p_shared_library_->get_function_pointer("DAQmxCfgDigEdgeRefTrig"));
  function_pointers_.CfgDigEdgeStartTrig = reinterpret_cast<CfgDigEdgeStartTrigPtr>(p_shared_library_->get_function_pointer("DAQmxCfgDigEdgeStartTrig"));
  function_pointers_.CfgDigPatternRefTrig = reinterpret_cast<CfgDigPatternRefTrigPtr>(p_shared_library_->get_function_pointer("DAQmxCfgDigPatternRefTrig"));
  function_pointers_.CfgDigPatternStartTrig = reinterpret_cast<CfgDigPatternStartTrigPtr>(p_shared_library_->get_function_pointer("DAQmxCfgDigPatternStartTrig"));
  function_pointers_.CfgHandshakingTiming = reinterpret_cast<CfgHandshakingTimingPtr>(p_shared_library_->get_function_pointer("DAQmxCfgHandshakingTiming"));
  function_pointers_.CfgImplicitTiming = reinterpret_cast<CfgImplicitTimingPtr>(p_shared_library_->get_function_pointer("DAQmxCfgImplicitTiming"));
  function_pointers_.CfgInputBuffer = reinterpret_cast<CfgInputBufferPtr>(p_shared_library_->get_function_pointer("DAQmxCfgInputBuffer"));
  function_pointers_.CfgOutputBuffer = reinterpret_cast<CfgOutputBufferPtr>(p_shared_library_->get_function_pointer("DAQmxCfgOutputBuffer"));
  function_pointers_.CfgPipelinedSampClkTiming = reinterpret_cast<CfgPipelinedSampClkTimingPtr>(p_shared_library_->get_function_pointer("DAQmxCfgPipelinedSampClkTiming"));
  function_pointers_.CfgSampClkTiming = reinterpret_cast<CfgSampClkTimingPtr>(p_shared_library_->get_function_pointer("DAQmxCfgSampClkTiming"));
  function_pointers_.CfgTimeStartTrig = reinterpret_cast<CfgTimeStartTrigPtr>(p_shared_library_->get_function_pointer("DAQmxCfgTimeStartTrig"));
  function_pointers_.CfgWatchdogAOExpirStates = reinterpret_cast<CfgWatchdogAOExpirStatesPtr>(p_shared_library_->get_function_pointer("DAQmxCfgWatchdogAOExpirStates"));
  function_pointers_.CfgWatchdogCOExpirStates = reinterpret_cast<CfgWatchdogCOExpirStatesPtr>(p_shared_library_->get_function_pointer("DAQmxCfgWatchdogCOExpirStates"));
  function_pointers_.CfgWatchdogDOExpirStates = reinterpret_cast<CfgWatchdogDOExpirStatesPtr>(p_shared_library_->get_function_pointer("DAQmxCfgWatchdogDOExpirStates"));
  function_pointers_.ClearTEDS = reinterpret_cast<ClearTEDSPtr>(p_shared_library_->get_function_pointer("DAQmxClearTEDS"));
  function_pointers_.ClearTask = reinterpret_cast<ClearTaskPtr>(p_shared_library_->get_function_pointer("DAQmxClearTask"));
  function_pointers_.ConfigureLogging = reinterpret_cast<ConfigureLoggingPtr>(p_shared_library_->get_function_pointer("DAQmxConfigureLogging"));
  function_pointers_.ConfigureTEDS = reinterpret_cast<ConfigureTEDSPtr>(p_shared_library_->get_function_pointer("DAQmxConfigureTEDS"));
  function_pointers_.ConnectTerms = reinterpret_cast<ConnectTermsPtr>(p_shared_library_->get_function_pointer("DAQmxConnectTerms"));
  function_pointers_.ControlWatchdogTask = reinterpret_cast<ControlWatchdogTaskPtr>(p_shared_library_->get_function_pointer("DAQmxControlWatchdogTask"));
  function_pointers_.CreateAIAccel4WireDCVoltageChan = reinterpret_cast<CreateAIAccel4WireDCVoltageChanPtr>(p_shared_library_->get_function_pointer("DAQmxCreateAIAccel4WireDCVoltageChan"));
  function_pointers_.CreateAIAccelChan = reinterpret_cast<CreateAIAccelChanPtr>(p_shared_library_->get_function_pointer("DAQmxCreateAIAccelChan"));
  function_pointers_.CreateAIAccelChargeChan = reinterpret_cast<CreateAIAccelChargeChanPtr>(p_shared_library_->get_function_pointer("DAQmxCreateAIAccelChargeChan"));
  function_pointers_.CreateAIBridgeChan = reinterpret_cast<CreateAIBridgeChanPtr>(p_shared_library_->get_function_pointer("DAQmxCreateAIBridgeChan"));
  function_pointers_.CreateAIChargeChan = reinterpret_cast<CreateAIChargeChanPtr>(p_shared_library_->get_function_pointer("DAQmxCreateAIChargeChan"));
  function_pointers_.CreateAICurrentChan = reinterpret_cast<CreateAICurrentChanPtr>(p_shared_library_->get_function_pointer("DAQmxCreateAICurrentChan"));
  function_pointers_.CreateAICurrentRMSChan = reinterpret_cast<CreateAICurrentRMSChanPtr>(p_shared_library_->get_function_pointer("DAQmxCreateAICurrentRMSChan"));
  function_pointers_.CreateAIForceBridgePolynomialChan = reinterpret_cast<CreateAIForceBridgePolynomialChanPtr>(p_shared_library_->get_function_pointer("DAQmxCreateAIForceBridgePolynomialChan"));
  function_pointers_.CreateAIForceBridgeTableChan = reinterpret_cast<CreateAIForceBridgeTableChanPtr>(p_shared_library_->get_function_pointer("DAQmxCreateAIForceBridgeTableChan"));
  function_pointers_.CreateAIForceBridgeTwoPointLinChan = reinterpret_cast<CreateAIForceBridgeTwoPointLinChanPtr>(p_shared_library_->get_function_pointer("DAQmxCreateAIForceBridgeTwoPointLinChan"));
  function_pointers_.CreateAIForceIEPEChan = reinterpret_cast<CreateAIForceIEPEChanPtr>(p_shared_library_->get_function_pointer("DAQmxCreateAIForceIEPEChan"));
  function_pointers_.CreateAIFreqVoltageChan = reinterpret_cast<CreateAIFreqVoltageChanPtr>(p_shared_library_->get_function_pointer("DAQmxCreateAIFreqVoltageChan"));
  function_pointers_.CreateAIMicrophoneChan = reinterpret_cast<CreateAIMicrophoneChanPtr>(p_shared_library_->get_function_pointer("DAQmxCreateAIMicrophoneChan"));
  function_pointers_.CreateAIPosEddyCurrProxProbeChan = reinterpret_cast<CreateAIPosEddyCurrProxProbeChanPtr>(p_shared_library_->get_function_pointer("DAQmxCreateAIPosEddyCurrProxProbeChan"));
  function_pointers_.CreateAIPosLVDTChan = reinterpret_cast<CreateAIPosLVDTChanPtr>(p_shared_library_->get_function_pointer("DAQmxCreateAIPosLVDTChan"));
  function_pointers_.CreateAIPosRVDTChan = reinterpret_cast<CreateAIPosRVDTChanPtr>(p_shared_library_->get_function_pointer("DAQmxCreateAIPosRVDTChan"));
  function_pointers_.CreateAIPowerChan = reinterpret_cast<CreateAIPowerChanPtr>(p_shared_library_->get_function_pointer("DAQmxCreateAIPowerChan"));
  function_pointers_.CreateAIPressureBridgePolynomialChan = reinterpret_cast<CreateAIPressureBridgePolynomialChanPtr>(p_shared_library_->get_function_pointer("DAQmxCreateAIPressureBridgePolynomialChan"));
  function_pointers_.CreateAIPressureBridgeTableChan = reinterpret_cast<CreateAIPressureBridgeTableChanPtr>(p_shared_library_->get_function_pointer("DAQmxCreateAIPressureBridgeTableChan"));
  function_pointers_.CreateAIPressureBridgeTwoPointLinChan = reinterpret_cast<CreateAIPressureBridgeTwoPointLinChanPtr>(p_shared_library_->get_function_pointer("DAQmxCreateAIPressureBridgeTwoPointLinChan"));
  function_pointers_.CreateAIRTDChan = reinterpret_cast<CreateAIRTDChanPtr>(p_shared_library_->get_function_pointer("DAQmxCreateAIRTDChan"));
  function_pointers_.CreateAIResistanceChan = reinterpret_cast<CreateAIResistanceChanPtr>(p_shared_library_->get_function_pointer("DAQmxCreateAIResistanceChan"));
  function_pointers_.CreateAIRosetteStrainGageChan = reinterpret_cast<CreateAIRosetteStrainGageChanPtr>(p_shared_library_->get_function_pointer("DAQmxCreateAIRosetteStrainGageChan"));
  function_pointers_.CreateAIStrainGageChan = reinterpret_cast<CreateAIStrainGageChanPtr>(p_shared_library_->get_function_pointer("DAQmxCreateAIStrainGageChan"));
  function_pointers_.CreateAITempBuiltInSensorChan = reinterpret_cast<CreateAITempBuiltInSensorChanPtr>(p_shared_library_->get_function_pointer("DAQmxCreateAITempBuiltInSensorChan"));
  function_pointers_.CreateAIThrmcplChan = reinterpret_cast<CreateAIThrmcplChanPtr>(p_shared_library_->get_function_pointer("DAQmxCreateAIThrmcplChan"));
  function_pointers_.CreateAIThrmstrChanIex = reinterpret_cast<CreateAIThrmstrChanIexPtr>(p_shared_library_->get_function_pointer("DAQmxCreateAIThrmstrChanIex"));
  function_pointers_.CreateAIThrmstrChanVex = reinterpret_cast<CreateAIThrmstrChanVexPtr>(p_shared_library_->get_function_pointer("DAQmxCreateAIThrmstrChanVex"));
  function_pointers_.CreateAITorqueBridgePolynomialChan = reinterpret_cast<CreateAITorqueBridgePolynomialChanPtr>(p_shared_library_->get_function_pointer("DAQmxCreateAITorqueBridgePolynomialChan"));
  function_pointers_.CreateAITorqueBridgeTableChan = reinterpret_cast<CreateAITorqueBridgeTableChanPtr>(p_shared_library_->get_function_pointer("DAQmxCreateAITorqueBridgeTableChan"));
  function_pointers_.CreateAITorqueBridgeTwoPointLinChan = reinterpret_cast<CreateAITorqueBridgeTwoPointLinChanPtr>(p_shared_library_->get_function_pointer("DAQmxCreateAITorqueBridgeTwoPointLinChan"));
  function_pointers_.CreateAIVelocityIEPEChan = reinterpret_cast<CreateAIVelocityIEPEChanPtr>(p_shared_library_->get_function_pointer("DAQmxCreateAIVelocityIEPEChan"));
  function_pointers_.CreateAIVoltageChan = reinterpret_cast<CreateAIVoltageChanPtr>(p_shared_library_->get_function_pointer("DAQmxCreateAIVoltageChan"));
  function_pointers_.CreateAIVoltageChanWithExcit = reinterpret_cast<CreateAIVoltageChanWithExcitPtr>(p_shared_library_->get_function_pointer("DAQmxCreateAIVoltageChanWithExcit"));
  function_pointers_.CreateAIVoltageRMSChan = reinterpret_cast<CreateAIVoltageRMSChanPtr>(p_shared_library_->get_function_pointer("DAQmxCreateAIVoltageRMSChan"));
  function_pointers_.CreateAOCurrentChan = reinterpret_cast<CreateAOCurrentChanPtr>(p_shared_library_->get_function_pointer("DAQmxCreateAOCurrentChan"));
  function_pointers_.CreateAOFuncGenChan = reinterpret_cast<CreateAOFuncGenChanPtr>(p_shared_library_->get_function_pointer("DAQmxCreateAOFuncGenChan"));
  function_pointers_.CreateAOVoltageChan = reinterpret_cast<CreateAOVoltageChanPtr>(p_shared_library_->get_function_pointer("DAQmxCreateAOVoltageChan"));
  function_pointers_.CreateCIAngEncoderChan = reinterpret_cast<CreateCIAngEncoderChanPtr>(p_shared_library_->get_function_pointer("DAQmxCreateCIAngEncoderChan"));
  function_pointers_.CreateCIAngVelocityChan = reinterpret_cast<CreateCIAngVelocityChanPtr>(p_shared_library_->get_function_pointer("DAQmxCreateCIAngVelocityChan"));
  function_pointers_.CreateCICountEdgesChan = reinterpret_cast<CreateCICountEdgesChanPtr>(p_shared_library_->get_function_pointer("DAQmxCreateCICountEdgesChan"));
  function_pointers_.CreateCIDutyCycleChan = reinterpret_cast<CreateCIDutyCycleChanPtr>(p_shared_library_->get_function_pointer("DAQmxCreateCIDutyCycleChan"));
  function_pointers_.CreateCIFreqChan = reinterpret_cast<CreateCIFreqChanPtr>(p_shared_library_->get_function_pointer("DAQmxCreateCIFreqChan"));
  function_pointers_.CreateCIGPSTimestampChan = reinterpret_cast<CreateCIGPSTimestampChanPtr>(p_shared_library_->get_function_pointer("DAQmxCreateCIGPSTimestampChan"));
  function_pointers_.CreateCILinEncoderChan = reinterpret_cast<CreateCILinEncoderChanPtr>(p_shared_library_->get_function_pointer("DAQmxCreateCILinEncoderChan"));
  function_pointers_.CreateCILinVelocityChan = reinterpret_cast<CreateCILinVelocityChanPtr>(p_shared_library_->get_function_pointer("DAQmxCreateCILinVelocityChan"));
  function_pointers_.CreateCIPeriodChan = reinterpret_cast<CreateCIPeriodChanPtr>(p_shared_library_->get_function_pointer("DAQmxCreateCIPeriodChan"));
  function_pointers_.CreateCIPulseChanFreq = reinterpret_cast<CreateCIPulseChanFreqPtr>(p_shared_library_->get_function_pointer("DAQmxCreateCIPulseChanFreq"));
  function_pointers_.CreateCIPulseChanTicks = reinterpret_cast<CreateCIPulseChanTicksPtr>(p_shared_library_->get_function_pointer("DAQmxCreateCIPulseChanTicks"));
  function_pointers_.CreateCIPulseChanTime = reinterpret_cast<CreateCIPulseChanTimePtr>(p_shared_library_->get_function_pointer("DAQmxCreateCIPulseChanTime"));
  function_pointers_.CreateCIPulseWidthChan = reinterpret_cast<CreateCIPulseWidthChanPtr>(p_shared_library_->get_function_pointer("DAQmxCreateCIPulseWidthChan"));
  function_pointers_.CreateCISemiPeriodChan = reinterpret_cast<CreateCISemiPeriodChanPtr>(p_shared_library_->get_function_pointer("DAQmxCreateCISemiPeriodChan"));
  function_pointers_.CreateCITwoEdgeSepChan = reinterpret_cast<CreateCITwoEdgeSepChanPtr>(p_shared_library_->get_function_pointer("DAQmxCreateCITwoEdgeSepChan"));
  function_pointers_.CreateCOPulseChanFreq = reinterpret_cast<CreateCOPulseChanFreqPtr>(p_shared_library_->get_function_pointer("DAQmxCreateCOPulseChanFreq"));
  function_pointers_.CreateCOPulseChanTicks = reinterpret_cast<CreateCOPulseChanTicksPtr>(p_shared_library_->get_function_pointer("DAQmxCreateCOPulseChanTicks"));
  function_pointers_.CreateCOPulseChanTime = reinterpret_cast<CreateCOPulseChanTimePtr>(p_shared_library_->get_function_pointer("DAQmxCreateCOPulseChanTime"));
  function_pointers_.CreateDIChan = reinterpret_cast<CreateDIChanPtr>(p_shared_library_->get_function_pointer("DAQmxCreateDIChan"));
  function_pointers_.CreateDOChan = reinterpret_cast<CreateDOChanPtr>(p_shared_library_->get_function_pointer("DAQmxCreateDOChan"));
  function_pointers_.CreateLinScale = reinterpret_cast<CreateLinScalePtr>(p_shared_library_->get_function_pointer("DAQmxCreateLinScale"));
  function_pointers_.CreateMapScale = reinterpret_cast<CreateMapScalePtr>(p_shared_library_->get_function_pointer("DAQmxCreateMapScale"));
  function_pointers_.CreatePolynomialScale = reinterpret_cast<CreatePolynomialScalePtr>(p_shared_library_->get_function_pointer("DAQmxCreatePolynomialScale"));
  function_pointers_.CreateTEDSAIAccelChan = reinterpret_cast<CreateTEDSAIAccelChanPtr>(p_shared_library_->get_function_pointer("DAQmxCreateTEDSAIAccelChan"));
  function_pointers_.CreateTEDSAIBridgeChan = reinterpret_cast<CreateTEDSAIBridgeChanPtr>(p_shared_library_->get_function_pointer("DAQmxCreateTEDSAIBridgeChan"));
  function_pointers_.CreateTEDSAICurrentChan = reinterpret_cast<CreateTEDSAICurrentChanPtr>(p_shared_library_->get_function_pointer("DAQmxCreateTEDSAICurrentChan"));
  function_pointers_.CreateTEDSAIForceBridgeChan = reinterpret_cast<CreateTEDSAIForceBridgeChanPtr>(p_shared_library_->get_function_pointer("DAQmxCreateTEDSAIForceBridgeChan"));
  function_pointers_.CreateTEDSAIForceIEPEChan = reinterpret_cast<CreateTEDSAIForceIEPEChanPtr>(p_shared_library_->get_function_pointer("DAQmxCreateTEDSAIForceIEPEChan"));
  function_pointers_.CreateTEDSAIMicrophoneChan = reinterpret_cast<CreateTEDSAIMicrophoneChanPtr>(p_shared_library_->get_function_pointer("DAQmxCreateTEDSAIMicrophoneChan"));
  function_pointers_.CreateTEDSAIPosLVDTChan = reinterpret_cast<CreateTEDSAIPosLVDTChanPtr>(p_shared_library_->get_function_pointer("DAQmxCreateTEDSAIPosLVDTChan"));
  function_pointers_.CreateTEDSAIPosRVDTChan = reinterpret_cast<CreateTEDSAIPosRVDTChanPtr>(p_shared_library_->get_function_pointer("DAQmxCreateTEDSAIPosRVDTChan"));
  function_pointers_.CreateTEDSAIPressureBridgeChan = reinterpret_cast<CreateTEDSAIPressureBridgeChanPtr>(p_shared_library_->get_function_pointer("DAQmxCreateTEDSAIPressureBridgeChan"));
  function_pointers_.CreateTEDSAIRTDChan = reinterpret_cast<CreateTEDSAIRTDChanPtr>(p_shared_library_->get_function_pointer("DAQmxCreateTEDSAIRTDChan"));
  function_pointers_.CreateTEDSAIResistanceChan = reinterpret_cast<CreateTEDSAIResistanceChanPtr>(p_shared_library_->get_function_pointer("DAQmxCreateTEDSAIResistanceChan"));
  function_pointers_.CreateTEDSAIStrainGageChan = reinterpret_cast<CreateTEDSAIStrainGageChanPtr>(p_shared_library_->get_function_pointer("DAQmxCreateTEDSAIStrainGageChan"));
  function_pointers_.CreateTEDSAIThrmcplChan = reinterpret_cast<CreateTEDSAIThrmcplChanPtr>(p_shared_library_->get_function_pointer("DAQmxCreateTEDSAIThrmcplChan"));
  function_pointers_.CreateTEDSAIThrmstrChanIex = reinterpret_cast<CreateTEDSAIThrmstrChanIexPtr>(p_shared_library_->get_function_pointer("DAQmxCreateTEDSAIThrmstrChanIex"));
  function_pointers_.CreateTEDSAIThrmstrChanVex = reinterpret_cast<CreateTEDSAIThrmstrChanVexPtr>(p_shared_library_->get_function_pointer("DAQmxCreateTEDSAIThrmstrChanVex"));
  function_pointers_.CreateTEDSAITorqueBridgeChan = reinterpret_cast<CreateTEDSAITorqueBridgeChanPtr>(p_shared_library_->get_function_pointer("DAQmxCreateTEDSAITorqueBridgeChan"));
  function_pointers_.CreateTEDSAIVoltageChan = reinterpret_cast<CreateTEDSAIVoltageChanPtr>(p_shared_library_->get_function_pointer("DAQmxCreateTEDSAIVoltageChan"));
  function_pointers_.CreateTEDSAIVoltageChanWithExcit = reinterpret_cast<CreateTEDSAIVoltageChanWithExcitPtr>(p_shared_library_->get_function_pointer("DAQmxCreateTEDSAIVoltageChanWithExcit"));
  function_pointers_.CreateTableScale = reinterpret_cast<CreateTableScalePtr>(p_shared_library_->get_function_pointer("DAQmxCreateTableScale"));
  function_pointers_.CreateTask = reinterpret_cast<CreateTaskPtr>(p_shared_library_->get_function_pointer("DAQmxCreateTask"));
  function_pointers_.CreateWatchdogTimerTask = reinterpret_cast<CreateWatchdogTimerTaskPtr>(p_shared_library_->get_function_pointer("DAQmxCreateWatchdogTimerTask"));
  function_pointers_.CreateWatchdogTimerTaskEx = reinterpret_cast<CreateWatchdogTimerTaskExPtr>(p_shared_library_->get_function_pointer("DAQmxCreateWatchdogTimerTaskEx"));
  function_pointers_.DeleteNetworkDevice = reinterpret_cast<DeleteNetworkDevicePtr>(p_shared_library_->get_function_pointer("DAQmxDeleteNetworkDevice"));
  function_pointers_.DeleteSavedGlobalChan = reinterpret_cast<DeleteSavedGlobalChanPtr>(p_shared_library_->get_function_pointer("DAQmxDeleteSavedGlobalChan"));
  function_pointers_.DeleteSavedScale = reinterpret_cast<DeleteSavedScalePtr>(p_shared_library_->get_function_pointer("DAQmxDeleteSavedScale"));
  function_pointers_.DeleteSavedTask = reinterpret_cast<DeleteSavedTaskPtr>(p_shared_library_->get_function_pointer("DAQmxDeleteSavedTask"));
  function_pointers_.DeviceSupportsCal = reinterpret_cast<DeviceSupportsCalPtr>(p_shared_library_->get_function_pointer("DAQmxDeviceSupportsCal"));
  function_pointers_.DisableRefTrig = reinterpret_cast<DisableRefTrigPtr>(p_shared_library_->get_function_pointer("DAQmxDisableRefTrig"));
  function_pointers_.DisableStartTrig = reinterpret_cast<DisableStartTrigPtr>(p_shared_library_->get_function_pointer("DAQmxDisableStartTrig"));
  function_pointers_.DisconnectTerms = reinterpret_cast<DisconnectTermsPtr>(p_shared_library_->get_function_pointer("DAQmxDisconnectTerms"));
  function_pointers_.ExportSignal = reinterpret_cast<ExportSignalPtr>(p_shared_library_->get_function_pointer("DAQmxExportSignal"));
  function_pointers_.GetAIChanCalCalDate = reinterpret_cast<GetAIChanCalCalDatePtr>(p_shared_library_->get_function_pointer("DAQmxGetAIChanCalCalDate"));
  function_pointers_.GetAIChanCalExpDate = reinterpret_cast<GetAIChanCalExpDatePtr>(p_shared_library_->get_function_pointer("DAQmxGetAIChanCalExpDate"));
  function_pointers_.GetAnalogPowerUpStates = reinterpret_cast<GetAnalogPowerUpStatesPtr>(p_shared_library_->get_function_pointer("DAQmxGetAnalogPowerUpStates"));
  function_pointers_.GetAnalogPowerUpStatesWithOutputType = reinterpret_cast<GetAnalogPowerUpStatesWithOutputTypePtr>(p_shared_library_->get_function_pointer("DAQmxGetAnalogPowerUpStatesWithOutputType"));
  function_pointers_.GetArmStartTrigTimestampVal = reinterpret_cast<GetArmStartTrigTimestampValPtr>(p_shared_library_->get_function_pointer("DAQmxGetArmStartTrigTimestampVal"));
  function_pointers_.GetArmStartTrigTrigWhen = reinterpret_cast<GetArmStartTrigTrigWhenPtr>(p_shared_library_->get_function_pointer("DAQmxGetArmStartTrigTrigWhen"));
  function_pointers_.GetAutoConfiguredCDAQSyncConnections = reinterpret_cast<GetAutoConfiguredCDAQSyncConnectionsPtr>(p_shared_library_->get_function_pointer("DAQmxGetAutoConfiguredCDAQSyncConnections"));
  function_pointers_.GetBufferAttributeUInt32 = reinterpret_cast<GetBufferAttributeUInt32Ptr>(p_shared_library_->get_function_pointer("DAQmxGetBufferAttribute"));
  function_pointers_.GetCalInfoAttributeBool = reinterpret_cast<GetCalInfoAttributeBoolPtr>(p_shared_library_->get_function_pointer("DAQmxGetCalInfoAttribute"));
  function_pointers_.GetCalInfoAttributeDouble = reinterpret_cast<GetCalInfoAttributeDoublePtr>(p_shared_library_->get_function_pointer("DAQmxGetCalInfoAttribute"));
  function_pointers_.GetCalInfoAttributeString = reinterpret_cast<GetCalInfoAttributeStringPtr>(p_shared_library_->get_function_pointer("DAQmxGetCalInfoAttribute"));
  function_pointers_.GetCalInfoAttributeUInt32 = reinterpret_cast<GetCalInfoAttributeUInt32Ptr>(p_shared_library_->get_function_pointer("DAQmxGetCalInfoAttribute"));
  function_pointers_.GetChanAttributeBool = reinterpret_cast<GetChanAttributeBoolPtr>(p_shared_library_->get_function_pointer("DAQmxGetChanAttribute"));
  function_pointers_.GetChanAttributeDouble = reinterpret_cast<GetChanAttributeDoublePtr>(p_shared_library_->get_function_pointer("DAQmxGetChanAttribute"));
  function_pointers_.GetChanAttributeDoubleArray = reinterpret_cast<GetChanAttributeDoubleArrayPtr>(p_shared_library_->get_function_pointer("DAQmxGetChanAttribute"));
  function_pointers_.GetChanAttributeInt32 = reinterpret_cast<GetChanAttributeInt32Ptr>(p_shared_library_->get_function_pointer("DAQmxGetChanAttribute"));
  function_pointers_.GetChanAttributeString = reinterpret_cast<GetChanAttributeStringPtr>(p_shared_library_->get_function_pointer("DAQmxGetChanAttribute"));
  function_pointers_.GetChanAttributeUInt32 = reinterpret_cast<GetChanAttributeUInt32Ptr>(p_shared_library_->get_function_pointer("DAQmxGetChanAttribute"));
  function_pointers_.GetDeviceAttributeBool = reinterpret_cast<GetDeviceAttributeBoolPtr>(p_shared_library_->get_function_pointer("DAQmxGetDeviceAttribute"));
  function_pointers_.GetDeviceAttributeDouble = reinterpret_cast<GetDeviceAttributeDoublePtr>(p_shared_library_->get_function_pointer("DAQmxGetDeviceAttribute"));
  function_pointers_.GetDeviceAttributeDoubleArray = reinterpret_cast<GetDeviceAttributeDoubleArrayPtr>(p_shared_library_->get_function_pointer("DAQmxGetDeviceAttribute"));
  function_pointers_.GetDeviceAttributeInt32 = reinterpret_cast<GetDeviceAttributeInt32Ptr>(p_shared_library_->get_function_pointer("DAQmxGetDeviceAttribute"));
  function_pointers_.GetDeviceAttributeInt32Array = reinterpret_cast<GetDeviceAttributeInt32ArrayPtr>(p_shared_library_->get_function_pointer("DAQmxGetDeviceAttribute"));
  function_pointers_.GetDeviceAttributeString = reinterpret_cast<GetDeviceAttributeStringPtr>(p_shared_library_->get_function_pointer("DAQmxGetDeviceAttribute"));
  function_pointers_.GetDeviceAttributeUInt32 = reinterpret_cast<GetDeviceAttributeUInt32Ptr>(p_shared_library_->get_function_pointer("DAQmxGetDeviceAttribute"));
  function_pointers_.GetDeviceAttributeUInt32Array = reinterpret_cast<GetDeviceAttributeUInt32ArrayPtr>(p_shared_library_->get_function_pointer("DAQmxGetDeviceAttribute"));
  function_pointers_.GetDigitalLogicFamilyPowerUpState = reinterpret_cast<GetDigitalLogicFamilyPowerUpStatePtr>(p_shared_library_->get_function_pointer("DAQmxGetDigitalLogicFamilyPowerUpState"));
  function_pointers_.GetDigitalPowerUpStates = reinterpret_cast<GetDigitalPowerUpStatesPtr>(p_shared_library_->get_function_pointer("DAQmxGetDigitalPowerUpStates"));
  function_pointers_.GetDigitalPullUpPullDownStates = reinterpret_cast<GetDigitalPullUpPullDownStatesPtr>(p_shared_library_->get_function_pointer("DAQmxGetDigitalPullUpPullDownStates"));
  function_pointers_.GetDisconnectedCDAQSyncPorts = reinterpret_cast<GetDisconnectedCDAQSyncPortsPtr>(p_shared_library_->get_function_pointer("DAQmxGetDisconnectedCDAQSyncPorts"));
  function_pointers_.GetErrorString = reinterpret_cast<GetErrorStringPtr>(p_shared_library_->get_function_pointer("DAQmxGetErrorString"));
  function_pointers_.GetExportedSignalAttributeBool = reinterpret_cast<GetExportedSignalAttributeBoolPtr>(p_shared_library_->get_function_pointer("DAQmxGetExportedSignalAttribute"));
  function_pointers_.GetExportedSignalAttributeDouble = reinterpret_cast<GetExportedSignalAttributeDoublePtr>(p_shared_library_->get_function_pointer("DAQmxGetExportedSignalAttribute"));
  function_pointers_.GetExportedSignalAttributeInt32 = reinterpret_cast<GetExportedSignalAttributeInt32Ptr>(p_shared_library_->get_function_pointer("DAQmxGetExportedSignalAttribute"));
  function_pointers_.GetExportedSignalAttributeString = reinterpret_cast<GetExportedSignalAttributeStringPtr>(p_shared_library_->get_function_pointer("DAQmxGetExportedSignalAttribute"));
  function_pointers_.GetExportedSignalAttributeUInt32 = reinterpret_cast<GetExportedSignalAttributeUInt32Ptr>(p_shared_library_->get_function_pointer("DAQmxGetExportedSignalAttribute"));
  function_pointers_.GetExtendedErrorInfo = reinterpret_cast<GetExtendedErrorInfoPtr>(p_shared_library_->get_function_pointer("DAQmxGetExtendedErrorInfo"));
  function_pointers_.GetFirstSampClkWhen = reinterpret_cast<GetFirstSampClkWhenPtr>(p_shared_library_->get_function_pointer("DAQmxGetFirstSampClkWhen"));
  function_pointers_.GetFirstSampTimestampVal = reinterpret_cast<GetFirstSampTimestampValPtr>(p_shared_library_->get_function_pointer("DAQmxGetFirstSampTimestampVal"));
  function_pointers_.GetNthTaskChannel = reinterpret_cast<GetNthTaskChannelPtr>(p_shared_library_->get_function_pointer("DAQmxGetNthTaskChannel"));
  function_pointers_.GetNthTaskDevice = reinterpret_cast<GetNthTaskDevicePtr>(p_shared_library_->get_function_pointer("DAQmxGetNthTaskDevice"));
  function_pointers_.GetNthTaskReadChannel = reinterpret_cast<GetNthTaskReadChannelPtr>(p_shared_library_->get_function_pointer("DAQmxGetNthTaskReadChannel"));
  function_pointers_.GetPersistedChanAttributeBool = reinterpret_cast<GetPersistedChanAttributeBoolPtr>(p_shared_library_->get_function_pointer("DAQmxGetPersistedChanAttribute"));
  function_pointers_.GetPersistedChanAttributeString = reinterpret_cast<GetPersistedChanAttributeStringPtr>(p_shared_library_->get_function_pointer("DAQmxGetPersistedChanAttribute"));
  function_pointers_.GetPersistedScaleAttributeBool = reinterpret_cast<GetPersistedScaleAttributeBoolPtr>(p_shared_library_->get_function_pointer("DAQmxGetPersistedScaleAttribute"));
  function_pointers_.GetPersistedScaleAttributeString = reinterpret_cast<GetPersistedScaleAttributeStringPtr>(p_shared_library_->get_function_pointer("DAQmxGetPersistedScaleAttribute"));
  function_pointers_.GetPersistedTaskAttributeBool = reinterpret_cast<GetPersistedTaskAttributeBoolPtr>(p_shared_library_->get_function_pointer("DAQmxGetPersistedTaskAttribute"));
  function_pointers_.GetPersistedTaskAttributeString = reinterpret_cast<GetPersistedTaskAttributeStringPtr>(p_shared_library_->get_function_pointer("DAQmxGetPersistedTaskAttribute"));
  function_pointers_.GetPhysicalChanAttributeBool = reinterpret_cast<GetPhysicalChanAttributeBoolPtr>(p_shared_library_->get_function_pointer("DAQmxGetPhysicalChanAttribute"));
  function_pointers_.GetPhysicalChanAttributeBytes = reinterpret_cast<GetPhysicalChanAttributeBytesPtr>(p_shared_library_->get_function_pointer("DAQmxGetPhysicalChanAttribute"));
  function_pointers_.GetPhysicalChanAttributeDouble = reinterpret_cast<GetPhysicalChanAttributeDoublePtr>(p_shared_library_->get_function_pointer("DAQmxGetPhysicalChanAttribute"));
  function_pointers_.GetPhysicalChanAttributeDoubleArray = reinterpret_cast<GetPhysicalChanAttributeDoubleArrayPtr>(p_shared_library_->get_function_pointer("DAQmxGetPhysicalChanAttribute"));
  function_pointers_.GetPhysicalChanAttributeInt32 = reinterpret_cast<GetPhysicalChanAttributeInt32Ptr>(p_shared_library_->get_function_pointer("DAQmxGetPhysicalChanAttribute"));
  function_pointers_.GetPhysicalChanAttributeInt32Array = reinterpret_cast<GetPhysicalChanAttributeInt32ArrayPtr>(p_shared_library_->get_function_pointer("DAQmxGetPhysicalChanAttribute"));
  function_pointers_.GetPhysicalChanAttributeString = reinterpret_cast<GetPhysicalChanAttributeStringPtr>(p_shared_library_->get_function_pointer("DAQmxGetPhysicalChanAttribute"));
  function_pointers_.GetPhysicalChanAttributeUInt32 = reinterpret_cast<GetPhysicalChanAttributeUInt32Ptr>(p_shared_library_->get_function_pointer("DAQmxGetPhysicalChanAttribute"));
  function_pointers_.GetPhysicalChanAttributeUInt32Array = reinterpret_cast<GetPhysicalChanAttributeUInt32ArrayPtr>(p_shared_library_->get_function_pointer("DAQmxGetPhysicalChanAttribute"));
  function_pointers_.GetReadAttributeBool = reinterpret_cast<GetReadAttributeBoolPtr>(p_shared_library_->get_function_pointer("DAQmxGetReadAttribute"));
  function_pointers_.GetReadAttributeDouble = reinterpret_cast<GetReadAttributeDoublePtr>(p_shared_library_->get_function_pointer("DAQmxGetReadAttribute"));
  function_pointers_.GetReadAttributeInt32 = reinterpret_cast<GetReadAttributeInt32Ptr>(p_shared_library_->get_function_pointer("DAQmxGetReadAttribute"));
  function_pointers_.GetReadAttributeString = reinterpret_cast<GetReadAttributeStringPtr>(p_shared_library_->get_function_pointer("DAQmxGetReadAttribute"));
  function_pointers_.GetReadAttributeUInt32 = reinterpret_cast<GetReadAttributeUInt32Ptr>(p_shared_library_->get_function_pointer("DAQmxGetReadAttribute"));
  function_pointers_.GetReadAttributeUInt64 = reinterpret_cast<GetReadAttributeUInt64Ptr>(p_shared_library_->get_function_pointer("DAQmxGetReadAttribute"));
  function_pointers_.GetRealTimeAttributeBool = reinterpret_cast<GetRealTimeAttributeBoolPtr>(p_shared_library_->get_function_pointer("DAQmxGetRealTimeAttribute"));
  function_pointers_.GetRealTimeAttributeInt32 = reinterpret_cast<GetRealTimeAttributeInt32Ptr>(p_shared_library_->get_function_pointer("DAQmxGetRealTimeAttribute"));
  function_pointers_.GetRealTimeAttributeUInt32 = reinterpret_cast<GetRealTimeAttributeUInt32Ptr>(p_shared_library_->get_function_pointer("DAQmxGetRealTimeAttribute"));
  function_pointers_.GetRefTrigTimestampVal = reinterpret_cast<GetRefTrigTimestampValPtr>(p_shared_library_->get_function_pointer("DAQmxGetRefTrigTimestampVal"));
  function_pointers_.GetScaleAttributeDouble = reinterpret_cast<GetScaleAttributeDoublePtr>(p_shared_library_->get_function_pointer("DAQmxGetScaleAttribute"));
  function_pointers_.GetScaleAttributeDoubleArray = reinterpret_cast<GetScaleAttributeDoubleArrayPtr>(p_shared_library_->get_function_pointer("DAQmxGetScaleAttribute"));
  function_pointers_.GetScaleAttributeInt32 = reinterpret_cast<GetScaleAttributeInt32Ptr>(p_shared_library_->get_function_pointer("DAQmxGetScaleAttribute"));
  function_pointers_.GetScaleAttributeString = reinterpret_cast<GetScaleAttributeStringPtr>(p_shared_library_->get_function_pointer("DAQmxGetScaleAttribute"));
  function_pointers_.GetSelfCalLastDateAndTime = reinterpret_cast<GetSelfCalLastDateAndTimePtr>(p_shared_library_->get_function_pointer("DAQmxGetSelfCalLastDateAndTime"));
  function_pointers_.GetStartTrigTimestampVal = reinterpret_cast<GetStartTrigTimestampValPtr>(p_shared_library_->get_function_pointer("DAQmxGetStartTrigTimestampVal"));
  function_pointers_.GetStartTrigTrigWhen = reinterpret_cast<GetStartTrigTrigWhenPtr>(p_shared_library_->get_function_pointer("DAQmxGetStartTrigTrigWhen"));
  function_pointers_.GetSyncPulseTimeWhen = reinterpret_cast<GetSyncPulseTimeWhenPtr>(p_shared_library_->get_function_pointer("DAQmxGetSyncPulseTimeWhen"));
  function_pointers_.GetSystemInfoAttributeString = reinterpret_cast<GetSystemInfoAttributeStringPtr>(p_shared_library_->get_function_pointer("DAQmxGetSystemInfoAttribute"));
  function_pointers_.GetSystemInfoAttributeUInt32 = reinterpret_cast<GetSystemInfoAttributeUInt32Ptr>(p_shared_library_->get_function_pointer("DAQmxGetSystemInfoAttribute"));
  function_pointers_.GetTaskAttributeBool = reinterpret_cast<GetTaskAttributeBoolPtr>(p_shared_library_->get_function_pointer("DAQmxGetTaskAttribute"));
  function_pointers_.GetTaskAttributeString = reinterpret_cast<GetTaskAttributeStringPtr>(p_shared_library_->get_function_pointer("DAQmxGetTaskAttribute"));
  function_pointers_.GetTaskAttributeUInt32 = reinterpret_cast<GetTaskAttributeUInt32Ptr>(p_shared_library_->get_function_pointer("DAQmxGetTaskAttribute"));
  function_pointers_.GetTimingAttributeBool = reinterpret_cast<GetTimingAttributeBoolPtr>(p_shared_library_->get_function_pointer("DAQmxGetTimingAttribute"));
  function_pointers_.GetTimingAttributeDouble = reinterpret_cast<GetTimingAttributeDoublePtr>(p_shared_library_->get_function_pointer("DAQmxGetTimingAttribute"));
  function_pointers_.GetTimingAttributeExBool = reinterpret_cast<GetTimingAttributeExBoolPtr>(p_shared_library_->get_function_pointer("DAQmxGetTimingAttributeEx"));
  function_pointers_.GetTimingAttributeExDouble = reinterpret_cast<GetTimingAttributeExDoublePtr>(p_shared_library_->get_function_pointer("DAQmxGetTimingAttributeEx"));
  function_pointers_.GetTimingAttributeExInt32 = reinterpret_cast<GetTimingAttributeExInt32Ptr>(p_shared_library_->get_function_pointer("DAQmxGetTimingAttributeEx"));
  function_pointers_.GetTimingAttributeExString = reinterpret_cast<GetTimingAttributeExStringPtr>(p_shared_library_->get_function_pointer("DAQmxGetTimingAttributeEx"));
  function_pointers_.GetTimingAttributeExTimestamp = reinterpret_cast<GetTimingAttributeExTimestampPtr>(p_shared_library_->get_function_pointer("DAQmxGetTimingAttributeEx"));
  function_pointers_.GetTimingAttributeExUInt32 = reinterpret_cast<GetTimingAttributeExUInt32Ptr>(p_shared_library_->get_function_pointer("DAQmxGetTimingAttributeEx"));
  function_pointers_.GetTimingAttributeExUInt64 = reinterpret_cast<GetTimingAttributeExUInt64Ptr>(p_shared_library_->get_function_pointer("DAQmxGetTimingAttributeEx"));
  function_pointers_.GetTimingAttributeInt32 = reinterpret_cast<GetTimingAttributeInt32Ptr>(p_shared_library_->get_function_pointer("DAQmxGetTimingAttribute"));
  function_pointers_.GetTimingAttributeString = reinterpret_cast<GetTimingAttributeStringPtr>(p_shared_library_->get_function_pointer("DAQmxGetTimingAttribute"));
  function_pointers_.GetTimingAttributeTimestamp = reinterpret_cast<GetTimingAttributeTimestampPtr>(p_shared_library_->get_function_pointer("DAQmxGetTimingAttribute"));
  function_pointers_.GetTimingAttributeUInt32 = reinterpret_cast<GetTimingAttributeUInt32Ptr>(p_shared_library_->get_function_pointer("DAQmxGetTimingAttribute"));
  function_pointers_.GetTimingAttributeUInt64 = reinterpret_cast<GetTimingAttributeUInt64Ptr>(p_shared_library_->get_function_pointer("DAQmxGetTimingAttribute"));
  function_pointers_.GetTrigAttributeBool = reinterpret_cast<GetTrigAttributeBoolPtr>(p_shared_library_->get_function_pointer("DAQmxGetTrigAttribute"));
  function_pointers_.GetTrigAttributeDouble = reinterpret_cast<GetTrigAttributeDoublePtr>(p_shared_library_->get_function_pointer("DAQmxGetTrigAttribute"));
  function_pointers_.GetTrigAttributeDoubleArray = reinterpret_cast<GetTrigAttributeDoubleArrayPtr>(p_shared_library_->get_function_pointer("DAQmxGetTrigAttribute"));
  function_pointers_.GetTrigAttributeInt32 = reinterpret_cast<GetTrigAttributeInt32Ptr>(p_shared_library_->get_function_pointer("DAQmxGetTrigAttribute"));
  function_pointers_.GetTrigAttributeInt32Array = reinterpret_cast<GetTrigAttributeInt32ArrayPtr>(p_shared_library_->get_function_pointer("DAQmxGetTrigAttribute"));
  function_pointers_.GetTrigAttributeString = reinterpret_cast<GetTrigAttributeStringPtr>(p_shared_library_->get_function_pointer("DAQmxGetTrigAttribute"));
  function_pointers_.GetTrigAttributeTimestamp = reinterpret_cast<GetTrigAttributeTimestampPtr>(p_shared_library_->get_function_pointer("DAQmxGetTrigAttribute"));
  function_pointers_.GetTrigAttributeUInt32 = reinterpret_cast<GetTrigAttributeUInt32Ptr>(p_shared_library_->get_function_pointer("DAQmxGetTrigAttribute"));
  function_pointers_.GetWatchdogAttributeBool = reinterpret_cast<GetWatchdogAttributeBoolPtr>(p_shared_library_->get_function_pointer("DAQmxGetWatchdogAttribute"));
  function_pointers_.GetWatchdogAttributeDouble = reinterpret_cast<GetWatchdogAttributeDoublePtr>(p_shared_library_->get_function_pointer("DAQmxGetWatchdogAttribute"));
  function_pointers_.GetWatchdogAttributeInt32 = reinterpret_cast<GetWatchdogAttributeInt32Ptr>(p_shared_library_->get_function_pointer("DAQmxGetWatchdogAttribute"));
  function_pointers_.GetWatchdogAttributeString = reinterpret_cast<GetWatchdogAttributeStringPtr>(p_shared_library_->get_function_pointer("DAQmxGetWatchdogAttribute"));
  function_pointers_.GetWriteAttributeBool = reinterpret_cast<GetWriteAttributeBoolPtr>(p_shared_library_->get_function_pointer("DAQmxGetWriteAttribute"));
  function_pointers_.GetWriteAttributeDouble = reinterpret_cast<GetWriteAttributeDoublePtr>(p_shared_library_->get_function_pointer("DAQmxGetWriteAttribute"));
  function_pointers_.GetWriteAttributeInt32 = reinterpret_cast<GetWriteAttributeInt32Ptr>(p_shared_library_->get_function_pointer("DAQmxGetWriteAttribute"));
  function_pointers_.GetWriteAttributeString = reinterpret_cast<GetWriteAttributeStringPtr>(p_shared_library_->get_function_pointer("DAQmxGetWriteAttribute"));
  function_pointers_.GetWriteAttributeUInt32 = reinterpret_cast<GetWriteAttributeUInt32Ptr>(p_shared_library_->get_function_pointer("DAQmxGetWriteAttribute"));
  function_pointers_.GetWriteAttributeUInt64 = reinterpret_cast<GetWriteAttributeUInt64Ptr>(p_shared_library_->get_function_pointer("DAQmxGetWriteAttribute"));
  function_pointers_.IsTaskDone = reinterpret_cast<IsTaskDonePtr>(p_shared_library_->get_function_pointer("DAQmxIsTaskDone"));
  function_pointers_.LoadTask = reinterpret_cast<LoadTaskPtr>(p_shared_library_->get_function_pointer("DAQmxLoadTask"));
  function_pointers_.ReadAnalogF64 = reinterpret_cast<ReadAnalogF64Ptr>(p_shared_library_->get_function_pointer("DAQmxReadAnalogF64"));
  function_pointers_.ReadAnalogScalarF64 = reinterpret_cast<ReadAnalogScalarF64Ptr>(p_shared_library_->get_function_pointer("DAQmxReadAnalogScalarF64"));
  function_pointers_.ReadBinaryI16 = reinterpret_cast<ReadBinaryI16Ptr>(p_shared_library_->get_function_pointer("DAQmxReadBinaryI16"));
  function_pointers_.ReadBinaryI32 = reinterpret_cast<ReadBinaryI32Ptr>(p_shared_library_->get_function_pointer("DAQmxReadBinaryI32"));
  function_pointers_.ReadBinaryU16 = reinterpret_cast<ReadBinaryU16Ptr>(p_shared_library_->get_function_pointer("DAQmxReadBinaryU16"));
  function_pointers_.ReadBinaryU32 = reinterpret_cast<ReadBinaryU32Ptr>(p_shared_library_->get_function_pointer("DAQmxReadBinaryU32"));
  function_pointers_.ReadCounterF64 = reinterpret_cast<ReadCounterF64Ptr>(p_shared_library_->get_function_pointer("DAQmxReadCounterF64"));
  function_pointers_.ReadCounterF64Ex = reinterpret_cast<ReadCounterF64ExPtr>(p_shared_library_->get_function_pointer("DAQmxReadCounterF64Ex"));
  function_pointers_.ReadCounterScalarF64 = reinterpret_cast<ReadCounterScalarF64Ptr>(p_shared_library_->get_function_pointer("DAQmxReadCounterScalarF64"));
  function_pointers_.ReadCounterScalarU32 = reinterpret_cast<ReadCounterScalarU32Ptr>(p_shared_library_->get_function_pointer("DAQmxReadCounterScalarU32"));
  function_pointers_.ReadCounterU32 = reinterpret_cast<ReadCounterU32Ptr>(p_shared_library_->get_function_pointer("DAQmxReadCounterU32"));
  function_pointers_.ReadCounterU32Ex = reinterpret_cast<ReadCounterU32ExPtr>(p_shared_library_->get_function_pointer("DAQmxReadCounterU32Ex"));
  function_pointers_.ReadCtrFreq = reinterpret_cast<ReadCtrFreqPtr>(p_shared_library_->get_function_pointer("DAQmxReadCtrFreq"));
  function_pointers_.ReadCtrFreqScalar = reinterpret_cast<ReadCtrFreqScalarPtr>(p_shared_library_->get_function_pointer("DAQmxReadCtrFreqScalar"));
  function_pointers_.ReadCtrTicks = reinterpret_cast<ReadCtrTicksPtr>(p_shared_library_->get_function_pointer("DAQmxReadCtrTicks"));
  function_pointers_.ReadCtrTicksScalar = reinterpret_cast<ReadCtrTicksScalarPtr>(p_shared_library_->get_function_pointer("DAQmxReadCtrTicksScalar"));
  function_pointers_.ReadCtrTime = reinterpret_cast<ReadCtrTimePtr>(p_shared_library_->get_function_pointer("DAQmxReadCtrTime"));
  function_pointers_.ReadCtrTimeScalar = reinterpret_cast<ReadCtrTimeScalarPtr>(p_shared_library_->get_function_pointer("DAQmxReadCtrTimeScalar"));
  function_pointers_.ReadDigitalLines = reinterpret_cast<ReadDigitalLinesPtr>(p_shared_library_->get_function_pointer("DAQmxReadDigitalLines"));
  function_pointers_.ReadDigitalScalarU32 = reinterpret_cast<ReadDigitalScalarU32Ptr>(p_shared_library_->get_function_pointer("DAQmxReadDigitalScalarU32"));
  function_pointers_.ReadDigitalU16 = reinterpret_cast<ReadDigitalU16Ptr>(p_shared_library_->get_function_pointer("DAQmxReadDigitalU16"));
  function_pointers_.ReadDigitalU32 = reinterpret_cast<ReadDigitalU32Ptr>(p_shared_library_->get_function_pointer("DAQmxReadDigitalU32"));
  function_pointers_.ReadDigitalU8 = reinterpret_cast<ReadDigitalU8Ptr>(p_shared_library_->get_function_pointer("DAQmxReadDigitalU8"));
  function_pointers_.ReadPowerBinaryI16 = reinterpret_cast<ReadPowerBinaryI16Ptr>(p_shared_library_->get_function_pointer("DAQmxReadPowerBinaryI16"));
  function_pointers_.ReadPowerF64 = reinterpret_cast<ReadPowerF64Ptr>(p_shared_library_->get_function_pointer("DAQmxReadPowerF64"));
  function_pointers_.ReadPowerScalarF64 = reinterpret_cast<ReadPowerScalarF64Ptr>(p_shared_library_->get_function_pointer("DAQmxReadPowerScalarF64"));
  function_pointers_.ReadRaw = reinterpret_cast<ReadRawPtr>(p_shared_library_->get_function_pointer("DAQmxReadRaw"));
  function_pointers_.RegisterDoneEvent = reinterpret_cast<RegisterDoneEventPtr>(p_shared_library_->get_function_pointer("DAQmxRegisterDoneEvent"));
  function_pointers_.RegisterEveryNSamplesEvent = reinterpret_cast<RegisterEveryNSamplesEventPtr>(p_shared_library_->get_function_pointer("DAQmxRegisterEveryNSamplesEvent"));
  function_pointers_.RegisterSignalEvent = reinterpret_cast<RegisterSignalEventPtr>(p_shared_library_->get_function_pointer("DAQmxRegisterSignalEvent"));
  function_pointers_.RemoveCDAQSyncConnection = reinterpret_cast<RemoveCDAQSyncConnectionPtr>(p_shared_library_->get_function_pointer("DAQmxRemoveCDAQSyncConnection"));
  function_pointers_.ReserveNetworkDevice = reinterpret_cast<ReserveNetworkDevicePtr>(p_shared_library_->get_function_pointer("DAQmxReserveNetworkDevice"));
  function_pointers_.ResetBufferAttribute = reinterpret_cast<ResetBufferAttributePtr>(p_shared_library_->get_function_pointer("DAQmxResetBufferAttribute"));
  function_pointers_.ResetChanAttribute = reinterpret_cast<ResetChanAttributePtr>(p_shared_library_->get_function_pointer("DAQmxResetChanAttribute"));
  function_pointers_.ResetDevice = reinterpret_cast<ResetDevicePtr>(p_shared_library_->get_function_pointer("DAQmxResetDevice"));
  function_pointers_.ResetExportedSignalAttribute = reinterpret_cast<ResetExportedSignalAttributePtr>(p_shared_library_->get_function_pointer("DAQmxResetExportedSignalAttribute"));
  function_pointers_.ResetReadAttribute = reinterpret_cast<ResetReadAttributePtr>(p_shared_library_->get_function_pointer("DAQmxResetReadAttribute"));
  function_pointers_.ResetRealTimeAttribute = reinterpret_cast<ResetRealTimeAttributePtr>(p_shared_library_->get_function_pointer("DAQmxResetRealTimeAttribute"));
  function_pointers_.ResetTimingAttribute = reinterpret_cast<ResetTimingAttributePtr>(p_shared_library_->get_function_pointer("DAQmxResetTimingAttribute"));
  function_pointers_.ResetTimingAttributeEx = reinterpret_cast<ResetTimingAttributeExPtr>(p_shared_library_->get_function_pointer("DAQmxResetTimingAttributeEx"));
  function_pointers_.ResetTrigAttribute = reinterpret_cast<ResetTrigAttributePtr>(p_shared_library_->get_function_pointer("DAQmxResetTrigAttribute"));
  function_pointers_.ResetWatchdogAttribute = reinterpret_cast<ResetWatchdogAttributePtr>(p_shared_library_->get_function_pointer("DAQmxResetWatchdogAttribute"));
  function_pointers_.ResetWriteAttribute = reinterpret_cast<ResetWriteAttributePtr>(p_shared_library_->get_function_pointer("DAQmxResetWriteAttribute"));
  function_pointers_.SaveGlobalChan = reinterpret_cast<SaveGlobalChanPtr>(p_shared_library_->get_function_pointer("DAQmxSaveGlobalChan"));
  function_pointers_.SaveScale = reinterpret_cast<SaveScalePtr>(p_shared_library_->get_function_pointer("DAQmxSaveScale"));
  function_pointers_.SaveTask = reinterpret_cast<SaveTaskPtr>(p_shared_library_->get_function_pointer("DAQmxSaveTask"));
  function_pointers_.SelfCal = reinterpret_cast<SelfCalPtr>(p_shared_library_->get_function_pointer("DAQmxSelfCal"));
  function_pointers_.SelfTestDevice = reinterpret_cast<SelfTestDevicePtr>(p_shared_library_->get_function_pointer("DAQmxSelfTestDevice"));
  function_pointers_.SetAIChanCalCalDate = reinterpret_cast<SetAIChanCalCalDatePtr>(p_shared_library_->get_function_pointer("DAQmxSetAIChanCalCalDate"));
  function_pointers_.SetAIChanCalExpDate = reinterpret_cast<SetAIChanCalExpDatePtr>(p_shared_library_->get_function_pointer("DAQmxSetAIChanCalExpDate"));
  function_pointers_.SetAnalogPowerUpStates = reinterpret_cast<SetAnalogPowerUpStatesPtr>(p_shared_library_->get_function_pointer("DAQmxSetAnalogPowerUpStates"));
  function_pointers_.SetAnalogPowerUpStatesWithOutputType = reinterpret_cast<SetAnalogPowerUpStatesWithOutputTypePtr>(p_shared_library_->get_function_pointer("DAQmxSetAnalogPowerUpStatesWithOutputType"));
  function_pointers_.SetArmStartTrigTrigWhen = reinterpret_cast<SetArmStartTrigTrigWhenPtr>(p_shared_library_->get_function_pointer("DAQmxSetArmStartTrigTrigWhen"));
  function_pointers_.SetBufferAttributeUInt32 = reinterpret_cast<SetBufferAttributeUInt32Ptr>(p_shared_library_->get_function_pointer("DAQmxSetBufferAttribute"));
  function_pointers_.SetCalInfoAttributeBool = reinterpret_cast<SetCalInfoAttributeBoolPtr>(p_shared_library_->get_function_pointer("DAQmxSetCalInfoAttribute"));
  function_pointers_.SetCalInfoAttributeDouble = reinterpret_cast<SetCalInfoAttributeDoublePtr>(p_shared_library_->get_function_pointer("DAQmxSetCalInfoAttribute"));
  function_pointers_.SetCalInfoAttributeString = reinterpret_cast<SetCalInfoAttributeStringPtr>(p_shared_library_->get_function_pointer("DAQmxSetCalInfoAttribute"));
  function_pointers_.SetCalInfoAttributeUInt32 = reinterpret_cast<SetCalInfoAttributeUInt32Ptr>(p_shared_library_->get_function_pointer("DAQmxSetCalInfoAttribute"));
  function_pointers_.SetChanAttributeBool = reinterpret_cast<SetChanAttributeBoolPtr>(p_shared_library_->get_function_pointer("DAQmxSetChanAttribute"));
  function_pointers_.SetChanAttributeDouble = reinterpret_cast<SetChanAttributeDoublePtr>(p_shared_library_->get_function_pointer("DAQmxSetChanAttribute"));
  function_pointers_.SetChanAttributeDoubleArray = reinterpret_cast<SetChanAttributeDoubleArrayPtr>(p_shared_library_->get_function_pointer("DAQmxSetChanAttribute"));
  function_pointers_.SetChanAttributeInt32 = reinterpret_cast<SetChanAttributeInt32Ptr>(p_shared_library_->get_function_pointer("DAQmxSetChanAttribute"));
  function_pointers_.SetChanAttributeString = reinterpret_cast<SetChanAttributeStringPtr>(p_shared_library_->get_function_pointer("DAQmxSetChanAttribute"));
  function_pointers_.SetChanAttributeUInt32 = reinterpret_cast<SetChanAttributeUInt32Ptr>(p_shared_library_->get_function_pointer("DAQmxSetChanAttribute"));
  function_pointers_.SetDigitalLogicFamilyPowerUpState = reinterpret_cast<SetDigitalLogicFamilyPowerUpStatePtr>(p_shared_library_->get_function_pointer("DAQmxSetDigitalLogicFamilyPowerUpState"));
  function_pointers_.SetDigitalPowerUpStates = reinterpret_cast<SetDigitalPowerUpStatesPtr>(p_shared_library_->get_function_pointer("DAQmxSetDigitalPowerUpStates"));
  function_pointers_.SetDigitalPullUpPullDownStates = reinterpret_cast<SetDigitalPullUpPullDownStatesPtr>(p_shared_library_->get_function_pointer("DAQmxSetDigitalPullUpPullDownStates"));
  function_pointers_.SetExportedSignalAttributeBool = reinterpret_cast<SetExportedSignalAttributeBoolPtr>(p_shared_library_->get_function_pointer("DAQmxSetExportedSignalAttribute"));
  function_pointers_.SetExportedSignalAttributeDouble = reinterpret_cast<SetExportedSignalAttributeDoublePtr>(p_shared_library_->get_function_pointer("DAQmxSetExportedSignalAttribute"));
  function_pointers_.SetExportedSignalAttributeInt32 = reinterpret_cast<SetExportedSignalAttributeInt32Ptr>(p_shared_library_->get_function_pointer("DAQmxSetExportedSignalAttribute"));
  function_pointers_.SetExportedSignalAttributeString = reinterpret_cast<SetExportedSignalAttributeStringPtr>(p_shared_library_->get_function_pointer("DAQmxSetExportedSignalAttribute"));
  function_pointers_.SetExportedSignalAttributeUInt32 = reinterpret_cast<SetExportedSignalAttributeUInt32Ptr>(p_shared_library_->get_function_pointer("DAQmxSetExportedSignalAttribute"));
  function_pointers_.SetFirstSampClkWhen = reinterpret_cast<SetFirstSampClkWhenPtr>(p_shared_library_->get_function_pointer("DAQmxSetFirstSampClkWhen"));
  function_pointers_.SetReadAttributeBool = reinterpret_cast<SetReadAttributeBoolPtr>(p_shared_library_->get_function_pointer("DAQmxSetReadAttribute"));
  function_pointers_.SetReadAttributeDouble = reinterpret_cast<SetReadAttributeDoublePtr>(p_shared_library_->get_function_pointer("DAQmxSetReadAttribute"));
  function_pointers_.SetReadAttributeInt32 = reinterpret_cast<SetReadAttributeInt32Ptr>(p_shared_library_->get_function_pointer("DAQmxSetReadAttribute"));
  function_pointers_.SetReadAttributeString = reinterpret_cast<SetReadAttributeStringPtr>(p_shared_library_->get_function_pointer("DAQmxSetReadAttribute"));
  function_pointers_.SetReadAttributeUInt32 = reinterpret_cast<SetReadAttributeUInt32Ptr>(p_shared_library_->get_function_pointer("DAQmxSetReadAttribute"));
  function_pointers_.SetReadAttributeUInt64 = reinterpret_cast<SetReadAttributeUInt64Ptr>(p_shared_library_->get_function_pointer("DAQmxSetReadAttribute"));
  function_pointers_.SetRealTimeAttributeBool = reinterpret_cast<SetRealTimeAttributeBoolPtr>(p_shared_library_->get_function_pointer("DAQmxSetRealTimeAttribute"));
  function_pointers_.SetRealTimeAttributeInt32 = reinterpret_cast<SetRealTimeAttributeInt32Ptr>(p_shared_library_->get_function_pointer("DAQmxSetRealTimeAttribute"));
  function_pointers_.SetRealTimeAttributeUInt32 = reinterpret_cast<SetRealTimeAttributeUInt32Ptr>(p_shared_library_->get_function_pointer("DAQmxSetRealTimeAttribute"));
  function_pointers_.SetScaleAttributeDouble = reinterpret_cast<SetScaleAttributeDoublePtr>(p_shared_library_->get_function_pointer("DAQmxSetScaleAttribute"));
  function_pointers_.SetScaleAttributeDoubleArray = reinterpret_cast<SetScaleAttributeDoubleArrayPtr>(p_shared_library_->get_function_pointer("DAQmxSetScaleAttribute"));
  function_pointers_.SetScaleAttributeInt32 = reinterpret_cast<SetScaleAttributeInt32Ptr>(p_shared_library_->get_function_pointer("DAQmxSetScaleAttribute"));
  function_pointers_.SetScaleAttributeString = reinterpret_cast<SetScaleAttributeStringPtr>(p_shared_library_->get_function_pointer("DAQmxSetScaleAttribute"));
  function_pointers_.SetStartTrigTrigWhen = reinterpret_cast<SetStartTrigTrigWhenPtr>(p_shared_library_->get_function_pointer("DAQmxSetStartTrigTrigWhen"));
  function_pointers_.SetSyncPulseTimeWhen = reinterpret_cast<SetSyncPulseTimeWhenPtr>(p_shared_library_->get_function_pointer("DAQmxSetSyncPulseTimeWhen"));
  function_pointers_.SetTimingAttributeBool = reinterpret_cast<SetTimingAttributeBoolPtr>(p_shared_library_->get_function_pointer("DAQmxSetTimingAttribute"));
  function_pointers_.SetTimingAttributeDouble = reinterpret_cast<SetTimingAttributeDoublePtr>(p_shared_library_->get_function_pointer("DAQmxSetTimingAttribute"));
  function_pointers_.SetTimingAttributeExBool = reinterpret_cast<SetTimingAttributeExBoolPtr>(p_shared_library_->get_function_pointer("DAQmxSetTimingAttributeEx"));
  function_pointers_.SetTimingAttributeExDouble = reinterpret_cast<SetTimingAttributeExDoublePtr>(p_shared_library_->get_function_pointer("DAQmxSetTimingAttributeEx"));
  function_pointers_.SetTimingAttributeExInt32 = reinterpret_cast<SetTimingAttributeExInt32Ptr>(p_shared_library_->get_function_pointer("DAQmxSetTimingAttributeEx"));
  function_pointers_.SetTimingAttributeExString = reinterpret_cast<SetTimingAttributeExStringPtr>(p_shared_library_->get_function_pointer("DAQmxSetTimingAttributeEx"));
  function_pointers_.SetTimingAttributeExTimestamp = reinterpret_cast<SetTimingAttributeExTimestampPtr>(p_shared_library_->get_function_pointer("DAQmxSetTimingAttributeEx"));
  function_pointers_.SetTimingAttributeExUInt32 = reinterpret_cast<SetTimingAttributeExUInt32Ptr>(p_shared_library_->get_function_pointer("DAQmxSetTimingAttributeEx"));
  function_pointers_.SetTimingAttributeExUInt64 = reinterpret_cast<SetTimingAttributeExUInt64Ptr>(p_shared_library_->get_function_pointer("DAQmxSetTimingAttributeEx"));
  function_pointers_.SetTimingAttributeInt32 = reinterpret_cast<SetTimingAttributeInt32Ptr>(p_shared_library_->get_function_pointer("DAQmxSetTimingAttribute"));
  function_pointers_.SetTimingAttributeString = reinterpret_cast<SetTimingAttributeStringPtr>(p_shared_library_->get_function_pointer("DAQmxSetTimingAttribute"));
  function_pointers_.SetTimingAttributeTimestamp = reinterpret_cast<SetTimingAttributeTimestampPtr>(p_shared_library_->get_function_pointer("DAQmxSetTimingAttribute"));
  function_pointers_.SetTimingAttributeUInt32 = reinterpret_cast<SetTimingAttributeUInt32Ptr>(p_shared_library_->get_function_pointer("DAQmxSetTimingAttribute"));
  function_pointers_.SetTimingAttributeUInt64 = reinterpret_cast<SetTimingAttributeUInt64Ptr>(p_shared_library_->get_function_pointer("DAQmxSetTimingAttribute"));
  function_pointers_.SetTrigAttributeBool = reinterpret_cast<SetTrigAttributeBoolPtr>(p_shared_library_->get_function_pointer("DAQmxSetTrigAttribute"));
  function_pointers_.SetTrigAttributeDouble = reinterpret_cast<SetTrigAttributeDoublePtr>(p_shared_library_->get_function_pointer("DAQmxSetTrigAttribute"));
  function_pointers_.SetTrigAttributeDoubleArray = reinterpret_cast<SetTrigAttributeDoubleArrayPtr>(p_shared_library_->get_function_pointer("DAQmxSetTrigAttribute"));
  function_pointers_.SetTrigAttributeInt32 = reinterpret_cast<SetTrigAttributeInt32Ptr>(p_shared_library_->get_function_pointer("DAQmxSetTrigAttribute"));
  function_pointers_.SetTrigAttributeInt32Array = reinterpret_cast<SetTrigAttributeInt32ArrayPtr>(p_shared_library_->get_function_pointer("DAQmxSetTrigAttribute"));
  function_pointers_.SetTrigAttributeString = reinterpret_cast<SetTrigAttributeStringPtr>(p_shared_library_->get_function_pointer("DAQmxSetTrigAttribute"));
  function_pointers_.SetTrigAttributeTimestamp = reinterpret_cast<SetTrigAttributeTimestampPtr>(p_shared_library_->get_function_pointer("DAQmxSetTrigAttribute"));
  function_pointers_.SetTrigAttributeUInt32 = reinterpret_cast<SetTrigAttributeUInt32Ptr>(p_shared_library_->get_function_pointer("DAQmxSetTrigAttribute"));
  function_pointers_.SetWatchdogAttributeBool = reinterpret_cast<SetWatchdogAttributeBoolPtr>(p_shared_library_->get_function_pointer("DAQmxSetWatchdogAttribute"));
  function_pointers_.SetWatchdogAttributeDouble = reinterpret_cast<SetWatchdogAttributeDoublePtr>(p_shared_library_->get_function_pointer("DAQmxSetWatchdogAttribute"));
  function_pointers_.SetWatchdogAttributeInt32 = reinterpret_cast<SetWatchdogAttributeInt32Ptr>(p_shared_library_->get_function_pointer("DAQmxSetWatchdogAttribute"));
  function_pointers_.SetWatchdogAttributeString = reinterpret_cast<SetWatchdogAttributeStringPtr>(p_shared_library_->get_function_pointer("DAQmxSetWatchdogAttribute"));
  function_pointers_.SetWriteAttributeBool = reinterpret_cast<SetWriteAttributeBoolPtr>(p_shared_library_->get_function_pointer("DAQmxSetWriteAttribute"));
  function_pointers_.SetWriteAttributeDouble = reinterpret_cast<SetWriteAttributeDoublePtr>(p_shared_library_->get_function_pointer("DAQmxSetWriteAttribute"));
  function_pointers_.SetWriteAttributeInt32 = reinterpret_cast<SetWriteAttributeInt32Ptr>(p_shared_library_->get_function_pointer("DAQmxSetWriteAttribute"));
  function_pointers_.SetWriteAttributeString = reinterpret_cast<SetWriteAttributeStringPtr>(p_shared_library_->get_function_pointer("DAQmxSetWriteAttribute"));
  function_pointers_.SetWriteAttributeUInt32 = reinterpret_cast<SetWriteAttributeUInt32Ptr>(p_shared_library_->get_function_pointer("DAQmxSetWriteAttribute"));
  function_pointers_.SetWriteAttributeUInt64 = reinterpret_cast<SetWriteAttributeUInt64Ptr>(p_shared_library_->get_function_pointer("DAQmxSetWriteAttribute"));
  function_pointers_.StartNewFile = reinterpret_cast<StartNewFilePtr>(p_shared_library_->get_function_pointer("DAQmxStartNewFile"));
  function_pointers_.StartTask = reinterpret_cast<StartTaskPtr>(p_shared_library_->get_function_pointer("DAQmxStartTask"));
  function_pointers_.StopTask = reinterpret_cast<StopTaskPtr>(p_shared_library_->get_function_pointer("DAQmxStopTask"));
  function_pointers_.TaskControl = reinterpret_cast<TaskControlPtr>(p_shared_library_->get_function_pointer("DAQmxTaskControl"));
  function_pointers_.TristateOutputTerm = reinterpret_cast<TristateOutputTermPtr>(p_shared_library_->get_function_pointer("DAQmxTristateOutputTerm"));
  function_pointers_.UnregisterDoneEvent = reinterpret_cast<UnregisterDoneEventPtr>(p_shared_library_->get_function_pointer("DAQmxRegisterDoneEvent"));
  function_pointers_.UnregisterEveryNSamplesEvent = reinterpret_cast<UnregisterEveryNSamplesEventPtr>(p_shared_library_->get_function_pointer("DAQmxRegisterEveryNSamplesEvent"));
  function_pointers_.UnregisterSignalEvent = reinterpret_cast<UnregisterSignalEventPtr>(p_shared_library_->get_function_pointer("DAQmxRegisterSignalEvent"));
  function_pointers_.UnreserveNetworkDevice = reinterpret_cast<UnreserveNetworkDevicePtr>(p_shared_library_->get_function_pointer("DAQmxUnreserveNetworkDevice"));
  function_pointers_.WaitForNextSampleClock = reinterpret_cast<WaitForNextSampleClockPtr>(p_shared_library_->get_function_pointer("DAQmxWaitForNextSampleClock"));
  function_pointers_.WaitForValidTimestamp = reinterpret_cast<WaitForValidTimestampPtr>(p_shared_library_->get_function_pointer("DAQmxWaitForValidTimestamp"));
  function_pointers_.WaitUntilTaskDone = reinterpret_cast<WaitUntilTaskDonePtr>(p_shared_library_->get_function_pointer("DAQmxWaitUntilTaskDone"));
  function_pointers_.WriteAnalogF64 = reinterpret_cast<WriteAnalogF64Ptr>(p_shared_library_->get_function_pointer("DAQmxWriteAnalogF64"));
  function_pointers_.WriteAnalogScalarF64 = reinterpret_cast<WriteAnalogScalarF64Ptr>(p_shared_library_->get_function_pointer("DAQmxWriteAnalogScalarF64"));
  function_pointers_.WriteBinaryI16 = reinterpret_cast<WriteBinaryI16Ptr>(p_shared_library_->get_function_pointer("DAQmxWriteBinaryI16"));
  function_pointers_.WriteBinaryI32 = reinterpret_cast<WriteBinaryI32Ptr>(p_shared_library_->get_function_pointer("DAQmxWriteBinaryI32"));
  function_pointers_.WriteBinaryU16 = reinterpret_cast<WriteBinaryU16Ptr>(p_shared_library_->get_function_pointer("DAQmxWriteBinaryU16"));
  function_pointers_.WriteBinaryU32 = reinterpret_cast<WriteBinaryU32Ptr>(p_shared_library_->get_function_pointer("DAQmxWriteBinaryU32"));
  function_pointers_.WriteCtrFreq = reinterpret_cast<WriteCtrFreqPtr>(p_shared_library_->get_function_pointer("DAQmxWriteCtrFreq"));
  function_pointers_.WriteCtrFreqScalar = reinterpret_cast<WriteCtrFreqScalarPtr>(p_shared_library_->get_function_pointer("DAQmxWriteCtrFreqScalar"));
  function_pointers_.WriteCtrTicks = reinterpret_cast<WriteCtrTicksPtr>(p_shared_library_->get_function_pointer("DAQmxWriteCtrTicks"));
  function_pointers_.WriteCtrTicksScalar = reinterpret_cast<WriteCtrTicksScalarPtr>(p_shared_library_->get_function_pointer("DAQmxWriteCtrTicksScalar"));
  function_pointers_.WriteCtrTime = reinterpret_cast<WriteCtrTimePtr>(p_shared_library_->get_function_pointer("DAQmxWriteCtrTime"));
  function_pointers_.WriteCtrTimeScalar = reinterpret_cast<WriteCtrTimeScalarPtr>(p_shared_library_->get_function_pointer("DAQmxWriteCtrTimeScalar"));
  function_pointers_.WriteDigitalLines = reinterpret_cast<WriteDigitalLinesPtr>(p_shared_library_->get_function_pointer("DAQmxWriteDigitalLines"));
  function_pointers_.WriteDigitalScalarU32 = reinterpret_cast<WriteDigitalScalarU32Ptr>(p_shared_library_->get_function_pointer("DAQmxWriteDigitalScalarU32"));
  function_pointers_.WriteDigitalU16 = reinterpret_cast<WriteDigitalU16Ptr>(p_shared_library_->get_function_pointer("DAQmxWriteDigitalU16"));
  function_pointers_.WriteDigitalU32 = reinterpret_cast<WriteDigitalU32Ptr>(p_shared_library_->get_function_pointer("DAQmxWriteDigitalU32"));
  function_pointers_.WriteDigitalU8 = reinterpret_cast<WriteDigitalU8Ptr>(p_shared_library_->get_function_pointer("DAQmxWriteDigitalU8"));
  function_pointers_.WriteRaw = reinterpret_cast<WriteRawPtr>(p_shared_library_->get_function_pointer("DAQmxWriteRaw"));
  function_pointers_.WriteToTEDSFromArray = reinterpret_cast<WriteToTEDSFromArrayPtr>(p_shared_library_->get_function_pointer("DAQmxWriteToTEDSFromArray"));
  function_pointers_.WriteToTEDSFromFile = reinterpret_cast<WriteToTEDSFromFilePtr>(p_shared_library_->get_function_pointer("DAQmxWriteToTEDSFromFile"));
}
