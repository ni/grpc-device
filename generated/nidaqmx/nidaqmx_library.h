...
class NiDAQmxLibrary : public nidaqmx_grpc::NiDAQmxLibraryInterface {
 ...
 private:
  ...
  using CreateWatchdogTimerTaskPtr = int32 (*)(const char deviceName[], const char sessionName[], TaskHandle* task, float64 timeout, const char channelNames[], int32 expState, ...);
  ...
  using GetAnalogPowerUpStatesPtr = int32 (*)(const char deviceName[], const char channelName[], double* state, int32 channelType, ...);
  ...
  using SetAnalogPowerUpStatesPtr = int32 (*)(const char deviceName[], const char channelNames[], double state, int32 channelType, ...);
