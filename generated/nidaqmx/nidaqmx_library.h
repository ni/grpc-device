...
class NiDAQmxLibrary : public nidaqmx_grpc::NiDAQmxLibraryInterface {
 ...
 private:
  ...
  using GetPhysicalChanAttributeDoubleArrayPtr = int32 (*)(const char physicalChannel[], int32 attribute, float64 value[], uInt32 size);
  using GetPhysicalChanAttributeInt32Ptr = int32 (*)(const char physicalChannel[], int32 attribute, int32* value, uInt32 size);
  using GetPhysicalChanAttributeInt32ArrayPtr = int32 (*)(const char physicalChannel[], int32 attribute, int32 value[], uInt32 size);
  using GetPhysicalChanAttributeStringPtr = int32 (*)(const char physicalChannel[], int32 attribute, char value[], uInt32 size);
  using GetPhysicalChanAttributeUInt32Ptr = int32 (*)(const char physicalChannel[], int32 attribute, uInt32* value, uInt32 size);
  using GetPhysicalChanAttributeUInt32ArrayPtr = int32 (*)(const char physicalChannel[], int32 attribute, uInt32 value[], uInt32 size);
