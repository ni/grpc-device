...
class NiDAQmxService final : public NiDAQmx::ExperimentalWithCallbackMethod_RegisterSignalEvent<NiDAQmx::ExperimentalWithCallbackMethod_RegisterEveryNSamplesEvent<NiDAQmx::ExperimentalWithCallbackMethod_RegisterDoneEvent<NiDAQmx::Service>>> {
public:
  ...
  ::grpc::experimental::ServerWriteReactor<RegisterEveryNSamplesEventResponse>* RegisterEveryNSamplesEvent(::grpc::CallbackServerContext* context, const RegisterEveryNSamplesEventRequest* request) override;
  ::grpc::experimental::ServerWriteReactor<RegisterSignalEventResponse>* RegisterSignalEvent(::grpc::CallbackServerContext* context, const RegisterSignalEventRequest* request) override;
