...
class NiDAQmxLibraryInterface {
 public:
  ...
  virtual int32 GetCalInfoAttributeBool(const char deviceName[], int32 attribute, bool32* value, uInt32 size) = 0;
  virtual int32 GetCalInfoAttributeDouble(const char deviceName[], int32 attribute, float64* value, uInt32 size) = 0;
  virtual int32 GetCalInfoAttributeString(const char deviceName[], int32 attribute, char value[], uInt32 size) = 0;
  virtual int32 GetCalInfoAttributeUInt32(const char deviceName[], int32 attribute, uInt32* value, uInt32 size) = 0;
  ...
  virtual int32 GetPhysicalChanAttributeInt32(const char physicalChannel[], int32 attribute, int32* value, uInt32 size) = 0;
  ...
  virtual int32 GetPhysicalChanAttributeUInt32(const char physicalChannel[], int32 attribute, uInt32* value, uInt32 size) = 0;
  virtual int32 GetPhysicalChanAttributeUInt32Array(const char physicalChannel[], int32 attribute, uInt32 value[], uInt32 size) = 0;
  virtual int32 GetReadAttributeBool(TaskHandle task, int32 attribute, bool32* value, uInt32 size) = 0;
  virtual int32 GetReadAttributeDouble(TaskHandle task, int32 attribute, float64* value, uInt32 size) = 0;
  virtual int32 GetReadAttributeInt32(TaskHandle task, int32 attribute, int32* value, uInt32 size) = 0;
  ...
  virtual int32 GetTimingAttributeBool(TaskHandle task, int32 attribute, bool32* value, uInt32 size) = 0;
  virtual int32 GetTimingAttributeDouble(TaskHandle task, int32 attribute, float64* value, uInt32 size) = 0;
  virtual int32 GetTimingAttributeExBool(TaskHandle task, const char deviceNames[], int32 attribute, bool32* value, uInt32 size) = 0;
  virtual int32 GetTimingAttributeExDouble(TaskHandle task, const char deviceNames[], int32 attribute, float64* value, uInt32 size) = 0;
  virtual int32 GetTimingAttributeExInt32(TaskHandle task, const char deviceNames[], int32 attribute, int32* value, uInt32 size) = 0;
  virtual int32 GetTimingAttributeExString(TaskHandle task, const char deviceNames[], int32 attribute, char value[], uInt32 size) = 0;
  virtual int32 GetTimingAttributeExTimestamp(TaskHandle task, const char deviceNames[], int32 attribute, CVIAbsoluteTime* value, uInt32 size) = 0;
  virtual int32 GetTimingAttributeExUInt32(TaskHandle task, const char deviceNames[], int32 attribute, uInt32* value, uInt32 size) = 0;
  virtual int32 GetTimingAttributeExUInt64(TaskHandle task, const char deviceNames[], int32 attribute, uInt64* value, uInt32 size) = 0;
  virtual int32 GetTimingAttributeInt32(TaskHandle task, int32 attribute, int32* value, uInt32 size) = 0;
  ...
  virtual int32 GetTimingAttributeUInt64(TaskHandle task, int32 attribute, uInt64* value, uInt32 size) = 0;
  ...
  virtual int32 GetWriteAttributeUInt32(TaskHandle task, int32 attribute, uInt32* value, uInt32 size) = 0;
  virtual int32 GetWriteAttributeUInt64(TaskHandle task, int32 attribute, uInt64* value, uInt32 size) = 0;
  ...
  virtual int32 SetCalInfoAttributeDouble(const char deviceName[], int32 attribute, float64 value, uInt32 size) = 0;
  virtual int32 SetCalInfoAttributeString(const char deviceName[], int32 attribute, const char value[], uInt32 size) = 0;
  virtual int32 SetCalInfoAttributeUInt32(const char deviceName[], int32 attribute, uInt32 value, uInt32 size) = 0;
  ...
  virtual int32 SetReadAttributeInt32(TaskHandle task, int32 attribute, int32 value, uInt32 size) = 0;
  ...
  virtual int32 SetScaleAttributeString(const char scaleName[], int32 attribute, const char value[], uInt32 size) = 0;
  ...
  virtual int32 SetTimingAttributeBool(TaskHandle task, int32 attribute, bool32 value, uInt32 size) = 0;
  virtual int32 SetTimingAttributeDouble(TaskHandle task, int32 attribute, float64 value, uInt32 size) = 0;
  virtual int32 SetTimingAttributeExBool(TaskHandle task, const char deviceNames[], int32 attribute, bool32 value, uInt32 size) = 0;
  virtual int32 SetTimingAttributeExDouble(TaskHandle task, const char deviceNames[], int32 attribute, float64 value, uInt32 size) = 0;
  virtual int32 SetTimingAttributeExInt32(TaskHandle task, const char deviceNames[], int32 attribute, int32 value, uInt32 size) = 0;
  virtual int32 SetTimingAttributeExString(TaskHandle task, const char deviceNames[], int32 attribute, const char value[], uInt32 size) = 0;
  virtual int32 SetTimingAttributeExTimestamp(TaskHandle task, const char deviceNames[], int32 attribute, CVIAbsoluteTime value, uInt32 size) = 0;
  virtual int32 SetTimingAttributeExUInt32(TaskHandle task, const char deviceNames[], int32 attribute, uInt32 value, uInt32 size) = 0;
  virtual int32 SetTimingAttributeExUInt64(TaskHandle task, const char deviceNames[], int32 attribute, uInt64 value, uInt32 size) = 0;
  virtual int32 SetTimingAttributeInt32(TaskHandle task, int32 attribute, int32 value, uInt32 size) = 0;
  ...
  virtual int32 SetTimingAttributeUInt64(TaskHandle task, int32 attribute, uInt64 value, uInt32 size) = 0;
  ...
  virtual int32 SetWriteAttributeString(TaskHandle task, int32 attribute, const char value[], uInt32 size) = 0;
  virtual int32 SetWriteAttributeUInt32(TaskHandle task, int32 attribute, uInt32 value, uInt32 size) = 0;
  virtual int32 SetWriteAttributeUInt64(TaskHandle task, int32 attribute, uInt64 value, uInt32 size) = 0;
