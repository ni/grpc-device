...
class NiDAQmxMockLibrary : public nidaqmx_grpc::NiDAQmxLibraryInterface {
 public:
  ...
  MOCK_METHOD(int32, GetSystemInfoAttributeUInt32, (int32 attribute, uInt32* value, uInt32 size), (override));
  ...
  MOCK_METHOD(int32, GetTimingAttributeBool, (TaskHandle task, int32 attribute, bool32* value, uInt32 size), (override));
  MOCK_METHOD(int32, GetTimingAttributeDouble, (TaskHandle task, int32 attribute, float64* value, uInt32 size), (override));
  MOCK_METHOD(int32, GetTimingAttributeExBool, (TaskHandle task, const char deviceNames[], int32 attribute, bool32* value, uInt32 size), (override));
  MOCK_METHOD(int32, GetTimingAttributeExDouble, (TaskHandle task, const char deviceNames[], int32 attribute, float64* value, uInt32 size), (override));
  MOCK_METHOD(int32, GetTimingAttributeExInt32, (TaskHandle task, const char deviceNames[], int32 attribute, int32* value, uInt32 size), (override));
  ...
  MOCK_METHOD(int32, GetWatchdogAttributeBool, (TaskHandle task, const char lines[], int32 attribute, bool32* value, uInt32 size), (override));
  MOCK_METHOD(int32, GetWatchdogAttributeDouble, (TaskHandle task, const char lines[], int32 attribute, float64* value, uInt32 size), (override));
  MOCK_METHOD(int32, GetWatchdogAttributeInt32, (TaskHandle task, const char lines[], int32 attribute, int32* value, uInt32 size), (override));
  ...
  MOCK_METHOD(int32, GetWriteAttributeBool, (TaskHandle task, int32 attribute, bool32* value, uInt32 size), (override));
  MOCK_METHOD(int32, GetWriteAttributeDouble, (TaskHandle task, int32 attribute, float64* value, uInt32 size), (override));
  ...
  MOCK_METHOD(int32, SetReadAttributeInt32, (TaskHandle task, int32 attribute, int32 value, uInt32 size), (override));
  ...
  MOCK_METHOD(int32, SetScaleAttributeString, (const char scaleName[], int32 attribute, const char value[], uInt32 size), (override));
  ...
  MOCK_METHOD(int32, SetTimingAttributeBool, (TaskHandle task, int32 attribute, bool32 value, uInt32 size), (override));
  MOCK_METHOD(int32, SetTimingAttributeDouble, (TaskHandle task, int32 attribute, float64 value, uInt32 size), (override));
  MOCK_METHOD(int32, SetTimingAttributeExBool, (TaskHandle task, const char deviceNames[], int32 attribute, bool32 value, uInt32 size), (override));
  MOCK_METHOD(int32, SetTimingAttributeExDouble, (TaskHandle task, const char deviceNames[], int32 attribute, float64 value, uInt32 size), (override));
  MOCK_METHOD(int32, SetTimingAttributeExInt32, (TaskHandle task, const char deviceNames[], int32 attribute, int32 value, uInt32 size), (override));
  ...
  MOCK_METHOD(int32, SetWatchdogAttributeBool, (TaskHandle task, const char lines[], int32 attribute, bool32 value, uInt32 size), (override));
  MOCK_METHOD(int32, SetWatchdogAttributeDouble, (TaskHandle task, const char lines[], int32 attribute, float64 value, uInt32 size), (override));
  MOCK_METHOD(int32, SetWatchdogAttributeInt32, (TaskHandle task, const char lines[], int32 attribute, int32 value, uInt32 size), (override));
  MOCK_METHOD(int32, SetWatchdogAttributeString, (TaskHandle task, const char lines[], int32 attribute, const char value[], uInt32 size), (override));
  MOCK_METHOD(int32, SetWriteAttributeBool, (TaskHandle task, int32 attribute, bool32 value, uInt32 size), (override));
  MOCK_METHOD(int32, SetWriteAttributeDouble, (TaskHandle task, int32 attribute, float64 value, uInt32 size), (override));
