...
private:
  ...
  std::map<std::int32_t, std::string> exportterminalrangetable_input_map_ { {1, ""},{2, "PFI0"},{3, "PFI1"},{4, "PXI_Trig0"},{5, "PXI_Trig1"},{6, "PXI_Trig2"},{7, "PXI_Trig3"},{8, "PXI_Trig4"},{9, "PXI_Trig5"},{10, "PXI_Trig6"},{11, "PXI_Trig7"},{12, "PXI_STAR"},{13, "PXIe_DStarC"},{14, "RefOut"},{15, "RefOut2"},{16, "ClkOut"}, };
  std::map<std::string, std::int32_t> exportterminalrangetable_output_map_ { {"", 1},{"PFI0", 2},{"PFI1", 3},{"PXI_Trig0", 4},{"PXI_Trig1", 5},{"PXI_Trig2", 6},{"PXI_Trig3", 7},{"PXI_Trig4", 8},{"PXI_Trig5", 9},{"PXI_Trig6", 10},{"PXI_Trig7", 11},{"PXI_STAR", 12},{"PXIe_DStarC", 13},{"RefOut", 14},{"RefOut2", 15},{"ClkOut", 16}, };
  ...
  std::map<std::int32_t, std::string> pxichassisclk10sourcerangetable_input_map_ { {1, "None"},{2, "OnboardClock"},{3, "RefIn"}, };
  std::map<std::string, std::int32_t> pxichassisclk10sourcerangetable_output_map_ { {"None", 1},{"OnboardClock", 2},{"RefIn", 3}, };
  std::map<std::int32_t, std::string> refclocksourcerangetable_input_map_ { {1, "None"},{2, "OnboardClock"},{3, "RefIn"},{4, "PXI_Clk"},{5, "ClkIn"},{6, "RefIn2"},{7, "PXI_ClkMaster"}, };
  std::map<std::string, std::int32_t> refclocksourcerangetable_output_map_ { {"None", 1},{"OnboardClock", 2},{"RefIn", 3},{"PXI_Clk", 4},{"ClkIn", 5},{"RefIn2", 6},{"PXI_ClkMaster", 7}, };
