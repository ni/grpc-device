...
NiRFSALibrary::NiRFSALibrary(std::shared_ptr<nidevice_grpc::SharedLibraryInterface> pSharedLibrary) : p_shared_library_(pSharedLibrary)
{
  ...
  function_pointers_.Abort = reinterpret_cast<AbortPtr>(p_shared_library_->get_function_pointer("niRFSA_Abort"));
  function_pointers_.CheckAcquisitionStatus = reinterpret_cast<CheckAcquisitionStatusPtr>(p_shared_library_->get_function_pointer("niRFSA_CheckAcquisitionStatus"));
  function_pointers_.ClearError = reinterpret_cast<ClearErrorPtr>(p_shared_library_->get_function_pointer("niRFSA_ClearError"));
  function_pointers_.ClearSelfCalibrateRange = reinterpret_cast<ClearSelfCalibrateRangePtr>(p_shared_library_->get_function_pointer("niRFSA_ClearSelfCalibrateRange"));
  function_pointers_.Close = reinterpret_cast<ClosePtr>(p_shared_library_->get_function_pointer("niRFSA_close"));
  function_pointers_.Commit = reinterpret_cast<CommitPtr>(p_shared_library_->get_function_pointer("niRFSA_Commit"));
  function_pointers_.ConfigureAcquisitionType = reinterpret_cast<ConfigureAcquisitionTypePtr>(p_shared_library_->get_function_pointer("niRFSA_ConfigureAcquisitionType"));
  function_pointers_.ConfigureDeembeddingTableInterpolationLinear = reinterpret_cast<ConfigureDeembeddingTableInterpolationLinearPtr>(p_shared_library_->get_function_pointer("niRFSA_ConfigureDeembeddingTableInterpolationLinear"));
  function_pointers_.ConfigureDeembeddingTableInterpolationNearest = reinterpret_cast<ConfigureDeembeddingTableInterpolationNearestPtr>(p_shared_library_->get_function_pointer("niRFSA_ConfigureDeembeddingTableInterpolationNearest"));
  function_pointers_.ConfigureDeembeddingTableInterpolationSpline = reinterpret_cast<ConfigureDeembeddingTableInterpolationSplinePtr>(p_shared_library_->get_function_pointer("niRFSA_ConfigureDeembeddingTableInterpolationSpline"));
  function_pointers_.ConfigureDigitalEdgeAdvanceTrigger = reinterpret_cast<ConfigureDigitalEdgeAdvanceTriggerPtr>(p_shared_library_->get_function_pointer("niRFSA_ConfigureDigitalEdgeAdvanceTrigger"));
  function_pointers_.ConfigureDigitalEdgeRefTrigger = reinterpret_cast<ConfigureDigitalEdgeRefTriggerPtr>(p_shared_library_->get_function_pointer("niRFSA_ConfigureDigitalEdgeRefTrigger"));
  function_pointers_.ConfigureDigitalEdgeStartTrigger = reinterpret_cast<ConfigureDigitalEdgeStartTriggerPtr>(p_shared_library_->get_function_pointer("niRFSA_ConfigureDigitalEdgeStartTrigger"));
  function_pointers_.ConfigureIQCarrierFrequency = reinterpret_cast<ConfigureIQCarrierFrequencyPtr>(p_shared_library_->get_function_pointer("niRFSA_ConfigureIQCarrierFrequency"));
  function_pointers_.ConfigureIQPowerEdgeRefTrigger = reinterpret_cast<ConfigureIQPowerEdgeRefTriggerPtr>(p_shared_library_->get_function_pointer("niRFSA_ConfigureIQPowerEdgeRefTrigger"));
  function_pointers_.ConfigureIQRate = reinterpret_cast<ConfigureIQRatePtr>(p_shared_library_->get_function_pointer("niRFSA_ConfigureIQRate"));
  function_pointers_.ConfigureNumberOfRecords = reinterpret_cast<ConfigureNumberOfRecordsPtr>(p_shared_library_->get_function_pointer("niRFSA_ConfigureNumberOfRecords"));
  function_pointers_.ConfigureNumberOfSamples = reinterpret_cast<ConfigureNumberOfSamplesPtr>(p_shared_library_->get_function_pointer("niRFSA_ConfigureNumberOfSamples"));
  function_pointers_.ConfigurePXIChassisClk10 = reinterpret_cast<ConfigurePXIChassisClk10Ptr>(p_shared_library_->get_function_pointer("niRFSA_ConfigurePXIChassisClk10"));
  function_pointers_.ConfigureRefClock = reinterpret_cast<ConfigureRefClockPtr>(p_shared_library_->get_function_pointer("niRFSA_ConfigureRefClock"));
  function_pointers_.ConfigureReferenceLevel = reinterpret_cast<ConfigureReferenceLevelPtr>(p_shared_library_->get_function_pointer("niRFSA_ConfigureReferenceLevel"));
  function_pointers_.ConfigureResolutionBandwidth = reinterpret_cast<ConfigureResolutionBandwidthPtr>(p_shared_library_->get_function_pointer("niRFSA_ConfigureResolutionBandwidth"));
  function_pointers_.ConfigureSoftwareEdgeAdvanceTrigger = reinterpret_cast<ConfigureSoftwareEdgeAdvanceTriggerPtr>(p_shared_library_->get_function_pointer("niRFSA_ConfigureSoftwareEdgeAdvanceTrigger"));
  function_pointers_.ConfigureSoftwareEdgeRefTrigger = reinterpret_cast<ConfigureSoftwareEdgeRefTriggerPtr>(p_shared_library_->get_function_pointer("niRFSA_ConfigureSoftwareEdgeRefTrigger"));
  function_pointers_.ConfigureSoftwareEdgeStartTrigger = reinterpret_cast<ConfigureSoftwareEdgeStartTriggerPtr>(p_shared_library_->get_function_pointer("niRFSA_ConfigureSoftwareEdgeStartTrigger"));
  function_pointers_.ConfigureSpectrumFrequencyCenterSpan = reinterpret_cast<ConfigureSpectrumFrequencyCenterSpanPtr>(p_shared_library_->get_function_pointer("niRFSA_ConfigureSpectrumFrequencyCenterSpan"));
  function_pointers_.ConfigureSpectrumFrequencyStartStop = reinterpret_cast<ConfigureSpectrumFrequencyStartStopPtr>(p_shared_library_->get_function_pointer("niRFSA_ConfigureSpectrumFrequencyStartStop"));
  function_pointers_.CreateConfigurationList = reinterpret_cast<CreateConfigurationListPtr>(p_shared_library_->get_function_pointer("niRFSA_CreateConfigurationList"));
  function_pointers_.CreateConfigurationListStep = reinterpret_cast<CreateConfigurationListStepPtr>(p_shared_library_->get_function_pointer("niRFSA_CreateConfigurationListStep"));
  function_pointers_.CreateDeembeddingSparameterTableArray = reinterpret_cast<CreateDeembeddingSparameterTableArrayPtr>(p_shared_library_->get_function_pointer("niRFSA_CreateDeembeddingSparameterTableArray"));
  function_pointers_.CreateDeembeddingSparameterTableS2PFile = reinterpret_cast<CreateDeembeddingSparameterTableS2PFilePtr>(p_shared_library_->get_function_pointer("niRFSA_CreateDeembeddingSparameterTableS2PFile"));
  function_pointers_.DeleteAllDeembeddingTables = reinterpret_cast<DeleteAllDeembeddingTablesPtr>(p_shared_library_->get_function_pointer("niRFSA_DeleteAllDeembeddingTables"));
  function_pointers_.DeleteConfigurationList = reinterpret_cast<DeleteConfigurationListPtr>(p_shared_library_->get_function_pointer("niRFSA_DeleteConfigurationList"));
  function_pointers_.DeleteDeembeddingTable = reinterpret_cast<DeleteDeembeddingTablePtr>(p_shared_library_->get_function_pointer("niRFSA_DeleteDeembeddingTable"));
  function_pointers_.Disable = reinterpret_cast<DisablePtr>(p_shared_library_->get_function_pointer("niRFSA_Disable"));
  function_pointers_.DisableAdvanceTrigger = reinterpret_cast<DisableAdvanceTriggerPtr>(p_shared_library_->get_function_pointer("niRFSA_DisableAdvanceTrigger"));
  function_pointers_.DisableRefTrigger = reinterpret_cast<DisableRefTriggerPtr>(p_shared_library_->get_function_pointer("niRFSA_DisableRefTrigger"));
  function_pointers_.DisableStartTrigger = reinterpret_cast<DisableStartTriggerPtr>(p_shared_library_->get_function_pointer("niRFSA_DisableStartTrigger"));
  function_pointers_.EnableSessionAccess = reinterpret_cast<EnableSessionAccessPtr>(p_shared_library_->get_function_pointer("niRFSA_EnableSessionAccess"));
  function_pointers_.ErrorMessage = reinterpret_cast<ErrorMessagePtr>(p_shared_library_->get_function_pointer("niRFSA_error_message"));
  function_pointers_.ErrorQuery = reinterpret_cast<ErrorQueryPtr>(p_shared_library_->get_function_pointer("niRFSA_error_query"));
  function_pointers_.ExportSignal = reinterpret_cast<ExportSignalPtr>(p_shared_library_->get_function_pointer("niRFSA_ExportSignal"));
  function_pointers_.FetchIQMultiRecordComplexF32 = reinterpret_cast<FetchIQMultiRecordComplexF32Ptr>(p_shared_library_->get_function_pointer("niRFSA_FetchIQMultiRecordComplexF32"));
  function_pointers_.FetchIQMultiRecordComplexF64 = reinterpret_cast<FetchIQMultiRecordComplexF64Ptr>(p_shared_library_->get_function_pointer("niRFSA_FetchIQMultiRecordComplexF64"));
  function_pointers_.FetchIQMultiRecordComplexI16 = reinterpret_cast<FetchIQMultiRecordComplexI16Ptr>(p_shared_library_->get_function_pointer("niRFSA_FetchIQMultiRecordComplexI16"));
  function_pointers_.FetchIQSingleRecordComplexF32 = reinterpret_cast<FetchIQSingleRecordComplexF32Ptr>(p_shared_library_->get_function_pointer("niRFSA_FetchIQSingleRecordComplexF32"));
  function_pointers_.FetchIQSingleRecordComplexF64 = reinterpret_cast<FetchIQSingleRecordComplexF64Ptr>(p_shared_library_->get_function_pointer("niRFSA_FetchIQSingleRecordComplexF64"));
  function_pointers_.FetchIQSingleRecordComplexI16 = reinterpret_cast<FetchIQSingleRecordComplexI16Ptr>(p_shared_library_->get_function_pointer("niRFSA_FetchIQSingleRecordComplexI16"));
  function_pointers_.GetAttributeViBoolean = reinterpret_cast<GetAttributeViBooleanPtr>(p_shared_library_->get_function_pointer("niRFSA_GetAttributeViBoolean"));
  function_pointers_.GetAttributeViInt32 = reinterpret_cast<GetAttributeViInt32Ptr>(p_shared_library_->get_function_pointer("niRFSA_GetAttributeViInt32"));
  function_pointers_.GetAttributeViInt64 = reinterpret_cast<GetAttributeViInt64Ptr>(p_shared_library_->get_function_pointer("niRFSA_GetAttributeViInt64"));
  function_pointers_.GetAttributeViReal64 = reinterpret_cast<GetAttributeViReal64Ptr>(p_shared_library_->get_function_pointer("niRFSA_GetAttributeViReal64"));
  function_pointers_.GetAttributeViSession = reinterpret_cast<GetAttributeViSessionPtr>(p_shared_library_->get_function_pointer("niRFSA_GetAttributeViSession"));
  function_pointers_.GetAttributeViString = reinterpret_cast<GetAttributeViStringPtr>(p_shared_library_->get_function_pointer("niRFSA_GetAttributeViString"));
  function_pointers_.GetCalUserDefinedInfo = reinterpret_cast<GetCalUserDefinedInfoPtr>(p_shared_library_->get_function_pointer("niRFSA_GetCalUserDefinedInfo"));
  function_pointers_.GetCalUserDefinedInfoMaxSize = reinterpret_cast<GetCalUserDefinedInfoMaxSizePtr>(p_shared_library_->get_function_pointer("niRFSA_GetCalUserDefinedInfoMaxSize"));
  function_pointers_.GetDeembeddingSparameters = reinterpret_cast<GetDeembeddingSparametersPtr>(p_shared_library_->get_function_pointer("niRFSA_GetDeembeddingSparameters"));
  function_pointers_.GetDeviceResponse = reinterpret_cast<GetDeviceResponsePtr>(p_shared_library_->get_function_pointer("niRFSA_GetDeviceResponse"));
  function_pointers_.GetError = reinterpret_cast<GetErrorPtr>(p_shared_library_->get_function_pointer("niRFSA_GetError"));
  function_pointers_.GetExtCalLastDateAndTime = reinterpret_cast<GetExtCalLastDateAndTimePtr>(p_shared_library_->get_function_pointer("niRFSA_GetExtCalLastDateAndTime"));
  function_pointers_.GetExtCalLastTemp = reinterpret_cast<GetExtCalLastTempPtr>(p_shared_library_->get_function_pointer("niRFSA_GetExtCalLastTemp"));
  function_pointers_.GetExtCalRecommendedInterval = reinterpret_cast<GetExtCalRecommendedIntervalPtr>(p_shared_library_->get_function_pointer("niRFSA_GetExtCalRecommendedInterval"));
  function_pointers_.GetFetchBacklog = reinterpret_cast<GetFetchBacklogPtr>(p_shared_library_->get_function_pointer("niRFSA_GetFetchBacklog"));
  function_pointers_.GetFrequencyResponse = reinterpret_cast<GetFrequencyResponsePtr>(p_shared_library_->get_function_pointer("niRFSA_GetFrequencyResponse"));
  function_pointers_.GetNormalizationCoefficients = reinterpret_cast<GetNormalizationCoefficientsPtr>(p_shared_library_->get_function_pointer("niRFSA_GetNormalizationCoefficients"));
  function_pointers_.GetNumberOfSpectralLines = reinterpret_cast<GetNumberOfSpectralLinesPtr>(p_shared_library_->get_function_pointer("niRFSA_GetNumberOfSpectralLines"));
  function_pointers_.GetRelayName = reinterpret_cast<GetRelayNamePtr>(p_shared_library_->get_function_pointer("niRFSA_GetRelayName"));
  function_pointers_.GetRelayOperationsCount = reinterpret_cast<GetRelayOperationsCountPtr>(p_shared_library_->get_function_pointer("niRFSA_GetRelayOperationsCount"));
  function_pointers_.GetScalingCoefficients = reinterpret_cast<GetScalingCoefficientsPtr>(p_shared_library_->get_function_pointer("niRFSA_GetScalingCoefficients"));
  function_pointers_.GetSelfCalLastDateAndTime = reinterpret_cast<GetSelfCalLastDateAndTimePtr>(p_shared_library_->get_function_pointer("niRFSA_GetSelfCalLastDateAndTime"));
  function_pointers_.GetSelfCalLastTemp = reinterpret_cast<GetSelfCalLastTempPtr>(p_shared_library_->get_function_pointer("niRFSA_GetSelfCalLastTemp"));
  function_pointers_.GetSpectralInfoForSMT = reinterpret_cast<GetSpectralInfoForSMTPtr>(p_shared_library_->get_function_pointer("niRFSA_GetSpectralInfoForSMT"));
  function_pointers_.GetStreamEndpointHandle = reinterpret_cast<GetStreamEndpointHandlePtr>(p_shared_library_->get_function_pointer("niRFSA_GetStreamEndpointHandle"));
  function_pointers_.GetTerminalName = reinterpret_cast<GetTerminalNamePtr>(p_shared_library_->get_function_pointer("niRFSA_GetTerminalName"));
  function_pointers_.GetUserData = reinterpret_cast<GetUserDataPtr>(p_shared_library_->get_function_pointer("niRFSA_GetUserData"));
  function_pointers_.Init = reinterpret_cast<InitPtr>(p_shared_library_->get_function_pointer("niRFSA_init"));
  function_pointers_.InitWithOptions = reinterpret_cast<InitWithOptionsPtr>(p_shared_library_->get_function_pointer("niRFSA_InitWithOptions"));
  function_pointers_.Initiate = reinterpret_cast<InitiatePtr>(p_shared_library_->get_function_pointer("niRFSA_Initiate"));
  function_pointers_.InvalidateAllAttributes = reinterpret_cast<InvalidateAllAttributesPtr>(p_shared_library_->get_function_pointer("niRFSA_InvalidateAllAttributes"));
  function_pointers_.IsSelfCalValid = reinterpret_cast<IsSelfCalValidPtr>(p_shared_library_->get_function_pointer("niRFSA_IsSelfCalValid"));
  function_pointers_.LockSession = reinterpret_cast<LockSessionPtr>(p_shared_library_->get_function_pointer("niRFSA_LockSession"));
  function_pointers_.PerformThermalCorrection = reinterpret_cast<PerformThermalCorrectionPtr>(p_shared_library_->get_function_pointer("niRFSA_PerformThermalCorrection"));
  function_pointers_.ReadIQSingleRecordComplexF64 = reinterpret_cast<ReadIQSingleRecordComplexF64Ptr>(p_shared_library_->get_function_pointer("niRFSA_ReadIQSingleRecordComplexF64"));
  function_pointers_.ReadPowerSpectrumF32 = reinterpret_cast<ReadPowerSpectrumF32Ptr>(p_shared_library_->get_function_pointer("niRFSA_ReadPowerSpectrumF32"));
  function_pointers_.ReadPowerSpectrumF64 = reinterpret_cast<ReadPowerSpectrumF64Ptr>(p_shared_library_->get_function_pointer("niRFSA_ReadPowerSpectrumF64"));
  function_pointers_.Reset = reinterpret_cast<ResetPtr>(p_shared_library_->get_function_pointer("niRFSA_reset"));
  function_pointers_.ResetAttribute = reinterpret_cast<ResetAttributePtr>(p_shared_library_->get_function_pointer("niRFSA_ResetAttribute"));
  function_pointers_.ResetDevice = reinterpret_cast<ResetDevicePtr>(p_shared_library_->get_function_pointer("niRFSA_ResetDevice"));
  function_pointers_.ResetWithDefaults = reinterpret_cast<ResetWithDefaultsPtr>(p_shared_library_->get_function_pointer("niRFSA_ResetWithDefaults"));
  function_pointers_.ResetWithOptions = reinterpret_cast<ResetWithOptionsPtr>(p_shared_library_->get_function_pointer("niRFSA_ResetWithOptions"));
  function_pointers_.RevisionQuery = reinterpret_cast<RevisionQueryPtr>(p_shared_library_->get_function_pointer("niRFSA_revision_query"));
  function_pointers_.SelfCal = reinterpret_cast<SelfCalPtr>(p_shared_library_->get_function_pointer("niRFSA_SelfCal"));
  function_pointers_.SelfCalibrate = reinterpret_cast<SelfCalibratePtr>(p_shared_library_->get_function_pointer("niRFSA_SelfCalibrate"));
  function_pointers_.SelfCalibrateRange = reinterpret_cast<SelfCalibrateRangePtr>(p_shared_library_->get_function_pointer("niRFSA_SelfCalibrateRange"));
  function_pointers_.SelfTest = reinterpret_cast<SelfTestPtr>(p_shared_library_->get_function_pointer("niRFSA_self_test"));
  function_pointers_.SendSoftwareEdgeTrigger = reinterpret_cast<SendSoftwareEdgeTriggerPtr>(p_shared_library_->get_function_pointer("niRFSA_SendSoftwareEdgeTrigger"));
  function_pointers_.SetAttributeViBoolean = reinterpret_cast<SetAttributeViBooleanPtr>(p_shared_library_->get_function_pointer("niRFSA_SetAttributeViBoolean"));
  function_pointers_.SetAttributeViInt32 = reinterpret_cast<SetAttributeViInt32Ptr>(p_shared_library_->get_function_pointer("niRFSA_SetAttributeViInt32"));
  function_pointers_.SetAttributeViInt64 = reinterpret_cast<SetAttributeViInt64Ptr>(p_shared_library_->get_function_pointer("niRFSA_SetAttributeViInt64"));
  function_pointers_.SetAttributeViReal64 = reinterpret_cast<SetAttributeViReal64Ptr>(p_shared_library_->get_function_pointer("niRFSA_SetAttributeViReal64"));
  function_pointers_.SetAttributeViSession = reinterpret_cast<SetAttributeViSessionPtr>(p_shared_library_->get_function_pointer("niRFSA_SetAttributeViSession"));
  function_pointers_.SetAttributeViString = reinterpret_cast<SetAttributeViStringPtr>(p_shared_library_->get_function_pointer("niRFSA_SetAttributeViString"));
  function_pointers_.SetCalUserDefinedInfo = reinterpret_cast<SetCalUserDefinedInfoPtr>(p_shared_library_->get_function_pointer("niRFSA_SetCalUserDefinedInfo"));
  function_pointers_.SetUserData = reinterpret_cast<SetUserDataPtr>(p_shared_library_->get_function_pointer("niRFSA_SetUserData"));
  function_pointers_.UnlockSession = reinterpret_cast<UnlockSessionPtr>(p_shared_library_->get_function_pointer("niRFSA_UnlockSession"));
}
