...
NiFgenLibrary::NiFgenLibrary(std::shared_ptr<nidevice_grpc::SharedLibraryInterface> pSharedLibrary) : p_shared_library_(pSharedLibrary), runtime_environment_set_(false)
{
  ...
  function_pointers_.AbortGeneration = reinterpret_cast<AbortGenerationPtr>(p_shared_library_->get_function_pointer("niFgen_AbortGeneration"));
  function_pointers_.AdjustSampleClockRelativeDelay = reinterpret_cast<AdjustSampleClockRelativeDelayPtr>(p_shared_library_->get_function_pointer("niFgen_AdjustSampleClockRelativeDelay"));
  function_pointers_.AllocateNamedWaveform = reinterpret_cast<AllocateNamedWaveformPtr>(p_shared_library_->get_function_pointer("niFgen_AllocateNamedWaveform"));
  function_pointers_.AllocateWaveform = reinterpret_cast<AllocateWaveformPtr>(p_shared_library_->get_function_pointer("niFgen_AllocateWaveform"));
  function_pointers_.CheckAttributeViBoolean = reinterpret_cast<CheckAttributeViBooleanPtr>(p_shared_library_->get_function_pointer("niFgen_CheckAttributeViBoolean"));
  function_pointers_.CheckAttributeViInt32 = reinterpret_cast<CheckAttributeViInt32Ptr>(p_shared_library_->get_function_pointer("niFgen_CheckAttributeViInt32"));
  function_pointers_.CheckAttributeViInt64 = reinterpret_cast<CheckAttributeViInt64Ptr>(p_shared_library_->get_function_pointer("niFgen_CheckAttributeViInt64"));
  function_pointers_.CheckAttributeViReal64 = reinterpret_cast<CheckAttributeViReal64Ptr>(p_shared_library_->get_function_pointer("niFgen_CheckAttributeViReal64"));
  function_pointers_.CheckAttributeViSession = reinterpret_cast<CheckAttributeViSessionPtr>(p_shared_library_->get_function_pointer("niFgen_CheckAttributeViSession"));
  function_pointers_.CheckAttributeViString = reinterpret_cast<CheckAttributeViStringPtr>(p_shared_library_->get_function_pointer("niFgen_CheckAttributeViString"));
  function_pointers_.ClearArbMemory = reinterpret_cast<ClearArbMemoryPtr>(p_shared_library_->get_function_pointer("niFgen_ClearArbMemory"));
  function_pointers_.ClearArbSequence = reinterpret_cast<ClearArbSequencePtr>(p_shared_library_->get_function_pointer("niFgen_ClearArbSequence"));
  function_pointers_.ClearArbWaveform = reinterpret_cast<ClearArbWaveformPtr>(p_shared_library_->get_function_pointer("niFgen_ClearArbWaveform"));
  function_pointers_.ClearError = reinterpret_cast<ClearErrorPtr>(p_shared_library_->get_function_pointer("niFgen_ClearError"));
  function_pointers_.ClearFreqList = reinterpret_cast<ClearFreqListPtr>(p_shared_library_->get_function_pointer("niFgen_ClearFreqList"));
  function_pointers_.ClearInterchangeWarnings = reinterpret_cast<ClearInterchangeWarningsPtr>(p_shared_library_->get_function_pointer("niFgen_ClearInterchangeWarnings"));
  function_pointers_.ClearUserStandardWaveform = reinterpret_cast<ClearUserStandardWaveformPtr>(p_shared_library_->get_function_pointer("niFgen_ClearUserStandardWaveform"));
  function_pointers_.Close = reinterpret_cast<ClosePtr>(p_shared_library_->get_function_pointer("niFgen_close"));
  function_pointers_.Commit = reinterpret_cast<CommitPtr>(p_shared_library_->get_function_pointer("niFgen_Commit"));
  function_pointers_.ConfigureAmplitude = reinterpret_cast<ConfigureAmplitudePtr>(p_shared_library_->get_function_pointer("niFgen_ConfigureAmplitude"));
  function_pointers_.ConfigureArbSequence = reinterpret_cast<ConfigureArbSequencePtr>(p_shared_library_->get_function_pointer("niFgen_ConfigureArbSequence"));
  function_pointers_.ConfigureArbWaveform = reinterpret_cast<ConfigureArbWaveformPtr>(p_shared_library_->get_function_pointer("niFgen_ConfigureArbWaveform"));
  function_pointers_.ConfigureChannels = reinterpret_cast<ConfigureChannelsPtr>(p_shared_library_->get_function_pointer("niFgen_ConfigureChannels"));
  function_pointers_.ConfigureClockMode = reinterpret_cast<ConfigureClockModePtr>(p_shared_library_->get_function_pointer("niFgen_ConfigureClockMode"));
  function_pointers_.ConfigureCustomFIRFilterCoefficients = reinterpret_cast<ConfigureCustomFIRFilterCoefficientsPtr>(p_shared_library_->get_function_pointer("niFgen_ConfigureCustomFIRFilterCoefficients"));
  function_pointers_.ConfigureDigitalEdgeScriptTrigger = reinterpret_cast<ConfigureDigitalEdgeScriptTriggerPtr>(p_shared_library_->get_function_pointer("niFgen_ConfigureDigitalEdgeScriptTrigger"));
  function_pointers_.ConfigureDigitalEdgeStartTrigger = reinterpret_cast<ConfigureDigitalEdgeStartTriggerPtr>(p_shared_library_->get_function_pointer("niFgen_ConfigureDigitalEdgeStartTrigger"));
  function_pointers_.ConfigureDigitalLevelScriptTrigger = reinterpret_cast<ConfigureDigitalLevelScriptTriggerPtr>(p_shared_library_->get_function_pointer("niFgen_ConfigureDigitalLevelScriptTrigger"));
  function_pointers_.ConfigureFreqList = reinterpret_cast<ConfigureFreqListPtr>(p_shared_library_->get_function_pointer("niFgen_ConfigureFreqList"));
  function_pointers_.ConfigureFrequency = reinterpret_cast<ConfigureFrequencyPtr>(p_shared_library_->get_function_pointer("niFgen_ConfigureFrequency"));
  function_pointers_.ConfigureOperationMode = reinterpret_cast<ConfigureOperationModePtr>(p_shared_library_->get_function_pointer("niFgen_ConfigureOperationMode"));
  function_pointers_.ConfigureOutputEnabled = reinterpret_cast<ConfigureOutputEnabledPtr>(p_shared_library_->get_function_pointer("niFgen_ConfigureOutputEnabled"));
  function_pointers_.ConfigureOutputImpedance = reinterpret_cast<ConfigureOutputImpedancePtr>(p_shared_library_->get_function_pointer("niFgen_ConfigureOutputImpedance"));
  function_pointers_.ConfigureOutputMode = reinterpret_cast<ConfigureOutputModePtr>(p_shared_library_->get_function_pointer("niFgen_ConfigureOutputMode"));
  function_pointers_.ConfigureP2PEndpointFullnessStartTrigger = reinterpret_cast<ConfigureP2PEndpointFullnessStartTriggerPtr>(p_shared_library_->get_function_pointer("niFgen_ConfigureP2PEndpointFullnessStartTrigger"));
  function_pointers_.ConfigureReferenceClock = reinterpret_cast<ConfigureReferenceClockPtr>(p_shared_library_->get_function_pointer("niFgen_ConfigureReferenceClock"));
  function_pointers_.ConfigureSampleClockSource = reinterpret_cast<ConfigureSampleClockSourcePtr>(p_shared_library_->get_function_pointer("niFgen_ConfigureSampleClockSource"));
  function_pointers_.ConfigureSampleRate = reinterpret_cast<ConfigureSampleRatePtr>(p_shared_library_->get_function_pointer("niFgen_ConfigureSampleRate"));
  function_pointers_.ConfigureSoftwareEdgeScriptTrigger = reinterpret_cast<ConfigureSoftwareEdgeScriptTriggerPtr>(p_shared_library_->get_function_pointer("niFgen_ConfigureSoftwareEdgeScriptTrigger"));
  function_pointers_.ConfigureSoftwareEdgeStartTrigger = reinterpret_cast<ConfigureSoftwareEdgeStartTriggerPtr>(p_shared_library_->get_function_pointer("niFgen_ConfigureSoftwareEdgeStartTrigger"));
  function_pointers_.ConfigureStandardWaveform = reinterpret_cast<ConfigureStandardWaveformPtr>(p_shared_library_->get_function_pointer("niFgen_ConfigureStandardWaveform"));
  function_pointers_.ConfigureSynchronization = reinterpret_cast<ConfigureSynchronizationPtr>(p_shared_library_->get_function_pointer("niFgen_ConfigureSynchronization"));
  function_pointers_.ConfigureTriggerMode = reinterpret_cast<ConfigureTriggerModePtr>(p_shared_library_->get_function_pointer("niFgen_ConfigureTriggerMode"));
  function_pointers_.CreateAdvancedArbSequence = reinterpret_cast<CreateAdvancedArbSequencePtr>(p_shared_library_->get_function_pointer("niFgen_CreateAdvancedArbSequence"));
  function_pointers_.CreateArbSequence = reinterpret_cast<CreateArbSequencePtr>(p_shared_library_->get_function_pointer("niFgen_CreateArbSequence"));
  function_pointers_.CreateFreqList = reinterpret_cast<CreateFreqListPtr>(p_shared_library_->get_function_pointer("niFgen_CreateFreqList"));
  function_pointers_.CreateWaveformComplexF64 = reinterpret_cast<CreateWaveformComplexF64Ptr>(p_shared_library_->get_function_pointer("niFgen_CreateWaveformComplexF64"));
  function_pointers_.CreateWaveformF64 = reinterpret_cast<CreateWaveformF64Ptr>(p_shared_library_->get_function_pointer("niFgen_CreateWaveformF64"));
  function_pointers_.CreateWaveformFromFileF64 = reinterpret_cast<CreateWaveformFromFileF64Ptr>(p_shared_library_->get_function_pointer("niFgen_CreateWaveformFromFileF64"));
  function_pointers_.CreateWaveformFromFileHWS = reinterpret_cast<CreateWaveformFromFileHWSPtr>(p_shared_library_->get_function_pointer("niFgen_CreateWaveformFromFileHWS"));
  function_pointers_.CreateWaveformFromFileI16 = reinterpret_cast<CreateWaveformFromFileI16Ptr>(p_shared_library_->get_function_pointer("niFgen_CreateWaveformFromFileI16"));
  function_pointers_.CreateWaveformI16 = reinterpret_cast<CreateWaveformI16Ptr>(p_shared_library_->get_function_pointer("niFgen_CreateWaveformI16"));
  function_pointers_.DefineUserStandardWaveform = reinterpret_cast<DefineUserStandardWaveformPtr>(p_shared_library_->get_function_pointer("niFgen_DefineUserStandardWaveform"));
  function_pointers_.DeleteNamedWaveform = reinterpret_cast<DeleteNamedWaveformPtr>(p_shared_library_->get_function_pointer("niFgen_DeleteNamedWaveform"));
  function_pointers_.DeleteScript = reinterpret_cast<DeleteScriptPtr>(p_shared_library_->get_function_pointer("niFgen_DeleteScript"));
  function_pointers_.Disable = reinterpret_cast<DisablePtr>(p_shared_library_->get_function_pointer("niFgen_Disable"));
  function_pointers_.DisableAnalogFilter = reinterpret_cast<DisableAnalogFilterPtr>(p_shared_library_->get_function_pointer("niFgen_DisableAnalogFilter"));
  function_pointers_.DisableDigitalFilter = reinterpret_cast<DisableDigitalFilterPtr>(p_shared_library_->get_function_pointer("niFgen_DisableDigitalFilter"));
  function_pointers_.DisableDigitalPatterning = reinterpret_cast<DisableDigitalPatterningPtr>(p_shared_library_->get_function_pointer("niFgen_DisableDigitalPatterning"));
  function_pointers_.DisableScriptTrigger = reinterpret_cast<DisableScriptTriggerPtr>(p_shared_library_->get_function_pointer("niFgen_DisableScriptTrigger"));
  function_pointers_.DisableStartTrigger = reinterpret_cast<DisableStartTriggerPtr>(p_shared_library_->get_function_pointer("niFgen_DisableStartTrigger"));
  function_pointers_.EnableAnalogFilter = reinterpret_cast<EnableAnalogFilterPtr>(p_shared_library_->get_function_pointer("niFgen_EnableAnalogFilter"));
  function_pointers_.EnableDigitalFilter = reinterpret_cast<EnableDigitalFilterPtr>(p_shared_library_->get_function_pointer("niFgen_EnableDigitalFilter"));
  function_pointers_.EnableDigitalPatterning = reinterpret_cast<EnableDigitalPatterningPtr>(p_shared_library_->get_function_pointer("niFgen_EnableDigitalPatterning"));
  function_pointers_.ErrorHandler = reinterpret_cast<ErrorHandlerPtr>(p_shared_library_->get_function_pointer("niFgen_ErrorHandler"));
  function_pointers_.ErrorMessage = reinterpret_cast<ErrorMessagePtr>(p_shared_library_->get_function_pointer("niFgen_error_message"));
  function_pointers_.ErrorQuery = reinterpret_cast<ErrorQueryPtr>(p_shared_library_->get_function_pointer("niFgen_error_query"));
  function_pointers_.ExportAttributeConfigurationBuffer = reinterpret_cast<ExportAttributeConfigurationBufferPtr>(p_shared_library_->get_function_pointer("niFgen_ExportAttributeConfigurationBuffer"));
  function_pointers_.ExportAttributeConfigurationFile = reinterpret_cast<ExportAttributeConfigurationFilePtr>(p_shared_library_->get_function_pointer("niFgen_ExportAttributeConfigurationFile"));
  function_pointers_.ExportSignal = reinterpret_cast<ExportSignalPtr>(p_shared_library_->get_function_pointer("niFgen_ExportSignal"));
  function_pointers_.GetAttributeViBoolean = reinterpret_cast<GetAttributeViBooleanPtr>(p_shared_library_->get_function_pointer("niFgen_GetAttributeViBoolean"));
  function_pointers_.GetAttributeViInt32 = reinterpret_cast<GetAttributeViInt32Ptr>(p_shared_library_->get_function_pointer("niFgen_GetAttributeViInt32"));
  function_pointers_.GetAttributeViInt64 = reinterpret_cast<GetAttributeViInt64Ptr>(p_shared_library_->get_function_pointer("niFgen_GetAttributeViInt64"));
  function_pointers_.GetAttributeViReal64 = reinterpret_cast<GetAttributeViReal64Ptr>(p_shared_library_->get_function_pointer("niFgen_GetAttributeViReal64"));
  function_pointers_.GetAttributeViSession = reinterpret_cast<GetAttributeViSessionPtr>(p_shared_library_->get_function_pointer("niFgen_GetAttributeViSession"));
  function_pointers_.GetAttributeViString = reinterpret_cast<GetAttributeViStringPtr>(p_shared_library_->get_function_pointer("niFgen_GetAttributeViString"));
  function_pointers_.GetChannelName = reinterpret_cast<GetChannelNamePtr>(p_shared_library_->get_function_pointer("niFgen_GetChannelName"));
  function_pointers_.GetError = reinterpret_cast<GetErrorPtr>(p_shared_library_->get_function_pointer("niFgen_GetError"));
  function_pointers_.GetExtCalLastDateAndTime = reinterpret_cast<GetExtCalLastDateAndTimePtr>(p_shared_library_->get_function_pointer("niFgen_GetExtCalLastDateAndTime"));
  function_pointers_.GetExtCalLastTemp = reinterpret_cast<GetExtCalLastTempPtr>(p_shared_library_->get_function_pointer("niFgen_GetExtCalLastTemp"));
  function_pointers_.GetExtCalRecommendedInterval = reinterpret_cast<GetExtCalRecommendedIntervalPtr>(p_shared_library_->get_function_pointer("niFgen_GetExtCalRecommendedInterval"));
  function_pointers_.GetFIRFilterCoefficients = reinterpret_cast<GetFIRFilterCoefficientsPtr>(p_shared_library_->get_function_pointer("niFgen_GetFIRFilterCoefficients"));
  function_pointers_.GetHardwareState = reinterpret_cast<GetHardwareStatePtr>(p_shared_library_->get_function_pointer("niFgen_GetHardwareState"));
  function_pointers_.GetNextCoercionRecord = reinterpret_cast<GetNextCoercionRecordPtr>(p_shared_library_->get_function_pointer("niFgen_GetNextCoercionRecord"));
  function_pointers_.GetNextInterchangeWarning = reinterpret_cast<GetNextInterchangeWarningPtr>(p_shared_library_->get_function_pointer("niFgen_GetNextInterchangeWarning"));
  function_pointers_.GetSelfCalLastDateAndTime = reinterpret_cast<GetSelfCalLastDateAndTimePtr>(p_shared_library_->get_function_pointer("niFgen_GetSelfCalLastDateAndTime"));
  function_pointers_.GetSelfCalLastTemp = reinterpret_cast<GetSelfCalLastTempPtr>(p_shared_library_->get_function_pointer("niFgen_GetSelfCalLastTemp"));
  function_pointers_.GetSelfCalSupported = reinterpret_cast<GetSelfCalSupportedPtr>(p_shared_library_->get_function_pointer("niFgen_GetSelfCalSupported"));
  function_pointers_.GetStreamEndpointHandle = reinterpret_cast<GetStreamEndpointHandlePtr>(p_shared_library_->get_function_pointer("niFgen_GetStreamEndpointHandle"));
  function_pointers_.ImportAttributeConfigurationBuffer = reinterpret_cast<ImportAttributeConfigurationBufferPtr>(p_shared_library_->get_function_pointer("niFgen_ImportAttributeConfigurationBuffer"));
  function_pointers_.ImportAttributeConfigurationFile = reinterpret_cast<ImportAttributeConfigurationFilePtr>(p_shared_library_->get_function_pointer("niFgen_ImportAttributeConfigurationFile"));
  function_pointers_.Init = reinterpret_cast<InitPtr>(p_shared_library_->get_function_pointer("niFgen_init"));
  function_pointers_.InitWithOptions = reinterpret_cast<InitWithOptionsPtr>(p_shared_library_->get_function_pointer("niFgen_InitWithOptions"));
  function_pointers_.InitializeWithChannels = reinterpret_cast<InitializeWithChannelsPtr>(p_shared_library_->get_function_pointer("niFgen_InitializeWithChannels"));
  function_pointers_.InitiateGeneration = reinterpret_cast<InitiateGenerationPtr>(p_shared_library_->get_function_pointer("niFgen_InitiateGeneration"));
  function_pointers_.InvalidateAllAttributes = reinterpret_cast<InvalidateAllAttributesPtr>(p_shared_library_->get_function_pointer("niFgen_InvalidateAllAttributes"));
  function_pointers_.IsDone = reinterpret_cast<IsDonePtr>(p_shared_library_->get_function_pointer("niFgen_IsDone"));
  function_pointers_.LockSession = reinterpret_cast<LockSessionPtr>(p_shared_library_->get_function_pointer("niFgen_LockSession"));
  function_pointers_.ManualEnableP2PStream = reinterpret_cast<ManualEnableP2PStreamPtr>(p_shared_library_->get_function_pointer("niFgen_ManualEnableP2PStream"));
  function_pointers_.QueryArbSeqCapabilities = reinterpret_cast<QueryArbSeqCapabilitiesPtr>(p_shared_library_->get_function_pointer("niFgen_QueryArbSeqCapabilities"));
  function_pointers_.QueryArbWfmCapabilities = reinterpret_cast<QueryArbWfmCapabilitiesPtr>(p_shared_library_->get_function_pointer("niFgen_QueryArbWfmCapabilities"));
  function_pointers_.QueryFreqListCapabilities = reinterpret_cast<QueryFreqListCapabilitiesPtr>(p_shared_library_->get_function_pointer("niFgen_QueryFreqListCapabilities"));
  function_pointers_.ReadCurrentTemperature = reinterpret_cast<ReadCurrentTemperaturePtr>(p_shared_library_->get_function_pointer("niFgen_ReadCurrentTemperature"));
  function_pointers_.Reset = reinterpret_cast<ResetPtr>(p_shared_library_->get_function_pointer("niFgen_reset"));
  function_pointers_.ResetAttribute = reinterpret_cast<ResetAttributePtr>(p_shared_library_->get_function_pointer("niFgen_ResetAttribute"));
  function_pointers_.ResetDevice = reinterpret_cast<ResetDevicePtr>(p_shared_library_->get_function_pointer("niFgen_ResetDevice"));
  function_pointers_.ResetInterchangeCheck = reinterpret_cast<ResetInterchangeCheckPtr>(p_shared_library_->get_function_pointer("niFgen_ResetInterchangeCheck"));
  function_pointers_.ResetWithDefaults = reinterpret_cast<ResetWithDefaultsPtr>(p_shared_library_->get_function_pointer("niFgen_ResetWithDefaults"));
  function_pointers_.RevisionQuery = reinterpret_cast<RevisionQueryPtr>(p_shared_library_->get_function_pointer("niFgen_revision_query"));
  function_pointers_.RouteSignalOut = reinterpret_cast<RouteSignalOutPtr>(p_shared_library_->get_function_pointer("niFgen_RouteSignalOut"));
  function_pointers_.SelfCal = reinterpret_cast<SelfCalPtr>(p_shared_library_->get_function_pointer("niFgen_SelfCal"));
  function_pointers_.SelfTest = reinterpret_cast<SelfTestPtr>(p_shared_library_->get_function_pointer("niFgen_self_test"));
  function_pointers_.SendSoftwareEdgeTrigger = reinterpret_cast<SendSoftwareEdgeTriggerPtr>(p_shared_library_->get_function_pointer("niFgen_SendSoftwareEdgeTrigger"));
  function_pointers_.SetAttributeViBoolean = reinterpret_cast<SetAttributeViBooleanPtr>(p_shared_library_->get_function_pointer("niFgen_SetAttributeViBoolean"));
  function_pointers_.SetAttributeViInt32 = reinterpret_cast<SetAttributeViInt32Ptr>(p_shared_library_->get_function_pointer("niFgen_SetAttributeViInt32"));
  function_pointers_.SetAttributeViInt64 = reinterpret_cast<SetAttributeViInt64Ptr>(p_shared_library_->get_function_pointer("niFgen_SetAttributeViInt64"));
  function_pointers_.SetAttributeViReal64 = reinterpret_cast<SetAttributeViReal64Ptr>(p_shared_library_->get_function_pointer("niFgen_SetAttributeViReal64"));
  function_pointers_.SetAttributeViSession = reinterpret_cast<SetAttributeViSessionPtr>(p_shared_library_->get_function_pointer("niFgen_SetAttributeViSession"));
  function_pointers_.SetAttributeViString = reinterpret_cast<SetAttributeViStringPtr>(p_shared_library_->get_function_pointer("niFgen_SetAttributeViString"));
  function_pointers_.SetNamedWaveformNextWritePosition = reinterpret_cast<SetNamedWaveformNextWritePositionPtr>(p_shared_library_->get_function_pointer("niFgen_SetNamedWaveformNextWritePosition"));
  function_pointers_.SetWaveformNextWritePosition = reinterpret_cast<SetWaveformNextWritePositionPtr>(p_shared_library_->get_function_pointer("niFgen_SetWaveformNextWritePosition"));
  function_pointers_.UnlockSession = reinterpret_cast<UnlockSessionPtr>(p_shared_library_->get_function_pointer("niFgen_UnlockSession"));
  function_pointers_.WaitUntilDone = reinterpret_cast<WaitUntilDonePtr>(p_shared_library_->get_function_pointer("niFgen_WaitUntilDone"));
  function_pointers_.WriteBinary16Waveform = reinterpret_cast<WriteBinary16WaveformPtr>(p_shared_library_->get_function_pointer("niFgen_WriteBinary16Waveform"));
  function_pointers_.WriteComplexBinary16Waveform = reinterpret_cast<WriteComplexBinary16WaveformPtr>(p_shared_library_->get_function_pointer("niFgen_WriteComplexBinary16Waveform"));
  function_pointers_.WriteNamedWaveformComplexF64 = reinterpret_cast<WriteNamedWaveformComplexF64Ptr>(p_shared_library_->get_function_pointer("niFgen_WriteNamedWaveformComplexF64"));
  function_pointers_.WriteNamedWaveformComplexI16 = reinterpret_cast<WriteNamedWaveformComplexI16Ptr>(p_shared_library_->get_function_pointer("niFgen_WriteNamedWaveformComplexI16"));
  function_pointers_.WriteNamedWaveformF64 = reinterpret_cast<WriteNamedWaveformF64Ptr>(p_shared_library_->get_function_pointer("niFgen_WriteNamedWaveformF64"));
  function_pointers_.WriteNamedWaveformI16 = reinterpret_cast<WriteNamedWaveformI16Ptr>(p_shared_library_->get_function_pointer("niFgen_WriteNamedWaveformI16"));
  function_pointers_.WriteP2PEndpointI16 = reinterpret_cast<WriteP2PEndpointI16Ptr>(p_shared_library_->get_function_pointer("niFgen_WriteP2PEndpointI16"));
  function_pointers_.WriteScript = reinterpret_cast<WriteScriptPtr>(p_shared_library_->get_function_pointer("niFgen_WriteScript"));
  function_pointers_.WriteWaveform = reinterpret_cast<WriteWaveformPtr>(p_shared_library_->get_function_pointer("niFgen_WriteWaveform"));
  function_pointers_.WriteWaveformComplexF64 = reinterpret_cast<WriteWaveformComplexF64Ptr>(p_shared_library_->get_function_pointer("niFgen_WriteWaveformComplexF64"));
  function_pointers_.SetRuntimeEnvironment = reinterpret_cast<SetRuntimeEnvironmentPtr>(p_shared_library_->get_function_pointer("niFgen_SetRuntimeEnvironment"));
