...
InitResponse init(const StubPtr& stub, const pb::string& resource_name, const bool& id_query, const bool& reset_device, const nidevice_grpc::SessionInitializationBehavior& requested_behavior);
...
InitializeWithChannelsResponse initialize_with_channels(const StubPtr& stub, const pb::string& resource_name, const pb::string& channel_name, const bool& reset_device, const pb::string& option_string, const nidevice_grpc::SessionInitializationBehavior& requested_behavior);
