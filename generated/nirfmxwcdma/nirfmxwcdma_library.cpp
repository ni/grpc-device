...
NiRFmxWCDMALibrary::NiRFmxWCDMALibrary(std::shared_ptr<nidevice_grpc::SharedLibraryInterface> pSharedLibrary) : p_shared_library_(pSharedLibrary)
{
  ...
  function_pointers_.ACPCfgAveraging = reinterpret_cast<ACPCfgAveragingPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_ACPCfgAveraging"));
  function_pointers_.ACPCfgMeasurementMethod = reinterpret_cast<ACPCfgMeasurementMethodPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_ACPCfgMeasurementMethod"));
  function_pointers_.ACPCfgNoiseCompensationEnabled = reinterpret_cast<ACPCfgNoiseCompensationEnabledPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_ACPCfgNoiseCompensationEnabled"));
  function_pointers_.ACPCfgNumberOfOffsets = reinterpret_cast<ACPCfgNumberOfOffsetsPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_ACPCfgNumberOfOffsets"));
  function_pointers_.ACPCfgOffsetPowerReference = reinterpret_cast<ACPCfgOffsetPowerReferencePtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_ACPCfgOffsetPowerReference"));
  function_pointers_.ACPCfgRBWFilter = reinterpret_cast<ACPCfgRBWFilterPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_ACPCfgRBWFilter"));
  function_pointers_.ACPCfgSweepTime = reinterpret_cast<ACPCfgSweepTimePtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_ACPCfgSweepTime"));
  function_pointers_.ACPFetchAbsolutePowersTrace = reinterpret_cast<ACPFetchAbsolutePowersTracePtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_ACPFetchAbsolutePowersTrace"));
  function_pointers_.ACPFetchCarrierMeasurement = reinterpret_cast<ACPFetchCarrierMeasurementPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_ACPFetchCarrierMeasurement"));
  function_pointers_.ACPFetchCarrierMeasurementArray = reinterpret_cast<ACPFetchCarrierMeasurementArrayPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_ACPFetchCarrierMeasurementArray"));
  function_pointers_.ACPFetchOffsetMeasurement = reinterpret_cast<ACPFetchOffsetMeasurementPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_ACPFetchOffsetMeasurement"));
  function_pointers_.ACPFetchOffsetMeasurementArray = reinterpret_cast<ACPFetchOffsetMeasurementArrayPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_ACPFetchOffsetMeasurementArray"));
  function_pointers_.ACPFetchRelativePowersTrace = reinterpret_cast<ACPFetchRelativePowersTracePtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_ACPFetchRelativePowersTrace"));
  function_pointers_.ACPFetchSpectrum = reinterpret_cast<ACPFetchSpectrumPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_ACPFetchSpectrum"));
  function_pointers_.ACPFetchTotalCarrierPower = reinterpret_cast<ACPFetchTotalCarrierPowerPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_ACPFetchTotalCarrierPower"));
  function_pointers_.AbortMeasurements = reinterpret_cast<AbortMeasurementsPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_AbortMeasurements"));
  function_pointers_.AnalyzeIQ1Waveform = reinterpret_cast<AnalyzeIQ1WaveformPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_AnalyzeIQ1Waveform"));
  function_pointers_.AnalyzeSpectrum1Waveform = reinterpret_cast<AnalyzeSpectrum1WaveformPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_AnalyzeSpectrum1Waveform"));
  function_pointers_.AutoLevel = reinterpret_cast<AutoLevelPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_AutoLevel"));
  function_pointers_.BuildCarrierString = reinterpret_cast<BuildCarrierStringPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_BuildCarrierString"));
  function_pointers_.BuildChannelString = reinterpret_cast<BuildChannelStringPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_BuildChannelString"));
  function_pointers_.BuildOffsetString = reinterpret_cast<BuildOffsetStringPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_BuildOffsetString"));
  function_pointers_.BuildSignalString = reinterpret_cast<BuildSignalStringPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_BuildSignalString"));
  function_pointers_.CDACfgMeasurementChannel = reinterpret_cast<CDACfgMeasurementChannelPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_CDACfgMeasurementChannel"));
  function_pointers_.CDACfgPowerUnit = reinterpret_cast<CDACfgPowerUnitPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_CDACfgPowerUnit"));
  function_pointers_.CDACfgSynchronizationModeAndInterval = reinterpret_cast<CDACfgSynchronizationModeAndIntervalPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_CDACfgSynchronizationModeAndInterval"));
  function_pointers_.CDAFetchCodeDomainIAndQPower = reinterpret_cast<CDAFetchCodeDomainIAndQPowerPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_CDAFetchCodeDomainIAndQPower"));
  function_pointers_.CDAFetchCodeDomainIAndQPowerTrace = reinterpret_cast<CDAFetchCodeDomainIAndQPowerTracePtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_CDAFetchCodeDomainIAndQPowerTrace"));
  function_pointers_.CDAFetchCodeDomainPower = reinterpret_cast<CDAFetchCodeDomainPowerPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_CDAFetchCodeDomainPower"));
  function_pointers_.CDAFetchCodeDomainPowerTrace = reinterpret_cast<CDAFetchCodeDomainPowerTracePtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_CDAFetchCodeDomainPowerTrace"));
  function_pointers_.CDAFetchSymbolEVM = reinterpret_cast<CDAFetchSymbolEVMPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_CDAFetchSymbolEVM"));
  function_pointers_.CDAFetchSymbolEVMTrace = reinterpret_cast<CDAFetchSymbolEVMTracePtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_CDAFetchSymbolEVMTrace"));
  function_pointers_.CDAFetchSymbolMagnitudeErrorTrace = reinterpret_cast<CDAFetchSymbolMagnitudeErrorTracePtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_CDAFetchSymbolMagnitudeErrorTrace"));
  function_pointers_.CDAFetchSymbolPhaseErrorTrace = reinterpret_cast<CDAFetchSymbolPhaseErrorTracePtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_CDAFetchSymbolPhaseErrorTrace"));
  function_pointers_.CDAFetchSymbolPowerTrace = reinterpret_cast<CDAFetchSymbolPowerTracePtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_CDAFetchSymbolPowerTrace"));
  function_pointers_.CHPCfgAveraging = reinterpret_cast<CHPCfgAveragingPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_CHPCfgAveraging"));
  function_pointers_.CHPCfgRBWFilter = reinterpret_cast<CHPCfgRBWFilterPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_CHPCfgRBWFilter"));
  function_pointers_.CHPCfgSweepTime = reinterpret_cast<CHPCfgSweepTimePtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_CHPCfgSweepTime"));
  function_pointers_.CHPFetchCarrierMeasurement = reinterpret_cast<CHPFetchCarrierMeasurementPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_CHPFetchCarrierMeasurement"));
  function_pointers_.CHPFetchCarrierMeasurementArray = reinterpret_cast<CHPFetchCarrierMeasurementArrayPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_CHPFetchCarrierMeasurementArray"));
  function_pointers_.CHPFetchSpectrum = reinterpret_cast<CHPFetchSpectrumPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_CHPFetchSpectrum"));
  function_pointers_.CHPFetchTotalCarrierPower = reinterpret_cast<CHPFetchTotalCarrierPowerPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_CHPFetchTotalCarrierPower"));
  function_pointers_.CfgBand = reinterpret_cast<CfgBandPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_CfgBand"));
  function_pointers_.CfgCarrierFrequency = reinterpret_cast<CfgCarrierFrequencyPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_CfgCarrierFrequency"));
  function_pointers_.CfgCarrierFrequencyArray = reinterpret_cast<CfgCarrierFrequencyArrayPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_CfgCarrierFrequencyArray"));
  function_pointers_.CfgChannelConfigurationMode = reinterpret_cast<CfgChannelConfigurationModePtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_CfgChannelConfigurationMode"));
  function_pointers_.CfgContiguousCarriers = reinterpret_cast<CfgContiguousCarriersPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_CfgContiguousCarriers"));
  function_pointers_.CfgDigitalEdgeTrigger = reinterpret_cast<CfgDigitalEdgeTriggerPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_CfgDigitalEdgeTrigger"));
  function_pointers_.CfgExternalAttenuation = reinterpret_cast<CfgExternalAttenuationPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_CfgExternalAttenuation"));
  function_pointers_.CfgFrequency = reinterpret_cast<CfgFrequencyPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_CfgFrequency"));
  function_pointers_.CfgFrequencyReference = reinterpret_cast<CfgFrequencyReferencePtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_CfgFrequencyReference"));
  function_pointers_.CfgFrequencyUARFCN = reinterpret_cast<CfgFrequencyUARFCNPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_CfgFrequencyUARFCN"));
  function_pointers_.CfgIQPowerEdgeTrigger = reinterpret_cast<CfgIQPowerEdgeTriggerPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_CfgIQPowerEdgeTrigger"));
  function_pointers_.CfgMechanicalAttenuation = reinterpret_cast<CfgMechanicalAttenuationPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_CfgMechanicalAttenuation"));
  function_pointers_.CfgNumberOfCarriers = reinterpret_cast<CfgNumberOfCarriersPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_CfgNumberOfCarriers"));
  function_pointers_.CfgNumberOfChannels = reinterpret_cast<CfgNumberOfChannelsPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_CfgNumberOfChannels"));
  function_pointers_.CfgNumberOfChannelsArray = reinterpret_cast<CfgNumberOfChannelsArrayPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_CfgNumberOfChannelsArray"));
  function_pointers_.CfgRF = reinterpret_cast<CfgRFPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_CfgRF"));
  function_pointers_.CfgRFAttenuation = reinterpret_cast<CfgRFAttenuationPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_CfgRFAttenuation"));
  function_pointers_.CfgReferenceLevel = reinterpret_cast<CfgReferenceLevelPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_CfgReferenceLevel"));
  function_pointers_.CfgSoftwareEdgeTrigger = reinterpret_cast<CfgSoftwareEdgeTriggerPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_CfgSoftwareEdgeTrigger"));
  function_pointers_.CfgUplinkScrambling = reinterpret_cast<CfgUplinkScramblingPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_CfgUplinkScrambling"));
  function_pointers_.CfgUplinkScramblingArray = reinterpret_cast<CfgUplinkScramblingArrayPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_CfgUplinkScramblingArray"));
  function_pointers_.CfgUplinkTestModel = reinterpret_cast<CfgUplinkTestModelPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_CfgUplinkTestModel"));
  function_pointers_.CfgUplinkTestModelArray = reinterpret_cast<CfgUplinkTestModelArrayPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_CfgUplinkTestModelArray"));
  function_pointers_.CfgUserDefinedChannel = reinterpret_cast<CfgUserDefinedChannelPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_CfgUserDefinedChannel"));
  function_pointers_.CfgUserDefinedChannelArray = reinterpret_cast<CfgUserDefinedChannelArrayPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_CfgUserDefinedChannelArray"));
  function_pointers_.CheckMeasurementStatus = reinterpret_cast<CheckMeasurementStatusPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_CheckMeasurementStatus"));
  function_pointers_.ClearAllNamedResults = reinterpret_cast<ClearAllNamedResultsPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_ClearAllNamedResults"));
  function_pointers_.ClearNamedResult = reinterpret_cast<ClearNamedResultPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_ClearNamedResult"));
  function_pointers_.CloneSignalConfiguration = reinterpret_cast<CloneSignalConfigurationPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_CloneSignalConfiguration"));
  function_pointers_.Close = reinterpret_cast<ClosePtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_Close"));
  function_pointers_.Commit = reinterpret_cast<CommitPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_Commit"));
  function_pointers_.CreateSignalConfiguration = reinterpret_cast<CreateSignalConfigurationPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_CreateSignalConfiguration"));
  function_pointers_.DeleteSignalConfiguration = reinterpret_cast<DeleteSignalConfigurationPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_DeleteSignalConfiguration"));
  function_pointers_.DisableTrigger = reinterpret_cast<DisableTriggerPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_DisableTrigger"));
  function_pointers_.GetAllNamedResultNames = reinterpret_cast<GetAllNamedResultNamesPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_GetAllNamedResultNames"));
  function_pointers_.GetAttributeF32 = reinterpret_cast<GetAttributeF32Ptr>(p_shared_library_->get_function_pointer("RFmxWCDMA_GetAttributeF32"));
  function_pointers_.GetAttributeF32Array = reinterpret_cast<GetAttributeF32ArrayPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_GetAttributeF32Array"));
  function_pointers_.GetAttributeF64 = reinterpret_cast<GetAttributeF64Ptr>(p_shared_library_->get_function_pointer("RFmxWCDMA_GetAttributeF64"));
  function_pointers_.GetAttributeF64Array = reinterpret_cast<GetAttributeF64ArrayPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_GetAttributeF64Array"));
  function_pointers_.GetAttributeI16 = reinterpret_cast<GetAttributeI16Ptr>(p_shared_library_->get_function_pointer("RFmxWCDMA_GetAttributeI16"));
  function_pointers_.GetAttributeI32 = reinterpret_cast<GetAttributeI32Ptr>(p_shared_library_->get_function_pointer("RFmxWCDMA_GetAttributeI32"));
  function_pointers_.GetAttributeI32Array = reinterpret_cast<GetAttributeI32ArrayPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_GetAttributeI32Array"));
  function_pointers_.GetAttributeI64 = reinterpret_cast<GetAttributeI64Ptr>(p_shared_library_->get_function_pointer("RFmxWCDMA_GetAttributeI64"));
  function_pointers_.GetAttributeI64Array = reinterpret_cast<GetAttributeI64ArrayPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_GetAttributeI64Array"));
  function_pointers_.GetAttributeI8 = reinterpret_cast<GetAttributeI8Ptr>(p_shared_library_->get_function_pointer("RFmxWCDMA_GetAttributeI8"));
  function_pointers_.GetAttributeI8Array = reinterpret_cast<GetAttributeI8ArrayPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_GetAttributeI8Array"));
  function_pointers_.GetAttributeNIComplexDoubleArray = reinterpret_cast<GetAttributeNIComplexDoubleArrayPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_GetAttributeNIComplexDoubleArray"));
  function_pointers_.GetAttributeNIComplexSingleArray = reinterpret_cast<GetAttributeNIComplexSingleArrayPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_GetAttributeNIComplexSingleArray"));
  function_pointers_.GetAttributeString = reinterpret_cast<GetAttributeStringPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_GetAttributeString"));
  function_pointers_.GetAttributeU16 = reinterpret_cast<GetAttributeU16Ptr>(p_shared_library_->get_function_pointer("RFmxWCDMA_GetAttributeU16"));
  function_pointers_.GetAttributeU32 = reinterpret_cast<GetAttributeU32Ptr>(p_shared_library_->get_function_pointer("RFmxWCDMA_GetAttributeU32"));
  function_pointers_.GetAttributeU32Array = reinterpret_cast<GetAttributeU32ArrayPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_GetAttributeU32Array"));
  function_pointers_.GetAttributeU64Array = reinterpret_cast<GetAttributeU64ArrayPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_GetAttributeU64Array"));
  function_pointers_.GetAttributeU8 = reinterpret_cast<GetAttributeU8Ptr>(p_shared_library_->get_function_pointer("RFmxWCDMA_GetAttributeU8"));
  function_pointers_.GetAttributeU8Array = reinterpret_cast<GetAttributeU8ArrayPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_GetAttributeU8Array"));
  function_pointers_.GetError = reinterpret_cast<GetErrorPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_GetError"));
  function_pointers_.GetErrorString = reinterpret_cast<GetErrorStringPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_GetErrorString"));
  function_pointers_.Initialize = reinterpret_cast<InitializePtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_Initialize"));
  function_pointers_.InitializeFromNIRFSASession = reinterpret_cast<InitializeFromNIRFSASessionPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_InitializeFromNIRFSASession"));
  function_pointers_.Initiate = reinterpret_cast<InitiatePtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_Initiate"));
  function_pointers_.ModAccCfgReferenceWaveform = reinterpret_cast<ModAccCfgReferenceWaveformPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_ModAccCfgReferenceWaveform"));
  function_pointers_.ModAccCfgSynchronizationModeAndInterval = reinterpret_cast<ModAccCfgSynchronizationModeAndIntervalPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_ModAccCfgSynchronizationModeAndInterval"));
  function_pointers_.ModAccFetchConstellationTrace = reinterpret_cast<ModAccFetchConstellationTracePtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_ModAccFetchConstellationTrace"));
  function_pointers_.ModAccFetchDetectedChannel = reinterpret_cast<ModAccFetchDetectedChannelPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_ModAccFetchDetectedChannel"));
  function_pointers_.ModAccFetchDetectedChannelArray = reinterpret_cast<ModAccFetchDetectedChannelArrayPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_ModAccFetchDetectedChannelArray"));
  function_pointers_.ModAccFetchEVM = reinterpret_cast<ModAccFetchEVMPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_ModAccFetchEVM"));
  function_pointers_.ModAccFetchEVMArray = reinterpret_cast<ModAccFetchEVMArrayPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_ModAccFetchEVMArray"));
  function_pointers_.ModAccFetchEVMTrace = reinterpret_cast<ModAccFetchEVMTracePtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_ModAccFetchEVMTrace"));
  function_pointers_.ModAccFetchIQImpairments = reinterpret_cast<ModAccFetchIQImpairmentsPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_ModAccFetchIQImpairments"));
  function_pointers_.ModAccFetchIQImpairmentsArray = reinterpret_cast<ModAccFetchIQImpairmentsArrayPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_ModAccFetchIQImpairmentsArray"));
  function_pointers_.ModAccFetchMagnitudeErrorTrace = reinterpret_cast<ModAccFetchMagnitudeErrorTracePtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_ModAccFetchMagnitudeErrorTrace"));
  function_pointers_.ModAccFetchMulticarrierIQImpairments = reinterpret_cast<ModAccFetchMulticarrierIQImpairmentsPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_ModAccFetchMulticarrierIQImpairments"));
  function_pointers_.ModAccFetchNumberOfDetectedChannels = reinterpret_cast<ModAccFetchNumberOfDetectedChannelsPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_ModAccFetchNumberOfDetectedChannels"));
  function_pointers_.ModAccFetchNumberOfDetectedChannelsArray = reinterpret_cast<ModAccFetchNumberOfDetectedChannelsArrayPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_ModAccFetchNumberOfDetectedChannelsArray"));
  function_pointers_.ModAccFetchPeakActiveCDE = reinterpret_cast<ModAccFetchPeakActiveCDEPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_ModAccFetchPeakActiveCDE"));
  function_pointers_.ModAccFetchPeakActiveCDEArray = reinterpret_cast<ModAccFetchPeakActiveCDEArrayPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_ModAccFetchPeakActiveCDEArray"));
  function_pointers_.ModAccFetchPeakCDE = reinterpret_cast<ModAccFetchPeakCDEPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_ModAccFetchPeakCDE"));
  function_pointers_.ModAccFetchPeakCDEArray = reinterpret_cast<ModAccFetchPeakCDEArrayPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_ModAccFetchPeakCDEArray"));
  function_pointers_.ModAccFetchPhaseErrorTrace = reinterpret_cast<ModAccFetchPhaseErrorTracePtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_ModAccFetchPhaseErrorTrace"));
  function_pointers_.ModAccFetchRCDE = reinterpret_cast<ModAccFetchRCDEPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_ModAccFetchRCDE"));
  function_pointers_.ModAccFetchRCDEArray = reinterpret_cast<ModAccFetchRCDEArrayPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_ModAccFetchRCDEArray"));
  function_pointers_.ModAccFetchRCDETrace = reinterpret_cast<ModAccFetchRCDETracePtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_ModAccFetchRCDETrace"));
  function_pointers_.ModAccFetchReferenceWaveform = reinterpret_cast<ModAccFetchReferenceWaveformPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_ModAccFetchReferenceWaveform"));
  function_pointers_.OBWCfgAveraging = reinterpret_cast<OBWCfgAveragingPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_OBWCfgAveraging"));
  function_pointers_.OBWCfgRBWFilter = reinterpret_cast<OBWCfgRBWFilterPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_OBWCfgRBWFilter"));
  function_pointers_.OBWCfgSweepTime = reinterpret_cast<OBWCfgSweepTimePtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_OBWCfgSweepTime"));
  function_pointers_.OBWFetchMeasurement = reinterpret_cast<OBWFetchMeasurementPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_OBWFetchMeasurement"));
  function_pointers_.OBWFetchSpectrum = reinterpret_cast<OBWFetchSpectrumPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_OBWFetchSpectrum"));
  function_pointers_.QEVMCfgAveraging = reinterpret_cast<QEVMCfgAveragingPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_QEVMCfgAveraging"));
  function_pointers_.QEVMCfgMeasurementLength = reinterpret_cast<QEVMCfgMeasurementLengthPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_QEVMCfgMeasurementLength"));
  function_pointers_.QEVMFetchConstellationTrace = reinterpret_cast<QEVMFetchConstellationTracePtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_QEVMFetchConstellationTrace"));
  function_pointers_.QEVMFetchEVM = reinterpret_cast<QEVMFetchEVMPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_QEVMFetchEVM"));
  function_pointers_.QEVMFetchEVMTrace = reinterpret_cast<QEVMFetchEVMTracePtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_QEVMFetchEVMTrace"));
  function_pointers_.QEVMFetchIQImpairments = reinterpret_cast<QEVMFetchIQImpairmentsPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_QEVMFetchIQImpairments"));
  function_pointers_.QEVMFetchMagnitudeErrorTrace = reinterpret_cast<QEVMFetchMagnitudeErrorTracePtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_QEVMFetchMagnitudeErrorTrace"));
  function_pointers_.QEVMFetchPhaseErrorTrace = reinterpret_cast<QEVMFetchPhaseErrorTracePtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_QEVMFetchPhaseErrorTrace"));
  function_pointers_.ResetAttribute = reinterpret_cast<ResetAttributePtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_ResetAttribute"));
  function_pointers_.ResetToDefault = reinterpret_cast<ResetToDefaultPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_ResetToDefault"));
  function_pointers_.SEMCfgAveraging = reinterpret_cast<SEMCfgAveragingPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_SEMCfgAveraging"));
  function_pointers_.SEMCfgSweepTime = reinterpret_cast<SEMCfgSweepTimePtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_SEMCfgSweepTime"));
  function_pointers_.SEMFetchCarrierMeasurement = reinterpret_cast<SEMFetchCarrierMeasurementPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_SEMFetchCarrierMeasurement"));
  function_pointers_.SEMFetchCarrierMeasurementArray = reinterpret_cast<SEMFetchCarrierMeasurementArrayPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_SEMFetchCarrierMeasurementArray"));
  function_pointers_.SEMFetchLowerOffsetMargin = reinterpret_cast<SEMFetchLowerOffsetMarginPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_SEMFetchLowerOffsetMargin"));
  function_pointers_.SEMFetchLowerOffsetMarginArray = reinterpret_cast<SEMFetchLowerOffsetMarginArrayPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_SEMFetchLowerOffsetMarginArray"));
  function_pointers_.SEMFetchLowerOffsetPower = reinterpret_cast<SEMFetchLowerOffsetPowerPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_SEMFetchLowerOffsetPower"));
  function_pointers_.SEMFetchLowerOffsetPowerArray = reinterpret_cast<SEMFetchLowerOffsetPowerArrayPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_SEMFetchLowerOffsetPowerArray"));
  function_pointers_.SEMFetchMeasurementStatus = reinterpret_cast<SEMFetchMeasurementStatusPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_SEMFetchMeasurementStatus"));
  function_pointers_.SEMFetchSpectrum = reinterpret_cast<SEMFetchSpectrumPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_SEMFetchSpectrum"));
  function_pointers_.SEMFetchTotalCarrierPower = reinterpret_cast<SEMFetchTotalCarrierPowerPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_SEMFetchTotalCarrierPower"));
  function_pointers_.SEMFetchUpperOffsetMargin = reinterpret_cast<SEMFetchUpperOffsetMarginPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_SEMFetchUpperOffsetMargin"));
  function_pointers_.SEMFetchUpperOffsetMarginArray = reinterpret_cast<SEMFetchUpperOffsetMarginArrayPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_SEMFetchUpperOffsetMarginArray"));
  function_pointers_.SEMFetchUpperOffsetPower = reinterpret_cast<SEMFetchUpperOffsetPowerPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_SEMFetchUpperOffsetPower"));
  function_pointers_.SEMFetchUpperOffsetPowerArray = reinterpret_cast<SEMFetchUpperOffsetPowerArrayPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_SEMFetchUpperOffsetPowerArray"));
  function_pointers_.SelectMeasurements = reinterpret_cast<SelectMeasurementsPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_SelectMeasurements"));
  function_pointers_.SendSoftwareEdgeTrigger = reinterpret_cast<SendSoftwareEdgeTriggerPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_SendSoftwareEdgeTrigger"));
  function_pointers_.SetAttributeF32 = reinterpret_cast<SetAttributeF32Ptr>(p_shared_library_->get_function_pointer("RFmxWCDMA_SetAttributeF32"));
  function_pointers_.SetAttributeF32Array = reinterpret_cast<SetAttributeF32ArrayPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_SetAttributeF32Array"));
  function_pointers_.SetAttributeF64 = reinterpret_cast<SetAttributeF64Ptr>(p_shared_library_->get_function_pointer("RFmxWCDMA_SetAttributeF64"));
  function_pointers_.SetAttributeF64Array = reinterpret_cast<SetAttributeF64ArrayPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_SetAttributeF64Array"));
  function_pointers_.SetAttributeI16 = reinterpret_cast<SetAttributeI16Ptr>(p_shared_library_->get_function_pointer("RFmxWCDMA_SetAttributeI16"));
  function_pointers_.SetAttributeI32 = reinterpret_cast<SetAttributeI32Ptr>(p_shared_library_->get_function_pointer("RFmxWCDMA_SetAttributeI32"));
  function_pointers_.SetAttributeI32Array = reinterpret_cast<SetAttributeI32ArrayPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_SetAttributeI32Array"));
  function_pointers_.SetAttributeI64 = reinterpret_cast<SetAttributeI64Ptr>(p_shared_library_->get_function_pointer("RFmxWCDMA_SetAttributeI64"));
  function_pointers_.SetAttributeI64Array = reinterpret_cast<SetAttributeI64ArrayPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_SetAttributeI64Array"));
  function_pointers_.SetAttributeI8 = reinterpret_cast<SetAttributeI8Ptr>(p_shared_library_->get_function_pointer("RFmxWCDMA_SetAttributeI8"));
  function_pointers_.SetAttributeI8Array = reinterpret_cast<SetAttributeI8ArrayPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_SetAttributeI8Array"));
  function_pointers_.SetAttributeNIComplexDoubleArray = reinterpret_cast<SetAttributeNIComplexDoubleArrayPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_SetAttributeNIComplexDoubleArray"));
  function_pointers_.SetAttributeNIComplexSingleArray = reinterpret_cast<SetAttributeNIComplexSingleArrayPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_SetAttributeNIComplexSingleArray"));
  function_pointers_.SetAttributeString = reinterpret_cast<SetAttributeStringPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_SetAttributeString"));
  function_pointers_.SetAttributeU16 = reinterpret_cast<SetAttributeU16Ptr>(p_shared_library_->get_function_pointer("RFmxWCDMA_SetAttributeU16"));
  function_pointers_.SetAttributeU32 = reinterpret_cast<SetAttributeU32Ptr>(p_shared_library_->get_function_pointer("RFmxWCDMA_SetAttributeU32"));
  function_pointers_.SetAttributeU32Array = reinterpret_cast<SetAttributeU32ArrayPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_SetAttributeU32Array"));
  function_pointers_.SetAttributeU64Array = reinterpret_cast<SetAttributeU64ArrayPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_SetAttributeU64Array"));
  function_pointers_.SetAttributeU8 = reinterpret_cast<SetAttributeU8Ptr>(p_shared_library_->get_function_pointer("RFmxWCDMA_SetAttributeU8"));
  function_pointers_.SetAttributeU8Array = reinterpret_cast<SetAttributeU8ArrayPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_SetAttributeU8Array"));
  function_pointers_.SlotPhaseCfgSynchronizationModeAndInterval = reinterpret_cast<SlotPhaseCfgSynchronizationModeAndIntervalPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_SlotPhaseCfgSynchronizationModeAndInterval"));
  function_pointers_.SlotPhaseFetchChipPhaseErrorLinearFitTrace = reinterpret_cast<SlotPhaseFetchChipPhaseErrorLinearFitTracePtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_SlotPhaseFetchChipPhaseErrorLinearFitTrace"));
  function_pointers_.SlotPhaseFetchChipPhaseErrorTrace = reinterpret_cast<SlotPhaseFetchChipPhaseErrorTracePtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_SlotPhaseFetchChipPhaseErrorTrace"));
  function_pointers_.SlotPhaseFetchMeasurement = reinterpret_cast<SlotPhaseFetchMeasurementPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_SlotPhaseFetchMeasurement"));
  function_pointers_.SlotPhaseFetchPhaseDiscontinuities = reinterpret_cast<SlotPhaseFetchPhaseDiscontinuitiesPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_SlotPhaseFetchPhaseDiscontinuities"));
  function_pointers_.SlotPowerCfgSynchronizationModeAndInterval = reinterpret_cast<SlotPowerCfgSynchronizationModeAndIntervalPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_SlotPowerCfgSynchronizationModeAndInterval"));
  function_pointers_.SlotPowerFetchPowers = reinterpret_cast<SlotPowerFetchPowersPtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_SlotPowerFetchPowers"));
  function_pointers_.WaitForAcquisitionComplete = reinterpret_cast<WaitForAcquisitionCompletePtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_WaitForAcquisitionComplete"));
  function_pointers_.WaitForMeasurementComplete = reinterpret_cast<WaitForMeasurementCompletePtr>(p_shared_library_->get_function_pointer("RFmxWCDMA_WaitForMeasurementComplete"));
}
