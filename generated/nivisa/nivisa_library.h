...
//---------------------------------------------------------------------
// Real implementation of LibraryInterface for NI-VISA Library
//---------------------------------------------------------------------
#ifndef NIVISA_GRPC_LIBRARY_H
#define NIVISA_GRPC_LIBRARY_H
...
class NiVISALibrary : public nivisa_grpc::NiVISALibraryInterface {
 public:
  NiVISALibrary();
  explicit NiVISALibrary(std::shared_ptr<nidevice_grpc::SharedLibraryInterface> shared_library);
  virtual ~NiVISALibrary();
