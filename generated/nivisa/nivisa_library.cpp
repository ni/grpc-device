...
#if defined(_MSC_VER)
static const char* kLibraryName = "nivisa64.dll";
#else
...
NiVISALibrary::NiVISALibrary() : NiVISALibrary(std::make_shared<nidevice_grpc::SharedLibrary>()) {}

NiVISALibrary::NiVISALibrary(std::shared_ptr<nidevice_grpc::SharedLibraryInterface> shared_library) : shared_library_(shared_library)
{
...
NiVISALibrary::~NiVISALibrary()
{
}

::grpc::Status NiVISALibrary::check_function_exists(std::string functionName)
{
...
ViStatus NiVISALibrary::AssertIntrSignal(ViSession vi, ViInt16 mode, ViUInt32 statusId)
{
...
ViStatus NiVISALibrary::AssertTrigger(ViSession vi, ViUInt16 protocol)
{
...
ViStatus NiVISALibrary::AssertUtilSignal(ViSession vi, ViUInt16 mode)
{
...
ViStatus NiVISALibrary::Clear(ViSession vi)
{
...
ViStatus NiVISALibrary::Close(ViObject objectHandle)
{
...
ViStatus NiVISALibrary::DisableEvent(ViSession vi, ViEventType eventType, ViUInt16 eventMechanism)
{
...
ViStatus NiVISALibrary::DiscardEvents(ViSession vi, ViEventType eventType, ViUInt16 eventMechanism)
{
...
ViStatus NiVISALibrary::EnableEvent(ViSession vi, ViEventType eventType, ViUInt16 eventMechanism, ViEventFilter filterContext)
{
...
ViStatus NiVISALibrary::FindRsrc(ViSession rsrcManagerHandle, ViConstString expression, ViFindList* findHandle, ViUInt32* returnCount, ViChar instrumentDescriptor[256])
{
...
ViStatus NiVISALibrary::Flush(ViSession vi, ViUInt16 mask)
{
...
ViStatus NiVISALibrary::GetAttribute(ViObject objectHandle, ViAttr attributeName, void* attributeValue)
{
...
ViStatus NiVISALibrary::GpibCommand(ViSession vi, ViByte buffer[], ViUInt32 count, ViUInt32* returnCount)
{
...
ViStatus NiVISALibrary::GpibControlATN(ViSession vi, ViUInt16 mode)
{
...
ViStatus NiVISALibrary::GpibControlREN(ViSession vi, ViUInt16 mode)
{
...
ViStatus NiVISALibrary::GpibPassControl(ViSession vi, ViUInt16 primaryAddress, ViUInt16 secondaryAddress)
{
...
ViStatus NiVISALibrary::GpibSendIFC(ViSession vi)
{
...
ViStatus NiVISALibrary::In16Ex(ViSession vi, ViUInt16 addressSpace, ViBusAddress64 offset, ViUInt16* value)
{
...
ViStatus NiVISALibrary::In32Ex(ViSession vi, ViUInt16 addressSpace, ViBusAddress64 offset, ViUInt32* value)
{
...
ViStatus NiVISALibrary::In64Ex(ViSession vi, ViUInt16 addressSpace, ViBusAddress64 offset, ViUInt64* value)
{
...
ViStatus NiVISALibrary::In8Ex(ViSession vi, ViUInt16 addressSpace, ViBusAddress64 offset, ViUInt8* value)
{
...
ViStatus NiVISALibrary::Lock(ViSession vi, ViAccessMode lockType, ViUInt32 timeout, ViConstKeyId requestedKey, ViChar accessKey[256])
{
...
ViStatus NiVISALibrary::MapAddressEx(ViSession vi, ViUInt16 addressSpace, ViBusAddress64 offset, ViBusSize mapSize, ViBoolean ownerAccess, ViAddr suggestedAddress, ViAddr* address)
{
...
ViStatus NiVISALibrary::MapTrigger(ViSession vi, ViInt16 triggerSource, ViInt16 triggerDestination, ViUInt16 mode)
{
...
ViStatus NiVISALibrary::MemAlloc(ViSession vi, ViBusSize size, ViBusAddress* offset)
{
...
ViStatus NiVISALibrary::MemAllocEx(ViSession vi, ViBusSize size, ViBusAddress64* offset)
{
...
ViStatus NiVISALibrary::MemFreeEx(ViSession vi, ViBusAddress64 offset)
{
...
ViStatus NiVISALibrary::MoveIn16Ex(ViSession vi, ViUInt16 addressSpace, ViBusAddress64 offset, ViBusSize count, ViUInt16 buffer[])
{
...
ViStatus NiVISALibrary::MoveIn32Ex(ViSession vi, ViUInt16 addressSpace, ViBusAddress64 offset, ViBusSize count, ViUInt32 buffer[])
{
...
ViStatus NiVISALibrary::MoveIn64Ex(ViSession vi, ViUInt16 addressSpace, ViBusAddress64 offset, ViBusSize count, ViUInt64 buffer[])
{
...
ViStatus NiVISALibrary::MoveIn8Ex(ViSession vi, ViUInt16 addressSpace, ViBusAddress64 offset, ViBusSize count, ViUInt8 buffer[])
{
...
ViStatus NiVISALibrary::MoveOut16Ex(ViSession vi, ViUInt16 addressSpace, ViBusAddress64 offset, ViBusSize count, ViUInt16 buffer[])
{
...
ViStatus NiVISALibrary::MoveOut32Ex(ViSession vi, ViUInt16 addressSpace, ViBusAddress64 offset, ViBusSize count, ViUInt32 buffer[])
{
...
ViStatus NiVISALibrary::MoveOut64Ex(ViSession vi, ViUInt16 addressSpace, ViBusAddress64 offset, ViBusSize count, ViUInt64 buffer[])
{
...
ViStatus NiVISALibrary::MoveOut8Ex(ViSession vi, ViUInt16 addressSpace, ViBusAddress64 offset, ViBusSize count, ViUInt8 buffer[])
{
...
ViStatus NiVISALibrary::Open(ViSession rsrcManagerHandle, ViConstRsrc instrumentDescriptor, ViAccessMode accessMode, ViUInt32 openTimeout, ViSession* vi)
{
...
ViStatus NiVISALibrary::Out16Ex(ViSession vi, ViUInt16 addressSpace, ViBusAddress64 offset, ViUInt16 value)
{
...
ViStatus NiVISALibrary::Out32Ex(ViSession vi, ViUInt16 addressSpace, ViBusAddress64 offset, ViUInt32 value)
{
...
ViStatus NiVISALibrary::Out64Ex(ViSession vi, ViUInt16 addressSpace, ViBusAddress64 offset, ViUInt64 value)
{
...
ViStatus NiVISALibrary::Out8Ex(ViSession vi, ViUInt16 addressSpace, ViBusAddress64 offset, ViUInt8 value)
{
...
ViStatus NiVISALibrary::ParseRsrcEx(ViSession sessionHandle, ViConstRsrc resourceName, ViUInt16* interfaceType, ViUInt16* interfaceNumber, ViChar resourceClass[256], ViChar expandedUnaliasedName[256], ViChar aliasIfExists[256])
{
...
void NiVISALibrary::Peek16(ViSession vi, ViAddr address, ViUInt16* value)
{
...
void NiVISALibrary::Peek32(ViSession vi, ViAddr address, ViUInt32* value)
{
...
void NiVISALibrary::Peek64(ViSession vi, ViAddr address, ViUInt64* value)
{
...
void NiVISALibrary::Peek8(ViSession vi, ViAddr address, ViUInt8* value)
{
...
void NiVISALibrary::Poke16(ViSession vi, ViAddr address, ViUInt16 value)
{
...
void NiVISALibrary::Poke32(ViSession vi, ViAddr address, ViUInt32 value)
{
...
void NiVISALibrary::Poke64(ViSession vi, ViAddr address, ViUInt64 value)
{
...
void NiVISALibrary::Poke8(ViSession vi, ViAddr address, ViUInt8 value)
{
...
ViStatus NiVISALibrary::PxiReserveTriggers(ViSession vi, ViInt16 cnt, ViInt16 trigBuses[], ViInt16 trigLines[], ViInt16* failureIndex)
{
...
ViStatus NiVISALibrary::Read(ViSession vi, ViByte buffer[], ViUInt32 count, ViUInt32* returnCount)
{
...
ViStatus NiVISALibrary::ReadAsync(ViSession vi, void* readBuffer, ViUInt32 count, ViJobId* jobIdentifier)
{
...
ViStatus NiVISALibrary::ReadSTB(ViSession vi, ViUInt16* statusByte)
{
...
ViStatus NiVISALibrary::SetAttribute(ViObject objectHandle, ViAttr attributeName, ViAttrState attributeValue)
{
...
ViStatus NiVISALibrary::SetBuf(ViSession vi, ViUInt16 mask, ViUInt32 bufferSize)
{
...
ViStatus NiVISALibrary::StatusDesc(ViObject objectHandle, ViStatus statusValue, ViChar statusDescription[256])
{
...
ViStatus NiVISALibrary::Terminate(ViSession vi, ViUInt16 degree, ViJobId jobIdentifier)
{
...
ViStatus NiVISALibrary::Unlock(ViSession vi)
{
...
ViStatus NiVISALibrary::UnmapAddress(ViSession vi)
{
...
ViStatus NiVISALibrary::UnmapTrigger(ViSession vi, ViInt16 triggerSource, ViInt16 triggerDestination)
{
...
ViStatus NiVISALibrary::UsbControlIn(ViSession vi, ViInt16 bmRequestType, ViInt16 bRequest, ViUInt16 wValue, ViUInt16 wIndex, ViUInt16 wLength, ViByte buffer[], ViUInt16* returnCount)
{
...
ViStatus NiVISALibrary::UsbControlOut(ViSession vi, ViInt16 bmRequestType, ViInt16 bRequest, ViUInt16 wValue, ViUInt16 wIndex, ViUInt16 wLength, ViByte buffer[])
{
...
ViStatus NiVISALibrary::VxiCommandQuery(ViSession vi, ViUInt16 mode, ViUInt32 command, ViUInt32* response)
{
...
ViStatus NiVISALibrary::WaitOnEvent(ViSession vi, ViEventType inEventType, ViUInt32 timeout, ViEventType* outEventType, ViEvent* eventHandle)
{
...
ViStatus NiVISALibrary::Write(ViSession vi, ViByte buffer[], ViUInt32 count, ViUInt32* returnCount)
{
...
ViStatus NiVISALibrary::WriteAsync(ViSession vi, ViByte writeBuffer[], ViUInt32 count, ViJobId* jobIdentifier)
{
