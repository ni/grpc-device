...
//---------------------------------------------------------------------
// Library wrapper for implementing interactions with NI-VISA Library
//---------------------------------------------------------------------
#ifndef NIVISA_GRPC_LIBRARY_WRAPPER_H
#define NIVISA_GRPC_LIBRARY_WRAPPER_H
...
class NiVISALibraryInterface {
 public:
  virtual ~NiVISALibraryInterface() {}
  ...
  virtual ViStatus ReadAsync(ViSession vi, void* readBuffer, ViUInt32 count, ViJobId* jobIdentifier) = 0;
...
#endif  // NIVISA_GRPC_LIBRARY_WRAPPER_H
