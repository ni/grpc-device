...
//---------------------------------------------------------------------
// Mock of LibraryInterface for NI-VISA Library
//---------------------------------------------------------------------
#ifndef NIVISA_GRPC_MOCK_LIBRARY_H
#define NIVISA_GRPC_MOCK_LIBRARY_H
...
class NiVISAMockLibrary : public nivisa_grpc::NiVISALibraryInterface {
 public:
  ...
  MOCK_METHOD(ViStatus, In16Ex, (ViSession vi, ViUInt16 addressSpace, ViBusAddress64 offset, ViUInt16* value), (override));
  MOCK_METHOD(ViStatus, In32Ex, (ViSession vi, ViUInt16 addressSpace, ViBusAddress64 offset, ViUInt32* value), (override));
  MOCK_METHOD(ViStatus, In64Ex, (ViSession vi, ViUInt16 addressSpace, ViBusAddress64 offset, ViUInt64* value), (override));
  MOCK_METHOD(ViStatus, In8Ex, (ViSession vi, ViUInt16 addressSpace, ViBusAddress64 offset, ViUInt8* value), (override));
  ...
  MOCK_METHOD(ViStatus, MapAddressEx, (ViSession vi, ViUInt16 addressSpace, ViBusAddress64 offset, ViBusSize mapSize, ViBoolean ownerAccess, ViAddr suggestedAddress, ViAddr* address), (override));
  MOCK_METHOD(ViStatus, MapTrigger, (ViSession vi, ViInt16 triggerSource, ViInt16 triggerDestination, ViUInt16 mode), (override));
  MOCK_METHOD(ViStatus, MemAlloc, (ViSession vi, ViBusSize size, ViBusAddress* offset), (override));
  MOCK_METHOD(ViStatus, MemAllocEx, (ViSession vi, ViBusSize size, ViBusAddress64* offset), (override));
  MOCK_METHOD(ViStatus, MemFreeEx, (ViSession vi, ViBusAddress64 offset), (override));
  MOCK_METHOD(ViStatus, MoveIn16Ex, (ViSession vi, ViUInt16 addressSpace, ViBusAddress64 offset, ViBusSize count, ViUInt16 buffer[]), (override));
  MOCK_METHOD(ViStatus, MoveIn32Ex, (ViSession vi, ViUInt16 addressSpace, ViBusAddress64 offset, ViBusSize count, ViUInt32 buffer[]), (override));
  MOCK_METHOD(ViStatus, MoveIn64Ex, (ViSession vi, ViUInt16 addressSpace, ViBusAddress64 offset, ViBusSize count, ViUInt64 buffer[]), (override));
  MOCK_METHOD(ViStatus, MoveIn8Ex, (ViSession vi, ViUInt16 addressSpace, ViBusAddress64 offset, ViBusSize count, ViUInt8 buffer[]), (override));
  MOCK_METHOD(ViStatus, MoveOut16Ex, (ViSession vi, ViUInt16 addressSpace, ViBusAddress64 offset, ViBusSize count, ViUInt16 buffer[]), (override));
  MOCK_METHOD(ViStatus, MoveOut32Ex, (ViSession vi, ViUInt16 addressSpace, ViBusAddress64 offset, ViBusSize count, ViUInt32 buffer[]), (override));
  MOCK_METHOD(ViStatus, MoveOut64Ex, (ViSession vi, ViUInt16 addressSpace, ViBusAddress64 offset, ViBusSize count, ViUInt64 buffer[]), (override));
  MOCK_METHOD(ViStatus, MoveOut8Ex, (ViSession vi, ViUInt16 addressSpace, ViBusAddress64 offset, ViBusSize count, ViUInt8 buffer[]), (override));
  ...
  MOCK_METHOD(ViStatus, Out16Ex, (ViSession vi, ViUInt16 addressSpace, ViBusAddress64 offset, ViUInt16 value), (override));
  MOCK_METHOD(ViStatus, Out32Ex, (ViSession vi, ViUInt16 addressSpace, ViBusAddress64 offset, ViUInt32 value), (override));
  MOCK_METHOD(ViStatus, Out64Ex, (ViSession vi, ViUInt16 addressSpace, ViBusAddress64 offset, ViUInt64 value), (override));
  MOCK_METHOD(ViStatus, Out8Ex, (ViSession vi, ViUInt16 addressSpace, ViBusAddress64 offset, ViUInt8 value), (override));
  MOCK_METHOD(ViStatus, ParseRsrcEx, (ViSession sessionHandle, ViConstRsrc resourceName, ViUInt16* interfaceType, ViUInt16* interfaceNumber, ViChar resourceClass[256], ViChar expandedUnaliasedName[256], ViChar aliasIfExists[256]), (override));
  ...
  MOCK_METHOD(ViStatus, VxiCommandQuery, (ViSession vi, ViUInt16 mode, ViUInt32 command, ViUInt32* response), (override));
  ...
  MOCK_METHOD(ViStatus, WriteAsync, (ViSession vi, ViByte writeBuffer[], ViUInt32 count, ViJobId* jobIdentifier), (override));
};

}  // namespace unit
}  // namespace tests
}  // namespace ni
#endif  // NIVISA_GRPC_MOCK_LIBRARY_H
