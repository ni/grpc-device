...
NiRFmxCDMA2kLibrary::NiRFmxCDMA2kLibrary(std::shared_ptr<nidevice_grpc::SharedLibraryInterface> pSharedLibrary) : p_shared_library_(pSharedLibrary)
{
  ...
  function_pointers_.ACPCfgAveraging = reinterpret_cast<ACPCfgAveragingPtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_ACPCfgAveraging"));
  function_pointers_.ACPCfgMeasurementMethod = reinterpret_cast<ACPCfgMeasurementMethodPtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_ACPCfgMeasurementMethod"));
  function_pointers_.ACPCfgNoiseCompensationEnabled = reinterpret_cast<ACPCfgNoiseCompensationEnabledPtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_ACPCfgNoiseCompensationEnabled"));
  function_pointers_.ACPCfgNumberOfOffsets = reinterpret_cast<ACPCfgNumberOfOffsetsPtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_ACPCfgNumberOfOffsets"));
  function_pointers_.ACPCfgRBWFilter = reinterpret_cast<ACPCfgRBWFilterPtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_ACPCfgRBWFilter"));
  function_pointers_.ACPCfgSweepTime = reinterpret_cast<ACPCfgSweepTimePtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_ACPCfgSweepTime"));
  function_pointers_.ACPFetchAbsolutePowersTrace = reinterpret_cast<ACPFetchAbsolutePowersTracePtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_ACPFetchAbsolutePowersTrace"));
  function_pointers_.ACPFetchCarrierAbsolutePower = reinterpret_cast<ACPFetchCarrierAbsolutePowerPtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_ACPFetchCarrierAbsolutePower"));
  function_pointers_.ACPFetchOffsetMeasurement = reinterpret_cast<ACPFetchOffsetMeasurementPtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_ACPFetchOffsetMeasurement"));
  function_pointers_.ACPFetchOffsetMeasurementArray = reinterpret_cast<ACPFetchOffsetMeasurementArrayPtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_ACPFetchOffsetMeasurementArray"));
  function_pointers_.ACPFetchRelativePowersTrace = reinterpret_cast<ACPFetchRelativePowersTracePtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_ACPFetchRelativePowersTrace"));
  function_pointers_.ACPFetchSpectrum = reinterpret_cast<ACPFetchSpectrumPtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_ACPFetchSpectrum"));
  function_pointers_.AbortMeasurements = reinterpret_cast<AbortMeasurementsPtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_AbortMeasurements"));
  function_pointers_.AnalyzeIQ1Waveform = reinterpret_cast<AnalyzeIQ1WaveformPtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_AnalyzeIQ1Waveform"));
  function_pointers_.AnalyzeSpectrum1Waveform = reinterpret_cast<AnalyzeSpectrum1WaveformPtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_AnalyzeSpectrum1Waveform"));
  function_pointers_.AutoLevel = reinterpret_cast<AutoLevelPtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_AutoLevel"));
  function_pointers_.BuildChannelString = reinterpret_cast<BuildChannelStringPtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_BuildChannelString"));
  function_pointers_.BuildOffsetString = reinterpret_cast<BuildOffsetStringPtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_BuildOffsetString"));
  function_pointers_.BuildSignalString = reinterpret_cast<BuildSignalStringPtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_BuildSignalString"));
  function_pointers_.CDACfgMeasurementChannel = reinterpret_cast<CDACfgMeasurementChannelPtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_CDACfgMeasurementChannel"));
  function_pointers_.CDACfgPowerUnit = reinterpret_cast<CDACfgPowerUnitPtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_CDACfgPowerUnit"));
  function_pointers_.CDACfgSynchronizationModeAndInterval = reinterpret_cast<CDACfgSynchronizationModeAndIntervalPtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_CDACfgSynchronizationModeAndInterval"));
  function_pointers_.CDAFetchCodeDomainIAndQPower = reinterpret_cast<CDAFetchCodeDomainIAndQPowerPtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_CDAFetchCodeDomainIAndQPower"));
  function_pointers_.CDAFetchCodeDomainIAndQPowerTrace = reinterpret_cast<CDAFetchCodeDomainIAndQPowerTracePtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_CDAFetchCodeDomainIAndQPowerTrace"));
  function_pointers_.CDAFetchCodeDomainPower = reinterpret_cast<CDAFetchCodeDomainPowerPtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_CDAFetchCodeDomainPower"));
  function_pointers_.CDAFetchIQImpairments = reinterpret_cast<CDAFetchIQImpairmentsPtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_CDAFetchIQImpairments"));
  function_pointers_.CDAFetchSymbolConstellationTrace = reinterpret_cast<CDAFetchSymbolConstellationTracePtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_CDAFetchSymbolConstellationTrace"));
  function_pointers_.CDAFetchSymbolEVM = reinterpret_cast<CDAFetchSymbolEVMPtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_CDAFetchSymbolEVM"));
  function_pointers_.CDAFetchSymbolEVMTrace = reinterpret_cast<CDAFetchSymbolEVMTracePtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_CDAFetchSymbolEVMTrace"));
  function_pointers_.CDAFetchSymbolMagnitudeErrorTrace = reinterpret_cast<CDAFetchSymbolMagnitudeErrorTracePtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_CDAFetchSymbolMagnitudeErrorTrace"));
  function_pointers_.CDAFetchSymbolPhaseErrorTrace = reinterpret_cast<CDAFetchSymbolPhaseErrorTracePtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_CDAFetchSymbolPhaseErrorTrace"));
  function_pointers_.CDAFetchSymbolPowerTrace = reinterpret_cast<CDAFetchSymbolPowerTracePtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_CDAFetchSymbolPowerTrace"));
  function_pointers_.CHPCfgAveraging = reinterpret_cast<CHPCfgAveragingPtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_CHPCfgAveraging"));
  function_pointers_.CHPCfgRBWFilter = reinterpret_cast<CHPCfgRBWFilterPtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_CHPCfgRBWFilter"));
  function_pointers_.CHPCfgSweepTime = reinterpret_cast<CHPCfgSweepTimePtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_CHPCfgSweepTime"));
  function_pointers_.CHPFetchCarrierAbsolutePower = reinterpret_cast<CHPFetchCarrierAbsolutePowerPtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_CHPFetchCarrierAbsolutePower"));
  function_pointers_.CHPFetchSpectrum = reinterpret_cast<CHPFetchSpectrumPtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_CHPFetchSpectrum"));
  function_pointers_.CfgBandClass = reinterpret_cast<CfgBandClassPtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_CfgBandClass"));
  function_pointers_.CfgChannelConfigurationMode = reinterpret_cast<CfgChannelConfigurationModePtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_CfgChannelConfigurationMode"));
  function_pointers_.CfgDigitalEdgeTrigger = reinterpret_cast<CfgDigitalEdgeTriggerPtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_CfgDigitalEdgeTrigger"));
  function_pointers_.CfgExternalAttenuation = reinterpret_cast<CfgExternalAttenuationPtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_CfgExternalAttenuation"));
  function_pointers_.CfgFrequency = reinterpret_cast<CfgFrequencyPtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_CfgFrequency"));
  function_pointers_.CfgFrequencyChannelNumber = reinterpret_cast<CfgFrequencyChannelNumberPtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_CfgFrequencyChannelNumber"));
  function_pointers_.CfgFrequencyReference = reinterpret_cast<CfgFrequencyReferencePtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_CfgFrequencyReference"));
  function_pointers_.CfgIQPowerEdgeTrigger = reinterpret_cast<CfgIQPowerEdgeTriggerPtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_CfgIQPowerEdgeTrigger"));
  function_pointers_.CfgMechanicalAttenuation = reinterpret_cast<CfgMechanicalAttenuationPtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_CfgMechanicalAttenuation"));
  function_pointers_.CfgNumberOfChannels = reinterpret_cast<CfgNumberOfChannelsPtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_CfgNumberOfChannels"));
  function_pointers_.CfgRF = reinterpret_cast<CfgRFPtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_CfgRF"));
  function_pointers_.CfgRFAttenuation = reinterpret_cast<CfgRFAttenuationPtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_CfgRFAttenuation"));
  function_pointers_.CfgRadioConfiguration = reinterpret_cast<CfgRadioConfigurationPtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_CfgRadioConfiguration"));
  function_pointers_.CfgReferenceLevel = reinterpret_cast<CfgReferenceLevelPtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_CfgReferenceLevel"));
  function_pointers_.CfgSoftwareEdgeTrigger = reinterpret_cast<CfgSoftwareEdgeTriggerPtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_CfgSoftwareEdgeTrigger"));
  function_pointers_.CfgUplinkSpreading = reinterpret_cast<CfgUplinkSpreadingPtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_CfgUplinkSpreading"));
  function_pointers_.CfgUserDefinedChannel = reinterpret_cast<CfgUserDefinedChannelPtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_CfgUserDefinedChannel"));
  function_pointers_.CfgUserDefinedChannelArray = reinterpret_cast<CfgUserDefinedChannelArrayPtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_CfgUserDefinedChannelArray"));
  function_pointers_.CheckMeasurementStatus = reinterpret_cast<CheckMeasurementStatusPtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_CheckMeasurementStatus"));
  function_pointers_.ClearAllNamedResults = reinterpret_cast<ClearAllNamedResultsPtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_ClearAllNamedResults"));
  function_pointers_.ClearNamedResult = reinterpret_cast<ClearNamedResultPtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_ClearNamedResult"));
  function_pointers_.CloneSignalConfiguration = reinterpret_cast<CloneSignalConfigurationPtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_CloneSignalConfiguration"));
  function_pointers_.Close = reinterpret_cast<ClosePtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_Close"));
  function_pointers_.Commit = reinterpret_cast<CommitPtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_Commit"));
  function_pointers_.CreateSignalConfiguration = reinterpret_cast<CreateSignalConfigurationPtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_CreateSignalConfiguration"));
  function_pointers_.DeleteSignalConfiguration = reinterpret_cast<DeleteSignalConfigurationPtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_DeleteSignalConfiguration"));
  function_pointers_.DisableTrigger = reinterpret_cast<DisableTriggerPtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_DisableTrigger"));
  function_pointers_.GetAllNamedResultNames = reinterpret_cast<GetAllNamedResultNamesPtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_GetAllNamedResultNames"));
  function_pointers_.GetAttributeF32 = reinterpret_cast<GetAttributeF32Ptr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_GetAttributeF32"));
  function_pointers_.GetAttributeF32Array = reinterpret_cast<GetAttributeF32ArrayPtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_GetAttributeF32Array"));
  function_pointers_.GetAttributeF64 = reinterpret_cast<GetAttributeF64Ptr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_GetAttributeF64"));
  function_pointers_.GetAttributeF64Array = reinterpret_cast<GetAttributeF64ArrayPtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_GetAttributeF64Array"));
  function_pointers_.GetAttributeI16 = reinterpret_cast<GetAttributeI16Ptr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_GetAttributeI16"));
  function_pointers_.GetAttributeI32 = reinterpret_cast<GetAttributeI32Ptr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_GetAttributeI32"));
  function_pointers_.GetAttributeI32Array = reinterpret_cast<GetAttributeI32ArrayPtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_GetAttributeI32Array"));
  function_pointers_.GetAttributeI64 = reinterpret_cast<GetAttributeI64Ptr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_GetAttributeI64"));
  function_pointers_.GetAttributeI64Array = reinterpret_cast<GetAttributeI64ArrayPtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_GetAttributeI64Array"));
  function_pointers_.GetAttributeI8 = reinterpret_cast<GetAttributeI8Ptr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_GetAttributeI8"));
  function_pointers_.GetAttributeI8Array = reinterpret_cast<GetAttributeI8ArrayPtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_GetAttributeI8Array"));
  function_pointers_.GetAttributeNIComplexDoubleArray = reinterpret_cast<GetAttributeNIComplexDoubleArrayPtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_GetAttributeNIComplexDoubleArray"));
  function_pointers_.GetAttributeNIComplexSingleArray = reinterpret_cast<GetAttributeNIComplexSingleArrayPtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_GetAttributeNIComplexSingleArray"));
  function_pointers_.GetAttributeString = reinterpret_cast<GetAttributeStringPtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_GetAttributeString"));
  function_pointers_.GetAttributeU16 = reinterpret_cast<GetAttributeU16Ptr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_GetAttributeU16"));
  function_pointers_.GetAttributeU32 = reinterpret_cast<GetAttributeU32Ptr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_GetAttributeU32"));
  function_pointers_.GetAttributeU32Array = reinterpret_cast<GetAttributeU32ArrayPtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_GetAttributeU32Array"));
  function_pointers_.GetAttributeU64Array = reinterpret_cast<GetAttributeU64ArrayPtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_GetAttributeU64Array"));
  function_pointers_.GetAttributeU8 = reinterpret_cast<GetAttributeU8Ptr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_GetAttributeU8"));
  function_pointers_.GetAttributeU8Array = reinterpret_cast<GetAttributeU8ArrayPtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_GetAttributeU8Array"));
  function_pointers_.GetError = reinterpret_cast<GetErrorPtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_GetError"));
  function_pointers_.GetErrorString = reinterpret_cast<GetErrorStringPtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_GetErrorString"));
  function_pointers_.Initialize = reinterpret_cast<InitializePtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_Initialize"));
  function_pointers_.InitializeFromNIRFSASession = reinterpret_cast<InitializeFromNIRFSASessionPtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_InitializeFromNIRFSASession"));
  function_pointers_.Initiate = reinterpret_cast<InitiatePtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_Initiate"));
  function_pointers_.ModAccCfgSynchronizationModeAndInterval = reinterpret_cast<ModAccCfgSynchronizationModeAndIntervalPtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_ModAccCfgSynchronizationModeAndInterval"));
  function_pointers_.ModAccFetchConstellationTrace = reinterpret_cast<ModAccFetchConstellationTracePtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_ModAccFetchConstellationTrace"));
  function_pointers_.ModAccFetchDetectedChannel = reinterpret_cast<ModAccFetchDetectedChannelPtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_ModAccFetchDetectedChannel"));
  function_pointers_.ModAccFetchDetectedChannelArray = reinterpret_cast<ModAccFetchDetectedChannelArrayPtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_ModAccFetchDetectedChannelArray"));
  function_pointers_.ModAccFetchEVM = reinterpret_cast<ModAccFetchEVMPtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_ModAccFetchEVM"));
  function_pointers_.ModAccFetchEVMTrace = reinterpret_cast<ModAccFetchEVMTracePtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_ModAccFetchEVMTrace"));
  function_pointers_.ModAccFetchIQImpairments = reinterpret_cast<ModAccFetchIQImpairmentsPtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_ModAccFetchIQImpairments"));
  function_pointers_.ModAccFetchMagnitudeErrorTrace = reinterpret_cast<ModAccFetchMagnitudeErrorTracePtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_ModAccFetchMagnitudeErrorTrace"));
  function_pointers_.ModAccFetchNumberOfDetectedChannels = reinterpret_cast<ModAccFetchNumberOfDetectedChannelsPtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_ModAccFetchNumberOfDetectedChannels"));
  function_pointers_.ModAccFetchPeakActiveCDE = reinterpret_cast<ModAccFetchPeakActiveCDEPtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_ModAccFetchPeakActiveCDE"));
  function_pointers_.ModAccFetchPeakCDE = reinterpret_cast<ModAccFetchPeakCDEPtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_ModAccFetchPeakCDE"));
  function_pointers_.ModAccFetchPhaseErrorTrace = reinterpret_cast<ModAccFetchPhaseErrorTracePtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_ModAccFetchPhaseErrorTrace"));
  function_pointers_.OBWCfgAveraging = reinterpret_cast<OBWCfgAveragingPtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_OBWCfgAveraging"));
  function_pointers_.OBWCfgRBWFilter = reinterpret_cast<OBWCfgRBWFilterPtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_OBWCfgRBWFilter"));
  function_pointers_.OBWCfgSweepTime = reinterpret_cast<OBWCfgSweepTimePtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_OBWCfgSweepTime"));
  function_pointers_.OBWFetchMeasurement = reinterpret_cast<OBWFetchMeasurementPtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_OBWFetchMeasurement"));
  function_pointers_.OBWFetchSpectrum = reinterpret_cast<OBWFetchSpectrumPtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_OBWFetchSpectrum"));
  function_pointers_.QEVMCfgAveraging = reinterpret_cast<QEVMCfgAveragingPtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_QEVMCfgAveraging"));
  function_pointers_.QEVMCfgMeasurementLength = reinterpret_cast<QEVMCfgMeasurementLengthPtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_QEVMCfgMeasurementLength"));
  function_pointers_.QEVMFetchConstellationTrace = reinterpret_cast<QEVMFetchConstellationTracePtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_QEVMFetchConstellationTrace"));
  function_pointers_.QEVMFetchEVM = reinterpret_cast<QEVMFetchEVMPtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_QEVMFetchEVM"));
  function_pointers_.QEVMFetchEVMTrace = reinterpret_cast<QEVMFetchEVMTracePtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_QEVMFetchEVMTrace"));
  function_pointers_.QEVMFetchIQImpairments = reinterpret_cast<QEVMFetchIQImpairmentsPtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_QEVMFetchIQImpairments"));
  function_pointers_.QEVMFetchMagnitudeErrorTrace = reinterpret_cast<QEVMFetchMagnitudeErrorTracePtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_QEVMFetchMagnitudeErrorTrace"));
  function_pointers_.QEVMFetchPhaseErrorTrace = reinterpret_cast<QEVMFetchPhaseErrorTracePtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_QEVMFetchPhaseErrorTrace"));
  function_pointers_.ResetAttribute = reinterpret_cast<ResetAttributePtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_ResetAttribute"));
  function_pointers_.ResetToDefault = reinterpret_cast<ResetToDefaultPtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_ResetToDefault"));
  function_pointers_.SEMCfgAveraging = reinterpret_cast<SEMCfgAveragingPtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_SEMCfgAveraging"));
  function_pointers_.SEMCfgSweepTime = reinterpret_cast<SEMCfgSweepTimePtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_SEMCfgSweepTime"));
  function_pointers_.SEMFetchCarrierAbsoluteIntegratedPower = reinterpret_cast<SEMFetchCarrierAbsoluteIntegratedPowerPtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_SEMFetchCarrierAbsoluteIntegratedPower"));
  function_pointers_.SEMFetchLowerOffsetMargin = reinterpret_cast<SEMFetchLowerOffsetMarginPtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_SEMFetchLowerOffsetMargin"));
  function_pointers_.SEMFetchLowerOffsetMarginArray = reinterpret_cast<SEMFetchLowerOffsetMarginArrayPtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_SEMFetchLowerOffsetMarginArray"));
  function_pointers_.SEMFetchLowerOffsetPower = reinterpret_cast<SEMFetchLowerOffsetPowerPtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_SEMFetchLowerOffsetPower"));
  function_pointers_.SEMFetchLowerOffsetPowerArray = reinterpret_cast<SEMFetchLowerOffsetPowerArrayPtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_SEMFetchLowerOffsetPowerArray"));
  function_pointers_.SEMFetchMeasurementStatus = reinterpret_cast<SEMFetchMeasurementStatusPtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_SEMFetchMeasurementStatus"));
  function_pointers_.SEMFetchSpectrum = reinterpret_cast<SEMFetchSpectrumPtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_SEMFetchSpectrum"));
  function_pointers_.SEMFetchUpperOffsetMargin = reinterpret_cast<SEMFetchUpperOffsetMarginPtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_SEMFetchUpperOffsetMargin"));
  function_pointers_.SEMFetchUpperOffsetMarginArray = reinterpret_cast<SEMFetchUpperOffsetMarginArrayPtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_SEMFetchUpperOffsetMarginArray"));
  function_pointers_.SEMFetchUpperOffsetPower = reinterpret_cast<SEMFetchUpperOffsetPowerPtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_SEMFetchUpperOffsetPower"));
  function_pointers_.SEMFetchUpperOffsetPowerArray = reinterpret_cast<SEMFetchUpperOffsetPowerArrayPtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_SEMFetchUpperOffsetPowerArray"));
  function_pointers_.SelectMeasurements = reinterpret_cast<SelectMeasurementsPtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_SelectMeasurements"));
  function_pointers_.SendSoftwareEdgeTrigger = reinterpret_cast<SendSoftwareEdgeTriggerPtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_SendSoftwareEdgeTrigger"));
  function_pointers_.SetAttributeF32 = reinterpret_cast<SetAttributeF32Ptr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_SetAttributeF32"));
  function_pointers_.SetAttributeF32Array = reinterpret_cast<SetAttributeF32ArrayPtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_SetAttributeF32Array"));
  function_pointers_.SetAttributeF64 = reinterpret_cast<SetAttributeF64Ptr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_SetAttributeF64"));
  function_pointers_.SetAttributeF64Array = reinterpret_cast<SetAttributeF64ArrayPtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_SetAttributeF64Array"));
  function_pointers_.SetAttributeI16 = reinterpret_cast<SetAttributeI16Ptr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_SetAttributeI16"));
  function_pointers_.SetAttributeI32 = reinterpret_cast<SetAttributeI32Ptr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_SetAttributeI32"));
  function_pointers_.SetAttributeI32Array = reinterpret_cast<SetAttributeI32ArrayPtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_SetAttributeI32Array"));
  function_pointers_.SetAttributeI64 = reinterpret_cast<SetAttributeI64Ptr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_SetAttributeI64"));
  function_pointers_.SetAttributeI64Array = reinterpret_cast<SetAttributeI64ArrayPtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_SetAttributeI64Array"));
  function_pointers_.SetAttributeI8 = reinterpret_cast<SetAttributeI8Ptr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_SetAttributeI8"));
  function_pointers_.SetAttributeI8Array = reinterpret_cast<SetAttributeI8ArrayPtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_SetAttributeI8Array"));
  function_pointers_.SetAttributeNIComplexDoubleArray = reinterpret_cast<SetAttributeNIComplexDoubleArrayPtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_SetAttributeNIComplexDoubleArray"));
  function_pointers_.SetAttributeNIComplexSingleArray = reinterpret_cast<SetAttributeNIComplexSingleArrayPtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_SetAttributeNIComplexSingleArray"));
  function_pointers_.SetAttributeString = reinterpret_cast<SetAttributeStringPtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_SetAttributeString"));
  function_pointers_.SetAttributeU16 = reinterpret_cast<SetAttributeU16Ptr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_SetAttributeU16"));
  function_pointers_.SetAttributeU32 = reinterpret_cast<SetAttributeU32Ptr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_SetAttributeU32"));
  function_pointers_.SetAttributeU32Array = reinterpret_cast<SetAttributeU32ArrayPtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_SetAttributeU32Array"));
  function_pointers_.SetAttributeU64Array = reinterpret_cast<SetAttributeU64ArrayPtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_SetAttributeU64Array"));
  function_pointers_.SetAttributeU8 = reinterpret_cast<SetAttributeU8Ptr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_SetAttributeU8"));
  function_pointers_.SetAttributeU8Array = reinterpret_cast<SetAttributeU8ArrayPtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_SetAttributeU8Array"));
  function_pointers_.SlotPhaseCfgSynchronizationModeAndInterval = reinterpret_cast<SlotPhaseCfgSynchronizationModeAndIntervalPtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_SlotPhaseCfgSynchronizationModeAndInterval"));
  function_pointers_.SlotPhaseFetchChipPhaseErrorLinearFitTrace = reinterpret_cast<SlotPhaseFetchChipPhaseErrorLinearFitTracePtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_SlotPhaseFetchChipPhaseErrorLinearFitTrace"));
  function_pointers_.SlotPhaseFetchChipPhaseErrorTrace = reinterpret_cast<SlotPhaseFetchChipPhaseErrorTracePtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_SlotPhaseFetchChipPhaseErrorTrace"));
  function_pointers_.SlotPhaseFetchMaximumPhaseDiscontinuity = reinterpret_cast<SlotPhaseFetchMaximumPhaseDiscontinuityPtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_SlotPhaseFetchMaximumPhaseDiscontinuity"));
  function_pointers_.SlotPhaseFetchPhaseDiscontinuities = reinterpret_cast<SlotPhaseFetchPhaseDiscontinuitiesPtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_SlotPhaseFetchPhaseDiscontinuities"));
  function_pointers_.SlotPowerCfgSynchronizationModeAndInterval = reinterpret_cast<SlotPowerCfgSynchronizationModeAndIntervalPtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_SlotPowerCfgSynchronizationModeAndInterval"));
  function_pointers_.SlotPowerFetchPowers = reinterpret_cast<SlotPowerFetchPowersPtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_SlotPowerFetchPowers"));
  function_pointers_.WaitForAcquisitionComplete = reinterpret_cast<WaitForAcquisitionCompletePtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_WaitForAcquisitionComplete"));
  function_pointers_.WaitForMeasurementComplete = reinterpret_cast<WaitForMeasurementCompletePtr>(p_shared_library_->get_function_pointer("RFmxCDMA2k_WaitForMeasurementComplete"));
}
