...
class NiRFmxInstrLibrary : public nirfmxinstr_grpc::NiRFmxInstrLibraryInterface {
 public:
  ...
  int32 CfgExternalAttenuationInterpolationLinear(niRFmxInstrHandle instrument, char selectorString[], char tableName[], int32 format);
  int32 CfgExternalAttenuationInterpolationNearest(niRFmxInstrHandle instrument, char selectorString[], char tableName[]);
  int32 CfgExternalAttenuationInterpolationSpline(niRFmxInstrHandle instrument, char selectorString[], char tableName[]);
  int32 CfgExternalAttenuationTable(niRFmxInstrHandle instrument, char selectorString[], char tableName[], float64 frequency[], float64 externalAttenuation[], int32 arraySize);
  ...
  int32 CfgSParameterExternalAttenuationTable(niRFmxInstrHandle instrument, char selectorString[], char tableName[], float64 frequency[], int32 frequencyArraySize, NIComplexDouble sParameters[], int32 sParameterTableSize, int32 numberOfPorts, int32 sParameterOrientation);
  int32 CfgSParameterExternalAttenuationType(niRFmxInstrHandle instrument, char selectorString[], int32 sParameterType);
  int32 CheckAcquisitionStatus(niRFmxInstrHandle instrument, int32* acquisitionDone);
  int32 CheckIfListExists(niRFmxInstrHandle instrument, char listName[], int32* listExists, int32* personality);
  int32 CheckIfSignalConfigurationExists(niRFmxInstrHandle instrument, char signalName[], int32* signalConfigurationExists, int32* personality);
  int32 Close(niRFmxInstrHandle instrument, int32 forceDestroy);
  int32 DeleteAllExternalAttenuationTables(niRFmxInstrHandle instrument, char selectorString[]);
  int32 DeleteExternalAttenuationTable(niRFmxInstrHandle instrument, char selectorString[], char tableName[]);
  int32 DisableCalibrationPlane(niRFmxInstrHandle instrument, char selectorString[]);
  int32 EnableCalibrationPlane(niRFmxInstrHandle instrument, char selectorString[]);
  int32 ExportSignal(niRFmxInstrHandle instrument, int32 exportSignalSource, char exportSignalOutputTerminal[]);
  int32 GetAttributeF32(niRFmxInstrHandle instrument, char channelName[], int32 attributeID, float32* attrVal);
  int32 GetAttributeF32Array(niRFmxInstrHandle instrument, char channelName[], int32 attributeID, float32 attrVal[], int32 arraySize, int32* actualArraySize);
  int32 GetAttributeF64(niRFmxInstrHandle instrument, char channelName[], int32 attributeID, float64* attrVal);
  int32 GetAttributeF64Array(niRFmxInstrHandle instrument, char channelName[], int32 attributeID, float64 attrVal[], int32 arraySize, int32* actualArraySize);
  int32 GetAttributeI16(niRFmxInstrHandle instrument, char channelName[], int32 attributeID, int16* attrVal);
  int32 GetAttributeI32(niRFmxInstrHandle instrument, char channelName[], int32 attributeID, int32* attrVal);
  int32 GetAttributeI32Array(niRFmxInstrHandle instrument, char channelName[], int32 attributeID, int32 attrVal[], int32 arraySize, int32* actualArraySize);
  int32 GetAttributeI64(niRFmxInstrHandle instrument, char channelName[], int32 attributeID, int64* attrVal);
  int32 GetAttributeI64Array(niRFmxInstrHandle instrument, char channelName[], int32 attributeID, int64 attrVal[], int32 arraySize, int32* actualArraySize);
  int32 GetAttributeI8(niRFmxInstrHandle instrument, char channelName[], int32 attributeID, int8* attrVal);
  int32 GetAttributeI8Array(niRFmxInstrHandle instrument, char channelName[], int32 attributeID, int8 attrVal[], int32 arraySize, int32* actualArraySize);
  int32 GetAttributeNIComplexDoubleArray(niRFmxInstrHandle instrument, char channelName[], int32 attributeID, NIComplexDouble attrVal[], int32 arraySize, int32* actualArraySize);
  int32 GetAttributeNIComplexSingleArray(niRFmxInstrHandle instrument, char channelName[], int32 attributeID, NIComplexSingle attrVal[], int32 arraySize, int32* actualArraySize);
  int32 GetAttributeString(niRFmxInstrHandle instrument, char channelName[], int32 attributeID, int32 arraySize, char attrVal[]);
  int32 GetAttributeU16(niRFmxInstrHandle instrument, char channelName[], int32 attributeID, uInt16* attrVal);
  int32 GetAttributeU32(niRFmxInstrHandle instrument, char channelName[], int32 attributeID, uInt32* attrVal);
  int32 GetAttributeU32Array(niRFmxInstrHandle instrument, char channelName[], int32 attributeID, uInt32 attrVal[], int32 arraySize, int32* actualArraySize);
  int32 GetAttributeU64Array(niRFmxInstrHandle instrument, char channelName[], int32 attributeID, uInt64 attrVal[], int32 arraySize, int32* actualArraySize);
  int32 GetAttributeU8(niRFmxInstrHandle instrument, char channelName[], int32 attributeID, uInt8* attrVal);
  int32 GetAttributeU8Array(niRFmxInstrHandle instrument, char channelName[], int32 attributeID, uInt8 attrVal[], int32 arraySize, int32* actualArraySize);
  int32 GetAvailablePorts(niRFmxInstrHandle instrument, char selectorString[], int32 arraySize, char availablePorts[]);
  ...
  int32 GetExternalAttenuationTableActualValue(niRFmxInstrHandle instrument, char selectorString[], float64* externalAttenuation);
  int32 GetNIRFSASession(niRFmxInstrHandle instrument, uInt32* niRfsaSession);
  int32 GetNIRFSASessionArray(niRFmxInstrHandle instrument, uInt32 nirfsaSessions[], int32 arraySize, int32* actualArraySize);
  int32 GetSelfCalibrateLastDateAndTime(niRFmxInstrHandle instrument, char selectorString[], int64 selfCalibrateStep, CVIAbsoluteTime* timestamp);
  int32 GetSelfCalibrateLastTemperature(niRFmxInstrHandle instrument, char selectorString[], int64 selfCalibrateStep, float64* temperature);
  ...
  int32 InitializeFromNIRFSASessionArray(uInt32 nirfsaSessions[], int32 numberOfNIRFSASessions, niRFmxInstrHandle* instrument);
  int32 IsSelfCalibrateValid(niRFmxInstrHandle instrument, char selectorString[], int32* selfCalibrateValid, int32* validSteps);
  int32 LoadAllConfigurations(niRFmxInstrHandle instrument, char filePath[], int32 loadRFInstrConfiguration);
  int32 LoadSParameterExternalAttenuationTableFromS2PFile(niRFmxInstrHandle instrument, char selectorString[], char tableName[], char s2PFilePath[], int32 sParameterOrientation);
  int32 ResetAttribute(niRFmxInstrHandle instrument, char channelName[], int32 attributeID);
  int32 ResetDriver(niRFmxInstrHandle instrument);
  int32 ResetEntireSession(niRFmxInstrHandle instrument);
  int32 ResetToDefault(niRFmxInstrHandle instrument);
  int32 SaveAllConfigurations(niRFmxInstrHandle instrument, char filePath[]);
  int32 SelectActiveExternalAttenuationTable(niRFmxInstrHandle instrument, char selectorString[], char tableName[]);
  int32 SelfCalibrate(niRFmxInstrHandle instrument, char selectorString[], int32 stepsToOmit);
  int32 SelfCalibrateRange(niRFmxInstrHandle instrument, char selectorString[], int32 stepsToOmit, float64 minimumFrequency, float64 maximumFrequency, float64 minimumReferenceLevel, float64 maximumReferenceLevel);
  int32 SendSoftwareEdgeAdvanceTrigger(niRFmxInstrHandle instrument);
  int32 SendSoftwareEdgeStartTrigger(niRFmxInstrHandle instrument);
  int32 SetAttributeF32(niRFmxInstrHandle instrument, char channelName[], int32 attributeID, float32 attrVal);
  int32 SetAttributeF32Array(niRFmxInstrHandle instrument, char channelName[], int32 attributeID, float32 attrVal[], int32 arraySize);
  int32 SetAttributeF64(niRFmxInstrHandle instrument, char channelName[], int32 attributeID, float64 attrVal);
  int32 SetAttributeF64Array(niRFmxInstrHandle instrument, char channelName[], int32 attributeID, float64 attrVal[], int32 arraySize);
  int32 SetAttributeI16(niRFmxInstrHandle instrument, char channelName[], int32 attributeID, int16 attrVal);
  int32 SetAttributeI32(niRFmxInstrHandle instrument, char channelName[], int32 attributeID, int32 attrVal);
  int32 SetAttributeI32Array(niRFmxInstrHandle instrument, char channelName[], int32 attributeID, int32 attrVal[], int32 arraySize);
  int32 SetAttributeI64(niRFmxInstrHandle instrument, char channelName[], int32 attributeID, int64 attrVal);
  int32 SetAttributeI64Array(niRFmxInstrHandle instrument, char channelName[], int32 attributeID, int64 attrVal[], int32 arraySize);
  int32 SetAttributeI8(niRFmxInstrHandle instrument, char channelName[], int32 attributeID, int8 attrVal);
  int32 SetAttributeI8Array(niRFmxInstrHandle instrument, char channelName[], int32 attributeID, int8 attrVal[], int32 arraySize);
  int32 SetAttributeNIComplexDoubleArray(niRFmxInstrHandle instrument, char channelName[], int32 attributeID, NIComplexDouble attrVal[], int32 arraySize);
  int32 SetAttributeNIComplexSingleArray(niRFmxInstrHandle instrument, char channelName[], int32 attributeID, NIComplexSingle attrVal[], int32 arraySize);
  int32 SetAttributeString(niRFmxInstrHandle instrument, char channelName[], int32 attributeID, char attrVal[]);
  int32 SetAttributeU16(niRFmxInstrHandle instrument, char channelName[], int32 attributeID, uInt16 attrVal);
  int32 SetAttributeU32(niRFmxInstrHandle instrument, char channelName[], int32 attributeID, uInt32 attrVal);
  int32 SetAttributeU32Array(niRFmxInstrHandle instrument, char channelName[], int32 attributeID, uInt32 attrVal[], int32 arraySize);
  int32 SetAttributeU64Array(niRFmxInstrHandle instrument, char channelName[], int32 attributeID, uInt64 attrVal[], int32 arraySize);
  int32 SetAttributeU8(niRFmxInstrHandle instrument, char channelName[], int32 attributeID, uInt8 attrVal);
  int32 SetAttributeU8Array(niRFmxInstrHandle instrument, char channelName[], int32 attributeID, uInt8 attrVal[], int32 arraySize);
