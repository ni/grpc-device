...
CfgFrequencyReferenceResponse cfg_frequency_reference(const StubPtr& stub, const nidevice_grpc::Session& instrument, const pb::string& channel_name, const pb::string& frequency_reference_source, const double& frequency_reference_frequency);
CfgMechanicalAttenuationResponse cfg_mechanical_attenuation(const StubPtr& stub, const nidevice_grpc::Session& instrument, const pb::string& channel_name, const pb::int32& mechanical_attenuation_auto, const double& mechanical_attenuation_value);
CfgRFAttenuationResponse cfg_rf_attenuation(const StubPtr& stub, const nidevice_grpc::Session& instrument, const pb::string& channel_name, const pb::int32& rf_attenuation_auto, const double& rf_attenuation_value);
...
CfgSParameterExternalAttenuationTypeResponse cfg_s_parameter_external_attenuation_type(const StubPtr& stub, const nidevice_grpc::Session& instrument, const pb::string& selector_string, const pb::int32& s_parameter_type);
...
CloseResponse close(const StubPtr& stub, const nidevice_grpc::Session& instrument, const pb::int32& force_destroy);
...
ExportSignalResponse export_signal(const StubPtr& stub, const nidevice_grpc::Session& instrument, const pb::int32& export_signal_source, const pb::string& export_signal_output_terminal);
...
LoadSParameterExternalAttenuationTableFromS2PFileResponse load_s_parameter_external_attenuation_table_from_s2p_file(const StubPtr& stub, const nidevice_grpc::Session& instrument, const pb::string& selector_string, const pb::string& table_name, const pb::string& s2_p_file_path, const pb::int32& s_parameter_orientation);
...
SelfCalibrateResponse self_calibrate(const StubPtr& stub, const nidevice_grpc::Session& instrument, const pb::string& selector_string, const pb::int32& steps_to_omit);
SelfCalibrateRangeResponse self_calibrate_range(const StubPtr& stub, const nidevice_grpc::Session& instrument, const pb::string& selector_string, const pb::int32& steps_to_omit, const double& minimum_frequency, const double& maximum_frequency, const double& minimum_reference_level, const double& maximum_reference_level);
...
SetAttributeStringResponse set_attribute_string(const StubPtr& stub, const nidevice_grpc::Session& instrument, const pb::string& channel_name, const NiRFmxInstrAttribute& attribute_id, const pb::string& attr_val);
