...
private:
  ...
  ::grpc::Status ConvertApiErrorStatusForFakeHandle(google::protobuf::int32 status, FakeHandle handle);
  ::grpc::Status ConvertApiErrorStatusForSecondarySessionHandle(google::protobuf::int32 status, SecondarySessionHandle handle);
