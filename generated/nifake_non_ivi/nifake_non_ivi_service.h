...
private:
  ...
  ::grpc::Status ConvertApiErrorStatusForFakeHandle(::grpc::ServerContext* context, google::protobuf::int32 status, FakeHandle handle);
  ::grpc::Status ConvertApiErrorStatusForSecondarySessionHandle(::grpc::ServerContext* context, google::protobuf::int32 status, SecondarySessionHandle handle);
