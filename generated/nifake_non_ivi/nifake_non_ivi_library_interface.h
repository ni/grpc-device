...
class NiFakeNonIviLibraryInterface {
 public:
  ...
  virtual int32 OutputArraysWithNarrowIntegerTypes(int32 numberOfU16Samples, uInt16 u16Data[], int32 numberOfI16Samples, int16 i16Data[], int32 numberOfI8Samples, int8 i8Data[]) = 0;
  virtual int32 InputArrayOfBytes(const uInt8* u8Array) = 0;
  virtual int32 OutputArrayOfBytes(int32 numberOfU8Samples, uInt8 u8Data[]) = 0;
};
