...
class NiFakeNonIviLibraryInterface {
 public:
  ...
  virtual int32 InputVarArgs(const char inputName[], const char channelName[], int32 color, const char myString0[], int32 myEnum0, const char myString1[], int32 myEnum1, const char myString2[], int32 myEnum2) = 0;
};
