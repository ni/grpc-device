...
NiRFmxGSMLibrary::NiRFmxGSMLibrary(std::shared_ptr<nidevice_grpc::SharedLibraryInterface> pSharedLibrary) : p_shared_library_(pSharedLibrary)
{
  ...
  function_pointers_.AbortMeasurements = reinterpret_cast<AbortMeasurementsPtr>(p_shared_library_->get_function_pointer("RFmxGSM_AbortMeasurements"));
  function_pointers_.AnalyzeIQ1Waveform = reinterpret_cast<AnalyzeIQ1WaveformPtr>(p_shared_library_->get_function_pointer("RFmxGSM_AnalyzeIQ1Waveform"));
  function_pointers_.AutoLevel = reinterpret_cast<AutoLevelPtr>(p_shared_library_->get_function_pointer("RFmxGSM_AutoLevel"));
  function_pointers_.BuildOffsetString = reinterpret_cast<BuildOffsetStringPtr>(p_shared_library_->get_function_pointer("RFmxGSM_BuildOffsetString"));
  function_pointers_.BuildSignalString = reinterpret_cast<BuildSignalStringPtr>(p_shared_library_->get_function_pointer("RFmxGSM_BuildSignalString"));
  function_pointers_.BuildSlotString = reinterpret_cast<BuildSlotStringPtr>(p_shared_library_->get_function_pointer("RFmxGSM_BuildSlotString"));
  function_pointers_.CfgAutoTSCDetectionEnabled = reinterpret_cast<CfgAutoTSCDetectionEnabledPtr>(p_shared_library_->get_function_pointer("RFmxGSM_CfgAutoTSCDetectionEnabled"));
  function_pointers_.CfgBand = reinterpret_cast<CfgBandPtr>(p_shared_library_->get_function_pointer("RFmxGSM_CfgBand"));
  function_pointers_.CfgBurstSynchronizationType = reinterpret_cast<CfgBurstSynchronizationTypePtr>(p_shared_library_->get_function_pointer("RFmxGSM_CfgBurstSynchronizationType"));
  function_pointers_.CfgDigitalEdgeTrigger = reinterpret_cast<CfgDigitalEdgeTriggerPtr>(p_shared_library_->get_function_pointer("RFmxGSM_CfgDigitalEdgeTrigger"));
  function_pointers_.CfgExternalAttenuation = reinterpret_cast<CfgExternalAttenuationPtr>(p_shared_library_->get_function_pointer("RFmxGSM_CfgExternalAttenuation"));
  function_pointers_.CfgFrequency = reinterpret_cast<CfgFrequencyPtr>(p_shared_library_->get_function_pointer("RFmxGSM_CfgFrequency"));
  function_pointers_.CfgFrequencyARFCN = reinterpret_cast<CfgFrequencyARFCNPtr>(p_shared_library_->get_function_pointer("RFmxGSM_CfgFrequencyARFCN"));
  function_pointers_.CfgFrequencyReference = reinterpret_cast<CfgFrequencyReferencePtr>(p_shared_library_->get_function_pointer("RFmxGSM_CfgFrequencyReference"));
  function_pointers_.CfgIQPowerEdgeTrigger = reinterpret_cast<CfgIQPowerEdgeTriggerPtr>(p_shared_library_->get_function_pointer("RFmxGSM_CfgIQPowerEdgeTrigger"));
  function_pointers_.CfgLinkDirection = reinterpret_cast<CfgLinkDirectionPtr>(p_shared_library_->get_function_pointer("RFmxGSM_CfgLinkDirection"));
  function_pointers_.CfgMechanicalAttenuation = reinterpret_cast<CfgMechanicalAttenuationPtr>(p_shared_library_->get_function_pointer("RFmxGSM_CfgMechanicalAttenuation"));
  function_pointers_.CfgNumberOfTimeslots = reinterpret_cast<CfgNumberOfTimeslotsPtr>(p_shared_library_->get_function_pointer("RFmxGSM_CfgNumberOfTimeslots"));
  function_pointers_.CfgPowerControlLevel = reinterpret_cast<CfgPowerControlLevelPtr>(p_shared_library_->get_function_pointer("RFmxGSM_CfgPowerControlLevel"));
  function_pointers_.CfgRF = reinterpret_cast<CfgRFPtr>(p_shared_library_->get_function_pointer("RFmxGSM_CfgRF"));
  function_pointers_.CfgRFAttenuation = reinterpret_cast<CfgRFAttenuationPtr>(p_shared_library_->get_function_pointer("RFmxGSM_CfgRFAttenuation"));
  function_pointers_.CfgReferenceLevel = reinterpret_cast<CfgReferenceLevelPtr>(p_shared_library_->get_function_pointer("RFmxGSM_CfgReferenceLevel"));
  function_pointers_.CfgSignalType = reinterpret_cast<CfgSignalTypePtr>(p_shared_library_->get_function_pointer("RFmxGSM_CfgSignalType"));
  function_pointers_.CfgSoftwareEdgeTrigger = reinterpret_cast<CfgSoftwareEdgeTriggerPtr>(p_shared_library_->get_function_pointer("RFmxGSM_CfgSoftwareEdgeTrigger"));
  function_pointers_.CfgTSC = reinterpret_cast<CfgTSCPtr>(p_shared_library_->get_function_pointer("RFmxGSM_CfgTSC"));
  function_pointers_.CheckMeasurementStatus = reinterpret_cast<CheckMeasurementStatusPtr>(p_shared_library_->get_function_pointer("RFmxGSM_CheckMeasurementStatus"));
  function_pointers_.ClearAllNamedResults = reinterpret_cast<ClearAllNamedResultsPtr>(p_shared_library_->get_function_pointer("RFmxGSM_ClearAllNamedResults"));
  function_pointers_.ClearNamedResult = reinterpret_cast<ClearNamedResultPtr>(p_shared_library_->get_function_pointer("RFmxGSM_ClearNamedResult"));
  function_pointers_.CloneSignalConfiguration = reinterpret_cast<CloneSignalConfigurationPtr>(p_shared_library_->get_function_pointer("RFmxGSM_CloneSignalConfiguration"));
  function_pointers_.Close = reinterpret_cast<ClosePtr>(p_shared_library_->get_function_pointer("RFmxGSM_Close"));
  function_pointers_.Commit = reinterpret_cast<CommitPtr>(p_shared_library_->get_function_pointer("RFmxGSM_Commit"));
  function_pointers_.CreateSignalConfiguration = reinterpret_cast<CreateSignalConfigurationPtr>(p_shared_library_->get_function_pointer("RFmxGSM_CreateSignalConfiguration"));
  function_pointers_.DeleteSignalConfiguration = reinterpret_cast<DeleteSignalConfigurationPtr>(p_shared_library_->get_function_pointer("RFmxGSM_DeleteSignalConfiguration"));
  function_pointers_.DisableTrigger = reinterpret_cast<DisableTriggerPtr>(p_shared_library_->get_function_pointer("RFmxGSM_DisableTrigger"));
  function_pointers_.GetAllNamedResultNames = reinterpret_cast<GetAllNamedResultNamesPtr>(p_shared_library_->get_function_pointer("RFmxGSM_GetAllNamedResultNames"));
  function_pointers_.GetAttributeF32 = reinterpret_cast<GetAttributeF32Ptr>(p_shared_library_->get_function_pointer("RFmxGSM_GetAttributeF32"));
  function_pointers_.GetAttributeF32Array = reinterpret_cast<GetAttributeF32ArrayPtr>(p_shared_library_->get_function_pointer("RFmxGSM_GetAttributeF32Array"));
  function_pointers_.GetAttributeF64 = reinterpret_cast<GetAttributeF64Ptr>(p_shared_library_->get_function_pointer("RFmxGSM_GetAttributeF64"));
  function_pointers_.GetAttributeF64Array = reinterpret_cast<GetAttributeF64ArrayPtr>(p_shared_library_->get_function_pointer("RFmxGSM_GetAttributeF64Array"));
  function_pointers_.GetAttributeI16 = reinterpret_cast<GetAttributeI16Ptr>(p_shared_library_->get_function_pointer("RFmxGSM_GetAttributeI16"));
  function_pointers_.GetAttributeI32 = reinterpret_cast<GetAttributeI32Ptr>(p_shared_library_->get_function_pointer("RFmxGSM_GetAttributeI32"));
  function_pointers_.GetAttributeI32Array = reinterpret_cast<GetAttributeI32ArrayPtr>(p_shared_library_->get_function_pointer("RFmxGSM_GetAttributeI32Array"));
  function_pointers_.GetAttributeI64 = reinterpret_cast<GetAttributeI64Ptr>(p_shared_library_->get_function_pointer("RFmxGSM_GetAttributeI64"));
  function_pointers_.GetAttributeI64Array = reinterpret_cast<GetAttributeI64ArrayPtr>(p_shared_library_->get_function_pointer("RFmxGSM_GetAttributeI64Array"));
  function_pointers_.GetAttributeI8 = reinterpret_cast<GetAttributeI8Ptr>(p_shared_library_->get_function_pointer("RFmxGSM_GetAttributeI8"));
  function_pointers_.GetAttributeI8Array = reinterpret_cast<GetAttributeI8ArrayPtr>(p_shared_library_->get_function_pointer("RFmxGSM_GetAttributeI8Array"));
  function_pointers_.GetAttributeNIComplexDoubleArray = reinterpret_cast<GetAttributeNIComplexDoubleArrayPtr>(p_shared_library_->get_function_pointer("RFmxGSM_GetAttributeNIComplexDoubleArray"));
  function_pointers_.GetAttributeNIComplexSingleArray = reinterpret_cast<GetAttributeNIComplexSingleArrayPtr>(p_shared_library_->get_function_pointer("RFmxGSM_GetAttributeNIComplexSingleArray"));
  function_pointers_.GetAttributeString = reinterpret_cast<GetAttributeStringPtr>(p_shared_library_->get_function_pointer("RFmxGSM_GetAttributeString"));
  function_pointers_.GetAttributeU16 = reinterpret_cast<GetAttributeU16Ptr>(p_shared_library_->get_function_pointer("RFmxGSM_GetAttributeU16"));
  function_pointers_.GetAttributeU32 = reinterpret_cast<GetAttributeU32Ptr>(p_shared_library_->get_function_pointer("RFmxGSM_GetAttributeU32"));
  function_pointers_.GetAttributeU32Array = reinterpret_cast<GetAttributeU32ArrayPtr>(p_shared_library_->get_function_pointer("RFmxGSM_GetAttributeU32Array"));
  function_pointers_.GetAttributeU64Array = reinterpret_cast<GetAttributeU64ArrayPtr>(p_shared_library_->get_function_pointer("RFmxGSM_GetAttributeU64Array"));
  function_pointers_.GetAttributeU8 = reinterpret_cast<GetAttributeU8Ptr>(p_shared_library_->get_function_pointer("RFmxGSM_GetAttributeU8"));
  function_pointers_.GetAttributeU8Array = reinterpret_cast<GetAttributeU8ArrayPtr>(p_shared_library_->get_function_pointer("RFmxGSM_GetAttributeU8Array"));
  function_pointers_.GetError = reinterpret_cast<GetErrorPtr>(p_shared_library_->get_function_pointer("RFmxGSM_GetError"));
  function_pointers_.GetErrorString = reinterpret_cast<GetErrorStringPtr>(p_shared_library_->get_function_pointer("RFmxGSM_GetErrorString"));
  function_pointers_.Initialize = reinterpret_cast<InitializePtr>(p_shared_library_->get_function_pointer("RFmxGSM_Initialize"));
  function_pointers_.InitializeFromNIRFSASession = reinterpret_cast<InitializeFromNIRFSASessionPtr>(p_shared_library_->get_function_pointer("RFmxGSM_InitializeFromNIRFSASession"));
  function_pointers_.Initiate = reinterpret_cast<InitiatePtr>(p_shared_library_->get_function_pointer("RFmxGSM_Initiate"));
  function_pointers_.ModAccCfgAveraging = reinterpret_cast<ModAccCfgAveragingPtr>(p_shared_library_->get_function_pointer("RFmxGSM_ModAccCfgAveraging"));
  function_pointers_.ModAccCfgDroopCompensationEnabled = reinterpret_cast<ModAccCfgDroopCompensationEnabledPtr>(p_shared_library_->get_function_pointer("RFmxGSM_ModAccCfgDroopCompensationEnabled"));
  function_pointers_.ModAccFetchConstellationTrace = reinterpret_cast<ModAccFetchConstellationTracePtr>(p_shared_library_->get_function_pointer("RFmxGSM_ModAccFetchConstellationTrace"));
  function_pointers_.ModAccFetchDemodulatedBits = reinterpret_cast<ModAccFetchDemodulatedBitsPtr>(p_shared_library_->get_function_pointer("RFmxGSM_ModAccFetchDemodulatedBits"));
  function_pointers_.ModAccFetchDetectedTSC = reinterpret_cast<ModAccFetchDetectedTSCPtr>(p_shared_library_->get_function_pointer("RFmxGSM_ModAccFetchDetectedTSC"));
  function_pointers_.ModAccFetchDetectedTSCArray = reinterpret_cast<ModAccFetchDetectedTSCArrayPtr>(p_shared_library_->get_function_pointer("RFmxGSM_ModAccFetchDetectedTSCArray"));
  function_pointers_.ModAccFetchEVM = reinterpret_cast<ModAccFetchEVMPtr>(p_shared_library_->get_function_pointer("RFmxGSM_ModAccFetchEVM"));
  function_pointers_.ModAccFetchEVMAmplitudeDroop = reinterpret_cast<ModAccFetchEVMAmplitudeDroopPtr>(p_shared_library_->get_function_pointer("RFmxGSM_ModAccFetchEVMAmplitudeDroop"));
  function_pointers_.ModAccFetchEVMMagnitudeError = reinterpret_cast<ModAccFetchEVMMagnitudeErrorPtr>(p_shared_library_->get_function_pointer("RFmxGSM_ModAccFetchEVMMagnitudeError"));
  function_pointers_.ModAccFetchEVMPhaseError = reinterpret_cast<ModAccFetchEVMPhaseErrorPtr>(p_shared_library_->get_function_pointer("RFmxGSM_ModAccFetchEVMPhaseError"));
  function_pointers_.ModAccFetchEVMTrace = reinterpret_cast<ModAccFetchEVMTracePtr>(p_shared_library_->get_function_pointer("RFmxGSM_ModAccFetchEVMTrace"));
  function_pointers_.ModAccFetchIQImpairments = reinterpret_cast<ModAccFetchIQImpairmentsPtr>(p_shared_library_->get_function_pointer("RFmxGSM_ModAccFetchIQImpairments"));
  function_pointers_.ModAccFetchMagnitudeErrorTrace = reinterpret_cast<ModAccFetchMagnitudeErrorTracePtr>(p_shared_library_->get_function_pointer("RFmxGSM_ModAccFetchMagnitudeErrorTrace"));
  function_pointers_.ModAccFetchPFER = reinterpret_cast<ModAccFetchPFERPtr>(p_shared_library_->get_function_pointer("RFmxGSM_ModAccFetchPFER"));
  function_pointers_.ModAccFetchPhaseErrorTrace = reinterpret_cast<ModAccFetchPhaseErrorTracePtr>(p_shared_library_->get_function_pointer("RFmxGSM_ModAccFetchPhaseErrorTrace"));
  function_pointers_.ORFSCfgAveraging = reinterpret_cast<ORFSCfgAveragingPtr>(p_shared_library_->get_function_pointer("RFmxGSM_ORFSCfgAveraging"));
  function_pointers_.ORFSCfgEvaluationSymbols = reinterpret_cast<ORFSCfgEvaluationSymbolsPtr>(p_shared_library_->get_function_pointer("RFmxGSM_ORFSCfgEvaluationSymbols"));
  function_pointers_.ORFSCfgMeasurementType = reinterpret_cast<ORFSCfgMeasurementTypePtr>(p_shared_library_->get_function_pointer("RFmxGSM_ORFSCfgMeasurementType"));
  function_pointers_.ORFSCfgModulationCustomOffsetFrequencyArray = reinterpret_cast<ORFSCfgModulationCustomOffsetFrequencyArrayPtr>(p_shared_library_->get_function_pointer("RFmxGSM_ORFSCfgModulationCustomOffsetFrequencyArray"));
  function_pointers_.ORFSCfgNoiseCompensationEnabled = reinterpret_cast<ORFSCfgNoiseCompensationEnabledPtr>(p_shared_library_->get_function_pointer("RFmxGSM_ORFSCfgNoiseCompensationEnabled"));
  function_pointers_.ORFSCfgOffsetFrequencyMode = reinterpret_cast<ORFSCfgOffsetFrequencyModePtr>(p_shared_library_->get_function_pointer("RFmxGSM_ORFSCfgOffsetFrequencyMode"));
  function_pointers_.ORFSCfgSwitchingCustomOffsetFrequencyArray = reinterpret_cast<ORFSCfgSwitchingCustomOffsetFrequencyArrayPtr>(p_shared_library_->get_function_pointer("RFmxGSM_ORFSCfgSwitchingCustomOffsetFrequencyArray"));
  function_pointers_.ORFSFetchModulationPowerTrace = reinterpret_cast<ORFSFetchModulationPowerTracePtr>(p_shared_library_->get_function_pointer("RFmxGSM_ORFSFetchModulationPowerTrace"));
  function_pointers_.ORFSFetchModulationResultsArray = reinterpret_cast<ORFSFetchModulationResultsArrayPtr>(p_shared_library_->get_function_pointer("RFmxGSM_ORFSFetchModulationResultsArray"));
  function_pointers_.ORFSFetchSwitchingPowerTrace = reinterpret_cast<ORFSFetchSwitchingPowerTracePtr>(p_shared_library_->get_function_pointer("RFmxGSM_ORFSFetchSwitchingPowerTrace"));
  function_pointers_.ORFSFetchSwitchingResultsArray = reinterpret_cast<ORFSFetchSwitchingResultsArrayPtr>(p_shared_library_->get_function_pointer("RFmxGSM_ORFSFetchSwitchingResultsArray"));
  function_pointers_.PVTCfgAveraging = reinterpret_cast<PVTCfgAveragingPtr>(p_shared_library_->get_function_pointer("RFmxGSM_PVTCfgAveraging"));
  function_pointers_.PVTFetchMeasurementStatus = reinterpret_cast<PVTFetchMeasurementStatusPtr>(p_shared_library_->get_function_pointer("RFmxGSM_PVTFetchMeasurementStatus"));
  function_pointers_.PVTFetchPowerTrace = reinterpret_cast<PVTFetchPowerTracePtr>(p_shared_library_->get_function_pointer("RFmxGSM_PVTFetchPowerTrace"));
  function_pointers_.PVTFetchSlotMeasurement = reinterpret_cast<PVTFetchSlotMeasurementPtr>(p_shared_library_->get_function_pointer("RFmxGSM_PVTFetchSlotMeasurement"));
  function_pointers_.PVTFetchSlotMeasurementArray = reinterpret_cast<PVTFetchSlotMeasurementArrayPtr>(p_shared_library_->get_function_pointer("RFmxGSM_PVTFetchSlotMeasurementArray"));
  function_pointers_.ResetAttribute = reinterpret_cast<ResetAttributePtr>(p_shared_library_->get_function_pointer("RFmxGSM_ResetAttribute"));
  function_pointers_.ResetToDefault = reinterpret_cast<ResetToDefaultPtr>(p_shared_library_->get_function_pointer("RFmxGSM_ResetToDefault"));
  function_pointers_.SelectMeasurements = reinterpret_cast<SelectMeasurementsPtr>(p_shared_library_->get_function_pointer("RFmxGSM_SelectMeasurements"));
  function_pointers_.SendSoftwareEdgeTrigger = reinterpret_cast<SendSoftwareEdgeTriggerPtr>(p_shared_library_->get_function_pointer("RFmxGSM_SendSoftwareEdgeTrigger"));
  function_pointers_.SetAttributeF32 = reinterpret_cast<SetAttributeF32Ptr>(p_shared_library_->get_function_pointer("RFmxGSM_SetAttributeF32"));
  function_pointers_.SetAttributeF32Array = reinterpret_cast<SetAttributeF32ArrayPtr>(p_shared_library_->get_function_pointer("RFmxGSM_SetAttributeF32Array"));
  function_pointers_.SetAttributeF64 = reinterpret_cast<SetAttributeF64Ptr>(p_shared_library_->get_function_pointer("RFmxGSM_SetAttributeF64"));
  function_pointers_.SetAttributeF64Array = reinterpret_cast<SetAttributeF64ArrayPtr>(p_shared_library_->get_function_pointer("RFmxGSM_SetAttributeF64Array"));
  function_pointers_.SetAttributeI16 = reinterpret_cast<SetAttributeI16Ptr>(p_shared_library_->get_function_pointer("RFmxGSM_SetAttributeI16"));
  function_pointers_.SetAttributeI32 = reinterpret_cast<SetAttributeI32Ptr>(p_shared_library_->get_function_pointer("RFmxGSM_SetAttributeI32"));
  function_pointers_.SetAttributeI32Array = reinterpret_cast<SetAttributeI32ArrayPtr>(p_shared_library_->get_function_pointer("RFmxGSM_SetAttributeI32Array"));
  function_pointers_.SetAttributeI64 = reinterpret_cast<SetAttributeI64Ptr>(p_shared_library_->get_function_pointer("RFmxGSM_SetAttributeI64"));
  function_pointers_.SetAttributeI64Array = reinterpret_cast<SetAttributeI64ArrayPtr>(p_shared_library_->get_function_pointer("RFmxGSM_SetAttributeI64Array"));
  function_pointers_.SetAttributeI8 = reinterpret_cast<SetAttributeI8Ptr>(p_shared_library_->get_function_pointer("RFmxGSM_SetAttributeI8"));
  function_pointers_.SetAttributeI8Array = reinterpret_cast<SetAttributeI8ArrayPtr>(p_shared_library_->get_function_pointer("RFmxGSM_SetAttributeI8Array"));
  function_pointers_.SetAttributeNIComplexDoubleArray = reinterpret_cast<SetAttributeNIComplexDoubleArrayPtr>(p_shared_library_->get_function_pointer("RFmxGSM_SetAttributeNIComplexDoubleArray"));
  function_pointers_.SetAttributeNIComplexSingleArray = reinterpret_cast<SetAttributeNIComplexSingleArrayPtr>(p_shared_library_->get_function_pointer("RFmxGSM_SetAttributeNIComplexSingleArray"));
  function_pointers_.SetAttributeString = reinterpret_cast<SetAttributeStringPtr>(p_shared_library_->get_function_pointer("RFmxGSM_SetAttributeString"));
  function_pointers_.SetAttributeU16 = reinterpret_cast<SetAttributeU16Ptr>(p_shared_library_->get_function_pointer("RFmxGSM_SetAttributeU16"));
  function_pointers_.SetAttributeU32 = reinterpret_cast<SetAttributeU32Ptr>(p_shared_library_->get_function_pointer("RFmxGSM_SetAttributeU32"));
  function_pointers_.SetAttributeU32Array = reinterpret_cast<SetAttributeU32ArrayPtr>(p_shared_library_->get_function_pointer("RFmxGSM_SetAttributeU32Array"));
  function_pointers_.SetAttributeU64Array = reinterpret_cast<SetAttributeU64ArrayPtr>(p_shared_library_->get_function_pointer("RFmxGSM_SetAttributeU64Array"));
  function_pointers_.SetAttributeU8 = reinterpret_cast<SetAttributeU8Ptr>(p_shared_library_->get_function_pointer("RFmxGSM_SetAttributeU8"));
  function_pointers_.SetAttributeU8Array = reinterpret_cast<SetAttributeU8ArrayPtr>(p_shared_library_->get_function_pointer("RFmxGSM_SetAttributeU8Array"));
  function_pointers_.WaitForAcquisitionComplete = reinterpret_cast<WaitForAcquisitionCompletePtr>(p_shared_library_->get_function_pointer("RFmxGSM_WaitForAcquisitionComplete"));
  function_pointers_.WaitForMeasurementComplete = reinterpret_cast<WaitForMeasurementCompletePtr>(p_shared_library_->get_function_pointer("RFmxGSM_WaitForMeasurementComplete"));
}
