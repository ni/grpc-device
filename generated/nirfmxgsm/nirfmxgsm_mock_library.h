...
class NiRFmxGSMMockLibrary : public nirfmxgsm_grpc::NiRFmxGSMLibraryInterface {
 public:
  ...
  MOCK_METHOD(int32, PVTFetchMaximumAndMinimumPowerTrace, (niRFmxInstrHandle instrumentHandle, char selectorString[], float64 timeout, float64* x0, float64* dx, float32 maximumSignalPower[], float32 minimumSignalPower[], int32 arraySize, int32* actualArraySize), (override));
